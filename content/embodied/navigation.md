...
#### 📝 一句话总结
RTAB-MAP 的核心目标是：外观闭环大规模长期在线SLAM。
...
#### 📝 一句话总结
SemGauss-SLAM 的核心目标是：稠密语义高斯泼溅SLAM。
...
#### 📝 一句话总结
SDD-SLAM 的核心目标是：语义驱动动态场景高斯SLAM。
...
#### 📝 一句话总结
ReSemGS-SLAM 的核心目标是：实时语义一致性感知3DGS。
...
#### 📝 一句话总结
GTS-SLAM 的核心目标是：GICP+3DGS极端环境鲁棒SLAM。
...
#### 📝 一句话总结
OVSegDT 的核心目标是：分割Transformer精确目标识别。
...
#### 📝 一句话总结
Code as Policies 的核心目标是：LLM代码生成表达行为逻辑。
...
#### 📝 一句话总结
LLM-Planner 的核心目标是：少样本提示动态调整任务计划。
...
#### 📝 一句话总结
RoboHorizon 的核心目标是：世界模型多视角长程规划。
...
#### 📝 一句话总结
LLM-as-BT-Planner 的核心目标是：LLM生成可组合行为树。
...
#### 📝 一句话总结
OpenVLA-2 的核心目标是：200ms实时精确动作推理。
...
#### 📝 一句话总结
Gemini Robotics-ER 的核心目标是：高层空间推理任务编排。
...
#### 📝 一句话总结
PokeVLA 的核心目标是：1.22B轻量SEG几何对齐VLA。
...
#### 📝 一句话总结
GR00T N1.6 的核心目标是：双系统规划+扩散动作架构。
