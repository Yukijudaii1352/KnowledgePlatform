...
hero_pills:
- "\U0001F3F7️ PINN · Neural Operators · Differentiable Physics · AI4Science"
...
#### 📝 一句话总结
hp-VPINNs 的核心目标是：结合变分法与hp细化处理奇异性。
...
#### 📝 一句话总结
gPINN 的核心目标是：加入PDE残差梯度提升稀疏数据精度。
...
#### 📝 一句话总结
ReLoBRaLo 的核心目标是：基于损失变化率动态平衡权重。
...
#### 📝 一句话总结
Frozen-PINN 的核心目标是：无梯度训练加速46-2945倍。
...
#### 📝 一句话总结
PIKANs 的核心目标是：KAN可学习激活函数提升高维精度。
...
#### 📝 一句话总结
Scale-PINN 的核心目标是：序列修正机制处理多尺度PDE。
...
#### 📝 一句话总结
DC-PINNs 的核心目标是：显式编码导数约束确保物理一致性。
...
#### 📝 一句话总结
SIMPLE-PINN 的核心目标是：引入CFD压力修正逻辑。
...
#### 📝 一句话总结
FNO 的核心目标是：傅里叶空间参数化积分核实现高效全局卷积。
...
#### 📝 一句话总结
Poseidon 的核心目标是：PDE基础模型20样本达FNO千样本精度。
...
#### 📝 一句话总结
GINOT 的核心目标是：Transformer与神经算子集成。
...
#### 📝 一句话总结
PI-Latent-NO 的核心目标是：潜空间算子学习线性计算缩放。
...
#### 📝 一句话总结
DiffTaichi 的核心目标是：基于Taichi的自动微分比传统快188倍。
...
#### 📝 一句话总结
NVIDIA-Warp 的核心目标是：Python编译为CUDA支持大规模微分模拟。
...
#### 📝 一句话总结
PIE-NeRF 的核心目标是：隐式NeRF无网格离散化形变模拟。
...
#### 📝 一句话总结
JAX-MPM 的核心目标是：统一拉格朗日-欧拉数据同化GPU框架。
...
#### 📝 一句话总结
AS-DiffMPM 的核心目标是：可微分碰撞处理复杂系统辨识。
...
#### 📝 一句话总结
POD-DL-ROM 的核心目标是：POD+Autoencoder加速140-3800倍。
...
#### 📝 一句话总结
NeuralPDE-jl 的核心目标是：Julia高性能符号微分框架。
...
#### 📝 一句话总结
PhysicsNeMo-v2 的核心目标是：PyTorch原生架构GNN速度提升2倍。
...
#### 📝 一句话总结
Mollifier-Layers 的核心目标是：平滑层处理噪声逆向PDE求解。
