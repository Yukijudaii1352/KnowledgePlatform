/**
 * vla-data.js — 由 pipeline/build.py 于 2026-05-21 16:52:36 自动生成。
  ...
  "algos": [
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "训练目标是 <strong>conditional flow matching</strong>，直接建模 \\(p(A_t \\mid o_t)\\) 的连续动作分布",
