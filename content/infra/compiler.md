...
hero_pills:
- "\U0001F3F7️ Deep Learning Compiler · Graph Optimization · Kernel Synthesis · LLM-Driven
  Compilation"
...
#### 📝 一句话总结
TC 的核心目标是：数学符号描述张量运算，多面体编译自动生成CUDA代码。
...
#### 📝 一句话总结
Quantix 的核心目标是：3-bit非均匀量化编译优化，大幅提升LLM推理吞吐。
