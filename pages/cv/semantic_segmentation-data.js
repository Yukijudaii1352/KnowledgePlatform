/**
 * semantic_segmentation-data.js — 由 pipeline/build.py 于 2026-06-16 17:00:11 自动生成。
...
window.PAGE_CONFIG = {
  ...
  "overview": [
    {
      "title": "",
      "body_html": "<h1>语义分割模型架构</h1>\n<ul>\n<li>来源平台: <strong>zhihu</strong>（知乎专栏文章）</li>\n<li>原文链接: <a href=\"https://zhuanlan.zhihu.com/p/2012918143731916856\">https://zhuanlan.zhihu.com/p/2012918143731916856</a></li>\n<li>作者: 考拉</li>\n</ul>\n<hr />\n<p>语义分割模型架构</p>\n<h1>语义分割模型架构</h1>\n<p>作者: 考拉, 赞: 4</p>\n<p>结合 <code>segmentation_models_pytorch</code> (SMP) 库的支持情况与计算机视觉领域的最新进展，以下是语义分割模型架构从经典 CNN 到现代 Transformer 及混合架构的近几年发展脉络梳理。</p>\n<hr />\n<h3>1. 发展脉络总览：从 CNN 主导到 Transformer 融合</h3>\n<p>语义分割架构的演进大致经历了三个阶段：<strong>全卷积网络奠基期</strong> <img alt=\"\\rightarrow\" src=\"https://www.zhihu.com/equation?tex=%5Crightarrow\" /> <strong>多尺度与注意力机制优化期</strong> <img alt=\"\\rightarrow\" src=\"https://www.zhihu.com/equation?tex=%5Crightarrow\" /> <strong>Transformer 与混合架构爆发期</strong>。</p>\n<h3>第一阶段：CNN 奠基与编码器 - 解码器范式确立 (2015-2018)</h3>\n<p>这一阶段确立了“编码器提取特征 + 解码器恢复分辨率”的主流范式。SMP 库中的经典模型多源于此时期。</p>\n<ul>\n<li><strong>FCN (Fully Convolutional Networks)</strong>: 开创了端到端像素级分类的先河，用卷积层替代全连接层。</li>\n<li>\n<p><strong>U-Net (2015)</strong>: 医学影像领域的里程碑。引入<strong>跳跃连接 (Skip Connections)</strong>，将编码器的浅层细节特征与解码器的深层语义特征融合，极大提升了边界分割精度。</p>\n</li>\n<li>\n<p><em>SMP 支持</em>: <code>Unet</code></p>\n</li>\n<li>\n<p><strong>SegNet / FC-DenseNet</strong>: 探索了不同的上采样策略（如索引上采样）和密集连接。</p>\n</li>\n<li>\n<p><em>SMP 支持</em>: <code>Linknet</code> (类似 SegNet 但使用加法融合), <code>FPN</code> (特征金字塔)。</p>\n</li>\n<li>\n<p><strong>DeepLab 系列 (v2/v3)</strong>: 引入<strong>空洞卷积 (Atrous Convolution)</strong> 扩大感受野而不降低分辨率，并提出 <strong>ASPP (空洞空间金字塔池化)</strong> 处理多尺度目标。</p>\n</li>\n<li>\n<p><em>SMP 支持</em>: <code>DeepLabV3</code>, <code>DeepLabV3+</code> (增加了decoder模块以恢复边缘细节)。</p>\n</li>\n<li>\n<p><strong>PSPNet</strong>: 提出金字塔池化模块，聚合不同区域的上下文信息。</p>\n</li>\n<li>\n<p><em>SMP 支持</em>: <code>PSPNet</code></p>\n</li>\n</ul>\n<h3>第二阶段：高效架构与注意力机制深化 (2019-2021)</h3>\n<p>研究重点转向如何在保持精度的同时提升效率，以及通过注意力机制更精准地聚焦关键区域。</p>\n<ul>\n<li>\n<p><strong>UNet++</strong>: 对 U-Net 的跳跃连接进行稠密重组，通过嵌套和密集的卷积块弥合编码器与解码器之间的语义鸿沟。</p>\n</li>\n<li>\n<p><em>SMP 支持</em>: <code>UnetPlusPlus</code></p>\n</li>\n<li>\n<p><strong>PANet / BiSeNet</strong>: 针对实时性需求，设计双路径（空间路径+上下文路径）或自底向上的路径增强，平衡速度与精度。</p>\n</li>\n<li><strong>EfficientNet 作为 Backbone</strong>: 随着分类领域 EfficientNet 的提出，SMP 迅速集成其作为编码器，显著提升了分割模型的参效比。</li>\n</ul>\n<h3>第三阶段：Transformer 崛起与 CNN-Transformer 混合 (2021-2024)</h3>\n<p>Vision Transformer (ViT) 的出现打破了 CNN 的垄断，全局建模能力成为新宠。</p>\n<ul>\n<li>\n<p><strong>Pure Transformer 架构</strong>:</p>\n</li>\n<li>\n<p><strong>SegFormer (2021)</strong>: 摒弃了复杂的位置编码和逐像素解码器，采用轻量级 MLP 解码器和层次化 Transformer 编码器，成为当时的 SOTA。</p>\n</li>\n<li>\n<p><em>SMP 支持</em>: <code>Segformer</code></p>\n</li>\n<li>\n<p><strong>Mask2Former / OneFormer</strong>: 将分割任务统一为掩码分类问题，支持全景、实例和语义分割的统一框架（注：SMP 主要关注纯语义分割，此类通用框架多见于 Detectron2 或 MMSegmentation，但理念影响深远）。</p>\n</li>\n<li>\n<p><strong>混合架构 (Hybrid Models)</strong>: 结合 CNN 的局部特征提取优势和 Transformer 的全局上下文能力。</p>\n</li>\n<li>\n<p><strong>ConvNeXt</strong>: 将 CNN 改造得具有 Transformer 风格（大核卷积、LayerNorm 等），在分割任务中表现优异，常被用作 SMP 的强力编码器。</p>\n</li>\n<li><strong>Swin Transformer</strong>: 引入滑动窗口机制，降低了计算复杂度，成为许多高端分割模型的默认 Backbone。</li>\n<li>\n<p><strong>DPT (Dense Prediction Transformer)</strong>: 专为密集预测任务设计的 Transformer，能有效融合不同层级的 Token 特征。</p>\n</li>\n<li>\n<p><em>SMP 支持</em>: <code>DPT</code> (部分版本或通过 timm 集成)</p>\n</li>\n</ul>\n<h3>第四阶段：大模型适配与特定场景优化 (2024-2026 趋势)</h3>\n<p>进入 2024-2026 年，发展呈现以下新趋势（部分已在 SMP 的最新版本或社区扩展中体现）：</p>\n<ul>\n<li><strong>基础模型微调 (Foundation Model Adaptation)</strong>: 利用 SAM (Segment Anything Model) 或大型视觉语言模型 (VLM) 的预训练权重进行微调。虽然 SAM 本身是实例分割，但其编码器被广泛用于语义分割任务的特征提取。</li>\n<li><strong>开放词汇分割 (Open-Vocabulary Segmentation)</strong>: 结合 CLIP 等图文对齐模型，实现未见类别的分割。</li>\n<li><strong>轻量化与边缘部署</strong>: 针对移动端优化的架构（如 MobileViT, FastSCNN 的改进版）再次受到重视，配合量化感知训练。</li>\n<li><strong>Mamba/SSM 架构探索</strong>: 2024 年后，基于状态空间模型 (State Space Models, 如 VM-UNet) 的架构开始涌现，试图以线性复杂度解决长序列依赖问题，是继 Transformer 后的新热点。</li>\n</ul>\n<hr />\n<h3>2. <code>segmentation_models_pytorch</code> (SMP) 中的架构映射</h3>\n<p>SMP 库因其模块化设计（Encoder-Decoder 解耦），完美记录了这一演进过程。用户可以通过更换 <code>encoder_name</code> 轻松体验不同时代的架构。</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>架构类型</th>\n<th>代表模型 (SMP Class)</th>\n<th>核心特点</th>\n<th>典型 Encoder (Backbone)</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>经典 CNN</td>\n<td>Unet, Linknet, FPN</td>\n<td>跳跃连接、特征金字塔、简单高效</td>\n<td>ResNet, VGG, MobileNetV2</td>\n</tr>\n<tr>\n<td>多尺度/空洞</td>\n<td>DeepLabV3, DeepLabV3+, PSPNet</td>\n<td>空洞卷积、ASPP、全局池化</td>\n<td>ResNet, Xception, EfficientNet</td>\n</tr>\n<tr>\n<td>嵌套/稠密</td>\n<td>UnetPlusPlus, MAnet (Multi-scale Attention Net)</td>\n<td>密集连接、多尺度注意力</td>\n<td>DenseNet, EfficientNet</td>\n</tr>\n<tr>\n<td>Transformer</td>\n<td>Segformer</td>\n<td>无位置编码、层次化 ViT、MLP Decoder</td>\n<td>MiT (Mix Vision Transformer)</td>\n</tr>\n<tr>\n<td>混合/现代</td>\n<td>DPT, FPN (with Swin/ConvNeXt)</td>\n<td>全局上下文、强特征表达</td>\n<td>Swin Transformer, ConvNeXt, ViT</td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>代码示例 (体现架构演进):</strong></p>\n<pre><code>import segmentation_models_pytorch as smp\n\n# 1. 经典时代 (2015-2017): U-Net + ResNet34\nmodel_classic = smp.Unet(\n    encoder_name=&quot;resnet34&quot;,        \n    encoder_weights=&quot;imagenet&quot;,     \n    in_channels=3,                  \n    classes=10                      \n)\n\n# 2. 高效时代 (2019-2020): DeepLabV3+ + EfficientNet-B4\nmodel_efficient = smp.DeepLabV3Plus(\n    encoder_name=&quot;efficientnet-b4&quot;, \n    encoder_weights=&quot;imagenet&quot;,     \n    in_channels=3,                  \n    classes=10                      \n)\n\n# 3. Transformer 时代 (2021-2023): SegFormer (纯 Transformer)\nmodel_transformer = smp.Segformer(\n    encoder_name=&quot;mit_b2&quot;,          # Mix Vision Transformer\n    encoder_weights=&quot;imagenet&quot;,     \n    in_channels=3,                  \n    classes=10                      \n)\n\n# 4. 混合/前沿时代 (2024+): FPN + ConvNeXt Large (类 Transformer 的 CNN)\nmodel_hybrid = smp.FPN(\n    encoder_name=&quot;convnext_large&quot;,  \n    encoder_weights=&quot;imagenet&quot;,     \n    in_channels=3,                  \n    classes=10                      \n)\n</code></pre>\n<hr />\n<h3>2.1. 模型架构与核心参数对照表</h3>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>模型名称</th>\n<th>SMP 类名</th>\n<th>提出年份</th>\n<th>核心机制</th>\n<th>关键参数 (Arguments)</th>\n<th>适用场景</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>U-Net</td>\n<td>smp.Unet</td>\n<td>2015</td>\n<td>跳跃连接 (Skip Connections)：将编码器浅层特征直接拼接到解码器，保留细节。</td>\n<td>encoder_depth (默认5), decoder_channels (每层通道数), decoder_block_type (‘transpose’, ‘upsampling’, ‘pixelshuffle’)</td>\n<td>医学影像、小数据集、需要精细边缘的任务</td>\n</tr>\n<tr>\n<td>U-Net++</td>\n<td>smp.UnetPlusPlus</td>\n<td>2018</td>\n<td>稠密跳跃连接：在 U-Net 基础上增加嵌套卷积块，弥合语义鸿沟。</td>\n<td>encoder_depth, decoder_channels, deep_supervision (是否启用深监督，默认False)</td>\n<td>复杂背景下的精细分割，医学影像</td>\n</tr>\n<tr>\n<td>LinkNet</td>\n<td>smp.Linknet</td>\n<td>2017</td>\n<td>残差加法融合：类似 ResNet 结构，使用加法而非拼接融合特征，速度较快。</td>\n<td>encoder_depth, decoder_channels</td>\n<td>实时性要求较高、显存受限的场景</td>\n</tr>\n<tr>\n<td>FPN (Feature Pyramid Network)</td>\n<td>smp.FPN</td>\n<td>2017</td>\n<td>特征金字塔：自顶向下构建多尺度特征图，擅长处理多尺度目标。</td>\n<td>encoder_depth, decoder_pyramid_channels (金字塔通道数), decoder_segmentation_channels</td>\n<td>遥感图像、目标尺度变化大的场景</td>\n</tr>\n<tr>\n<td>PSPNet (Pyramid Scene Parsing)</td>\n<td>smp.PSPNet</td>\n<td>2017</td>\n<td>金字塔池化模块 (PPM)：聚合不同区域的上下文信息，增强全局理解。</td>\n<td>encoder_depth, psp_dim (池化后维度), dropout</td>\n<td>场景解析、需要强全局上下文的任务</td>\n</tr>\n<tr>\n<td>DeepLabV3</td>\n<td>smp.DeepLabV3</td>\n<td>2017</td>\n<td>空洞空间金字塔池化 (ASPP)：并行不同膨胀率的空洞卷积捕捉多尺度信息。</td>\n<td>encoder_depth, atrous_rates (膨胀率列表), aspp_out_channels, add_background</td>\n<td>通用语义分割，Pascal VOC/Cityscapes</td>\n</tr>\n<tr>\n<td>DeepLabV3+</td>\n<td>smp.DeepLabV3Plus</td>\n<td>2018</td>\n<td>编码器 - 解码器 + ASPP：在 DeepLabV3 基础上增加简单解码器，恢复物体边界。</td>\n<td>encoder_depth, atrous_rates, decoder_channels (通常256), decoder_dropout</td>\n<td>对边缘精度要求高的通用任务 (目前最流行之一)</td>\n</tr>\n<tr>\n<td>PAN (Pyramid Attention Network)</td>\n<td>smp.PAN</td>\n<td>2018</td>\n<td>注意力特征金字塔：在 FPN 基础上引入注意力机制，过滤背景噪声。</td>\n<td>encoder_depth, decoder_pyramid_channels</td>\n<td>背景复杂、干扰较多的场景</td>\n</tr>\n<tr>\n<td>SegFormer</td>\n<td>smp.Segformer</td>\n<td>2021</td>\n<td>纯 Transformer：层次化 ViT 编码器 + 轻量级 MLP 解码器，无位置编码。</td>\n<td>encoder_name (必须为 mit_b0~b5), classes, dropout</td>\n<td>SOTA 性能追求、大数据集、多尺度场景</td>\n</tr>\n<tr>\n<td>DPT (Dense Prediction Transformer)</td>\n<td>smp.DPT</td>\n<td>2021</td>\n<td>Transformer 特征重组：专为密集预测设计的 Token 重组与融合机制。</td>\n<td>encoder_name (vitb_rn50_384等), use_bn</td>\n<td>高精度需求，尤其是深度估计或精细分割</td>\n</tr>\n</tbody>\n</table></div>\n<hr />\n<h3>2.2 通用参数详解 (适用于所有 SMP 模型)</h3>\n<p>在实例化上述任何模型时，以下参数是通用的，决定了模型的行为和容量：</p>\n<h3>A. 编码器相关 (Encoder)</h3>\n<ul>\n<li>\n<p><strong><code>encoder_name</code></strong> (str):</p>\n</li>\n<li>\n<p>选择骨干网络。SMP 支持数十种预训练模型。</p>\n</li>\n<li><em>经典 CNN</em>: <code>'resnet34'</code>, <code>'resnet50'</code>, <code>'efficientnet-b0'</code> ~ <code>'b7'</code>, <code>'mobilenet_v2'</code>.</li>\n<li><em>Transformer</em>: <code>'mit_b0'</code> ~ <code>'mit_b5'</code> (SegFormer专用), <code>'swin_base_patch4_window7_224'</code>, <code>'convnext_base'</code>.</li>\n<li>\n<p><em>特殊</em>: <code>'timm-efficientnet-b0'</code> (使用 timm 库的变体).</p>\n</li>\n<li>\n<p><strong><code>encoder_weights</code></strong> (str, optional):</p>\n</li>\n<li>\n<p>预训练权重来源。常用值：<code>'imagenet'</code> (最推荐), <code>'cityscapes'</code>, <code>None</code> (随机初始化).</p>\n</li>\n<li>\n<p><strong><code>encoder_depth</code></strong> (int):</p>\n</li>\n<li>\n<p>编码器的下采样次数。通常为 3, 4, 或 5。</p>\n</li>\n<li>深度越大，感受野越大，但空间分辨率越低，计算量越大。默认通常为 5。</li>\n</ul>\n<h3>B. 解码器与输出相关 (Decoder &amp; Output)</h3>\n<ul>\n<li>\n<p><strong><code>classes</code></strong> (int):</p>\n</li>\n<li>\n<p><strong>必填</strong>。分割的类别数量（包括背景）。例如 Cityscapes 为 19 或 20 (含背景)。</p>\n</li>\n<li>\n<p><strong><code>activation</code></strong> (str or callable):</p>\n</li>\n<li>\n<p>输出层的激活函数。</p>\n</li>\n<li>二分类：<code>'sigmoid'</code></li>\n<li>多分类：<code>'softmax'</code> (如果 loss 使用 CrossEntropy 且 target 是单通道标签，则模型输出通常不需要 activation，设为 <code>None</code>，由 Loss 函数处理；若 target 是 One-hot，则用 <code>'softmax'</code>)。</li>\n<li>\n<p>默认：<code>None</code>。</p>\n</li>\n<li>\n<p><strong><code>decoder_channels</code></strong> (list of int):</p>\n</li>\n<li>\n<p>解码器每一层的输出通道数。列表长度通常等于 <code>encoder_depth</code>。</p>\n</li>\n<li>例如 <code>[256, 128, 64, 32, 16]</code>。通道数越多，特征表达越强，但显存占用越高。</li>\n</ul>\n<h3>C. 进阶参数</h3>\n<ul>\n<li>\n<p><strong><code>aux_params</code></strong> (dict, optional):</p>\n</li>\n<li>\n<p>用于添加辅助分类头（例如同时做图像分类和分割）。</p>\n</li>\n<li>\n<p>格式：<code>{'pooling': 'avg', 'dropout': 0.5, 'classes': 10}</code>。</p>\n</li>\n<li>\n<p><strong><code>deep_supervision</code></strong> (bool, 仅部分模型如 UnetPlusPlus):</p>\n</li>\n<li>\n<p>是否在中间层输出辅助损失，有助于深层网络收敛。</p>\n</li>\n</ul>\n<hr />\n<h3>2.3 代码示例：如何配置不同经典模型</h3>\n<p>以下是针对几种典型场景的参数配置示例：</p>\n<h3>场景 A：医学影像小数据集 (追求细节，防止过拟合)</h3>\n<p>使用 <strong>U-Net</strong> + 轻量级 Encoder (MobileNetV2) + 深监督。</p>\n<pre><code>import segmentation_models_pytorch as smp\n\nmodel = smp.Unet(\n    encoder_name=&quot;mobilenet_v2&quot;,        # 轻量级 backbone，适合小数据\n    encoder_weights=&quot;imagenet&quot;,         # 使用 ImageNet 预训练加速收敛\n    in_channels=1,                      # 灰度图\n    classes=2,                          # 前景 + 背景\n    encoder_depth=5,                    # 标准深度\n    decoder_channels=[256, 128, 64, 32, 16],\n    # Unet 本身不支持 deep_supervision 参数直接传入 init，需在训练循环处理或使用 UnetPlusPlus\n)\n</code></pre>\n<h3>场景 B：自动驾驶/街景 (追求多尺度与边缘精度)</h3>\n<p>使用 <strong>DeepLabV3+</strong> + 强力 Encoder (EfficientNet-B4)。</p>\n<pre><code>model = smp.DeepLabV3Plus(\n    encoder_name=&quot;efficientnet-b4&quot;,     # 精度高，参效比好\n    encoder_weights=&quot;imagenet&quot;,\n    in_channels=3,\n    classes=19,                         # Cityscapes 类别数\n    decoder_channels=256,               # DeepLabV3+ 解码器固定通道数配置\n    dropout=0.1                         # 防止过拟合\n)\n</code></pre>\n<h3>场景 C：遥感/大场景 (追求全局上下文与 SOTA 性能)</h3>\n<p>使用 <strong>SegFormer</strong> (Transformer 架构)。</p>\n<pre><code>model = smp.Segformer(\n    encoder_name=&quot;mit_b2&quot;,              # Mix Vision Transformer Base\n    encoder_weights=&quot;imagenet&quot;,\n    in_channels=3,\n    classes=10,\n    dropout=0.1\n)\n# 注意：SegFormer 的 encoder_depth 和 decoder 结构是固定的，由 encoder_name 决定\n</code></pre>\n<h3>场景 D：实时嵌入式部署 (追求速度)</h3>\n<p>使用 <strong>LinkNet</strong> + MobileNet 或 ResNet18。</p>\n<pre><code>model = smp.Linknet(\n    encoder_name=&quot;resnet18&quot;,\n    encoder_weights=&quot;imagenet&quot;,\n    in_channels=3,\n    classes=5,\n    encoder_depth=5,\n    decoder_channels=[512, 256, 128, 64, 32] # LinkNet 通常通道数较大，可尝试减小以加速\n)\n</code></pre>\n<hr />\n<h3>3. 常见 Encoder 名称速查表 (SMP 支持的部分热门项)</h3>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>系列</th>\n<th>常用 encoder_name 字符串</th>\n<th>特点</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>ResNet</td>\n<td>'resnet18', 'resnet34', 'resnet50', 'resnet101'</td>\n<td>经典稳定，社区资源最丰富</td>\n</tr>\n<tr>\n<td>EfficientNet</td>\n<td>'efficientnet-b0' … 'efficientnet-b7'</td>\n<td>参效比极高，B0-B3 适合移动端，B4-B7 适合服务器</td>\n</tr>\n<tr>\n<td>MobileNet</td>\n<td>'mobilenet_v2', 'mobilenet_v3_large', 'mobilenet_v3_small'</td>\n<td>极致轻量，专为移动端设计</td>\n</tr>\n<tr>\n<td>Vision Transformer</td>\n<td>'mit_b0' … 'mit_b5'</td>\n<td>SegFormer 专用，性能强劲</td>\n</tr>\n<tr>\n<td>Swin Transformer</td>\n<td>'swin_tiny_patch4_window7_224', 'swin_base...'</td>\n<td>滑动窗口机制，适合密集预测</td>\n</tr>\n<tr>\n<td>ConvNeXt</td>\n<td>'convnext_tiny', 'convnext_base', 'convnext_large'</td>\n<td>CNN 架构，Transformer 性能，训练稳定</td>\n</tr>\n<tr>\n<td>DenseNet</td>\n<td>'densenet121', 'densenet169'</td>\n<td>特征复用率高，显存占用稍大</td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>提示</strong>：若要查看当前安装的 SMP 版本支持的所有 encoder 名称，可运行：</p>\n<pre><code>import segmentation_models_pytorch as smp\nprint(smp.encoders.get_encoders_names())\n</code></pre>\n<hr />\n<h3>3.1 常用 <code>encoder_weights</code> 选项总览</h3>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>选项值</th>\n<th>含义</th>\n<th>数据来源</th>\n<th>适用场景</th>\n<th>推荐指数</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>'imagenet'</td>\n<td>ImageNet 预训练</td>\n<td>1000 类自然图像分类任务</td>\n<td>通用首选。适用于绝大多数自然图像分割任务（如街景、医疗、遥感、工业检测）。能提取通用的边缘、纹理特征。</td>\n<td>⭐⭐⭐⭐⭐</td>\n</tr>\n<tr>\n<td>'cityscapes'</td>\n<td>Cityscapes 预训练</td>\n<td>城市街景语义分割任务</td>\n<td>特定领域。仅当你的任务也是城市道路场景（自动驾驶、路面分析）且类别与 Cityscapes 高度重合时使用。</td>\n<td>⭐⭐⭐ (限场景)</td>\n</tr>\n<tr>\n<td>None</td>\n<td>随机初始化</td>\n<td>无 (Kaiming/ Xavier 初始化)</td>\n<td>特殊数据。当输入数据分布与自然图像差异极大（如声纳图、X 光灰度图且通道数不匹配、红外热成像），或进行大规模自监督预训练时。</td>\n<td>⭐⭐</td>\n</tr>\n<tr>\n<td>'ssl' / 'swag'</td>\n<td>自监督/弱监督预训练</td>\n<td>Instagram YFCC100M 等大规模数据</td>\n<td>前沿探索。部分新架构（如某些 Swin 或 ResNet 变体）支持 Facebook AI 的 SSL/SWAG 权重，通常在下游任务表现优于 ImageNet，但 SMP 支持需视具体 encoder 而定。</td>\n<td>⭐⭐⭐</td>\n</tr>\n</tbody>\n</table></div>\n<hr />\n<h3>3.2 详细场景分析与选择策略</h3>\n<h3>A. <code>'imagenet'</code> (最常用，默认推荐)</h3>\n<ul>\n<li><strong>原理</strong>：模型已经在 1400 万张图像上学习到了从低级边缘到高级物体部件的特征表示。</li>\n<li>\n<p><strong>优势</strong>：</p>\n</li>\n<li>\n<p><strong>收敛快</strong>：只需少量 epoch 即可达到较好效果。</p>\n</li>\n<li><strong>泛化强</strong>：即使是非自然图像（如医学 CT、卫星图），底层的卷积核（检测边缘、角点）依然有效。</li>\n<li>\n<p><strong>兼容性</strong>：SMP 中 95% 以上的 <code>encoder_name</code> 都支持此选项。</p>\n</li>\n<li>\n<p><strong>注意</strong>：如果你的输入是单通道灰度图 (<code>in_channels=1</code>)，SMP 会自动将单通道复制为 3 通道以匹配 ImageNet 预训练权重，或者对权重第一层进行平均池化处理（取决于具体实现版本，通常自动处理）。</p>\n</li>\n</ul>\n<h3>B. <code>'cityscapes'</code> (仅限街景)</h3>\n<ul>\n<li><strong>原理</strong>：权重是在 Cityscapes 数据集（5000 张精细标注的城市街景图）上训练得到的分割模型权重。</li>\n<li>\n<p><strong>限制</strong>：</p>\n</li>\n<li>\n<p><strong>架构限制</strong>：通常只支持特定的编码器 - 解码器组合（如 DeepLabV3+ with ResNet101, PSPNet with ResNet50 等），并非所有 <code>encoder_name</code> 都有此权重。</p>\n</li>\n<li>\n<p><strong>类别限制</strong>：Cityscapes 只有 19 个类别（路、人、车、建筑等）。如果你要做天空、草地、动物的细分，这个权重可能不如 ImageNet 通用，因为它过度拟合了城市场景的统计分布。</p>\n</li>\n<li>\n<p><strong>何时使用</strong>：当你做自动驾驶相关任务，且希望模型开局就懂得“什么是路”、“什么是车道线”时。</p>\n</li>\n</ul>\n<h3>C. <code>None</code> (随机初始化)</h3>\n<ul>\n<li>\n<p><strong>何时必须使用</strong>：</p>\n</li>\n<li>\n<p><strong>输入通道数特殊</strong>：例如输入是 4 通道（RGB + 深度）或 6 通道（多光谱），且你不想通过简单的加权平均来适配 3 通道权重，希望从头学习通道间的关系。</p>\n</li>\n<li><strong>数据域差异极大</strong>：例如合成孔径雷达 (SAR) 图像、显微镜下的细胞相位图，其纹理特征与自然图像完全不同，ImageNet 权重可能带来负迁移（Negative Transfer）。</li>\n<li>\n<p><strong>研究目的</strong>：需要验证架构本身的有效性，排除预训练带来的偏差。</p>\n</li>\n<li>\n<p><strong>缺点</strong>：需要更多的数据和更长的训练时间，容易陷入局部最优。</p>\n</li>\n</ul>\n<hr />\n<h3>3.3 代码示例：不同权重的配置</h3>\n<h3>示例 1：标准自然图像分割 (推荐)</h3>\n<pre><code>import segmentation_models_pytorch as smp\n\n# 使用 ImageNet 预训练的 EfficientNet-B4\nmodel = smp.DeepLabV3Plus(\n    encoder_name=&quot;efficientnet-b4&quot;,\n    encoder_weights=&quot;imagenet&quot;,  # &lt;--- 关键设置\n    in_channels=3,\n    classes=21\n)\n</code></pre>\n<h3>示例 2：城市街景专用 (如果支持)</h3>\n<p><em>注意：并非所有 encoder 都有 cityscapes 权重，需查阅 SMP 文档或尝试捕获异常。</em></p>\n<pre><code>try:\n    model = smp.PSPNet(\n        encoder_name=&quot;resnet50&quot;,\n        encoder_weights=&quot;cityscapes&quot;, # &lt;--- 仅在特定组合下可用\n        in_channels=3,\n        classes=19\n    )\n    print(&quot;成功加载 Cityscapes 权重&quot;)\nexcept ValueError as e:\n    print(f&quot;该编码器不支持 Cityscapes 权重: {e}&quot;)\n    # 降级方案\n    model = smp.PSPNet(\n        encoder_name=&quot;resnet50&quot;,\n        encoder_weights=&quot;imagenet&quot;,\n        in_channels=3,\n        classes=19\n    )\n</code></pre>\n<h3>示例 3：特殊通道数/领域 (随机初始化)</h3>\n<p>假设输入是 4 通道遥感影像 (R, G, B, Near-Infrared)。</p>\n<pre><code>model = smp.Unet(\n    encoder_name=&quot;resnet34&quot;,\n    encoder_weights=None,          # &lt;--- 不使用预训练，避免通道不匹配\n    in_channels=4,                 # 4 通道输入\n    classes=5\n)\n# 提示：如果使用 None，建议配合较强的数据增强和更长的训练周期\n</code></pre>\n<h3>示例 4：灰度图医学影像 (巧妙使用 ImageNet)</h3>\n<p>虽然输入是 1 通道，但通常仍推荐使用 ImageNet 权重，SMP 会自动处理。</p>\n<pre><code>model = smp.Unet(\n    encoder_name=&quot;mobilenet_v2&quot;,\n    encoder_weights=&quot;imagenet&quot;,    # &lt;--- SMP 内部会将 3 通道权重适配给 1 通道输入\n    in_channels=1,                 # 输入是灰度图\n    classes=2\n)\n# 原理：SMP 通常会对预训练权重的第一层卷积核在通道维度求平均，或者将输入灰度图复制3份。\n</code></pre>\n<hr />\n<h3>3.4 如何查询当前支持的权重？</h3>\n<p>你可以使用 SMP 提供的 API 来查询特定编码器支持哪些权重：</p>\n<pre><code>import segmentation_models_pytorch as smp\n\nencoder_name = &quot;resnet50&quot;\n\n# 获取该编码器的所有可用权重名称\navailable_weights = smp.encoders.get_pretrained_cfg(encoder_name).weights\n\nprint(f&quot;Encoder '{encoder_name}' 支持的权重: {available_weights}&quot;)\n\n# 输出示例: ['imagenet', 'cityscapes', 'ssl', 'swag'] (具体取决于版本和编码器)\n</code></pre>\n<hr />\n<h3>3.5 总结建议</h3>\n<ol>\n<li><strong>默认规则</strong>：除非你有非常充分的理由，否则<strong>永远优先选择 <code>encoder_weights='imagenet'</code></strong>。</li>\n<li><strong>特殊领域</strong>：如果是自动驾驶街景，可以尝试 <code>'cityscapes'</code>，但如果报错或不支持，回退到 <code>'imagenet'</code> 通常也能得到很好的结果。</li>\n<li><strong>非 RGB 输入</strong>：即使是红外、雷达或医学影像，<code>'imagenet'</code> 的底层特征（边缘、斑点检测）通常仍然比随机初始化 <code>None</code> 更有用。只有在输入通道数极其特殊或数据分布完全异质时，才考虑 <code>None</code>。</li>\n</ol>"
    }
  ],
  "latest_overview": [
    {
      "title": "",
      "body_html": "<h1>ICML 2026｜不用训练、不靠 SAM，VIP 让开放词汇分割再涨 8.4 mIoU</h1>\n<ul>\n<li>来源平台: <strong>zhihu</strong>（知乎专栏文章）</li>\n<li>原文链接: <a href=\"https://zhuanlan.zhihu.com/p/2038204608389067811\">https://zhuanlan.zhihu.com/p/2038204608389067811</a></li>\n<li>作者: 智能CV</li>\n</ul>\n<hr />\n<p>ICML 2026｜不用训练、不靠 SAM，VIP 让开放词汇分割再涨 8.4 mIoU</p>\n<h1>ICML 2026｜不用训练、不靠 SAM，VIP 让开放词汇分割再涨 8.4 mIoU</h1>\n<p>作者: 智能CV, 赞: 7</p>\n<p><img alt=\"\" src=\"https://pica.zhimg.com/v2-f4cfe5def7f0db87593b2aef306a3c84_1440w.jpg\" /></p>\n<p>论文：<a href=\"https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/2605.12325\">https://arxiv.org/pdf/2605.12325</a></p>\n<p>代码：<a href=\"https://link.zhihu.com/?target=https%3A//github.com/MiSsU-HH/VIP\">https://github.com/MiSsU-HH/VIP</a></p>\n<h3><strong>一、研究方向及背景</strong></h3>\n<p>这篇论文关注的是 <strong>Open-Vocabulary Semantic Segmentation, OVSS，开放词汇语义分割</strong>：给定任意文本类别，例如 <em>person / bus / building</em>，模型需要在图像中分割出对应区域。传统方法往往需要微调视觉语言模型，或者训练额外模块，依赖人工标注和训练成本；近年的训练自由方法则尝试直接利用 CLIP 的图文对齐能力做 dense prediction。</p>\n<p><img alt=\"\" src=\"https://pic3.zhimg.com/v2-4a0bec0f0610302c2aa09e2834b094be_1440w.jpg\" /></p>\n<p>但作者指出，<strong>CLIP 的图文对齐主要发生在全局图像级别</strong>，其 patch-level dense feature 天然缺少精细空间感知能力。因此，很多方法通过修改最后一层 self-attention 来恢复空间结构，但 CLIP 的空间偏差与跨模态对齐纠缠较深，进一步扩展 attention modulation 反而可能破坏图文对齐，如原文 <strong>图1(a)(b)</strong> 所示。</p>\n<p>为绕开 CLIP 的空间偏差，论文转向近期的 <strong>dino.txt</strong> 框架。dino.txt 基于冻结的 DINOv3 视觉骨干，具有更强的局部判别和空间感知能力；通过 self-correction 可以较好消除图像级预训练带来的空间偏差，如原文 <strong>图1(c)</strong> 所示。但作者进一步发现，dino.txt 的瓶颈转移到了<strong>文本侧</strong>：数据集给出的标准类别名过于单薄，和预训练图文描述中的自然语言表达存在词汇差距，导致 dense image feature 找不到足够准确的 text semantic anchor。</p>\n<p>一句话概括：<strong>这篇论文不是继续“修图像特征”，而是利用视觉先验反过来筛选和进化文本提示，从而释放 dino.txt 的密集感知能力。</strong></p>\n<hr />\n<h3><strong>二、研究方法或创新点</strong></h3>\n<p><img alt=\"\" src=\"https://pic2.zhimg.com/v2-4d01e9046e7e494a84defb16dad6e63b_1440w.jpg\" /></p>\n<h3><strong>1. 总体框架：从 CLIP 范式转向 dino.txt + 文本提示进化</strong></h3>\n<p>原文 <strong>图3</strong> 给出了 VIP 的整体流程，包含三个核心模块：<strong>语义扩展、别名蒸馏、激活聚合</strong>。输入类别名后，先由大语言模型生成多个 image-caption 风格的类别别名；再利用 DINOv3 的视觉先验筛掉不可靠别名；最后将保留下来的多个别名激活图进行鲁棒聚合，输出最终分割结果。</p>\n<p>可以把 VIP 理解为：<br />\n<strong>类别名 → LLM 扩写为多个候选视觉别名 → 用视觉特征检查这些别名是否真的“指向对的区域” → 聚合多个可靠别名的响应图。</strong></p>\n<hr />\n<h3><strong>2. 创新点一：LLM 驱动的类别语义扩展</strong></h3>\n<p>普通 OVSS 方法通常直接使用数据集类别名，例如 <em>person</em>、<em>bus</em>、<em>building</em>。作者认为这类标准类别名语义覆盖不足，比如图像字幕中可能更常出现 <em>people</em> 而不是 <em>person</em>。因此，VIP 让 LLM 为每个类别生成 20 个 image-caption style noun phrases，覆盖同义词、复数、下位词和具体视觉变体。论文给出的提示格式为：<br />\n<strong>“Generate 20 image-caption style noun phrases for {category name}, covering synonyms, plurals, hyponyms, and concrete visual variants.”</strong></p>\n<p>不过，作者也强调：<strong>直接把 LLM 生成的别名全用上会带来噪声</strong>。例如某些下位词可能过窄，某些同义表达可能跨类别混淆，因此需要下一步筛选。</p>\n<hr />\n<h3><strong>3. 创新点二：Visual-guided Alias Distillation，视觉引导的别名蒸馏</strong></h3>\n<p>这是论文的核心。VIP 不依赖 mask 标注，而是用 DINOv3 backbone 的多层 attention matrix 构建 <strong>visual affinity</strong>，作为一种“无标注视觉监督信号”。这些视觉亲和关系同时包含低层边界信息和高层语义线索，用来判断某个文本别名激活出的区域是否符合图像内部结构。</p>\n<p>作者设计了两个筛选指标：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>指标</th>\n<th>作用</th>\n<th>直观理解</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>Visual Grounding Score</td>\n<td>衡量别名激活图与 DINOv3 视觉亲和结构的一致性</td>\n<td>这个词激活出来的区域，是否贴合真实物体边界和视觉结构</td>\n</tr>\n<tr>\n<td>Semantic Certainty Score</td>\n<td>用 entropy 衡量类别间判别确定性</td>\n<td>这个词是否语义明确，而不是把多个类别混在一起</td>\n</tr>\n</tbody>\n</table></div>\n<p>最终筛选规则是：以原始标准类别名为锚点，只保留那些 <strong>Visual Grounding Score 更高、Semantic Certainty Score 更低</strong> 的候选别名。这样既扩展语义覆盖，又避免 LLM 扩写带来的类别边界混淆。</p>\n<hr />\n<h3><strong>4. 创新点三：Saliency-aware Soft Aggregation，显著性感知软聚合</strong></h3>\n<p>筛选出多个可靠别名后，还需要把它们对应的 dense activation map 合并成一个类别预测图。作者发现简单的 mean 或 max 聚合并不理想：mean 容易稀释有效信号，max 容易被离群噪声影响。</p>\n<p>因此 VIP 先计算图像全局特征与各个别名文本特征之间的响应，将其作为 saliency factor 调制 dense activation map；随后借鉴 energy-based model 中的 free energy 函数，把多个别名响应整合为单一类别激活。论文认为这种方式更像是在奖励多个别名之间的“共识区域”，而不是依赖单个最强响应。</p>\n<hr />\n<h3><strong>5. 创新点四：提示模板也可以被进化</strong></h3>\n<p>除类别名外，完整文本输入通常还包含模板，例如 “a photo of the {class_name}”。作者进一步探索将 VIP 的扩展与筛选思想迁移到 text templates 上：让 LLM 生成更适合 dense prediction 的模板，再用固定后的类别别名进行评分筛选。消融实验显示，这一步还能带来额外收益。</p>\n<hr />\n<h3><strong>三、实验结果</strong></h3>\n<p><img alt=\"\" src=\"https://pic4.zhimg.com/v2-7cca89eff0d329de07da58cfe61a8195_1440w.jpg\" /><img alt=\"\" src=\"https://pic3.zhimg.com/v2-476e61cb3d753f11a826797e084456ce_1440w.jpg\" /></p>\n<h3><strong>1. 主实验：自然图像与城市街景上达到新 SOTA</strong></h3>\n<p>原文 <strong>表1</strong> 比较了 VIP 与多种训练自由 OVSS 方法，在 PASCAL VOC、PASCAL Context、COCO Object、COCO Stuff、Cityscapes、ADE20K 等基准上的表现。VIP 在不依赖额外视觉模型的情况下，平均 mIoU 达到 <strong>52.4</strong>，超过单视觉模型方法 SFP 的 <strong>44.0</strong>，提升 <strong>8.4 个百分点</strong>；即使对比使用 DINO+SAM2 的多模型方法 CorrCLIP，VIP 也以 <strong>52.4 vs. 51.0</strong> 取得优势。</p>\n<p>效率方面，表1显示 VIP 的推理时间为 <strong>100 ms</strong>、显存为 <strong>1650 MB</strong>；CorrCLIP 为 <strong>1440 ms</strong>、<strong>3200 MB</strong>。论文因此强调，VIP 在性能超过 CorrCLIP 的同时，推理速度显著更快、显存约减半。</p>\n<hr />\n<h3><strong>2. 跨域泛化：遥感图像上优势更明显</strong></h3>\n<p>原文 <strong>表2</strong> 评估了 iSAID、Vaihingen、Potsdam、VDD 四个遥感语义分割数据集。VIP 的平均 mIoU 为 <strong>44.3</strong>，超过专门面向遥感开放词汇分割的 SegEarth-OV 的 <strong>35.8</strong>，提升 <strong>8.5 个百分点</strong>。这说明 VIP 的优势不只是自然图像 benchmark 上的调参收益，而是具备较好的跨域泛化能力。</p>\n<p>这点很重要：很多 CLIP-based 方法在遥感这类 out-of-distribution 场景中退化明显，而 VIP 借助 DINOv3/dino.txt 的空间先验和视觉筛选机制，在遥感域也能维持较强表现。</p>\n<hr />\n<h3><strong>3. 消融实验：不是“LLM 扩写越多越好”，关键在筛选与聚合</strong></h3>\n<p>原文 <strong>表3</strong> 展示了关键组件的消融结果：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>方法配置</th>\n<th>VOC</th>\n<th>Object</th>\n<th>City</th>\n<th>ADE</th>\n<th>Avg</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>baseline</td>\n<td>35.9</td>\n<td>24.2</td>\n<td>22.6</td>\n<td>18.9</td>\n<td>25.4</td>\n</tr>\n<tr>\n<td>+ Self-Correction</td>\n<td>62.1</td>\n<td>31.4</td>\n<td>35.0</td>\n<td>23.6</td>\n<td>38.0</td>\n</tr>\n<tr>\n<td>+ LLM 语义扩展</td>\n<td>61.9</td>\n<td>28.6</td>\n<td>36.7</td>\n<td>23.0</td>\n<td>37.6</td>\n</tr>\n<tr>\n<td>+ Alias Distillation</td>\n<td>68.3</td>\n<td>41.3</td>\n<td>50.2</td>\n<td>27.1</td>\n<td>46.7</td>\n</tr>\n<tr>\n<td>+ Soft Aggregation</td>\n<td>72.3</td>\n<td>46.7</td>\n<td>54.8</td>\n<td>28.9</td>\n<td>50.7</td>\n</tr>\n<tr>\n<td>+ Templates</td>\n<td>73.2</td>\n<td>47.3</td>\n<td>55.7</td>\n<td>29.1</td>\n<td>51.3</td>\n</tr>\n</tbody>\n</table></div>\n<p>最值得注意的是：<strong>直接加入 LLM 生成别名反而从 38.0 降到 37.6</strong>，说明未过滤的文本扩展会引入噪声；而加入 Alias Distillation 后平均 mIoU 提升到 <strong>46.7</strong>，再加 Soft Aggregation 达到 <strong>50.7</strong>，最后结合模板进化达到 <strong>51.3</strong>。这证明 VIP 的关键不是“用 LLM 写更多词”，而是<strong>用视觉先验筛选出真正对 dense segmentation 有帮助的词</strong>。</p>\n<hr />\n<h3><strong>4. LLM 选择并不敏感</strong></h3>\n<p>原文 <strong>表4</strong> 比较 Gemini-2.5、DeepSeek-R1、GPT-5 生成别名的效果。三者平均 mIoU 分别为 <strong>51.1、50.8、51.3</strong>，差距很小。作者认为，这是因为生成类别别名对现代 LLM 来说是相对简单的任务，只要提示格式稳定，不同 LLM 生成的结果大体一致。</p>\n<hr />\n<h3><strong>5. 诊断分析：dino.txt 的空间偏差更可控，VIP 修正文本响应</strong></h3>\n<p>原文 <strong>图5</strong> 比较 CLIP 与 dino.txt 在 attention modulation 后的特征变化。结果显示，CLIP 在扩展调制层数后容易出现跨模态对齐崩塌；而 dino.txt 受益于 DINOv3 的空间感知先验，特征分布更稳定。</p>\n<p><img alt=\"\" src=\"https://pic1.zhimg.com/v2-102050c47874b0a41fb51f911ec34f2c_1440w.jpg\" /></p>\n<p>原文 <strong>图6</strong> 进一步展示文本查询响应质量：原始 text query 仍会产生明显噪声，而 VIP refined text queries 可以产生更完整、更干净的物体激活区域。</p>\n<hr />\n<h3><strong>四、总结</strong></h3>\n<p>这篇论文的核心贡献可以概括为：<strong>在训练自由开放词汇语义分割中，作者把问题从“如何修复视觉特征”转向“如何让文本提示更适合 dense visual feature”</strong>。VIP 基于 dino.txt 和 DINOv3 的空间感知能力，通过 LLM 生成候选别名，再用视觉亲和结构和语义确定性进行无监督筛选，最后用显著性感知软聚合得到高质量分割结果。</p>\n<p>从实验看，VIP 的优势体现在三方面：第一，在自然图像、城市街景等标准 OVSS benchmark 上达到或超过现有 SOTA；第二，在遥感图像等跨域场景中优势更明显；第三，额外开销较小，避免了 SAM/SAM2 后处理带来的高延迟和显存负担。论文结论认为，dino.txt 这类具备空间感知的 VLM 可能是训练自由 dense prediction 的更优基础，而文本侧 prompt evolution 是释放其能力的关键方向。</p>\n<p><strong>对更多实验结果和文章细节感兴趣的读者，可以阅读一下论文原文~本文仅做学术分享，如有侵权、笔误等，请联系修改、删文</strong></p>"
    }
  ],
  "graph": {
    "nodes": [
  ...
  "algos": [
    {
      ...
      "summary": "FCN 将分类 CNN 的全连接层卷积化，并用可学习上采样和跳连融合实现端到端像素预测，奠定了现代语义分割“全卷积编码器-解码器”的基础。",
      "keyPoints": [
      ...
      "detail": "<p><img alt=\"FCN 密集预测示意\" src=\"https://ar5iv.labs.arxiv.org/html/1411.4038/assets/x1.png\" />\n<em>图：FCN 将普通分类网络改造为整图输入、整图输出的像素级预测网络。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\">def fcn_8s(image):\n    pool3, pool4, conv7 = vgg_fully_convolutional(image)\n\n    score32 = conv1x1(conv7, num_classes)\n    up32 = deconv(score32, stride=2)\n\n    score16 = up32 + conv1x1(pool4, num_classes)\n    up16 = deconv(score16, stride=2)\n\n    score8 = up16 + conv1x1(pool3, num_classes)\n    logits = deconv(score8, stride=8)\n\n    return softmax(logits)\n</code></pre>\n<h5>方法解读</h5>\n<p>FCN 之前，很多分割系统把 CNN 当作局部 patch 分类器：对每个像素附近裁剪 patch，分类后再拼回整图。这既慢又浪费，因为相邻 patch 重叠巨大。FCN 的关键是把分类网络改成一次前向就输出二维 score map。</p>\n<p>全连接层可以视为覆盖整个输入特征图的卷积层。例如 VGG 的 <code>fc6/fc7</code> 可改成 <span class=\"kb-math kb-math-inline\">7\\times7</span> 与 <span class=\"kb-math kb-math-inline\">1\\times1</span> 卷积。这样网络不再要求固定输入尺寸，输出空间尺寸随输入变化：</p>\n<div class=\"kb-math kb-math-display\">S=f_{\\theta}(I)\\in\\mathbb{R}^{H&#x27;\\times W&#x27;\\times C}</div>\n<p>粗 score map 需要上采样回原图。FCN 使用反卷积层，其实是可学习的双线性上采样泛化：</p>\n<div class=\"kb-math kb-math-display\">\\hat{Y}=\\operatorname{Deconv}(S)</div>\n<p>只用最深层预测得到 FCN-32s，语义强但边界粗。FCN-16s 把上采样后的深层 score 与 pool4 的浅层 score 相加；FCN-8s 再融合 pool3，使细节更好：</p>\n<div class=\"kb-math kb-math-display\">S_{16}=\\operatorname{Up}_2(S_{32})+S_{pool4},\\quad\nS_{8}=\\operatorname{Up}_2(S_{16})+S_{pool3}</div>\n<p>训练目标是逐像素交叉熵：</p>\n<div class=\"kb-math kb-math-display\">\\mathcal{L}=-\\sum_{p}\\log P(y_p\\mid I;\\theta)</div>\n<p>FCN 与后续分割网络的差别在于它没有复杂上下文模块、空洞卷积或注意力；它证明了“分类骨干 + 全卷积输出 + 上采样 + 跳连”这条路线可行。之后的改进基本都在扩大感受野、保留分辨率、增强上下文或改善解码边界。</p>\n<div class=\"key-point\">💡 关键：FCN 的历史意义是把语义分割从手工后处理和 patch 分类推进到端到端密集预测。</div>",
      "quiz": {
        "q": "FCN 中 skip architecture 的主要作用是什么？",
        "options": [
          "减少类别数量",
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>加权交叉熵损失</strong>：引入预计算的权重图 <span class=\"kb-math kb-math-inline\">w(\\mathbf{x})</span>，对相邻细胞间的狭窄间隙赋予更高权重，迫使网络学习分离紧密接触的同类实例",
    ...
    },
    {
      ...
      "summary": "PSPNet 提出 Pyramid Pooling Module，在 FCN 主干上用多尺度池化聚合全局场景先验，解决局部感受野导致的类别混淆、关系错配和小目标不显眼问题。",
      "keyPoints": [
      ...
      "detail": "<p><img alt=\"PSPNet 架构图\" src=\"https://ar5iv.labs.arxiv.org/html/1612.01105/assets/x3.png\" />\n<em>图：CNN 特征经过金字塔池化模块汇聚多尺度上下文，再融合生成像素级预测。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\">def pspnet_forward(image):\n    feat = dilated_resnet(image)  # output_stride 通常为 8\n    pyramids = [feat]\n\n    for bin_size in [1, 2, 3, 6]:\n        pooled = adaptive_avg_pool(feat, output_size=(bin_size, bin_size))\n        reduced = conv1x1(pooled, out_channels=feat.channels // 4)\n        up = bilinear_upsample(reduced, size=feat.spatial_size)\n        pyramids.append(up)\n\n    context = concat(pyramids, dim=&quot;channel&quot;)\n    logits = segmentation_head(context)\n    return bilinear_upsample(logits, size=image.spatial_size)\n</code></pre>\n<h5>方法解读</h5>\n<p>FCN 已经能端到端分割，但每个像素的预测仍主要依赖局部卷积感受野。场景解析中，类别判断常需要全局信息：船通常在水上，床通常在室内，天空和道路的空间布局也有强先验。缺少上下文时，模型容易把局部纹理相似的类别混淆。</p>\n<p>PPM 的做法是对最终特征图 <span class=\"kb-math kb-math-inline\">F</span> 做多级自适应池化：</p>\n<div class=\"kb-math kb-math-display\">\\operatorname{PPM}(F)=\\operatorname{Concat}\\left(F,\\operatorname{Up}(g_1(P_1(F))),\\operatorname{Up}(g_2(P_2(F))),\\operatorname{Up}(g_3(P_3(F))),\\operatorname{Up}(g_4(P_4(F)))\\right)</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">P_n</span> 输出 1×1、2×2、3×3、6×6 网格，<span class=\"kb-math kb-math-inline\">g_n</span> 是 1×1 卷积降维。1×1 分支提供全图先验，2×2/3×3 捕获粗空间布局，6×6 保留较细区域上下文。</p>\n<p>通道降维很重要。若每个池化分支都保留原始通道，拼接后全局上下文会带来巨大参数和显存；PSPNet 将每个分支降到原通道的约 <span class=\"kb-math kb-math-inline\">1/N</span>，再拼回原特征，既节省计算又保留局部主干。</p>\n<p>Dilated ResNet 则解决分辨率问题：把后几层下采样改为空洞卷积，使输出 stride 从 32 降到 8，同时维持较大理论感受野。最终预测由 PPM 后特征经卷积分类，再上采样到原图。</p>\n<p>辅助损失可写为：</p>\n<div class=\"kb-math kb-math-display\">\\mathcal{L}=\\mathcal{L}_{main}+\\alpha\\mathcal{L}_{aux}</div>\n<p>论文中辅助头接在 ResNet 中间层，推理时丢弃。它给中层特征提供语义监督，让深层网络更容易收敛。</p>\n<div class=\"key-point\">💡 关键：PSPNet 的 PPM 不是简单多尺度输入，而是在同一高层特征图上构造“场景级上下文金字塔”，低成本补齐 FCN 的全局信息缺口。</div>",
      "quiz": {
        "q": "PSPNet 中 1×1 金字塔池化分支的主要作用是什么？",
        "options": [
          "提供全图级上下文先验",
          "增加输出类别数",
          "替代所有空洞卷积",
    ...
    },
    {
      ...
      "detail": "<h3>1. 空洞卷积基础</h3>\n<p>空洞卷积（Atrous/Dilated Convolution）通过在滤波器权重之间插入零来扩大感受野，而不增加参数量或降低分辨率：</p>\n<div class=\"kb-math kb-math-display\">y[i] = \\sum_{k} x[i + r \\cdot k] \\cdot w[k]</div>\n<p>其中 $r$ 为空洞率（rate）。$r=1$ 时退化为标准卷积。</p>\n<p><strong>output_stride</strong>：输入图像分辨率与最终特征图分辨率之比。通过调整空洞率，可以在不改变网络结构的情况下控制output_stride（如从32降到16或8），从而获得更密集的特征图。</p>\n<p><img alt=\"Atrous Convolution示意图\" src=\"https://ar5iv.labs.arxiv.org/html/1706.05587v3/assets/x1.png\" /></p>\n<h3>2. 架构设计：两种多尺度方案</h3>\n<h4>方案A：级联空洞卷积（Cascaded Modules）</h4>\n<p>在ResNet基础上添加额外的block（block5~block7），每个block内使用Multi-Grid策略：</p>\n<pre><code>ResNet Block结构（以block4为例）:\n  block4 = 3个bottleneck单元\n  Multi_Grid = (r1, r2, r3) = (1, 2, 4)\n\n  对于第i个单元:\n    实际空洞率 = unit_rate × Multi_Grid[i]\n    其中 unit_rate 由output_stride决定\n</code></pre>\n<p><strong>关键实验结果</strong>（output_stride=16, ResNet-101）：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>深度</th>\n<th>block4</th>\n<th>block5</th>\n<th>block6</th>\n<th>block7</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>mIOU</td>\n<td>68.39%</td>\n<td>73.21%</td>\n<td>75.34%</td>\n<td>75.76%</td>\n</tr>\n</tbody>\n</table></div>\n<h4>方案B：改进的ASPP（最终选择）</h4>\n<p><img alt=\"ASPP架构图\" src=\"https://ar5iv.labs.arxiv.org/html/1706.05587v3/assets/x9.png\" /></p>\n<p>ASPP并行使用多个不同采样率的空洞卷积捕获多尺度信息：</p>\n<pre><code>ASPP Module (output_stride=16):\n├── Branch 1: 1×1 Conv, 256 filters\n├── Branch 2: 3×3 Conv, rate=6, 256 filters  \n├── Branch 3: 3×3 Conv, rate=12, 256 filters\n├── Branch 4: 3×3 Conv, rate=18, 256 filters\n├── Branch 5: Global Average Pooling → 1×1 Conv → Bilinear Upsample  ← 关键新增！\n│\n└── Concat → 1×1 Conv (融合) → Final Logits → Bilinear 4× Upsample\n    所有分支后均有 BN + ReLU\n</code></pre>\n<p><strong>为什么需要图像级特征？</strong></p>\n<p><img alt=\"滤波器退化示意\" src=\"https://ar5iv.labs.arxiv.org/html/1706.05587v3/assets/x8.png\" /></p>\n<p>当空洞率过大时，3×3滤波器的9个采样点中大部分落在特征图边界外（padding区域），有效权重退化为仅中心1个点，等价于1×1卷积。图像级特征（Global Average Pooling）提供了真正的全局上下文，弥补了这一缺陷。</p>\n<h3>3. 伪代码</h3>\n<pre><code class=\"language-python\">class DeepLabv3(nn.Module):\n    def __init__(self, num_classes=21, output_stride=16):\n        # Backbone: ResNet-101 with Multi-Grid atrous convolution\n        self.backbone = ResNet101(\n            output_stride=output_stride,\n            multi_grid=(1, 2, 4)  # applied to block4's 3 units\n        )\n\n        # ASPP Module\n        if output_stride == 16:\n            rates = (6, 12, 18)\n        elif output_stride == 8:\n            rates = (12, 24, 36)\n\n        self.aspp = ASPP(\n            in_channels=2048,\n            out_channels=256,\n            rates=rates\n        )\n\n        # Final classifier\n        self.classifier = nn.Conv2d(256, num_classes, 1)\n\n    def forward(self, x):\n        input_size = x.shape[2:]\n\n        # 1. Extract features with controlled output_stride\n        features = self.backbone(x)  # H/16 or H/8\n\n        # 2. ASPP: multi-scale context encoding\n        x = self.aspp(features)\n\n        # 3. Classification + upsample to input resolution\n        x = self.classifier(x)\n        x = F.interpolate(x, size=input_size, mode='bilinear')\n        return x\n\n\nclass ASPP(nn.Module):\n    def __init__(self, in_ch, out_ch, rates=(6, 12, 18)):\n        # Branch 1: 1×1 convolution\n        self.conv1x1 = nn.Sequential(\n            nn.Conv2d(in_ch, out_ch, 1), nn.BatchNorm2d(out_ch), nn.ReLU()\n        )\n        # Branch 2-4: 3×3 atrous convolutions\n        self.atrous_convs = nn.ModuleList([\n            nn.Sequential(\n                nn.Conv2d(in_ch, out_ch, 3, padding=r, dilation=r),\n                nn.BatchNorm2d(out_ch), nn.ReLU()\n            ) for r in rates\n        ])\n        # Branch 5: Image-level features (Global Average Pooling)\n        self.image_pooling = nn.Sequential(\n            nn.AdaptiveAvgPool2d(1),\n            nn.Conv2d(in_ch, out_ch, 1), nn.BatchNorm2d(out_ch), nn.ReLU()\n        )\n        # Fusion: concat 5 branches → 1×1 conv\n        self.project = nn.Sequential(\n            nn.Conv2d(out_ch * 5, out_ch, 1),\n            nn.BatchNorm2d(out_ch), nn.ReLU(), nn.Dropout(0.1)\n        )\n\n    def forward(self, x):\n        h, w = x.shape[2:]\n        branches = [self.conv1x1(x)]\n        branches += [conv(x) for conv in self.atrous_convs]\n        # Image-level: pool → conv → upsample back\n        img_feat = self.image_pooling(x)\n        img_feat = F.interpolate(img_feat, size=(h, w), mode='bilinear')\n        branches.append(img_feat)\n\n        return self.project(torch.cat(branches, dim=1))\n</code></pre>\n<h3>4. 训练细节</h3>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>超参数</th>\n<th>值</th>\n<th>说明</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>学习率策略</td>\n<td>poly: $lr_0 \\times (1 - \\frac{iter}{max_iter})^{0.9}$</td>\n<td>初始lr=0.007</td>\n</tr>\n<tr>\n<td>Crop Size</td>\n<td>513×513</td>\n<td>大crop避免大rate空洞卷积采样到padding区域</td>\n</tr>\n<tr>\n<td>Batch Size</td>\n<td>16</td>\n<td>用于训练BN参数</td>\n</tr>\n<tr>\n<td>BN decay</td>\n<td>0.9997</td>\n<td>fine-tune BN是关键改进</td>\n</tr>\n<tr>\n<td>数据增强</td>\n<td>随机缩放(0.5~2.0) + 随机水平翻转</td>\n<td>—</td>\n</tr>\n<tr>\n<td>训练阶段1</td>\n<td>trainaug, OS=16, 30K iter, lr=0.007</td>\n<td>快速训练（特征图小4×）</td>\n</tr>\n<tr>\n<td>训练阶段2</td>\n<td>trainval, OS=8, 30K iter, lr=0.001, freeze BN</td>\n<td>精细化训练</td>\n</tr>\n<tr>\n<td>上采样logits</td>\n<td>✓（而非下采样GT）</td>\n<td>保留GT细节，提升边界质量</td>\n</tr>\n</tbody>\n</table></div>\n<h3>5. 关键消融实验</h3>\n<p><strong>ASPP配置消融</strong>（output_stride=16, PASCAL VOC 2012 val）：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>Multi-Grid</th>\n<th>ASPP rates</th>\n<th>Image Pooling</th>\n<th>mIOU</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>(1,1,1)</td>\n<td>(6,12,18)</td>\n<td>✗</td>\n<td>75.36%</td>\n</tr>\n<tr>\n<td>(1,2,1)</td>\n<td>(6,12,18)</td>\n<td>✗</td>\n<td>75.93%</td>\n</tr>\n<tr>\n<td>(1,2,4)</td>\n<td>(6,12,18)</td>\n<td>✗</td>\n<td>76.46%</td>\n</tr>\n<tr>\n<td>(1,2,4)</td>\n<td>(6,12,18)</td>\n<td><strong>✓</strong></td>\n<td><strong>77.21%</strong></td>\n</tr>\n<tr>\n<td>(1,2,4)</td>\n<td>(6,12,18,24)</td>\n<td>✗</td>\n<td>76.58%→加rate=24反而降</td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>推理策略累积效果</strong>：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>配置</th>\n<th>mIOU</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>MG+ASPP+ImgPool, OS=16</td>\n<td>77.21%</td>\n</tr>\n<tr>\n<td>+ OS=8</td>\n<td>78.51% (+1.30)</td>\n</tr>\n<tr>\n<td>+ Multi-Scale</td>\n<td>79.45% (+0.94)</td>\n</tr>\n<tr>\n<td>+ Flip</td>\n<td>79.77% (+0.32)</td>\n</tr>\n<tr>\n<td>+ COCO pretrain</td>\n<td>82.70% (+2.93)</td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>训练协议消融</strong>：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>改动</th>\n<th>mIOU</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>完整新协议</td>\n<td>77.21%</td>\n</tr>\n<tr>\n<td>不fine-tune BN</td>\n<td>75.95% (-1.26)</td>\n</tr>\n<tr>\n<td>不上采样logits</td>\n<td>76.01% (-1.20)</td>\n</tr>\n<tr>\n<td>crop=321（旧设置）</td>\n<td>67.22% (-9.99)</td>\n</tr>\n</tbody>\n</table></div>\n<h3>6. 与前作对比</h3>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>方法</th>\n<th>DenseCRF</th>\n<th>COCO</th>\n<th>Val mIOU</th>\n<th>Test mIOU</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>DeepLabv2</td>\n<td>✓</td>\n<td>✓</td>\n<td>77.69%</td>\n<td>79.7%</td>\n</tr>\n<tr>\n<td><strong>DeepLabv3</strong></td>\n<td><strong>✗</strong></td>\n<td>✓</td>\n<td>82.70%</td>\n<td><strong>85.7%</strong></td>\n</tr>\n</tbody>\n</table></div>\n<p>核心改进来源：(1) fine-tune BN参数 (2) 更好的多尺度上下文编码（改进ASPP+图像级特征）(3) 改进的训练协议</p>\n<hr />"
    },
    {
      "id": "deeplabv3plus",
      "num": 9,
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "联合训练策略：总损失 <span class=\"kb-math kb-math-inline\">L = \\lambda_i(L_c + L_b + L_m) + \\lambda_s L_s</span>，通过调节 <span class=\"kb-math kb-math-inline\">\\lambda_i / \\lambda_s</span> 平衡实例与语义任务",
    ...
    },
    {
      ...
      "detail": "<p><img alt=\"SETR 整体架构图\" src=\"https://ar5iv.labs.arxiv.org/html/2012.15840/assets/x1.png\" />\n<em>图：SETR 编码器架构——纯 Transformer 将图像 patch 序列编码为特征序列</em></p>\n<p><img alt=\"SETR 解码器设计\" src=\"https://ar5iv.labs.arxiv.org/html/2012.15840/assets/x2.png\" />\n<em>图：SETR-PUP 渐进上采样解码器</em></p>\n<p><img alt=\"SETR-MLA 解码器\" src=\"https://ar5iv.labs.arxiv.org/html/2012.15840/assets/x3.png\" />\n<em>图：SETR-MLA 多层特征聚合解码器</em></p>\n<h5>动机与背景</h5>\n<p>传统语义分割方法基于 FCN 编码器-解码器架构，编码器通过堆叠卷积层逐步降低分辨率来扩大感受野。然而，卷积操作的<strong>局部性</strong>导致感受野仅随层数线性增长，且增加更多层的收益会迅速递减。虽然空洞卷积和注意力模块可以缓解这一问题，但它们仅作为组件级别的改进，FCN 架构本身的局限性并未改变。</p>\n<p>SETR 的核心思想是：<strong>在架构级别做出根本性改变</strong>——完全放弃 FCN，采用纯 Transformer 编码器，使每一层都具有全局感受野，从根本上消除对感受野的担忧。</p>\n<h5>核心机制：Image-to-Sequence 编码</h5>\n<p><strong>Patch Embedding：</strong> 给定输入图像 <span class=\"kb-math kb-math-inline\">x \\in \\mathbb{R}^{H \\times W \\times 3}</span>，由于直接将每个像素作为 token 会导致序列长度过大（如 480×480 图像将产生 691,200 长度的序列），SETR 将图像划分为 <span class=\"kb-math kb-math-inline\">\\frac{H}{16} \\times \\frac{W}{16}</span> 个大小为 16×16 的 patch，每个 patch 通过线性投影映射到 <span class=\"kb-math kb-math-inline\">C</span> 维嵌入空间：</p>\n<div class=\"kb-math kb-math-display\">p \\longrightarrow e \\in \\mathbb{R}^C</div>\n<p><strong>位置编码：</strong> 为保留空间信息，为每个位置 <span class=\"kb-math kb-math-inline\">i</span> 学习一个位置嵌入 <span class=\"kb-math kb-math-inline\">p_i</span>，最终输入序列为：</p>\n<div class=\"kb-math kb-math-display\">E = \\{e_1 + p_1, \\ e_2 + p_2, \\ \\cdots, \\ e_L + p_L\\}</div>\n<p>其中序列长度 <span class=\"kb-math kb-math-inline\">L = \\frac{HW}{256}</span>。</p>\n<h5>Transformer 编码器</h5>\n<p>编码器由 <span class=\"kb-math kb-math-inline\">L_e</span> 层多头自注意力（MSA）和 MLP 块组成。在每层 <span class=\"kb-math kb-math-inline\">l</span>，计算过程为：</p>\n<p><strong>自注意力计算：</strong></p>\n<div class=\"kb-math kb-math-display\">\\text{query} = Z^{l-1} \\mathbf{W}_Q, \\quad \\text{key} = Z^{l-1} \\mathbf{W}_K, \\quad \\text{value} = Z^{l-1} \\mathbf{W}_V</div>\n<div class=\"kb-math kb-math-display\">SA(Z^{l-1}) = Z^{l-1} + \\text{softmax}\\left(\\frac{Z^{l-1}\\mathbf{W}_Q (Z^{l-1}\\mathbf{W}_K)^\\top}{\\sqrt{d}}\\right)(Z^{l-1}\\mathbf{W}_V)</div>\n<p><strong>多头注意力：</strong></p>\n<div class=\"kb-math kb-math-display\">MSA(Z^{l-1}) = [SA_1(Z^{l-1}); \\ SA_2(Z^{l-1}); \\ \\cdots; \\ SA_m(Z^{l-1})]\\mathbf{W}_O</div>\n<p><strong>层输出（含 MLP 和残差连接）：</strong></p>\n<div class=\"kb-math kb-math-display\">Z^l = MSA(Z^{l-1}) + MLP(MSA(Z^{l-1})) \\in \\mathbb{R}^{L \\times C}</div>\n<div class=\"key-point\">💡 关键：与 CNN 不同，Transformer 的自注意力在每一层都对所有 patch 进行全局交互，因此<strong>每一层都具有全局感受野</strong>，无需通过堆叠层数来扩大感受野。</div>\n<h5>三种解码器设计</h5>\n<p>编码器输出 <span class=\"kb-math kb-math-inline\">Z \\in \\mathbb{R}^{\\frac{HW}{256} \\times C}</span> 需要 reshape 为 <span class=\"kb-math kb-math-inline\">\\frac{H}{16} \\times \\frac{W}{16} \\times C</span> 的 3D 特征图后送入解码器：</p>\n<p><strong>1. SETR-Naive（朴素上采样）：</strong>\n- 对最后一层特征 <span class=\"kb-math kb-math-inline\">Z^{L_e}</span> 用 1×1 conv + BN + ReLU + 1×1 conv 投影到类别数维度\n- 直接双线性插值上采样到原始分辨率</p>\n<p><strong>2. SETR-PUP（渐进上采样）：</strong>\n- 避免一步上采样引入噪声，采用 4 次 2× 上采样交替 conv 层\n- 从 <span class=\"kb-math kb-math-inline\">\\frac{H}{16} \\times \\frac{W}{16}</span> 逐步恢复到 <span class=\"kb-math kb-math-inline\">H \\times W</span></p>\n<p><strong>3. SETR-MLA（多层特征聚合）：</strong>\n- 类似 FPN 思想，但所有层特征分辨率相同（无金字塔形状）\n- 从 <span class=\"kb-math kb-math-inline\">M</span> 个均匀分布的层（间隔 <span class=\"kb-math kb-math-inline\">\\frac{L_e}{M}</span>）提取特征\n- 每个流经过 1×1、3×3、3×3 卷积（通道逐步减半）+ 4× 上采样\n- 引入自顶向下的逐元素加法聚合跨流交互\n- 最终通过通道拼接融合所有流，再 4× 上采样到全分辨率</p>\n<pre><code class=\"language-python\"># SETR 前向传播伪代码\ndef setr_forward(image, patch_size=16):\n    # 1. Patch Embedding\n    H, W = image.shape[:2]\n    patches = split_into_patches(image, patch_size)  # (H/16 * W/16) patches\n    embeddings = linear_project(patches)  # [L, C], L = HW/256\n\n    # 2. 添加位置编码\n    pos_embed = learnable_position_embedding(L)\n    tokens = embeddings + pos_embed  # [L, C]\n\n    # 3. Transformer 编码器 (ViT-Large: 24层)\n    for layer in transformer_layers:  # 24 layers\n        tokens = layer.MSA(layer.LN(tokens)) + tokens  # 全局自注意力\n        tokens = layer.MLP(layer.LN(tokens)) + tokens  # FFN\n\n    # 4. Reshape 为 2D 特征图\n    feature_map = tokens.reshape(H//16, W//16, C)\n\n    # 5. 解码器 (以 PUP 为例)\n    for i in range(4):  # 4次 2x 上采样\n        feature_map = conv_bn_relu(feature_map)\n        feature_map = bilinear_upsample_2x(feature_map)\n\n    segmentation = pixel_classify(feature_map)  # [H, W, num_classes]\n    return segmentation\n</code></pre>\n<h5>与传统方法的区别</h5>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>特性</th>\n<th>FCN 编码器</th>\n<th>SETR 编码器</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>基本操作</td>\n<td>卷积（局部）</td>\n<td>自注意力（全局）</td>\n</tr>\n<tr>\n<td>感受野</td>\n<td>随层数线性增长</td>\n<td>每层即为全局</td>\n</tr>\n<tr>\n<td>分辨率变化</td>\n<td>逐步下采样</td>\n<td>保持不变（1/16）</td>\n</tr>\n<tr>\n<td>特征维度</td>\n<td>逐层变化</td>\n<td>所有层相同（C=1024）</td>\n</tr>\n<tr>\n<td>上下文建模</td>\n<td>仅高层有效</td>\n<td>每层都建模全局上下文</td>\n</tr>\n</tbody>\n</table></div>\n<div class=\"warn-box\">⚠️ 注意：SETR 的计算复杂度为 <span class=\"kb-math kb-math-inline\">O(L^2)</span>，其中 <span class=\"kb-math kb-math-inline\">L = \\frac{HW}{256}</span>。对于 480×480 图像，<span class=\"kb-math kb-math-inline\">L=900</span>；对于 768×768 图像，<span class=\"kb-math kb-math-inline\">L=2304</span>。这使得处理高分辨率图像时计算开销较大，模型参数量也较大（~306M）。</div>\n<h5>模型配置与实验结果</h5>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>配置</th>\n<th>层数</th>\n<th>隐藏维度</th>\n<th>注意力头数</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>T-Base</td>\n<td>12</td>\n<td>768</td>\n<td>12</td>\n</tr>\n<tr>\n<td>T-Large</td>\n<td>24</td>\n<td>1024</td>\n<td>16</td>\n</tr>\n</tbody>\n</table></div>\n<p>主要结果（使用 T-Large + ImageNet-21K 预训练）：\n- <strong>ADE20K</strong>: SETR-MLA 达到 50.28% mIoU（测试集 SOTA）\n- <strong>Pascal Context</strong>: 55.83% mIoU\n- <strong>Cityscapes</strong>: SETR-PUP 达到 79.34% mIoU（80k iterations）</p>",
      "quiz": {
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>高效自注意力</strong>：通过序列缩减（Reduction Ratio R=[64,16,4,1]）将复杂度从 <span class=\"kb-math kb-math-inline\">O(N^2)</span> 降至 <span class=\"kb-math kb-math-inline\">O(N^2/R)</span>",
    ...
    },
    {
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"Per-pixel classification vs Mask classification\" src=\"https://ar5iv.labs.arxiv.org/html/2107.06278/assets/x1.png\" />\n<em>图1：（左）传统逐像素分类对每个像素独立预测类别；（右）掩码分类预测一组二值掩码并为每个掩码分配一个类别标签。匹配可通过二部图匹配或固定匹配完成。</em></p>\n<p><img alt=\"MaskFormer 架构总览\" src=\"https://ar5iv.labs.arxiv.org/html/2107.06278/assets/x2.png\" />\n<em>图2：MaskFormer 架构。包含三个模块：像素级模块提取逐像素嵌入，Transformer 模块计算 N 个 per-segment 嵌入，分割模块生成最终的类别-掩码预测对。</em></p>\n<h5>算法核心流程</h5>\n<pre><code class=\"language-python\"># MaskFormer 前向推理伪代码\ndef maskformer_forward(image):\n    # 1. 像素级模块\n    F = backbone(image)                    # 特征图 F ∈ R^{C_F × H/S × W/S}\n    E_pixel = pixel_decoder(F)             # 逐像素嵌入 E_pixel ∈ R^{C_E × H × W}\n\n    # 2. Transformer 模块\n    Q = transformer_decoder(F, queries)    # N 个 per-segment 嵌入 Q ∈ R^{C_Q × N}\n\n    # 3. 分割模块\n    p = softmax(linear_classifier(Q))      # 类别概率 {p_i ∈ Δ^{K+1}}, 含 ∅ 类\n    E_mask = MLP(Q)                        # 掩码嵌入 E_mask ∈ R^{C_E × N}\n    m = sigmoid(E_mask.T @ E_pixel)        # 二值掩码 {m_i ∈ [0,1]^{H×W}}\n\n    # 4. 推理：语义分割\n    # 对每个像素 (h,w)，计算 c = argmax_k Σ_i p_i(k) · m_i(h,w)\n    return assemble_semantic(p, m)\n</code></pre>\n<h5>动机与背景</h5>\n<p>自 FCN 以来，语义分割几乎被等价为逐像素分类问题——对图像中每个像素独立预测其类别。然而，实例级分割任务（如实例分割、全景分割）天然采用掩码分类的思路：先检测目标区域，再为每个区域分配类别。这种范式差异导致语义分割和实例分割使用完全不同的模型架构和训练方式，阻碍了图像分割领域的统一发展。</p>\n<p>MaskFormer 的核心观察是：<strong>掩码分类具有足够的通用性，可以同时解决语义级和实例级分割任务</strong>。事实上，在 FCN 之前，最好的语义分割方法（如 O2P、SDS）就使用了掩码分类的形式。基于这一洞察，作者提出了一个自然的问题：能否用一个统一的掩码分类模型取代逐像素分类，并在语义分割上取得更好的效果？</p>\n<h5>掩码分类的形式化定义</h5>\n<p>传统逐像素分类将图像分割为 <span class=\"kb-math kb-math-inline\">K</span> 个类别，对每个像素 <span class=\"kb-math kb-math-inline\">(h, w)</span> 预测类别概率分布 <span class=\"kb-math kb-math-inline\">y \\in \\{1, \\ldots, K\\}^{H \\times W}</span>。</p>\n<p>掩码分类则将分割问题分解为：预测 <span class=\"kb-math kb-math-inline\">N</span> 个概率-掩码对 <span class=\"kb-math kb-math-inline\">z = \\{(p_i, m_i)\\}_{i=1}^{N}</span>，其中 <span class=\"kb-math kb-math-inline\">p_i \\in \\Delta^{K+1}</span> 是第 <span class=\"kb-math kb-math-inline\">i</span> 个掩码的类别概率分布（包含一个\"无对象\" <span class=\"kb-math kb-math-inline\">\\varnothing</span> 类），<span class=\"kb-math kb-math-inline\">m_i \\in [0, 1]^{H \\times W}</span> 是对应的二值掩码预测。</p>\n<div class=\"key-point\">💡 <strong>关键洞察</strong>：当 <span class=\"kb-math kb-math-inline\">N = K</span> 且使用固定匹配时，掩码分类退化为逐像素分类的特殊情况。因此掩码分类严格地比逐像素分类更通用。</div>\n<h5>三模块架构详解</h5>\n<p><strong>1. 像素级模块（Pixel-level Module）</strong></p>\n<p>该模块由一个 backbone 网络和一个 pixel decoder 组成。Backbone（如 ResNet、Swin Transformer）提取低分辨率特征图 <span class=\"kb-math kb-math-inline\">\\mathcal{F} \\in \\mathbb{R}^{C_{\\mathcal{F}} \\times \\frac{H}{S} \\times \\frac{W}{S}}</span>（stride <span class=\"kb-math kb-math-inline\">S=32</span>）。Pixel decoder 逐步上采样特征，生成全分辨率的逐像素嵌入 <span class=\"kb-math kb-math-inline\">\\mathcal{E}_{\\text{pixel}} \\in \\mathbb{R}^{C_{\\mathcal{E}} \\times H \\times W}</span>。</p>\n<div class=\"warn-box\">⚠️ <strong>设计亮点</strong>：任何现有的逐像素分类分割模型都可以直接作为像素级模块使用，MaskFormer 可以无缝地将其转换为掩码分类模型。</div>\n<p><strong>2. Transformer 模块</strong></p>\n<p>采用标准 Transformer decoder（与 DETR 类似），输入为图像特征 <span class=\"kb-math kb-math-inline\">\\mathcal{F}</span> 和 <span class=\"kb-math kb-math-inline\">N</span> 个可学习的位置嵌入（queries），输出 <span class=\"kb-math kb-math-inline\">N</span> 个 per-segment 嵌入 <span class=\"kb-math kb-math-inline\">\\mathcal{Q} \\in \\mathbb{R}^{C_{\\mathcal{Q}} \\times N}</span>。每个嵌入编码了对应分割区域的全局信息，所有预测并行生成。</p>\n<p><strong>3. 分割模块（Segmentation Module）</strong></p>\n<ul>\n<li><strong>类别预测</strong>：对 per-segment 嵌入 <span class=\"kb-math kb-math-inline\">\\mathcal{Q}</span> 施加线性分类器 + softmax，得到 <span class=\"kb-math kb-math-inline\">K+1</span> 类的概率分布（含 <span class=\"kb-math kb-math-inline\">\\varnothing</span> 类）</li>\n<li><strong>掩码预测</strong>：通过 2 层隐藏层的 MLP 将 <span class=\"kb-math kb-math-inline\">\\mathcal{Q}</span> 转换为掩码嵌入 <span class=\"kb-math kb-math-inline\">\\mathcal{E}_{\\text{mask}} \\in \\mathbb{R}^{C_{\\mathcal{E}} \\times N}</span>，然后与逐像素嵌入做点积 + sigmoid 得到二值掩码：</li>\n</ul>\n<div class=\"kb-math kb-math-display\">m_i[h, w] = \\text{sigmoid}(\\mathcal{E}_{\\text{mask}}[:, i]^{\\top} \\cdot \\mathcal{E}_{\\text{pixel}}[:, h, w])</div>\n<div class=\"key-point\">💡 <strong>关键设计</strong>：掩码预测之间不施加互斥约束（不用 softmax），而是使用独立的 sigmoid。这使得同一像素可以属于多个掩码，提高了模型的灵活性。</div>\n<h5>训练：匈牙利匹配 + 混合损失</h5>\n<p>训练时，使用匈牙利算法在 <span class=\"kb-math kb-math-inline\">N</span> 个预测和 GT 分割之间进行最优二部图匹配。匹配代价综合考虑分类损失和掩码损失。</p>\n<p>匹配完成后，总损失为：</p>\n<div class=\"kb-math kb-math-display\">\\mathcal{L}_{\\text{mask-cls}} = \\sum_{j=1}^{N} \\left[ -\\log p_{\\sigma(j)}(c_j) + \\mathbf{1}_{c_j \\neq \\varnothing} \\mathcal{L}_{\\text{mask}}(m_{\\sigma(j)}, m_j^{\\text{gt}}) \\right]</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">\\sigma</span> 为最优匹配，掩码损失 <span class=\"kb-math kb-math-inline\">\\mathcal{L}_{\\text{mask}}</span> 结合了 focal loss 和 dice loss：</p>\n<div class=\"kb-math kb-math-display\">\\mathcal{L}_{\\text{mask}} = \\lambda_{\\text{focal}} \\cdot \\mathcal{L}_{\\text{focal}} + \\lambda_{\\text{dice}} \\cdot \\mathcal{L}_{\\text{dice}}</div>\n<p>默认超参数：<span class=\"kb-math kb-math-inline\">\\lambda_{\\text{focal}} = 20</span>，<span class=\"kb-math kb-math-inline\">\\lambda_{\\text{dice}} = 1</span>，<span class=\"kb-math kb-math-inline\">\\lambda_{\\text{cls}} = 1</span>。</p>\n<h5>推理策略</h5>\n<p>MaskFormer 设计了两种推理策略以适配不同任务：</p>\n<p><strong>语义推理（Semantic Inference）</strong>：对每个像素 <span class=\"kb-math kb-math-inline\">(h, w)</span>，计算所有 <span class=\"kb-math kb-math-inline\">K</span> 个类别的加权概率并取 argmax：</p>\n<div class=\"kb-math kb-math-display\">\\text{label}(h, w) = \\arg\\max_{c \\in \\{1, \\ldots, K\\}} \\sum_{i=1}^{N} p_i(c) \\cdot m_i[h, w]</div>\n<p>这种方式自然地将多个预测同一类别的掩码聚合起来，适合语义分割。</p>\n<p><strong>通用推理（General Inference）</strong>：先用阈值（0.3）过滤低置信度掩码，再为剩余掩码分配类别标签，适合全景分割等需要区分实例的任务。</p>\n<h5>与传统方法的关键区别</h5>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>特性</th>\n<th>逐像素分类（FCN 范式）</th>\n<th>MaskFormer（掩码分类）</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>预测单元</td>\n<td>每个像素独立分类</td>\n<td>预测 N 个掩码-类别对</td>\n</tr>\n<tr>\n<td>类别数依赖</td>\n<td>输出通道数 = 类别数 K</td>\n<td>输出掩码数 N 与 K 解耦</td>\n</tr>\n<tr>\n<td>大类别数扩展</td>\n<td>内存随 K 线性增长</td>\n<td>内存与 K 无关</td>\n</tr>\n<tr>\n<td>全局上下文</td>\n<td>依赖感受野大小</td>\n<td>Transformer decoder 天然捕获全局信息</td>\n</tr>\n<tr>\n<td>任务统一性</td>\n<td>仅适用于语义分割</td>\n<td>统一语义分割和全景分割</td>\n</tr>\n</tbody>\n</table></div>\n<div class=\"key-point\">💡 <strong>为什么大类别数时掩码分类更优？</strong> 逐像素分类需要为每个像素预测 K 维概率向量，当 K 很大时（如 ADE20K-Full 的 847 类），分类头的参数量和内存消耗急剧增加。而掩码分类将类别预测解耦到 N 个掩码上（N 远小于像素数），每个掩码只需一次 K+1 维分类，大幅降低了计算和内存开销。实验表明，在 ADE20K-Full（847类）上，MaskFormer 仅需 6529M 训练内存，而 PerPixelBaseline+ 需要 26698M。</div>",
      "quiz": {
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>线性复杂度</strong>：序列长度 <span class=\"kb-math kb-math-inline\">n</span> 下计算和内存均为 <span class=\"kb-math kb-math-inline\">O(n)</span>，对比 ViT 的 <span class=\"kb-math kb-math-inline\">O(n^2)</span> 在高分辨率输入上优势显著",
        ...
        "<strong>COCO 检测</strong>：Vim-Ti AP<span class=\"kb-math kb-math-inline\">^{\\text{box}}</span> 45.7 (+1.3 vs DeiT-Ti)，AP<span class=\"kb-math kb-math-inline\">^{\\text{mask}}</span> 39.2 (+1.1)"
      ],
      "detail": "<p><img alt=\"Vim 整体架构\" src=\"https://github.com/hustvl/Vim/raw/main/assets/vim_pipeline.png\" />\n<em>图：Vision Mamba 整体流程——图像经 Patch Embedding 后加入位置嵌入和 CLS Token，送入 L 层 Vim Encoder Block，最后通过 Norm + MLP Head 输出分类结果。</em></p>\n<p><img alt=\"Vim Block 结构\" src=\"https://github.com/hustvl/Vim/raw/main/assets/vim_block.png\" />\n<em>图：Vim Block 内部结构——输入经 Normalize 后分为两个线性分支 (x, z)，x 分支进行双向 SSM 处理，z 分支提供门控信号。</em></p>\n<p><strong>算法伪代码（Vim Block）：</strong></p>\n<pre><code class=\"language-python\"># Vim Block 前向传播\ndef vim_block(input_T, params):\n    # input_T: (B, L, D) — B=batch, L=序列长度, D=维度\n    x_norm = Normalize(input_T)                  # LayerNorm\n    x = Linear_x(x_norm)  # (B, L, D) → (B, L, E)  投影到扩展维度\n    z = Linear_z(x_norm)  # (B, L, D) → (B, L, E)  门控分支\n\n    # === 前向 SSM ===\n    x_fwd = SiLU(Conv1d(x))                     # 局部特征 + 激活\n    B_fwd = Linear_B(x_fwd)                      # (B, L, N) 输入矩阵\n    C_fwd = Linear_C(x_fwd)                      # (B, L, N) 输出矩阵\n    delta_fwd = softplus(Linear_delta(x_fwd))     # (B, L, E) 步长参数\n    # 离散化: A_bar = exp(delta * A), B_bar = delta * B\n    y_fwd = SSM_scan(x_fwd, A_bar_fwd, B_bar_fwd, C_fwd)  # (B, L, E)\n\n    # === 后向 SSM ===\n    x_bwd = flip(x)  # 反转序列\n    # 同样流程: Conv1d → SiLU → Linear_{B,C,Δ} → 离散化 → SSM\n    y_bwd = SSM_scan(x_bwd, A_bar_bwd, B_bar_bwd, C_bwd)\n    y_bwd = flip(y_bwd)  # 反转回原序列顺序\n\n    # === 门控融合 ===\n    y_fwd_gated = y_fwd * SiLU(z)               # 前向输出 × 门控\n    y_bwd_gated = y_bwd * SiLU(z)               # 后向输出 × 门控\n    output = Linear_T(y_fwd_gated + y_bwd_gated) # (B, L, E) → (B, L, D)\n\n    return output + input_T                       # 残差连接\n</code></pre>\n<h5>动机与背景</h5>\n<p>Vision Transformer (ViT) 将图像切分为 patch 序列后使用自注意力建模，取得了优异的视觉表征能力，但自注意力的 <span class=\"kb-math kb-math-inline\">O(n^2)</span> 复杂度在高分辨率图像（如 1024×1024 产生 4096 个 patch）上带来严重的计算和内存瓶颈。传统解决方案如窗口注意力 (Swin) 虽降低了复杂度，但引入了 2D 先验，破坏了纯序列建模的通用性。</p>\n<p>Mamba 是一种选择性状态空间模型 (Selective SSM)，在 NLP 领域已展示出与 Transformer 匹敌的性能，同时保持 <span class=\"kb-math kb-math-inline\">O(n)</span> 的线性复杂度。然而，Mamba 原生设计为单向因果模型（从左到右），直接应用于视觉任务存在两个关键问题：\n1. <strong>单向性</strong>：图像 patch 序列不具有因果性，单向扫描无法充分利用全局上下文\n2. <strong>位置感知</strong>：视觉 token 需要空间位置信息</p>\n<h5>核心机制：双向状态空间模型</h5>\n<p><strong>SSM 基础</strong>：状态空间模型将输入序列 <span class=\"kb-math kb-math-inline\">x(t)</span> 映射到输出 <span class=\"kb-math kb-math-inline\">y(t)</span>，通过隐状态 <span class=\"kb-math kb-math-inline\">h(t)</span> 进行信息传递：</p>\n<div class=\"kb-math kb-math-display\">h&#x27;(t) = \\mathbf{A} h(t) + \\mathbf{B} x(t), \\quad y(t) = \\mathbf{C} h(t)</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">\\mathbf{A} \\in \\mathbb{R}^{N \\times N}</span> 是状态转移矩阵，<span class=\"kb-math kb-math-inline\">\\mathbf{B} \\in \\mathbb{R}^{N \\times 1}</span>、<span class=\"kb-math kb-math-inline\">\\mathbf{C} \\in \\mathbb{R}^{1 \\times N}</span> 分别是输入和输出投影。通过零阶保持 (ZOH) 离散化：</p>\n<div class=\"kb-math kb-math-display\">\\bar{\\mathbf{A}} = \\exp(\\Delta \\mathbf{A}), \\quad \\bar{\\mathbf{B}} = (\\Delta \\mathbf{A})^{-1}(\\exp(\\Delta \\mathbf{A}) - \\mathbf{I}) \\cdot \\Delta \\mathbf{B}</div>\n<p>离散后的递推形式为：</p>\n<div class=\"kb-math kb-math-display\">h_t = \\bar{\\mathbf{A}} h_{t-1} + \\bar{\\mathbf{B}} x_t, \\quad y_t = \\mathbf{C} h_t</div>\n<div class=\"key-point\">💡 <strong>关键直觉</strong>：SSM 本质上是一个\"压缩记忆\"机制——隐状态 <span class=\"kb-math kb-math-inline\">h_t</span> 将历史信息压缩为固定大小的向量，每步仅需 <span class=\"kb-math kb-math-inline\">O(1)</span> 更新，因此整个序列处理为 <span class=\"kb-math kb-math-inline\">O(n)</span>。</div>\n<p><strong>Mamba 的选择性机制</strong>：与传统 SSM（参数固定）不同，Mamba 让 <span class=\"kb-math kb-math-inline\">\\mathbf{B}</span>、<span class=\"kb-math kb-math-inline\">\\mathbf{C}</span>、<span class=\"kb-math kb-math-inline\">\\Delta</span> 依赖于输入 <span class=\"kb-math kb-math-inline\">x_t</span>，使模型能够根据内容动态选择保留或遗忘信息，类似于注意力机制的\"选择性关注\"。</p>\n<p><strong>Vim 的双向扩展</strong>：为解决单向 SSM 的局限性，Vim 对同一输入序列分别进行前向（<span class=\"kb-math kb-math-inline\">t = 1 \\to L</span>）和后向（<span class=\"kb-math kb-math-inline\">t = L \\to 1</span>）SSM 扫描，两个方向使用独立的参数（<span class=\"kb-math kb-math-inline\">\\mathbf{B}</span>、<span class=\"kb-math kb-math-inline\">\\mathbf{C}</span>、<span class=\"kb-math kb-math-inline\">\\Delta</span>），最终将两个方向的输出相加融合。这确保每个 token 都能同时获取来自序列两端的上下文信息。</p>\n<div class=\"warn-box\">⚠️ <strong>设计选择</strong>：消融实验表明，\"双向 SSM + Conv1d\"组合效果最佳（ImageNet 73.9 / ADE20K 35.9），优于仅双向层（70.9 / 33.6）或仅双向 SSM（72.8 / 33.2）。Conv1d 提供了局部特征提取能力，与 SSM 的全局建模形成互补。</div>\n<h5>整体架构</h5>\n<p>Vim 的整体架构遵循 ViT 的设计范式：</p>\n<ol>\n<li><strong>Patch Embedding</strong>：将输入图像 <span class=\"kb-math kb-math-inline\">I \\in \\mathbb{R}^{H \\times W \\times C}</span> 切分为 <span class=\"kb-math kb-math-inline\">J</span> 个大小为 <span class=\"kb-math kb-math-inline\">P \\times P</span> 的 patch，线性投影为 <span class=\"kb-math kb-math-inline\">D</span> 维 token 序列</li>\n<li><strong>位置嵌入 + CLS Token</strong>：添加可学习的 1D 位置嵌入 <span class=\"kb-math kb-math-inline\">E_{\\text{pos}} \\in \\mathbb{R}^{(J+1) \\times D}</span> 和分类 token <span class=\"kb-math kb-math-inline\">t_{\\text{cls}}</span></li>\n<li><strong>L 层 Vim Block</strong>：每层包含 Normalize → 双分支投影 → 双向 SSM → 门控融合 → 残差连接</li>\n<li><strong>分类头</strong>：最终 Normalize + MLP Head 作用于 CLS token</li>\n</ol>\n<p>模型配置：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>变体</th>\n<th>层数 L</th>\n<th>维度 D</th>\n<th>SSM 维度 N</th>\n<th>扩展比 E/D</th>\n<th>参数量</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>Vim-Ti</td>\n<td>24</td>\n<td>192</td>\n<td>16</td>\n<td>~2×</td>\n<td>7M</td>\n</tr>\n<tr>\n<td>Vim-S</td>\n<td>24</td>\n<td>384</td>\n<td>16</td>\n<td>~2×</td>\n<td>26M</td>\n</tr>\n</tbody>\n</table></div>\n<h5>效率分析</h5>\n<p>Vim 的核心优势在于线性复杂度。对于序列长度 <span class=\"kb-math kb-math-inline\">n</span>：\n- <strong>自注意力 (ViT)</strong>：计算 <span class=\"kb-math kb-math-inline\">O(n^2 \\cdot D)</span>，内存 <span class=\"kb-math kb-math-inline\">O(n^2)</span>\n- <strong>SSM (Vim)</strong>：计算 <span class=\"kb-math kb-math-inline\">O(n \\cdot D \\cdot N)</span>，内存 <span class=\"kb-math kb-math-inline\">O(n \\cdot D \\cdot N)</span></p>\n<p>实测效率对比（Vim-Ti vs DeiT-Ti）：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>分辨率</th>\n<th>Vim FPS 优势</th>\n<th>Vim 内存节省</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>512×512</td>\n<td>~1×</td>\n<td>~1×</td>\n</tr>\n<tr>\n<td>1248×1248</td>\n<td><strong>2.8×</strong> 更快</td>\n<td><strong>86.8%</strong> 节省</td>\n</tr>\n</tbody>\n</table></div>\n<div class=\"key-point\">💡 <strong>关键</strong>：在低分辨率下 Vim 与 DeiT 效率相当，但随着分辨率增长，线性 vs 二次的差距急剧放大。这使 Vim 特别适合高分辨率密集预测任务（语义分割、目标检测）以及超长序列多模态应用。</div>\n<h5>与传统方法的对比</h5>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>方面</th>\n<th>ViT / DeiT</th>\n<th>Swin Transformer</th>\n<th>Vim</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>序列建模</td>\n<td>全局自注意力</td>\n<td>窗口注意力 + 移位</td>\n<td>双向 SSM</td>\n</tr>\n<tr>\n<td>复杂度</td>\n<td><span class=\"kb-math kb-math-inline\">O(n^2)</span></td>\n<td><span class=\"kb-math kb-math-inline\">O(n)</span>（窗口内）</td>\n<td><span class=\"kb-math kb-math-inline\">O(n)</span></td>\n</tr>\n<tr>\n<td>2D 先验</td>\n<td>无</td>\n<td>窗口划分</td>\n<td>无</td>\n</tr>\n<tr>\n<td>高分辨率扩展</td>\n<td>差</td>\n<td>中</td>\n<td>优</td>\n</tr>\n<tr>\n<td>纯序列建模</td>\n<td>✓</td>\n<td>✗</td>\n<td>✓</td>\n</tr>\n</tbody>\n</table></div>\n<p>Vim 的独特优势在于：保持了 ViT 纯序列建模的通用性（无需窗口等 2D 先验），同时获得了与 Swin 类似的线性复杂度。在 COCO 检测中，DeiT 需要使用窗口注意力才能处理 1024×1024 输入，而 Vim 可以直接以纯序列方式处理。</p>\n<h5>实验结果汇总</h5>\n<p><strong>ImageNet-1K 分类：</strong></p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>模型</th>\n<th>参数量</th>\n<th>Top-1 Acc</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>ResNet-50</td>\n<td>25M</td>\n<td>76.2</td>\n</tr>\n<tr>\n<td>DeiT-Ti</td>\n<td>6M</td>\n<td>72.2</td>\n</tr>\n<tr>\n<td>DeiT-S</td>\n<td>22M</td>\n<td>79.8</td>\n</tr>\n<tr>\n<td>DeiT-B</td>\n<td>87M</td>\n<td>81.8</td>\n</tr>\n<tr>\n<td><strong>Vim-Ti</strong></td>\n<td>7M</td>\n<td><strong>76.1</strong></td>\n</tr>\n<tr>\n<td><strong>Vim-Ti†</strong></td>\n<td>7M</td>\n<td><strong>78.3</strong></td>\n</tr>\n<tr>\n<td><strong>Vim-S</strong></td>\n<td>26M</td>\n<td><strong>80.5</strong></td>\n</tr>\n<tr>\n<td><strong>Vim-S†</strong></td>\n<td>26M</td>\n<td><strong>81.6</strong></td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>ADE20K 语义分割（UperNet）：</strong></p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>骨干网络</th>\n<th>参数量</th>\n<th>mIoU</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>DeiT-Ti</td>\n<td>—</td>\n<td>39.2</td>\n</tr>\n<tr>\n<td>DeiT-S</td>\n<td>—</td>\n<td>44.0</td>\n</tr>\n<tr>\n<td><strong>Vim-Ti</strong></td>\n<td>13M</td>\n<td><strong>41.0</strong></td>\n</tr>\n<tr>\n<td><strong>Vim-S</strong></td>\n<td>46M</td>\n<td><strong>44.9</strong></td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>COCO 检测与实例分割（Cascade Mask R-CNN）：</strong></p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>骨干网络</th>\n<th>AP<span class=\"kb-math kb-math-inline\">^{\\text{box}}</span></th>\n<th>AP<span class=\"kb-math kb-math-inline\">^{\\text{mask}}</span></th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>DeiT-Ti</td>\n<td>44.4</td>\n<td>38.1</td>\n</tr>\n<tr>\n<td><strong>Vim-Ti</strong></td>\n<td><strong>45.7</strong></td>\n<td><strong>39.2</strong></td>\n</tr>\n</tbody>\n</table></div>",
      "quiz": {
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>线性复杂度</strong>：相比 ViT 的 <span class=\"kb-math kb-math-inline\">O(N^2)</span> 全局注意力和 CNN 的局部感受野，VMamba 以 <span class=\"kb-math kb-math-inline\">O(N)</span> 复杂度实现全局建模",
    ...
    },
    {
      ...
      "summary": "SPMamba 面向脊柱医学图像分割，把 Mamba 的长程建模能力与层级特征融合、通道排序结合，解决脊柱结构细长、相邻组织相似和局部卷积难以捕获全局形态连续性的问题。",
      "keyPoints": [
        "论文题名：SPMamba: Spinal image segmentation via Mamba framework with hierarchical feature fusion and channel sorting。",
        "发表信息：Biomedical Signal Processing and Control, 112, Article 108364, DOI <code>10.1016/j.bspc.2025.108364</code>。",
      ...
      "detail": "<p><img alt=\"SPMamba 图 1\" src=\"https://ars.els-cdn.com/content/image/1-s2.0-S1746809425008754-gr1.jpg\" />\n<em>图：ScienceDirect 公开的 SPMamba 图 1，用于展示论文核心框架。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\">def spmamba_segment(image):\n    pyramid = []\n    x = patch_embed(image)\n\n    # 编码：局部卷积/patch embedding + Mamba 长程建模\n    for stage in encoder_stages:\n        x = stage.local_block(x)\n        x = stage.mamba_block(x)\n        pyramid.append(x)\n        x = downsample(x)\n\n    # 层级融合：深层语义逐级回流到浅层边界\n    y = pyramid[-1]\n    for skip in reversed(pyramid[:-1]):\n        skip = channel_sort(skip)     # 强调与脊柱结构相关的通道\n        y = upsample(y)\n        y = hierarchical_fuse(y, skip)\n\n    return segmentation_head(y)\n</code></pre>\n<h5>方法解读</h5>\n<p>脊柱分割比普通器官分割更依赖形态连续性：椎体沿脊柱方向排列，局部边界可能被噪声、病变、低对比或邻近软组织干扰。如果只看局部卷积窗口，模型容易把相邻椎体或背景组织混在一起；如果只看全局，又可能损失精细边缘。</p>\n<p>Mamba 的价值在于以线性复杂度处理长序列。将二维或三维医学图像 patch 展平成序列后，选择性状态空间模型可用递推方式传播远距离信息：</p>\n<div class=\"kb-math kb-math-display\">h_t=A(x_t)h_{t-1}+B(x_t)x_t,\\quad y_t=C(x_t)h_t</div>\n<p>这比全局 self-attention 的二次复杂度更适合高分辨率医学图像。对脊柱而言，长程状态能捕获“多个椎体沿轴线连续排列”的结构先验。</p>\n<p>Hierarchical Feature Fusion 解决的是多尺度问题。浅层特征包含边缘、骨皮质纹理和局部灰度变化；深层特征包含椎体/椎间盘等结构语义。融合可抽象为：</p>\n<div class=\"kb-math kb-math-display\">F_{fuse}^{l}=\\phi\\left([F_{dec}^{l+1}\\uparrow,\\;F_{enc}^{l}]\\right)</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">\\phi</span> 可以是卷积、门控或注意力融合。若没有这一步，Mamba 的全局上下文可能不足以恢复小结构的像素边界。</p>\n<p>Channel Sorting 的直觉是不同通道对结构分割贡献不均。通过通道重要性度量 <span class=\"kb-math kb-math-inline\">s_c</span> 对通道重排或加权：</p>\n<div class=\"kb-math kb-math-display\">\\tilde{F}=F_{\\operatorname{argsort}(s)}</div>\n<p>它让与脊柱解剖结构相关的响应在融合时更突出，减少背景噪声通道干扰。这个思想类似通道注意力，但强调“排序后的层级融合”。</p>\n<p>训练通常采用 Dice + Cross Entropy 的组合以处理医学图像类别不均衡：</p>\n<div class=\"kb-math kb-math-display\">\\mathcal{L}=\\mathcal{L}_{ce}+\\lambda(1-\\operatorname{Dice})</div>\n<p>与 U-Net 类 CNN 相比，SPMamba 的优势在全局形态；与纯 Transformer 相比，它的优势在序列长度线性复杂度；与普通 VMamba 分割网络相比，它把层级融合和通道排序针对脊柱细长结构做了适配。</p>\n<div class=\"warn-box\">⚠️ 注意：由于公开摘要/页面可访问内容有限，本文未写入无法核验的具体 Dice、mIoU 或数据集数值。</div>",
      "quiz": {
        "q": "SPMamba 中层级特征融合最直接解决什么问题？",
        "options": [
          "让模型只输出图像级分类",
    ...
    },
    {
      ...
      "summary": "SegMaFormer 提出轻量级 3D 医学分割混合编码器，在高分辨率早期阶段使用 Mamba 降低长序列建模成本，在低分辨率深层阶段保留 Transformer 注意力，并用 3D RoPE 和 MLP 解码器兼顾效率与精度。",
      "keyPoints": [
      ...
      "detail": "<p><img alt=\"SegMaFormer 架构图\" src=\"https://arxiv.org/html/2603.22002v1/Network-Architecture-Page-1.png\" />\n<em>图：SegMaFormer 使用 3D patch embedding、3D RoPE、Mamba/Transformer 混合编码器和 all-MLP 解码器。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\">def segmaformer(volume):\n    x = overlapped_3d_patch_embedding(volume)\n    x = apply_3d_rope(x)\n    features = []\n\n    for i, block in enumerate(encoder_stages):\n        if i &lt; 3:\n            x = mix_vision_mamba_block(x)      # 高分辨率阶段，线性复杂度\n        else:\n            x = efficient_transformer_block(x) # 低分辨率阶段，自注意力成本可控\n        features.append(x)\n        x = downsample_3d(x)\n\n    projected = [mlp_project(f) for f in features]\n    upsampled = [upsample_to_full(p) for p in projected]\n    fused = mlp_fuse(concat(upsampled))\n    return conv1x1_3d(fused)\n</code></pre>\n<h5>方法解读</h5>\n<p>3D 医学图像的 token 数量增长很快。若把 <span class=\"kb-math kb-math-inline\">D\\times H\\times W</span> 体数据切成 patch 后直接全局 self-attention，复杂度近似 <span class=\"kb-math kb-math-inline\">O(N^2)</span>，其中 <span class=\"kb-math kb-math-inline\">N</span> 是体素 token 数；这在 CT/MRI 体数据上很容易超出显存和算力预算。</p>\n<p>SegMaFormer 的设计原则是把不同模块放在它们最合适的尺度上。早期阶段空间分辨率高、token 多，此时用 Mamba 的线性序列建模：</p>\n<div class=\"kb-math kb-math-display\">\\operatorname{Cost}_{Mamba}=O(NC)</div>\n<p>它能捕获长程依赖且不会像注意力那样随 token 数平方增长。后期阶段经过下采样，<span class=\"kb-math kb-math-inline\">N</span> 变小但通道维更高，此时 self-attention 的成本可控，更适合精炼全局语义。</p>\n<p>3D RoPE 解决位置感知问题。体数据中的上下、左右、前后方向都包含解剖意义，简单绝对位置嵌入在尺寸变化时泛化较差；旋转位置编码把相对位置信息注入 query/key 或序列表示，让 Mamba 与 Transformer 都能区分 3D 空间关系。</p>\n<p>编码器输出四个尺度特征，解码器不使用重卷积 U-Net 解码，而是采用 SegFormer 式 MLP：</p>\n<div class=\"kb-math kb-math-display\">\\hat{F}_l=\\operatorname{MLP}(F_l),\\quad\nF=\\operatorname{MLP}\\left(\\operatorname{Concat}(\\operatorname{Up}(\\hat{F}_1),...,\\operatorname{Up}(\\hat{F}_4))\\right)</div>\n<p>这种 all-MLP decoder 参数少，适合轻量化目标。训练通常使用 Dice 与交叉熵组合，论文还讨论 deep supervision 对小结构可能并非总是有利。</p>\n<p>与纯 VMamba 的区别是它没有在所有尺度都依赖状态空间层，而是在低分辨率处保留 Transformer 的全局表达；与纯 SegFormer3D 相比，它减少了高分辨率阶段的注意力成本。</p>\n<div class=\"key-point\">💡 关键：SegMaFormer 的“混合”不是堆模块，而是按 token 数和语义层次分配 Mamba 与 Transformer。</div>",
      "quiz": {
        "q": "SegMaFormer 为什么把 Mamba 放在早期高分辨率阶段？",
        "options": [
    ...
    },
    {
      ...
      "summary": "Taming SAM3 提出 ConceptBank，一个无参数校准框架，用目标域原型、代表性支持样本和候选概念融合修正 SAM3 的提示语义，使开放词汇分割在自然场景与遥感分布漂移下更稳健。",
      "keyPoints": [
      ...
      "detail": "<p><img alt=\"ConceptBank 方法图\" src=\"https://arxiv.org/html/2602.06333v1/x2.png\" />\n<em>图：ConceptBank 使用目标域统计构建概念库，在不改动 SAM3 参数的情况下校准开放词汇分割提示。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\">def build_concept_bank(sam3, support_set, class_names, llm, top_k=8, top_j=4, tau=0.07):\n    bank = {}\n    for cls in class_names:\n        # Stage I: 目标域视觉原型\n        crops = mask_pool_crops(support_set, cls)\n        feats = [normalize(sam3.image_encoder(crop)) for crop in crops]\n        prototype = normalize(mean(feats))\n\n        # Stage II: 代表性支持集\n        ranked = sort_by_cosine(feats, prototype)\n        reps = take_top_k(ranked, top_k)\n\n        # Stage III: 候选概念评分与融合\n        prompts = llm_generate_candidate_descriptions(cls)\n        scores, embeds = [], []\n        for prompt in prompts:\n            emb = sam3.text_encoder(prompt)\n            dice = evaluate_prompt_dice(sam3, reps, emb)\n            scores.append(dice)\n            embeds.append(normalize(emb))\n\n        best = top_j_indices(scores, top_j)\n        weights = softmax([scores[i] / tau for i in best])\n        bank[cls] = sum(w * embeds[i] for w, i in zip(weights, best))\n    return bank\n\ndef conceptbank_infer(sam3, image, bank):\n    return sam3.segment_with_concept_embeddings(image, bank.values())\n</code></pre>\n<h5>方法解读</h5>\n<p>SAM3 把分割推进到 concept prompt：给一个文本概念或图像范例，模型输出匹配实例的 mask。但开放词汇分割的标签不是天然稳定的。不同数据集对同一词有不同标注范围；遥感图像还存在俯视视角、尺度、纹理和成像条件差异，导致通用 prompt 与目标域视觉证据错位。</p>\n<p>论文把问题拆成两类漂移。Data drift 指视觉分布从 SAM3 预训练/源域转向目标域，例如遥感建筑、水体、道路与自然图像差异巨大。Concept drift 指类别词本身的含义变化，例如 “field”“building”“road” 在不同数据集中的标注粒度和边界规范不同。</p>\n<p>ConceptBank 不微调 SAM3，而是校准概念嵌入。Stage I 对每个类别从支持集 mask 区域抽取视觉特征并平均，得到目标域原型：</p>\n<div class=\"kb-math kb-math-display\">\\mu_c=\\operatorname{Norm}\\left(\\frac{1}{|S_c|}\\sum_{(x,y)\\in S_c}\\phi_I(\\operatorname{maskcrop}(x,y,c))\\right)</div>\n<p>Stage II 用余弦相似度选择代表性支持样本：</p>\n<div class=\"kb-math kb-math-display\">R_c=\\operatorname{TopK}_{(x,y)\\in S_c}\\cos(\\phi_I(x_c),\\mu_c)</div>\n<p>这样可以减少罕见视角、遮挡、错标和背景污染对后续 prompt 评分的影响。</p>\n<p>Stage III 的关键是不用静态文本相似度评分候选 prompt，而是在代表性支持集上实际跑 SAM3 分割，用 Dice 衡量候选概念是否“能切对”：</p>\n<div class=\"kb-math kb-math-display\">s_{c,m}=\\frac{1}{|R_c|}\\sum_{(x,y)\\in R_c}\\operatorname{Dice}(f_\\Phi(x,\\phi_T(t_{c,m})),y_c)</div>\n<p>得分最高的若干候选再经温度 softmax 融合为最终概念嵌入：</p>\n<div class=\"kb-math kb-math-display\">e_c^*=\\sum_{m\\in J_c}\\frac{\\exp(s_{c,m}/\\tau)}{\\sum_{j\\in J_c}\\exp(s_{c,j}/\\tau)}\\operatorname{Norm}(\\phi_T(t_{c,m}))</div>\n<p>推理时概念库 <span class=\"kb-math kb-math-inline\">B=\\{e_c^*\\}</span> 直接作为 SAM3 的概念锚点，文本编码器可以不再参与每次推理。与微调相比，这种方式计算轻、风险低，也更适合标签很少但类别定义明确的目标域。</p>\n<div class=\"key-point\">💡 关键：ConceptBank 校准的是“类别该怎么说、怎么对齐”，不是 SAM3 的视觉分割能力本身。</div>",
      "quiz": {
        "q": "ConceptBank 为什么用支持集 Dice 而不是只用文本余弦相似度给候选概念打分？",
        "options": [
    ...
    },
    {
      ...
      "keyPoints": [
        "<strong>Rein 核心机制</strong>：在冻结 VFM 的每一层之间嵌入可学习 token 集合 <span class=\"kb-math kb-math-inline\">T_i \\in \\mathbb{R}^{m \\times c}</span>，通过注意力机制生成逐层特征修正 <span class=\"kb-math kb-math-inline\">\\Delta f_i</span>",
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>语义描述符（Semantic Descriptors）</strong>：将图像划分为 <span class=\"kb-math kb-math-inline\">16 \\times 16 = 256</span> 个 patch，每个 patch 映射到对应的语义标签文本（如 \"sky\"、\"brown dog\"）",
        ...
        "<strong>可选 SAM 精炼器</strong>：推理时可用 SAM 将粗糙的 <span class=\"kb-math kb-math-inline\">16 \\times 16</span> 掩码上采样为像素级精细掩码，cIoU 从 73.5 提升至 79.3",
