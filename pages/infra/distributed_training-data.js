/**
 * distributed_training-data.js — 由 pipeline/build.py 于 2026-06-16 17:00:15 自动生成。
...
window.PAGE_CONFIG = {
  ...
  "latest_overview": [
    {
      "title": "",
      "body_html": "<h1>AI Infra 多机多卡训练深度分析报告与最佳实践</h1>\n<ul>\n<li>来源平台: <strong>zhihu</strong>（知乎专栏文章）</li>\n<li>原文链接: <a href=\"https://zhuanlan.zhihu.com/p/2019388279452088300\">https://zhuanlan.zhihu.com/p/2019388279452088300</a></li>\n<li>作者: 鹏Peng</li>\n</ul>\n<hr />\n<p>AI Infra 多机多卡训练深度分析报告与最佳实践</p>\n<h1>AI Infra 多机多卡训练深度分析报告与最佳实践</h1>\n<p>作者: 鹏Peng, 赞: 8</p>\n<p><img alt=\"\" src=\"https://pic1.zhimg.com/v2-f7bc5baea5849b0610a294b99e5924ba_1440w.jpg\" /></p>\n<hr />\n<h3>目录</h3>\n<ol>\n<li><a href=\"https://zhuanlan.zhihu.com/write#%E5%BC%95%E8%A8%80\">引言：为什么多机多卡训练如此重要</a></li>\n<li><a href=\"https://zhuanlan.zhihu.com/write#%E5%AD%A6%E4%B9%A0%E8%B7%AF%E5%BE%84\">完整学习路径：从入门到千卡级</a></li>\n<li><a href=\"https://zhuanlan.zhihu.com/write#ddp%E7%93%B6%E9%A2%88\">DDP 性能瓶颈深度剖析</a></li>\n<li><a href=\"https://zhuanlan.zhihu.com/write#fsdp%E5%8E%9F%E7%90%86\">FSDP：从全量复制到智能分片</a></li>\n<li><a href=\"https://zhuanlan.zhihu.com/write#vivo%E4%BC%98%E5%8C%96\">vivo 千卡集群四大优化方向</a></li>\n<li><a href=\"https://zhuanlan.zhihu.com/write#%E6%9C%80%E4%BC%98%E6%96%B9%E6%A1%88\">生产级最优方案：Accelerate + FSDP</a></li>\n<li><a href=\"https://zhuanlan.zhihu.com/write#%E4%BB%A3%E7%A0%81%E6%A8%A1%E6%9D%BF\">可直接使用的代码模板</a></li>\n<li><a href=\"https://zhuanlan.zhihu.com/write#%E6%80%A7%E8%83%BD%E7%9B%91%E6%8E%A7\">性能监控与调优指南</a></li>\n<li><a href=\"https://zhuanlan.zhihu.com/write#%E6%9C%AA%E6%9D%A5%E8%B6%8B%E5%8A%BF\">未来趋势与展望</a></li>\n</ol>\n<hr />\n<h3>引言：为什么多机多卡训练如此重要</h3>\n<h3>1.1 Scaling Law 的残酷现实</h3>\n<p>在大模型时代，<strong>算力即竞争力</strong>。GPT-4、Claude-3、Gemini 等顶尖模型背后，都是数千甚至上万张 GPU 的集群在支撑训练。</p>\n<blockquote>\n<p>“The bitter lesson: 规模才是王道。” —— Rich Sutton</p>\n</blockquote>\n<p>根据 OpenAI 的 Scaling Law：</p>\n<ul>\n<li>模型性能 ∝ 模型参数^0.5 × 数据量^0.5 × 算力^0.25</li>\n<li>这意味着：想要更好的模型，就必须扩大训练规模</li>\n</ul>\n<h3>1.2 多机多卡的核心挑战</h3>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>挑战类型</th>\n<th>具体问题</th>\n<th>影响</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>内存瓶颈</td>\n<td>大模型无法装入单卡</td>\n<td>70B 模型 FP32 需要 280GB</td>\n</tr>\n<tr>\n<td>通信开销</td>\n<td>多卡间梯度同步</td>\n<td>可能占用 50%+ 训练时间</td>\n</tr>\n<tr>\n<td>数据加载</td>\n<td>海量数据的 I/O 瓶颈</td>\n<td>数据等待导致 GPU 空闲</td>\n</tr>\n<tr>\n<td>稳定性</td>\n<td>千卡规模故障概率高</td>\n<td>单卡故障导致整体停滞</td>\n</tr>\n</tbody>\n</table></div>\n<h3>1.3 本文目标</h3>\n<p>本文将系统性地讲解：</p>\n<ol>\n<li><strong>完整学习路径</strong>：从 DDP 到 FSDP 再到千卡优化</li>\n<li><strong>原理深度剖析</strong>：每个优化手段背后的技术原理</li>\n<li><strong>生产级方案</strong>：可直接落地的 Accelerate + FSDP 架构</li>\n<li><strong>实战代码</strong>：数据预处理、训练、监控的完整代码</li>\n</ol>\n<hr />\n<h3>学习路径</h3>\n<p><img alt=\"\" src=\"https://pic3.zhimg.com/v2-8741e2554a5a9533686f9ca6efce0294_1440w.jpg\" /></p>\n<h3>2.1 阶段一：建立领域认知</h3>\n<p><strong>推荐资源：</strong></p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>大神</th>\n<th>背景</th>\n<th>推荐内容</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>姚顺雨</td>\n<td>腾讯首席 AI 科学家，前 OpenAI</td>\n<td>关注他对 LLM 训练 infrastructure 的分享</td>\n</tr>\n<tr>\n<td>翁家翌</td>\n<td>OpenAI RLHF/Infra 核心</td>\n<td>强烈推荐 听 WhynotTV Podcast 他的访谈</td>\n</tr>\n<tr>\n<td>尤洋</td>\n<td>Colossal-AI 创始人</td>\n<td>他的论文和演讲对理解分布式训练很有帮助</td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>学习目标：</strong> 建立对分布式训练”为什么难”的直觉认知。</p>\n<h3>2.2 阶段二：框架快速入门</h3>\n<p><strong>Hugging Face Accelerate</strong> —— 最推荐入门工具</p>\n<pre><code># 为什么推荐 Accelerate？\n# 1. 统一 API：一行代码切换 DDP/FSDP/DeepSpeed\n# 2. 配置驱动：YAML 配置，无需修改代码\n# 3. 生态兼容：与 Transformers、Diffusers 无缝集成\n</code></pre>\n<p><strong>安装与基础使用：</strong></p>\n<pre><code>pip install accelerate\naccelerate config  # 交互式配置\n</code></pre>\n<h3>2.3 阶段三：理解核心原理</h3>\n<p><strong>从 DDP 到 FSDP 的演进逻辑：</strong></p>\n<pre><code>DDP: 每个 GPU 保存完整模型副本 → 内存 = N × 模型大小\n     ↓\nFSDP: 每个 GPU 只保存 1/N 参数 → 内存 ≈ 1 × 模型大小\n     ↓\nDeepSpeed ZeRO: 进一步分片优化器状态 → 内存 &lt; 1 × 模型大小\n</code></pre>\n<p><strong>必须理解的核心概念：</strong></p>\n<ol>\n<li><strong>数据并行 (DP)</strong> vs <strong>模型并行 (MP)</strong> vs <strong>流水线并行 (PP)</strong></li>\n<li><strong>All-Reduce</strong> 通信原语</li>\n<li><strong>前向传播、反向传播、参数更新</strong> 的分布式实现</li>\n</ol>\n<h3>2.4 阶段四：掌握高级框架</h3>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>框架</th>\n<th>核心特性</th>\n<th>适用场景</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>DeepSpeed</td>\n<td>ZeRO-1/2/3，Offload</td>\n<td>超大模型（100B+）</td>\n</tr>\n<tr>\n<td>Colossal-AI</td>\n<td>统一并行，自动优化</td>\n<td>研究和快速原型</td>\n</tr>\n<tr>\n<td>FSDP</td>\n<td>PyTorch 原生，易用</td>\n<td>生产环境首选</td>\n</tr>\n<tr>\n<td>Megatron-LM</td>\n<td>张量并行专家</td>\n<td>GPT 类大模型</td>\n</tr>\n</tbody>\n</table></div>\n<h3>2.5 阶段五：千卡级实战</h3>\n<p><strong>关键学习资源：</strong></p>\n<ol>\n<li>\n<p><strong>vivo AI 团队《千卡 GPU 集群多模态大模型落地实践》</strong></p>\n</li>\n<li>\n<p>InfoQ 文字实录：<a href=\"https://link.zhihu.com/?target=https%3A//www.infoq.cn/article/yjkhbargjmkpsuqoc3l0\">https://www.infoq.cn/article/yjkhbargjmkpsuqoc3l0</a></p>\n</li>\n<li>视频：<a href=\"https://link.zhihu.com/?target=https%3A//www.infoq.cn/video/XU5oLYGXtGQkFOSKMqHx\">https://www.infoq.cn/video/XU5oLYGXtGQkFOSKMqHx</a></li>\n<li>\n<p>核心价值：四大优化方向的系统性总结</p>\n</li>\n<li>\n<p><strong>Together.ai 多节点 Scaling 指南</strong></p>\n</li>\n<li>\n<p>侧重通信优化和稳定性</p>\n</li>\n</ol>\n<hr />\n<h3>DDP 瓶颈</h3>\n<h3>3.1 PyTorch DDP 的工作原理</h3>\n<pre><code>import torch\nimport torch.nn as nn\nfrom torch.nn.parallel import DistributedDataParallel as DDP\n\n# DDP 的核心假设：每个 GPU 都能放下完整模型\nmodel = nn.Linear(1000, 1000).cuda(local_rank)\nmodel = DDP(model, device_ids=[local_rank])\n</code></pre>\n<p><strong>DDP 的训练流程：</strong></p>\n<ol>\n<li><strong>前向传播</strong>：每个 GPU 独立计算</li>\n<li><strong>损失计算</strong>：各自计算本地损失</li>\n<li><strong>反向传播</strong>：计算本地梯度</li>\n<li><strong>梯度同步</strong>：All-Reduce 聚合梯度</li>\n<li><strong>参数更新</strong>：每个 GPU 独立更新（相同梯度 → 相同更新）</li>\n</ol>\n<h3>3.2 DDP 的两大性能瓶颈</h3>\n<h3>瓶颈一：全模型复制导致 OOM</h3>\n<p><img alt=\"\" src=\"https://picx.zhimg.com/v2-d26b275440c9c4db5de7fda1ba94b4df_1440w.jpg\" /></p>\n<p><strong>原理分析：</strong></p>\n<pre><code>假设模型大小：10GB\nOptimizer State (Adam): 2 × 10GB = 20GB\nGradients: 10GB\nActivations: 5GB\n-----------------------------\n单 GPU 需求: ~45GB\n\nDDP 在 4 卡上的内存占用：4 × 45GB = 180GB\n</code></pre>\n<p><strong>问题：</strong> 对于 70B 模型，DDP 需要 4 张 A100 (80GB) 才能装下，成本极高。</p>\n<h3>瓶颈二：CUDA Pinned Memory 拷贝开销</h3>\n<p><strong>DataLoader 的默认行为：</strong></p>\n<pre><code># 问题代码示例\ndataloader = DataLoader(\n    dataset,\n    batch_size=32,\n    num_workers=4,\n    pin_memory=True,  # 默认启用\n)\n\nfor batch in dataloader:\n    # 这里会发生：\n    # 1. CPU pinned memory → GPU memory 的同步拷贝\n    # 2. 如果拷贝速度跟不上 GPU 计算速度，GPU 就会空闲\n    batch = batch.cuda()\n</code></pre>\n<p><strong>为什么 pin_memory 会慢？</strong></p>\n<ol>\n<li>\n<p><strong>Pageable vs Pinned Memory</strong>：</p>\n</li>\n<li>\n<p>Pageable：可分页内存，可能被换出到磁盘</p>\n</li>\n<li>\n<p>Pinned：页锁定内存，直接与 GPU 进行 DMA 传输</p>\n</li>\n<li>\n<p><strong>拷贝瓶颈</strong>：</p>\n</li>\n<li>\n<p>即使使用 pinned memory，如果数据预处理复杂，CPU → GPU 的拷贝仍可能成为瓶颈</p>\n</li>\n<li>默认情况下，拷贝和 GPU 计算是串行的</li>\n</ol>\n<h3>3.3 DDP 优化的临时方案</h3>\n<p>在彻底升级到 FSDP 之前，可以先优化 DataLoader：</p>\n<pre><code># 优化后的 DataLoader\ndataloader = DataLoader(\n    dataset,\n    batch_size=32,\n    num_workers=8,              # 增加 worker 数\n    pin_memory=True,\n    persistent_workers=True,    # 保持 worker 进程，避免频繁创建\n    prefetch_factor=4,          # 预取 batches 数量\n)\n\n# 使用 non_blocking 实现异步拷贝\nfor batch in dataloader:\n    batch = batch.cuda(non_blocking=True)  # 异步拷贝\n    # 这里可以进行一些 CPU 操作，与 GPU 拷贝并行\n    output = model(batch)\n</code></pre>\n<p><strong>但是</strong>，这些优化只能缓解症状，<strong>无法解决根本问题</strong>：DDP 的全模型复制设计就决定了它不适合大模型训练。</p>\n<hr />\n<h3>FSDP 原理</h3>\n<h3>4.1 FSDP 的核心思想：分片即正义</h3>\n<p><strong>Fully Sharded Data Parallel</strong> 的核心创新：</p>\n<blockquote>\n<p>不再让每个 GPU 保存完整模型，而是每个 GPU 只保存 1/N 的参数。</p>\n</blockquote>\n<pre><code>DDP 内存构成 (4卡):\nGPU0: [Params, Grads, Optim]  GPU1: [Params, Grads, Optim]\nGPU2: [Params, Grads, Optim]  GPU3: [Params, Grads, Optim]\n\nFSDP 内存构成 (4卡):\nGPU0: [1/4 Params, 1/4 Grads, 1/4 Optim]\nGPU1: [1/4 Params, 1/4 Grads, 1/4 Optim]\nGPU2: [1/4 Params, 1/4 Grads, 1/4 Optim]\nGPU3: [1/4 Params, 1/4 Grads, 1/4 Optim]\n</code></pre>\n<h3>4.2 FSDP 的完整训练流程</h3>\n<pre><code>import torch\nfrom torch.distributed.fsdp import FullyShardedDataParallel as FSDP\nfrom torch.distributed.fsdp.wrap import transformer_auto_wrap_policy\n\n# FSDP 包装\nmodel = FSDP(\n    model,\n    auto_wrap_policy=transformer_auto_wrap_policy,\n    mixed_precision=torch.bfloat16,\n    device_id=torch.cuda.current_device(),\n)\n</code></pre>\n<p><strong>FSDP 的前向传播：</strong></p>\n<ol>\n<li><strong>All-Gather 参数</strong>：从其他 GPU 收集当前层所需的参数分片</li>\n<li><strong>计算</strong>：使用完整的参数进行前向传播</li>\n<li><strong>释放参数</strong>：丢弃不需要的参数分片，只保留自己的 1/N</li>\n</ol>\n<p><strong>FSDP 的反向传播：</strong></p>\n<ol>\n<li><strong>All-Gather 参数</strong>：再次收集参数（用于梯度计算）</li>\n<li><strong>计算梯度</strong>：进行反向传播</li>\n<li><strong>Reduce-Scatter 梯度</strong>：将梯度分片聚合到对应 GPU</li>\n<li><strong>本地更新</strong>：每个 GPU 只更新自己负责的参数分片</li>\n</ol>\n<h3>4.3 FSDP 的内存节省计算</h3>\n<pre><code>假设模型大小：M\nAdam Optimizer 状态：2M (momentum + variance)\nGradients：M\n\nDDP 单卡内存: M (params) + M (grads) + 2M (optim) = 4M\nDDP 4卡总内存: 4 × 4M = 16M\n\nFSDP 单卡内存: M/4 + M/4 + 2M/4 = M\nFSDP 4卡总内存: 4 × M = 4M (可支持4倍大的模型)\n</code></pre>\n<p><strong>实际效果：</strong> FSDP 通常可节省 3-4 倍内存。</p>\n<h3>4.4 FSDP 的关键配置参数</h3>\n<pre><code>from torch.distributed.fsdp import (\n    FullyShardedDataParallel as FSDP,\n    MixedPrecision,\n    BackwardPrefetch,\n    ShardingStrategy,\n)\n\nmodel = FSDP(\n    model,\n    # 分片策略\n    sharding_strategy=ShardingStrategy.FULL_SHARD,  # 完全分片\n    # sharding_strategy=ShardingStrategy.SHARD_GRAD_OP,  # 只分片梯度\n\n    # 混合精度\n    mixed_precision=MixedPrecision(\n        param_dtype=torch.bfloat16,\n        reduce_dtype=torch.bfloat16,\n        buffer_dtype=torch.bfloat16,\n    ),\n\n    # 反向传播预取：提前准备下一层的参数\n    backward_prefetch=BackwardPrefetch.BACKWARD_PRE,\n\n    # CPU 卸载（进一步节省 GPU 内存）\n    cpu_offload=CPUOffload(offload_params=False),  # 可设为 True\n)\n</code></pre>\n<hr />\n<h3>vivo 优化</h3>\n<p><img alt=\"\" src=\"https://pica.zhimg.com/v2-31a8d43caca41231795f26644266a92a_1440w.jpg\" /></p>\n<h3>5.1 数据优化：让 GPU 不再等待</h3>\n<p><strong>问题：</strong> 在千卡训练中，数据加载往往成为瓶颈 —— GPU 计算完了，数据还没准备好。</p>\n<p><strong>vivo 的解决方案：</strong></p>\n<h3>5.1.1 离线数据预处理（Shard）</h3>\n<pre><code>&quot;&quot;&quot;\n原始数据格式：大量小文件\n- 读取慢（随机访问）\n- 元数据开销大\n- 不适合分布式读取\n\n预处理后：大文件 Shard\n- 顺序读取，充分利用磁盘带宽\n- 每个 worker 读不同的 shard\n- 减少元数据开销\n&quot;&quot;&quot;\n\nimport webdataset as wds\nimport json\n\ndef create_shards(input_files, output_pattern, shard_size=10000):\n    &quot;&quot;&quot;将原始数据转换为 WebDataset shard 格式&quot;&quot;&quot;\n    sink = wds.ShardWriter(output_pattern, maxcount=shard_size)\n\n    for filepath in input_files:\n        with open(filepath) as f:\n            for line in f:\n                sample = json.loads(line)\n                # 预处理（图像解码、裁剪等）\n                processed = preprocess(sample)\n                sink.write(processed)\n\n    sink.close()\n\n# 使用示例\ncreate_shards(\n    input_files=[&quot;data/part-001.json&quot;, &quot;data/part-002.json&quot;, ...],\n    output_pattern=&quot;shards/data-{000000..000999}.tar&quot;,\n    shard_size=10000,\n)\n</code></pre>\n<h3>5.1.2 本地 SSD 缓存</h3>\n<pre><code>&quot;&quot;&quot;\n架构：\n- 远端存储（对象存储/S3）：数据永久存储\n- 本地 SSD：热数据缓存\n- GPU 显存：当前 batch\n\n策略：\n- 第一次读取：从远端加载到本地 SSD\n- 后续读取：直接从本地 SSD 读取\n- LRU 缓存：自动淘汰不常用的 shard\n&quot;&quot;&quot;\n\nimport os\nimport fcntl\nfrom pathlib import Path\n\nclass LocalCache:\n    def __init__(self, cache_dir, remote_storage):\n        self.cache_dir = Path(cache_dir)\n        self.cache_dir.mkdir(parents=True, exist_okTrue=True)\n        self.remote_storage = remote_storage\n\n    def get(self, key):\n        local_path = self.cache_dir / key\n        if local_path.exists():\n            return local_path\n\n        # 从远端下载\n        self.remote_storage.download(key, local_path)\n        return local_path\n</code></pre>\n<h3>5.1.3 图像动态分桶</h3>\n<pre><code>&quot;&quot;&quot;\n问题：不同尺寸的图像需要不同的填充，导致显存浪费\n\n解决方案：将图像按尺寸分桶，同桶内图像一起处理\n&quot;&quot;&quot;\n\nclass BucketSampler:\n    def __init__(self, dataset, buckets=[(256,256), (512,512), (1024,1024)]):\n        self.buckets = {b: [] for b in buckets}\n\n        # 按图像尺寸分桶\n        for idx, sample in enumerate(dataset):\n            h, w = sample['image'].shape[-2:]\n            # 找到最合适的桶\n            bucket = min(buckets, key=lambda b: abs(b[0]-h) + abs(b[1]-w))\n            self.buckets[bucket].append(idx)\n\n    def __iter__(self):\n        # 随机打乱每个桶\n        for bucket, indices in self.buckets.items():\n            random.shuffle(indices)\n            for i in range(0, len(indices), self.batch_size):\n                yield indices[i:i+self.batch_size]\n</code></pre>\n<p><strong>数据优化效果：</strong> vivo 实测数据加载时间减少 90%</p>\n<h3>5.2 计算优化：榨干 GPU 算力</h3>\n<h3>5.2.1 FlashAttention</h3>\n<pre><code>&quot;&quot;&quot;\n标准 Attention 内存复杂度：O(N²)\nFlashAttention 通过分块计算 + 重计算，实现：\n- 内存：O(N)（不需要存储完整 attention matrix）\n- 速度：2-4x 加速（更好的 memory access pattern）\n&quot;&quot;&quot;\n\nfrom flash_attn import flash_attn_func\n\n# 替换标准 attention\n# 标准版：O = softmax(Q @ K.T / sqrt(d)) @ V\n# FlashAttention：分块计算，IO 感知的实现\noutput = flash_attn_func(q, k, v, causal=True)\n</code></pre>\n<h3>5.2.2 torch.compile</h3>\n<pre><code>&quot;&quot;&quot;\nPyTorch 2.0 的编译优化：\n- 将 Python 代码编译为优化的 C++/Triton kernels\n- 自动 kernel 融合\n- 典型加速：1.2-2x\n&quot;&quot;&quot;\n\nimport torch\n\nmodel = MyModel()\n\n# 编译模型\ncompiled_model = torch.compile(\n    model,\n    mode=&quot;reduce-overhead&quot;,  # 减少编译开销\n    fullgraph=False,         # 允许 graph break（更灵活）\n)\n\n# 第一次运行会触发编译（慢），后续使用编译后的版本（快）\noutput = compiled_model(input)\n</code></pre>\n<h3>5.3 通信优化：让数据飞起来</h3>\n<h3>5.3.1 InfiniBand + RDMA</h3>\n<pre><code>标准以太网：\n- 带宽：100Gbps\n- 延迟：10-100μs\n- 协议开销大\n\nInfiniBand + RDMA：\n- 带宽：400Gbps+\n- 延迟：1-2μs\n- 绕过 CPU，直接内存访问\n&quot;&quot;&quot;\n\n# NCCL 会自动使用 InfiniBand 如果可用\n# 检查是否使用了 IB\nimport os\nos.environ[&quot;NCCL_DEBUG&quot;] = &quot;INFO&quot;\nos.environ[&quot;NCCL_IB_DISABLE&quot;] = &quot;0&quot;  # 启用 IB\n</code></pre>\n<h3>5.3.2 GPUDirect RDMA</h3>\n<pre><code>&quot;&quot;&quot;\nGPUDirect RDMA：GPU 内存 ↔ 网卡 直接传输\n- 绕过 CPU 和系统内存\n- 减少一次内存拷贝\n- 典型加速：10-20%\n&quot;&quot;&quot;\n\n# 需要驱动支持\n# nvidia-smi topo -m 查看 GPU-NIC 拓扑\n</code></pre>\n<h3>5.4 稳定性优化：千卡不出错</h3>\n<h3>5.4.1 异步 Checkpoint</h3>\n<pre><code>&quot;&quot;&quot;\n问题：同步 checkpoint 会阻塞训练，千卡集群 checkpoint 可能需要几分钟\n\n解决方案：异步 checkpoint\n- 主线程继续训练\n- 后台线程写入 checkpoint\n- 需要 2x 内存保存两份模型状态\n&quot;&quot;&quot;\n\nimport threading\n\nclass AsyncCheckpoint:\n    def __init__(self, model):\n        self.model = model\n        self.checkpoint_thread = None\n\n    def save(self, path):\n        # 如果上一次的 checkpoint 还在写入，等待\n        if self.checkpoint_thread and self.checkpoint_thread.is_alive():\n            self.checkpoint_thread.join()\n\n        # 复制状态（浅拷贝引用，快）\n        state_dict = {k: v.cpu() for k, v in self.model.state_dict().items()}\n\n        # 后台写入\n        self.checkpoint_thread = threading.Thread(\n            target=torch.save,\n            args=(state_dict, path),\n        )\n        self.checkpoint_thread.start()\n</code></pre>\n<h3>5.4.2 自动故障恢复</h3>\n<pre><code>&quot;&quot;&quot;\n千卡集群平均每天可能有 1-2 次节点故障\n需要：\n1. 快速检测故障节点\n2. 自动重启训练进程\n3. 从最近的 checkpoint 恢复\n&quot;&quot;&quot;\n\n# Slurm 自动重试配置\n#SBATCH --requeue  # 任务失败自动重新排队\n#SBATCH --open-mode=append  # 追加日志\n\n# PyTorch Elastic Training\nimport torch.distributed.elastic.agent.server as elastic\n\n# 使用 torchrun 启动，支持弹性伸缩\n# torchrun --nnodes=1:8 --nproc_per_node=8 train.py\n</code></pre>\n<hr />\n<h3>最优方案</h3>\n<p><img alt=\"\" src=\"https://pic3.zhimg.com/v2-90856ebe9f180aa6f50f754c087558da_1440w.jpg\" /></p>\n<h3>6.1 推荐架构：Accelerate + FSDP</h3>\n<p><strong>为什么是 Accelerate + FSDP？</strong></p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>方案</th>\n<th>优点</th>\n<th>缺点</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>原生 DDP</td>\n<td>简单</td>\n<td>内存瓶颈</td>\n</tr>\n<tr>\n<td>DeepSpeed</td>\n<td>极致优化</td>\n<td>配置复杂，调试困难</td>\n</tr>\n<tr>\n<td>FSDP</td>\n<td>PyTorch 原生，易用</td>\n<td>需要 PyTorch 2.0+</td>\n</tr>\n<tr>\n<td>Accelerate + FSDP</td>\n<td>最佳平衡</td>\n<td>无明显缺点</td>\n</tr>\n</tbody>\n</table></div>\n<h3>6.2 完整配置</h3>\n<h3>6.2.1 accelerate.yaml 配置</h3>\n<pre><code># accelerate_config.yaml\ncompute_environment: LOCAL_MACHINE\ndistributed_type: FSDP\nfsdp_config:\n  # 分片策略\n  fsdp_auto_wrap_policy: TRANSFORMER_BASED_WRAP\n  fsdp_backward_prefetch_policy: BACKWARD_PRE\n  fsdp_offload_params: false\n  fsdp_sharding_strategy: FULL_SHARD\n  fsdp_state_dict_type: SHARDED_STATE_DICT\n\n  # 混合精度\n  fsdp_fp16: false\n  fsdp_bf16: true\n\n  # 激活检查点\n  fsdp_activation_checkpointing: true\n\ngpu_ids: all\nmachine_rank: 0\nmain_training_function: main\nmixed_precision: bf16\nnum_machines: 1\nnum_processes: 8\nuse_cpu: false\n</code></pre>\n<h3>6.2.2 启动命令</h3>\n<pre><code># 单机多卡\naccelerate launch --config_file accelerate_config.yaml train.py\n\n# 多机多卡（使用 torchrun）\ntorchrun \\\n    --nnodes=$NUM_NODES \\\n    --nproc_per_node=$NUM_GPUS \\\n    --master_addr=$MASTER_ADDR \\\n    --master_port=$MASTER_PORT \\\n    train.py\n</code></pre>\n<hr />\n<h3>代码模板</h3>\n<h3>7.1 完整训练脚本</h3>\n<pre><code>#!/usr/bin/env python3\n&quot;&quot;&quot;\n生产级多机多卡训练脚本\n基于：Accelerate + FSDP + vivo 优化\n&quot;&quot;&quot;\n\nimport os\nimport sys\nimport torch\nimport torch.nn as nn\nfrom torch.utils.data import DataLoader\nfrom accelerate import Accelerator\nfrom accelerate.utils import set_seed\nimport logging\n\n# ============ 配置区 ============\nclass Config:\n    # 模型配置\n    model_name = &quot;your-model-name&quot;\n\n    # 训练配置\n    batch_size = 4          # 单卡 batch size\n    num_epochs = 3\n    learning_rate = 1e-4\n    warmup_steps = 1000\n    max_grad_norm = 1.0\n\n    # 数据配置\n    num_workers = 8\n    prefetch_factor = 4\n    pin_memory = True\n\n    # 混合精度\n    mixed_precision = &quot;bf16&quot;\n\n    # Checkpoint\n    checkpoint_dir = &quot;./checkpoints&quot;\n    checkpoint_steps = 500\n\n    # 日志\n    log_steps = 10\n\nconfig = Config()\n\n# ============ 初始化 ============\ndef setup():\n    &quot;&quot;&quot;初始化分布式环境&quot;&quot;&quot;\n    # 初始化 Accelerator\n    accelerator = Accelerator(\n        mixed_precision=config.mixed_precision,\n        gradient_accumulation_steps=1,\n        log_with=&quot;tensorboard&quot;,\n        project_dir=&quot;./logs&quot;,\n    )\n\n    # 设置随机种子\n    set_seed(42)\n\n    # 配置日志\n    logging.basicConfig(\n        format=&quot;%(asctime)s - %(levelname)s - %(name)s - %(message)s&quot;,\n        datefmt=&quot;%m/%d/%Y %H:%M:%S&quot;,\n        level=logging.INFO,\n    )\n    logger = logging.getLogger(__name__)\n\n    return accelerator, logger\n\n# ============ 数据加载 ============\ndef create_dataloader(accelerator):\n    &quot;&quot;&quot;创建优化的 DataLoader&quot;&quot;&quot;\n    from torch.utils.data import IterableDataset\n\n    class ShardedDataset(IterableDataset):\n        &quot;&quot;&quot;支持分片读取的数据集&quot;&quot;&quot;\n        def __init__(self, shard_paths, rank=0, world_size=1):\n            self.shard_paths = shard_paths[rank::world_size]  # 每个 rank 读不同的 shard\n\n        def __iter__(self):\n            for shard_path in self.shard_paths:\n                # 从本地缓存或远程加载 shard\n                yield from load_shard(shard_path)\n\n    # 获取 world size 和 rank\n    world_size = accelerator.num_processes\n    rank = accelerator.process_index\n\n    # 创建数据集\n    shard_paths = [f&quot;shards/data-{i:06d}.tar&quot; for i in range(1000)]\n    dataset = ShardedDataset(shard_paths, rank, world_size)\n\n    # 优化的 DataLoader\n    dataloader = DataLoader(\n        dataset,\n        batch_size=config.batch_size,\n        num_workers=config.num_workers,\n        pin_memory=config.pin_memory,\n        prefetch_factor=config.prefetch_factor,\n        persistent_workers=True,  # 关键：保持 worker 进程\n    )\n\n    return dataloader\n\n# ============ 模型定义 ============\ndef create_model():\n    &quot;&quot;&quot;创建模型&quot;&quot;&quot;\n    # 这里使用你的模型\n    model = YourModel()\n\n    # 启用 FlashAttention（如果支持）\n    try:\n        from flash_attn import flash_attn_func\n        model.enable_flash_attn()\n    except ImportError:\n        pass\n\n    return model\n\n# ============ 训练循环 ============\ndef train():\n    accelerator, logger = setup()\n\n    # 创建模型\n    model = create_model()\n\n    # 创建优化器\n    optimizer = torch.optim.AdamW(\n        model.parameters(),\n        lr=config.learning_rate,\n        betas=(0.9, 0.999),\n        weight_decay=0.01,\n    )\n\n    # 创建学习率调度器\n    from torch.optim.lr_scheduler import get_cosine_schedule_with_warmup\n    scheduler = get_cosine_schedule_with_warmup(\n        optimizer,\n        num_warmup_steps=config.warmup_steps,\n        num_training_steps=total_steps,\n    )\n\n    # 准备数据\n    train_dataloader = create_dataloader(accelerator)\n\n    # 使用 Accelerator 准备所有组件\n    model, optimizer, train_dataloader, scheduler = accelerator.prepare(\n        model, optimizer, train_dataloader, scheduler\n    )\n\n    # 编译模型（PyTorch 2.0+）\n    if hasattr(torch, 'compile'):\n        model = torch.compile(model, mode=&quot;reduce-overhead&quot;)\n\n    # 训练循环\n    global_step = 0\n    model.train()\n\n    for epoch in range(config.num_epochs):\n        for step, batch in enumerate(train_dataloader):\n            # 前向传播\n            with accelerator.accumulate(model):\n                outputs = model(**batch)\n                loss = outputs.loss\n\n                # 反向传播\n                accelerator.backward(loss)\n\n                # 梯度裁剪\n                if accelerator.sync_gradients:\n                    accelerator.clip_grad_norm_(model.parameters(), config.max_grad_norm)\n\n                # 更新参数\n                optimizer.step()\n                scheduler.step()\n                optimizer.zero_grad()\n\n            # 日志\n            if step % config.log_steps == 0:\n                logger.info(\n                    f&quot;Epoch {epoch}, Step {step}, Loss: {loss.item():.4f}, &quot;\n                    f&quot;LR: {scheduler.get_last_lr()[0]:.2e}&quot;\n                )\n\n            # Checkpoint\n            if global_step % config.checkpoint_steps == 0:\n                accelerator.wait_for_everyone()\n                if accelerator.is_main_process:\n                    save_checkpoint(accelerator, model, optimizer, scheduler, global_step)\n\n            global_step += 1\n\n    # 保存最终模型\n    accelerator.wait_for_everyone()\n    accelerator.save_state(config.checkpoint_dir)\n\ndef save_checkpoint(accelerator, model, optimizer, scheduler, step):\n    &quot;&quot;&quot;保存 checkpoint（异步）&quot;&quot;&quot;\n    output_dir = f&quot;{config.checkpoint_dir}/checkpoint-{step}&quot;\n    os.makedirs(output_dir, exist_ok=True)\n\n    # 使用 accelerator 的保存方法\n    accelerator.save_state(output_dir)\n\n    # 保存额外信息\n    if accelerator.is_main_process:\n        torch.save({\n            &quot;step&quot;: step,\n            &quot;optimizer&quot;: optimizer.state_dict(),\n            &quot;scheduler&quot;: scheduler.state_dict(),\n        }, f&quot;{output_dir}/training_state.pt&quot;)\n\nif __name__ == &quot;__main__&quot;:\n    train()\n</code></pre>\n<h3>7.2 数据预处理脚本</h3>\n<pre><code>#!/usr/bin/env python3\n&quot;&quot;&quot;\n数据预处理脚本：创建 WebDataset shards\n&quot;&quot;&quot;\n\nimport json\nimport webdataset as wds\nfrom PIL import Image\nfrom pathlib import Path\nfrom tqdm import tqdm\nimport multiprocessing as mp\n\ndef process_sample(item):\n    &quot;&quot;&quot;处理单个样本&quot;&quot;&quot;\n    try:\n        # 加载图像\n        image = Image.open(item['image_path']).convert('RGB')\n\n        # 预处理（缩放、裁剪等）\n        image = preprocess_image(image)\n\n        # 编码为 bytes\n        import io\n        buf = io.BytesIO()\n        image.save(buf, format='WEBP', quality=95)\n        image_bytes = buf.getvalue()\n\n        return {\n            &quot;__key__&quot;: item['key'],\n            &quot;image.webp&quot;: image_bytes,\n            &quot;text.json&quot;: json.dumps(item['text']),\n        }\n    except Exception as e:\n        print(f&quot;Error processing {item['key']}: {e}&quot;)\n        return None\n\ndef create_shards(input_file, output_pattern, num_shards=100, samples_per_shard=10000):\n    &quot;&quot;&quot;\n    创建 WebDataset shards\n\n    Args:\n        input_file: 原始数据文件（每行一个 JSON）\n        output_pattern: 输出 shard 模式，如 &quot;shards/data-{000000..000999}.tar&quot;\n        num_shards: shard 数量\n        samples_per_shard: 每个 shard 的样本数\n    &quot;&quot;&quot;\n    # 创建 shard writer\n    sink = wds.ShardWriter(\n        output_pattern,\n        maxcount=samples_per_shard,\n        maxsize=1e9,  # 1GB per shard\n    )\n\n    # 读取原始数据\n    with open(input_file) as f:\n        samples = [json.loads(line) for line in f]\n\n    # 并行处理\n    with mp.Pool(mp.cpu_count()) as pool:\n        for result in tqdm(\n            pool.imap(process_sample, samples),\n            total=len(samples)\n        ):\n            if result:\n                sink.write(result)\n\n    sink.close()\n\nif __name__ == &quot;__main__&quot;:\n    create_shards(\n        input_file=&quot;raw_data.jsonl&quot;,\n        output_pattern=&quot;shards/data-{000000..000999}.tar&quot;,\n        num_shards=100,\n        samples_per_shard=10000,\n    )\n</code></pre>\n<hr />\n<h3>性能监控</h3>\n<h3>8.1 关键指标定义</h3>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>指标</th>\n<th>定义</th>\n<th>目标值</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>MFU</td>\n<td>Model FLOPs Utilization</td>\n<td>&gt; 40%</td>\n</tr>\n<tr>\n<td>带宽利用率</td>\n<td>实际通信带宽 / 理论带宽</td>\n<td>&gt; 90%</td>\n</tr>\n<tr>\n<td>线性加速比</td>\n<td>N卡速度 / 单卡速度 / N</td>\n<td>&gt; 80%</td>\n</tr>\n<tr>\n<td>数据加载时间</td>\n<td>等待数据的时间占比</td>\n<td>&lt; 10%</td>\n</tr>\n</tbody>\n</table></div>\n<h3>8.2 性能分析工具</h3>\n<pre><code># PyTorch Profiler\nfrom torch.profiler import profile, ProfilerActivity\n\nwith profile(\n    activities=[ProfilerActivity.CPU, ProfilerActivity.CUDA],\n    record_shapes=True,\n    profile_memory=True,\n) as prof:\n    for _ in range(10):\n        train_step()\n\nprint(prof.key_averages().table(sort_by=&quot;cuda_time_total&quot;))\nprof.export_chrome_trace(&quot;trace.json&quot;)  # 可视化\n</code></pre>\n<hr />\n<h3>未来趋势</h3>\n<h3>9.1 短期</h3>\n<ol>\n<li><strong>FP8 训练</strong>：NVIDIA H100 支持 FP8，可进一步提升 2x 吞吐量</li>\n<li><strong>更智能的并行策略自动搜索</strong>：自动选择最佳的并行组合</li>\n<li><strong>弹性训练</strong>：支持节点动态加入/退出</li>\n</ol>\n<h3>9.2 中期</h3>\n<ol>\n<li><strong>跨集群训练</strong>：跨数据中心的分布式训练</li>\n<li><strong>异构计算</strong>：CPU + GPU + TPU 混合训练</li>\n<li><strong>自动超参数搜索</strong>：AutoML for Distributed Training</li>\n</ol>\n<h3>9.3 长期</h3>\n<ol>\n<li><strong>AI 驱动的训练优化</strong>：用 AI 优化 AI 训练</li>\n<li><strong>量子-经典混合训练</strong>：量子计算辅助优化</li>\n</ol>\n<hr />\n<h3>总结</h3>\n<p>本文系统性地介绍了 AI Infra 多机多卡训练的完整知识体系：</p>\n<ol>\n<li><strong>学习路径</strong>：从建立认知到千卡实战的完整路线</li>\n<li><strong>DDP 瓶颈</strong>：内存复制 + 数据加载的根本问题</li>\n<li><strong>FSDP 原理</strong>：分片存储的革命性设计</li>\n<li><strong>vivo 优化</strong>：数据/计算/通信/稳定性四大方向</li>\n<li><strong>生产方案</strong>：Accelerate + FSDP 的最佳实践</li>\n<li><strong>代码模板</strong>：可直接使用的完整代码</li>\n</ol>\n<p><strong>记住：</strong> 多机多卡训练的本质是 <strong>在通信开销和内存限制之间寻找平衡</strong>。理解原理，才能灵活应对各种场景。</p>\n<hr />\n<h3>参考资源</h3>\n<ol>\n<li><strong>PyTorch FSDP 文档</strong>：<a href=\"https://link.zhihu.com/?target=https%3A//pytorch.org/docs/stable/fsdp.html\">https://pytorch.org/docs/stable/fsdp.html</a></li>\n<li><strong>Hugging Face Accelerate</strong>：<a href=\"https://link.zhihu.com/?target=https%3A//huggingface.co/docs/accelerate\">https://huggingface.co/docs/accelerate</a></li>\n<li><strong>vivo 千卡实践</strong>：InfoQ 文字实录</li>\n<li><strong>Together.ai Scaling 指南</strong></li>\n<li><strong>FlashAttention 论文</strong></li>\n</ol>\n<hr />\n<p><em>本文配图均为原创，转载请注明出处。</em></p>"
    }
  ],
  "graph": {
    "nodes": [
  ...
  "algos": [
    {
      ...
      "keyPoints": [
        "<strong>稀疏可分代价函数</strong>：目标函数形如 <span class=\"kb-math kb-math-inline\">f(x) = \\sum_{e \\in E} f_e(x_e)</span>，每个子函数 <span class=\"kb-math kb-math-inline\">f_e</span> 仅依赖决策变量的一小部分 <span class=\"kb-math kb-math-inline\">x_e</span>",
        "<strong>无锁共享内存协议</strong>：多个处理器同时读写共享向量 <span class=\"kb-math kb-math-inline\">x</span>，仅要求单个分量的写操作是原子的（硬件天然支持）",
        "<strong>稀疏性度量</strong>：定义 <span class=\"kb-math kb-math-inline\">\\Omega</span>（节点最大度）、<span class=\"kb-math kb-math-inline\">\\rho</span>（边对重叠率）、<span class=\"kb-math kb-math-inline\">\\Delta</span>（最大边重叠分数）三个量刻画冲突概率",
        "<strong>收敛保证（Proposition 4.1）</strong>：在 L-Lipschitz 梯度 + c-强凸条件下，当梯度延迟 <span class=\"kb-math kb-math-inline\">\\tau = o(n^{1/4})</span> 时，收敛速率与串行 SGD 相同，实现近线性加速",
        "<strong>实验验证</strong>：在稀疏 SVM、矩阵补全、图割三类任务上，HOGWILD! 均以数量级优势超越加锁方案"
      ],
      "detail": "<p><img alt=\"HOGWILD! 稀疏结构示意图\" src=\"https://ar5iv.labs.arxiv.org/html/1106.5730v2/assets/fig1.png\" />\n<em>图：代价函数诱导的超图结构。(a) 稀疏 SVM 中每个样本对应一条超边；(b) 矩阵补全中行列构成二部图；(c) 图割问题直接对应原图。稀疏性意味着超边之间重叠极少。</em></p>\n<pre><code class=\"language-python\"># HOGWILD! Algorithm 1 — 每个处理器独立执行的无锁更新\n# 共享: 决策变量 x (n维向量, 存于共享内存)\n# 输入: 步长 γ, 子函数集合 {f_e}_{e∈E}\n\ndef hogwild_worker(x_shared, gamma, E):\n    &quot;&quot;&quot;单个处理器的执行循环（无锁）&quot;&quot;&quot;\n    while not converged:\n        # Step 1: 均匀随机采样一条超边\n        e = sample_uniform(E)\n\n        # Step 2: 读取当前 x 的相关分量（可能是过时的）\n        x_e = read_components(x_shared, e)  # 无锁读\n\n        # Step 3: 计算该子函数的（子）梯度\n        G_e = compute_subgradient(f_e, x_e)\n\n        # Step 4: 原子更新每个涉及的分量\n        for v in e:\n            # 硬件保证单分量写入是原子的\n            x_shared[v] -= gamma * G_e[v]  # 无锁写\n</code></pre>\n<p><strong>动机与背景</strong></p>\n<p>传统并行 SGD 方案（如基于 MapReduce 的 AllReduce 同步、参数服务器加锁）在多核共享内存场景下面临严重的同步开销。多核系统的共享内存带宽可达 12GB/s、延迟仅数十纳秒，但锁竞争会将这一优势完全抵消。HOGWILD! 的核心洞察是：<strong>如果优化问题本身是稀疏的，那么多个处理器同时写同一分量的概率极低，无锁并行几乎不会引入额外误差。</strong></p>\n<p><strong>稀疏可分结构的形式化</strong></p>\n<p>将目标函数建模为超图 <span class=\"kb-math kb-math-inline\">\\mathcal{H} = (V, E)</span>：\n- 节点集 <span class=\"kb-math kb-math-inline\">V = \\{1, \\ldots, n\\}</span> 对应决策变量的各分量\n- 超边集 <span class=\"kb-math kb-math-inline\">E</span> 中每条边 <span class=\"kb-math kb-math-inline\">e</span> 对应一个子函数 <span class=\"kb-math kb-math-inline\">f_e</span>，仅涉及节点子集 <span class=\"kb-math kb-math-inline\">e \\subseteq V</span></p>\n<p>定义三个稀疏性度量：</p>\n<div class=\"kb-math kb-math-display\">\\Omega = \\max_v |\\\\{e \\in E : v \\in e\\\\}| / |E|</div>\n<div class=\"kb-math kb-math-display\">\\rho = \\max_e |e| / n</div>\n<div class=\"kb-math kb-math-display\">\\Delta = \\max_{e_1 \\neq e_2} |e_1 \\cap e_2| / |e_1|</div>\n<div class=\"key-point\">💡 关键：<span class=\"kb-math kb-math-inline\">\\Omega</span> 衡量单个变量被多少子函数共享（冲突频率），<span class=\"kb-math kb-math-inline\">\\rho</span> 衡量单次更新涉及的变量比例，<span class=\"kb-math kb-math-inline\">\\Delta</span> 衡量两次更新的重叠程度。三者越小，无锁并行越安全。</div>\n<p><strong>异步更新的数学建模</strong></p>\n<p>在异步执行中，处理器 j 使用的梯度基于一个<strong>过时</strong>的状态 <span class=\"kb-math kb-math-inline\">x_{k(j)}</span>，其中 <span class=\"kb-math kb-math-inline\">j - k(j) \\leq \\tau</span>（<span class=\"kb-math kb-math-inline\">\\tau</span> 为最大延迟，正比于处理器数量）。更新规则为：</p>\n<div class=\"kb-math kb-math-display\">x_{j+1} = x_j - \\gamma \\cdot |e| \\cdot \\mathcal{P}_v^T G_e(x_{k(j)})</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">\\mathcal{P}_v</span> 是到分量 <span class=\"kb-math kb-math-inline\">v</span> 的投影算子，<span class=\"kb-math kb-math-inline\">|e|</span> 是缩放因子（对应 with-replacement 采样的无偏修正）。</p>\n<p><strong>收敛性分析（Proposition 4.1）</strong></p>\n<p>在以下假设下：\n1. 每个 <span class=\"kb-math kb-math-inline\">f_e</span> 凸，<span class=\"kb-math kb-math-inline\">f</span> 强凸（模 <span class=\"kb-math kb-math-inline\">c</span>）\n2. <span class=\"kb-math kb-math-inline\">\\nabla f</span> 为 L-Lipschitz 连续\n3. 子梯度有界：<span class=\"kb-math kb-math-inline\">\\|G_e(x_e)\\|_2 \\leq M</span>\n4. 梯度延迟 <span class=\"kb-math kb-math-inline\">\\tau</span> 有界</p>\n<p>选择步长：</p>\n<div class=\"kb-math kb-math-display\">\\gamma = \\frac{\\vartheta \\epsilon c}{2LM^2 \\Omega(1 + 6\\rho\\tau + 4\\tau^2 \\Omega \\Delta^{1/2})}</div>\n<p>则经过以下步数后 <span class=\"kb-math kb-math-inline\">\\mathbb{E}[f(x_k) - f_\\star] \\leq \\epsilon</span>：</p>\n<div class=\"kb-math kb-math-display\">k \\geq \\frac{2LM^2 \\Omega(1 + 6\\tau\\rho + 6\\tau^2 \\Omega \\Delta^{1/2}) \\log(LD_0/\\epsilon)}{c^2 \\vartheta \\epsilon}</div>\n<div class=\"key-point\">💡 关键：当 <span class=\"kb-math kb-math-inline\">\\tau = 0</span>（串行），退化为标准 SGD 的 <span class=\"kb-math kb-math-inline\">O(\\frac{1}{\\epsilon}\\log\\frac{1}{\\epsilon})</span> 线性收敛速率。当 <span class=\"kb-math kb-math-inline\">\\tau = o(n^{1/4})</span> 且 <span class=\"kb-math kb-math-inline\">\\rho, \\Delta = o(1/n)</span>（典型稀疏问题），额外代价可忽略 → <strong>近线性加速</strong>。</div>\n<p><strong>与传统方法的对比</strong></p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>方法</th>\n<th>同步机制</th>\n<th>通信开销</th>\n<th>适用场景</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>AllReduce SGD</td>\n<td>全局同步</td>\n<td>高</td>\n<td>密集模型/集群</td>\n</tr>\n<tr>\n<td>参数服务器 (加锁)</td>\n<td>读写锁</td>\n<td>中</td>\n<td>通用</td>\n</tr>\n<tr>\n<td><strong>HOGWILD!</strong></td>\n<td><strong>无锁</strong></td>\n<td><strong>零</strong></td>\n<td>稀疏问题/共享内存</td>\n</tr>\n<tr>\n<td>Downpour SGD</td>\n<td>异步+锁</td>\n<td>中</td>\n<td>集群</td>\n</tr>\n</tbody>\n</table></div>\n<p>HOGWILD! 的优势在于：(1) 零同步开销；(2) 实现极其简单（仅需原子加）；(3) 在稀疏问题上理论保证最优。局限性在于要求问题具备稀疏结构，且仅适用于共享内存（单机多核）场景。</p>\n<p><strong>实验结果</strong></p>\n<p>在三个典型稀疏学习任务上验证：\n- <strong>稀疏 SVM</strong>（RCV1 数据集，78万维特征，平均每样本仅涉及 0.16% 特征）：10 核加速比约 9.5x\n- <strong>矩阵补全</strong>（Netflix 数据集，48万用户×18万电影，仅 1% 条目已知）：10 核加速比约 9.2x<br />\n- <strong>图割</strong>（DBLife 数据集）：10 核加速比约 8.8x</p>\n<p>所有任务中，HOGWILD! 均以 5-10 倍速度优势超越对应的加锁版本（Round-Robin 锁、全局互斥锁等）。</p>",
      "quiz": {
    ...
    },
    {
      ...
      "summary": "Parameter Server 将全局模型参数拆成键值分片放在 Server 组上，Worker 只拉取本地数据需要的 working set 并推送梯度，解决大规模数据并行训练中参数同步、异步容忍和网络通信开销过高的问题。",
      "keyPoints": [
        "Server-Worker 架构：Server 保存全局共享参数，Worker 保存数据分片并通过 <code>push</code>/<code>pull</code> 读写参数。",
      ...
      "detail": "<h5>远程示意图</h5>\n<p><img alt=\"多服务器参数服务器架构\" src=\"https://d2l.ai/_images/ps-multips.svg\" />\n<em>图：D2L 参数服务器章节提供的多服务器架构图，展示单个 Parameter Server 的带宽瓶颈以及多 Server 按参数分片聚合带宽的方案；该章节明确引用 Li et al. 2014 的参数服务器系统。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># Parameter Server 上的一轮同步或有界异步梯度聚合\ndef worker_loop(worker_id, data_shard, server_group, tau):\n    working_keys = infer_working_set(data_shard)\n    w_local = server_group.pull(working_keys)\n\n    for t in range(num_steps):\n        wait_until_iterations_before(t - tau).finished()\n\n        grad, coord_lr = compute_gradient_and_lr(data_shard, w_local)\n        active_grad = kkt_filter(grad, w_local)\n\n        server_group.push(keys=active_grad.keys(), values=(active_grad, coord_lr))\n        w_delta = server_group.pull(keys=working_keys, filter=&quot;significantly_modified&quot;)\n        w_local.update(w_delta)\n\ndef server_update(block_id, received_messages):\n    grad = sum(msg.grad for msg in received_messages)\n    coord_lr = aggregate_lr(msg.coord_lr for msg in received_messages)\n    U = diag(coord_lr)\n    w[block_id] = prox_update(w[block_id], grad, U)\n</code></pre>\n<h5>机制解读</h5>\n<p>Parameter Server 的核心抽象是把“分布式训练”改写成键值参数存储上的 <code>push</code> 和 <code>pull</code>。Worker 不需要知道全局参数如何分片，也不需要和其他 Worker 直接通信；它只负责用自己的数据分片计算梯度，并把梯度发给负责相应 key range 的 Server。Server 端执行可交换的聚合：</p>\n<div class=\"kb-math kb-math-display\">\\mathbf{g}^{(t)} = \\sum_{r=1}^{m} \\mathbf{g}_{r}^{(t)}, \\qquad\n\\mathbf{w}^{(t+1)} = \\mathbf{w}^{(t)} - \\eta \\left(\\mathbf{g}^{(t)} + \\partial h(\\mathbf{w}^{(t)})\\right)</div>\n<p>这里 <span class=\"kb-math kb-math-inline\">m</span> 是 Worker 数量，<span class=\"kb-math kb-math-inline\">h</span> 是正则项。实际系统并不总是全量同步所有参数，因为高维稀疏数据下，单个 Worker 只需要很小一部分 working set。论文报告在 100 个 Worker 时平均 Worker 只需要约 7.8% 的模型参数，Worker 数增加到 10000 时 working set 比例进一步降到 0.15%，这正是 <code>pull(keys)</code> 接口比全量广播更省通信的原因。</p>\n<p>一致性模型由任务依赖图控制，而不是硬编码在训练循环里。Sequential 等价于 BSP：第 <span class=\"kb-math kb-math-inline\">t+1</span> 个任务必须等待第 <span class=\"kb-math kb-math-inline\">t</span> 个任务完成；Eventual 允许任务尽快执行，但参数可能很旧；Bounded Delay 设置最大陈旧度 <span class=\"kb-math kb-math-inline\">\\tau</span>，新任务开始前必须保证 <span class=\"kb-math kb-math-inline\">t-\\tau</span> 以前的任务完成：</p>\n<div class=\"kb-math kb-math-display\">\\text{start}(t) \\Rightarrow \\forall t&#x27; \\le t-\\tau,\\ \\text{finished}(t&#x27;)</div>\n<p>这个设计把“系统吞吐”和“算法收敛”之间的取舍显式暴露出来。同步模型等待最慢 Worker，网络抖动和负载不均会形成 straggler；有界异步允许快 Worker 继续推进，只要延迟不超过 <span class=\"kb-math kb-math-inline\">\\tau</span>，算法仍能用适当学习率保持收敛。</p>\n<p>论文进一步提出 Delayed Block Proximal Gradient，把目标写成非凸、非光滑复合优化：</p>\n<div class=\"kb-math kb-math-display\">\\min_{\\mathbf{w}} F(\\mathbf{w}) = f(\\mathbf{w}) + h(\\mathbf{w})</div>\n<p>Server 对某个参数块执行广义近端更新：</p>\n<div class=\"kb-math kb-math-display\">\\operatorname{Prox}_{\\gamma}^{U}(x)=\n\\arg\\min_y h(y)+\\frac{1}{2\\gamma}\\|x-y\\|_{U}^{2},\n\\qquad\n\\mathbf{w}^{(t+1)}=\n\\operatorname{Prox}_{\\gamma_t}^{U}\\left(\\mathbf{w}^{(t)}-\\gamma_t\\nabla f(\\tilde{\\mathbf{w}}^{(t)})\\right)</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">\\tilde{\\mathbf{w}}^{(t)}</span> 是有界陈旧的参数视图，<span class=\"kb-math kb-math-inline\">U=\\operatorname{diag}(\\mathbf{u}^{(t)})</span> 表示坐标级学习率。论文给出的收敛条件体现了延迟代价：若最小坐标学习率为 <span class=\"kb-math kb-math-inline\">M_t</span>，学习率满足</p>\n<div class=\"kb-math kb-math-display\">\\gamma_t \\le \\frac{M_t}{L_{\\mathrm{var}}+\\tau L_{\\mathrm{cov}}+\\epsilon}</div>\n<p>则在有界延迟和过滤误差逐步减小的条件下，算法期望收敛到 stationary point。直觉是：<span class=\"kb-math kb-math-inline\">\\tau</span> 越大，陈旧梯度越不可靠，因此需要更保守的 <span class=\"kb-math kb-math-inline\">\\gamma_t</span>；但系统层面节省的等待时间通常可以覆盖这部分算法代价。</p>\n<p>用户自定义过滤器是 Parameter Server 相比朴素 Server-Worker 聚合的关键增强。以 <span class=\"kb-math kb-math-inline\">\\ell_1</span> 正则逻辑回归为例，KKT filter 利用 soft-shrinkage 的最优性条件：若某坐标当前为零且梯度不足以越过正则阈值，则该坐标更新后仍为零，可以跳过通信：</p>\n<div class=\"kb-math kb-math-display\">w_k=0 \\land |\\hat{g}_k| \\le \\lambda-\\delta\n\\Rightarrow \\text{skip coordinate } k</div>\n<p>这不是随机压缩，而是利用稀疏正则的活跃集结构；再叠加 key caching 和数值压缩后，论文在 636TB 点击数据实验中报告 Server 侧和 Worker 侧分别获得约 40x 和 12x 的通信压缩。相比 AllReduce 每步同步完整梯度，Parameter Server 更适合超高维稀疏模型，因为它把通信粒度从“整个张量”降到“会影响目标函数的 key-value 子集”。</p>",
      "quiz": {
        "q": "Parameter Server 的 Bounded Delay 一致性模型主要解决什么问题？",
        "options": [
    ...
    },
    {
      ...
      "keyPoints": [
        "<strong>弹性力机制</strong>：通过二次惩罚项 <span class=\"kb-math kb-math-inline\">\\frac{\\rho}{2}\\|x^i - \\tilde{x}\\|^2</span> 将 worker 参数 <span class=\"kb-math kb-math-inline\">x^i</span> 与中心参数 <span class=\"kb-math kb-math-inline\">\\tilde{x}</span> 弹性耦合",
        "<strong>探索-利用权衡</strong>：小 <span class=\"kb-math kb-math-inline\">\\rho</span> 允许 worker 更自由地探索参数空间，大 <span class=\"kb-math kb-math-inline\">\\rho</span> 强制更紧密同步",
        "<strong>异步通信</strong>：worker 独立计算梯度，每隔 <span class=\"kb-math kb-math-inline\">\\tau</span> 步与 master 通信一次，通信频率可大幅降低",
        ...
        "<strong>对通信周期 <span class=\"kb-math kb-math-inline\">\\tau</span> 鲁棒</strong>：即使 <span class=\"kb-math kb-math-inline\">\\tau</span> 较大（如 20），EAMSGD 仍优于 DOWNPOUR 和 ADMM"
      ],
      "detail": "<h5>核心框架示意</h5>\n<p><img alt=\"EASGD 稳定性分析图\" src=\"https://ar5iv.labs.arxiv.org/html/1412.6651/assets/x1.png\" />\n<em>图：EASGD 与 ADMM 在不同学习率 <span class=\"kb-math kb-math-inline\">\\eta</span> 和动量 <span class=\"kb-math kb-math-inline\">\\delta</span> 下的稳定性对比。EASGD（蓝色）的稳定区域显著大于 ADMM（红色），表明 EASGD 对超参数更鲁棒。</em></p>\n<p><img alt=\"CIFAR-10 实验结果\" src=\"https://ar5iv.labs.arxiv.org/html/1412.6651/assets/x3.png\" />\n<em>图：CIFAR-10 上不同方法的训练/测试损失和测试误差随时间变化曲线（p=4 workers）。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># EASGD 异步并行算法 (Algorithm 1)\n# Master 进程:\nx_center = initialize_parameters()\n\n# 每个 Worker i (并行执行):\nx_local_i = x_center.copy()\nt = 0\nwhile not converged:\n    # 1. 本地 SGD 更新\n    g = compute_gradient(x_local_i, minibatch)\n    x_local_i = x_local_i - eta * g\n    t += 1\n\n    # 2. 每隔 τ 步与 master 通信\n    if t % tau == 0:\n        # Worker 端弹性更新\n        x_local_i = x_local_i - alpha * (x_local_i - x_center)\n        # Master 端弹性更新  \n        x_center = x_center + alpha * (x_local_i - x_center)\n\n# EAMSGD (Algorithm 2) - 带动量变体:\n# Worker 端额外维护动量变量 v_i\nv_i = 0\nwhile not converged:\n    g = compute_gradient(x_local_i, minibatch)\n    v_i = delta * v_i - eta * g  # 动量更新\n    x_local_i = x_local_i + v_i - alpha * (x_local_i - x_center)  # 弹性+动量\n    if t % tau == 0:\n        x_center = x_center + alpha * (x_local_i - x_center)\n</code></pre>\n<h5>动机与背景</h5>\n<p>分布式深度学习训练面临两大核心挑战：</p>\n<ol>\n<li><strong>通信开销</strong>：传统同步 SGD（如 AllReduce）要求每步都同步梯度，通信成为瓶颈</li>\n<li><strong>梯度过时（staleness）</strong>：异步方法（如 DOWNPOUR）中 worker 使用过时参数计算梯度，导致训练不稳定</li>\n</ol>\n<p>DOWNPOUR SGD 采用参数服务器架构，worker 异步推送梯度并拉取参数，但其本质是对中心变量做梯度下降，当通信延迟增大时性能急剧下降。EASGD 从根本上重新设计了 worker 与 master 的交互方式。</p>\n<h5>核心机制：弹性平均</h5>\n<p>EASGD 的核心思想源自以下优化目标：</p>\n<div class=\"kb-math kb-math-display\">F(x^1, \\ldots, x^p, \\tilde{x}) = \\sum_{i=1}^{p} f(x^i) + \\frac{\\rho}{2} \\sum_{i=1}^{p} \\|x^i - \\tilde{x}\\|^2</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">f(x^i)</span> 是第 <span class=\"kb-math kb-math-inline\">i</span> 个 worker 的本地损失函数，<span class=\"kb-math kb-math-inline\">\\tilde{x}</span> 是中心变量，<span class=\"kb-math kb-math-inline\">\\rho</span> 是弹性强度（penalty）。</p>\n<div class=\"key-point\">💡 <strong>关键直觉</strong>：弹性力像\"橡皮筋\"一样连接每个 worker 和中心——worker 可以自由探索局部参数空间，但不会偏离中心太远。<span class=\"kb-math kb-math-inline\">\\rho</span> 越小，\"橡皮筋\"越松，探索空间越大。</div>\n<p>对该目标分别对 <span class=\"kb-math kb-math-inline\">x^i</span> 和 <span class=\"kb-math kb-math-inline\">\\tilde{x}</span> 求梯度，得到更新规则：</p>\n<p><strong>Worker 更新</strong>（结合 SGD）：\n<div class=\"kb-math kb-math-display\">x_{t+1}^i = x_t^i - \\eta \\left( \\tilde{g}_t^i + \\rho(x_t^i - \\tilde{x}_t) \\right)</div></p>\n<p><strong>Master 更新</strong>（对中心变量取梯度为零）：\n<div class=\"kb-math kb-math-display\">\\tilde{x}_{t+1} = \\frac{1}{p} \\sum_{i=1}^{p} x_{t+1}^i</div></p>\n<p>但在异步实现中，master 无法同时获取所有 worker 参数。因此实际采用<strong>移动平均</strong>更新：</p>\n<div class=\"kb-math kb-math-display\">\\tilde{x}_{t+1} = (1 - \\beta) \\tilde{x}_t + \\beta x_{t+1}^i, \\quad \\beta = p \\cdot \\alpha</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">\\alpha = \\eta \\rho</span> 是弹性更新步长。设 <span class=\"kb-math kb-math-inline\">\\beta = p\\alpha</span> 保证了弹性力的对称性——从 worker 角度施加的总力等于 center 接收的总力。</p>\n<h5>通信周期 <span class=\"kb-math kb-math-inline\">\\tau</span> 的作用</h5>\n<p>在异步 EASGD 中，worker 并非每步都与 master 通信，而是每隔 <span class=\"kb-math kb-math-inline\">\\tau</span> 步通信一次。这带来两个效果：</p>\n<ol>\n<li><strong>降低通信开销</strong>：<span class=\"kb-math kb-math-inline\">\\tau</span> 越大，通信频率越低，计算/通信比越高</li>\n<li><strong>增强探索</strong>：worker 在两次通信之间可以自由地沿本地梯度方向走 <span class=\"kb-math kb-math-inline\">\\tau</span> 步，探索更多局部结构</li>\n</ol>\n<div class=\"warn-box\">⚠️ <strong>注意</strong>：<span class=\"kb-math kb-math-inline\">\\tau</span> 过大会导致 worker 偏离过远，但实验表明 EASGD/EAMSGD 对 <span class=\"kb-math kb-math-inline\">\\tau</span> 的鲁棒性远优于 DOWNPOUR。在 <span class=\"kb-math kb-math-inline\">\\tau=20</span> 时 EAMSGD 仍能获得优异的测试误差。</div>\n<h5>与 ADMM 的对比</h5>\n<p>ADMM（交替方向乘子法）的分布式更新为：</p>\n<div class=\"kb-math kb-math-display\">x_{t+1}^i = x_t^i - \\eta \\left( \\tilde{g}_t^i + \\rho(x_t^i - \\tilde{x}_t) + \\lambda_t^i \\right)</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">\\lambda^i</span> 是对偶变量（拉格朗日乘子），在每次通信时更新：<span class=\"kb-math kb-math-inline\">\\lambda_{t+1}^i = \\lambda_t^i + \\rho(x_{t+1}^i - \\tilde{x}_{t+1})</span>。</p>\n<p>EASGD 去掉了对偶变量 <span class=\"kb-math kb-math-inline\">\\lambda^i</span>，这看似\"弱化\"了约束，但实际带来了关键优势：</p>\n<ul>\n<li><strong>更大的稳定区域</strong>：线性稳定性分析表明，EASGD 在学习率 <span class=\"kb-math kb-math-inline\">\\eta</span> 和动量 <span class=\"kb-math kb-math-inline\">\\delta</span> 的更大范围内保持稳定</li>\n<li><strong>更好的探索能力</strong>：没有对偶变量的累积惩罚，worker 可以更自由地探索</li>\n<li><strong>实验验证</strong>：EASGD 在测试误差上始终优于 ADMM</li>\n</ul>\n<h5>与 DOWNPOUR 的本质区别</h5>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>特性</th>\n<th>DOWNPOUR SGD</th>\n<th>EASGD</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>更新目标</td>\n<td>中心变量直接接收梯度</td>\n<td>中心变量通过弹性平均更新</td>\n</tr>\n<tr>\n<td>Worker 角色</td>\n<td>计算梯度后推送给 master</td>\n<td>维护独立参数，定期与 center 对齐</td>\n</tr>\n<tr>\n<td>通信内容</td>\n<td>梯度 <span class=\"kb-math kb-math-inline\">\\Delta x</span></td>\n<td>参数差 <span class=\"kb-math kb-math-inline\">x^i - \\tilde{x}</span></td>\n</tr>\n<tr>\n<td>探索能力</td>\n<td>受限（worker 参数被频繁覆盖）</td>\n<td>强（worker 保持独立参数轨迹）</td>\n</tr>\n<tr>\n<td><span class=\"kb-math kb-math-inline\">\\tau</span> 敏感性</td>\n<td>高（大 <span class=\"kb-math kb-math-inline\">\\tau</span> 性能急剧下降）</td>\n<td>低（大 <span class=\"kb-math kb-math-inline\">\\tau</span> 仍保持良好性能）</td>\n</tr>\n</tbody>\n</table></div>\n<h5>实验结果要点</h5>\n<p><strong>CIFAR-10</strong>（7层CNN，p=4/8/16 GPU）：\n- EAMSGD 在所有通信周期 <span class=\"kb-math kb-math-inline\">\\tau \\in \\{1, 5, 10, 20\\}</span> 下均优于 DOWNPOUR 和 ADMM\n- <span class=\"kb-math kb-math-inline\">\\tau=10</span> 时 EAMSGD 达到最佳测试误差，优于 <span class=\"kb-math kb-math-inline\">\\tau=1</span>（说明适度减少通信反而有利于泛化）\n- p=16 时实现 11.1x 加速比（相对于单 GPU 基线）</p>\n<p><strong>ImageNet</strong>（11层CNN，p=4/8 GPU）：\n- EAMSGD 在大规模数据集上同样表现最优\n- 验证了方法的可扩展性</p>",
      "quiz": {
    ...
    },
    {
      ...
      "keyPoints": [
        "<strong>内存分析</strong>：混合精度 Adam 训练中每参数占用 <span class=\"kb-math kb-math-inline\">16\\Psi</span> 字节（2Ψ fp16 参数 + 2Ψ fp16 梯度 + 12Ψ 优化器状态含 fp32 参数/动量/方差副本）",
        "<strong>ZeRO-DP 三阶段</strong>：Stage 1 切分优化器状态（<span class=\"kb-math kb-math-inline\">P_{os}</span>）→ 4x 省存；Stage 2 加切分梯度（<span class=\"kb-math kb-math-inline\">P_{os+g}</span>）→ 8x 省存；Stage 3 加切分参数（<span class=\"kb-math kb-math-inline\">P_{os+g+p}</span>）→ <span class=\"kb-math kb-math-inline\">N_d</span>x 省存",
        "<strong>通信量不变/极低开销</strong>：Stage 1+2 通信量与标准 DP 相同（<span class=\"kb-math kb-math-inline\">2\\Psi</span>）；Stage 3 仅增加 50%（<span class=\"kb-math kb-math-inline\">3\\Psi</span>）",
        "<strong>ZeRO-R 残余内存优化</strong>：激活分区（<span class=\"kb-math kb-math-inline\">P_a</span>）按 MP 度切分激活检查点；常量大小临时缓冲区；内存碎片整理",
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"ZeRO-DP 内存节省示意\" src=\"https://ar5iv.labs.arxiv.org/html/1910.02054/assets/x1.png\" />\n<em>图：ZeRO-DP 三阶段优化对 7.5B 参数模型内存占用的影响。基线 DP 需要 120GB，Stage 1 降至 31.4GB，Stage 1+2 降至 16.6GB，Stage 1+2+3 降至 1.9GB（Nd=64）。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># ZeRO-DP Stage 1+2 训练流程伪代码\n# 假设 Nd 个数据并行进程，每个进程负责 1/Nd 的参数分区\n\ndef zero_dp_train_step(model, data, rank, world_size):\n    # 每个进程持有完整 fp16 参数（Stage 1+2）\n    # 但只持有 1/Nd 的优化器状态和梯度\n\n    # Forward pass（所有进程用完整参数）\n    loss = model.forward(data)\n\n    # Backward pass\n    loss.backward()  # 计算本地梯度\n\n    # Stage 2: Reduce-Scatter 梯度\n    # 每个进程只保留自己负责分区的归约梯度\n    for partition_id in range(world_size):\n        if partition_id == rank:\n            # 归约收集本分区梯度（reduce 到本进程）\n            reduce(gradients[partition_id], dst=rank)\n        else:\n            # 发送梯度给负责的进程后释放内存\n            reduce(gradients[partition_id], dst=partition_id)\n            free(gradients[partition_id])\n\n    # 只更新本进程负责的 1/Nd 参数分区\n    optimizer.step(params[rank], grads[rank])  # 用本地优化器状态\n\n    # All-Gather 更新后的参数\n    all_gather(params)  # 收集所有分区的更新参数\n</code></pre>\n<pre><code class=\"language-python\"># ZeRO-DP Stage 3 训练流程伪代码（额外切分参数）\ndef zero_dp_stage3_train_step(model, data, rank, world_size):\n    # 每个进程只持有 1/Nd 的参数、梯度和优化器状态\n\n    # Forward pass: 流水线式 All-Gather 参数\n    for layer in model.layers:\n        # 收集该层完整参数（从负责的进程广播）\n        full_params = all_gather(layer.params)\n        output = layer.forward(input, full_params)\n        del full_params  # 用完即弃，不保留\n        input = output\n\n    # Backward pass: 反向再次 All-Gather\n    for layer in reversed(model.layers):\n        full_params = all_gather(layer.params)\n        grad = layer.backward(full_params)\n        del full_params\n        # Reduce-Scatter 梯度到负责进程\n        reduce_scatter(grad)\n\n    # 更新本地 1/Nd 分区\n    optimizer.step(local_params, local_grads)\n</code></pre>\n<h5>深入解释</h5>\n<p><strong>动机与背景</strong></p>\n<p>大模型训练面临严峻的内存墙问题。以混合精度 Adam 训练为例，一个 <span class=\"kb-math kb-math-inline\">\\Psi</span> 参数的模型需要：</p>\n<div class=\"kb-math kb-math-display\">\\text{总内存} = \\underbrace{2\\Psi}_{\\text{fp16 参数}} + \\underbrace{2\\Psi}_{\\text{fp16 梯度}} + \\underbrace{4\\Psi + 4\\Psi + 4\\Psi}_{\\text{fp32 参数副本 + 动量 + 方差}} = 16\\Psi \\text{ bytes}</div>\n<p>对于 GPT-2（1.5B 参数），这意味着至少 24GB 内存仅用于模型状态。传统数据并行（DP）在每个 GPU 上完整复制所有 <span class=\"kb-math kb-math-inline\">16\\Psi</span> 字节，造成巨大冗余。而模型并行（MP）虽然切分了模型状态，但通信开销大、计算粒度低、扩展性差。</p>\n<div class=\"key-point\">💡 关键洞察：DP 的内存冗余来自于每个进程都存储完整的模型状态，但实际上每个进程在每一步只需要更新 <span class=\"kb-math kb-math-inline\">1/N_d</span> 的参数。</div>\n<p><strong>ZeRO-DP 核心机制</strong></p>\n<p>ZeRO-DP 的核心思想是：<strong>保留 DP 的高计算效率和低通信量，同时通过分区（partition）而非复制（replicate）来消除内存冗余。</strong></p>\n<p><strong>Stage 1（<span class=\"kb-math kb-math-inline\">P_{os}</span>）— 优化器状态分区：</strong></p>\n<p>将优化器状态（fp32 参数副本 + 动量 + 方差，共 <span class=\"kb-math kb-math-inline\">12\\Psi</span> 字节）均分到 <span class=\"kb-math kb-math-inline\">N_d</span> 个进程。每个进程只维护 <span class=\"kb-math kb-math-inline\">1/N_d</span> 的优化器状态，只更新对应的参数分区。更新后通过 All-Gather 同步完整参数。</p>\n<div class=\"kb-math kb-math-display\">\\text{Stage 1 内存} = 4\\Psi + \\frac{12\\Psi}{N_d} \\xrightarrow{N_d \\to \\infty} 4\\Psi \\quad (\\text{4x 节省})</div>\n<p><strong>Stage 2（<span class=\"kb-math kb-math-inline\">P_{os+g}</span>）— 梯度分区：</strong></p>\n<p>既然每个进程只更新 <span class=\"kb-math kb-math-inline\">1/N_d</span> 的参数，那它也只需要对应分区的归约梯度。因此将标准 All-Reduce 替换为 Reduce-Scatter：每个梯度只归约到负责该分区的进程，归约后立即释放其余梯度内存。</p>\n<div class=\"kb-math kb-math-display\">\\text{Stage 2 内存} = 2\\Psi + \\frac{14\\Psi}{N_d} \\xrightarrow{N_d \\to \\infty} 2\\Psi \\quad (\\text{8x 节省})</div>\n<p><strong>Stage 3（<span class=\"kb-math kb-math-inline\">P_{os+g+p}</span>）— 参数分区：</strong></p>\n<p>进一步地，每个进程只存储 <span class=\"kb-math kb-math-inline\">1/N_d</span> 的模型参数。前向/反向传播时，通过流水线式 All-Gather 按需获取完整层参数，用完即弃。</p>\n<div class=\"kb-math kb-math-display\">\\text{Stage 3 内存} = \\frac{16\\Psi}{N_d} \\quad (N_d\\text{x 线性节省})</div>\n<div class=\"warn-box\">⚠️ 注意：Stage 3 的通信量从 <span class=\"kb-math kb-math-inline\">2\\Psi</span> 增加到 <span class=\"kb-math kb-math-inline\">3\\Psi</span>（前向 All-Gather <span class=\"kb-math kb-math-inline\">\\Psi</span> + 反向 All-Gather <span class=\"kb-math kb-math-inline\">\\Psi</span> + 梯度 Reduce-Scatter <span class=\"kb-math kb-math-inline\">\\Psi</span>），即 1.5 倍开销，但换来了线性内存缩减。</div>\n<p><strong>通信量分析</strong></p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>方案</th>\n<th>通信量</th>\n<th>内存节省</th>\n<th>通信原语</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>标准 DP (All-Reduce)</td>\n<td><span class=\"kb-math kb-math-inline\">2\\Psi</span></td>\n<td>1x</td>\n<td>Reduce-Scatter + All-Gather</td>\n</tr>\n<tr>\n<td>ZeRO Stage 1+2</td>\n<td><span class=\"kb-math kb-math-inline\">2\\Psi</span></td>\n<td>8x</td>\n<td>Reduce-Scatter + All-Gather</td>\n</tr>\n<tr>\n<td>ZeRO Stage 3</td>\n<td><span class=\"kb-math kb-math-inline\">3\\Psi</span></td>\n<td><span class=\"kb-math kb-math-inline\">N_d</span>x</td>\n<td>2×All-Gather + Reduce-Scatter</td>\n</tr>\n</tbody>\n</table></div>\n<p>标准 All-Reduce 本质上就是 Reduce-Scatter + All-Gather，通信量为 <span class=\"kb-math kb-math-inline\">2\\Psi</span>。ZeRO Stage 1+2 将 All-Reduce 拆解为：先 Reduce-Scatter 梯度（<span class=\"kb-math kb-math-inline\">\\Psi</span>），再 All-Gather 更新后的参数（<span class=\"kb-math kb-math-inline\">\\Psi</span>），总量完全相同。</p>\n<p><strong>ZeRO-R 残余内存优化</strong></p>\n<p>除模型状态外，训练还消耗大量内存用于：</p>\n<ol>\n<li><strong>激活内存</strong>（<span class=\"kb-math kb-math-inline\">P_a</span>）：MP 中激活被复制到所有 MP 进程。ZeRO 将激活检查点按 MP 度分区，需要时通过 All-Gather 重建。对于 100B 模型（MP=16），激活从 33GB 降至约 2GB。</li>\n<li><strong>临时缓冲区</strong>（<span class=\"kb-math kb-math-inline\">C_B</span>）：All-Reduce 等操作的临时缓冲区随模型增大而膨胀。ZeRO 使用固定大小缓冲区。</li>\n<li><strong>内存碎片</strong>（<span class=\"kb-math kb-math-inline\">M_D</span>）：短生命周期（激活）和长生命周期（梯度）对象交错分配导致碎片。ZeRO 将长生命周期对象预分配到连续内存块。</li>\n</ol>\n<p><strong>与传统方法的对比</strong></p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>维度</th>\n<th>标准 DP</th>\n<th>模型并行 (MP)</th>\n<th>ZeRO-DP</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>内存效率</td>\n<td>差（全复制）</td>\n<td>好（切分）</td>\n<td>好（切分）</td>\n</tr>\n<tr>\n<td>计算粒度</td>\n<td>高</td>\n<td>低（切分计算）</td>\n<td>高</td>\n</tr>\n<tr>\n<td>通信量</td>\n<td><span class=\"kb-math kb-math-inline\">2\\Psi</span></td>\n<td>随模型/硬件变化</td>\n<td><span class=\"kb-math kb-math-inline\">2\\Psi</span> ~ <span class=\"kb-math kb-math-inline\">3\\Psi</span></td>\n</tr>\n<tr>\n<td>扩展性</td>\n<td>好</td>\n<td>差（跨节点）</td>\n<td>好</td>\n</tr>\n<tr>\n<td>易用性</td>\n<td>高（无需改模型）</td>\n<td>低（需重构）</td>\n<td>高（无需改模型）</td>\n</tr>\n</tbody>\n</table></div>\n<div class=\"key-point\">💡 关键：ZeRO 证明了\"内存效率\"和\"通信效率\"并非不可兼得——通过巧妙利用模型状态的时序特性（不是所有状态在所有时刻都需要），可以在几乎不增加通信的前提下大幅降低内存。</div>",
      "quiz": {
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>f / g 共轭算子</strong>：<span class=\"kb-math kb-math-inline\">f</span> 前向恒等 + 反向 All-Reduce；<span class=\"kb-math kb-math-inline\">g</span> 前向 All-Reduce + 反向恒等，仅需几行 PyTorch 代码实现",
    ...
    },
    {
      ...
      "keyPoints": [
        "<strong>3D 处理器排列</strong>：将 <span class=\"kb-math kb-math-inline\">p = dq^2</span> 个 GPU 组织为 <span class=\"kb-math kb-math-inline\">[q, q, d]</span> 三维网格，其中 <span class=\"kb-math kb-math-inline\">q \\times q</span> 为 2D 平面，<span class=\"kb-math kb-math-inline\">d</span> 为 depth 维度",
        "<strong>基于 2.5D SUMMA 的矩阵乘法</strong>：在 depth 维度上复制输入矩阵，每层独立执行 2D SUMMA 的子集计算，最终通过 reduce-scatter 合并结果",
        "<strong>通信量优化</strong>：单次矩阵乘法通信量从 2D 的 <span class=\"kb-math kb-math-inline\">O(n^2/q)</span> 降至 <span class=\"kb-math kb-math-inline\">O(n^2/(dq))</span>，减少 <span class=\"kb-math kb-math-inline\">d</span> 倍",
      ...
      "detail": "<h5>核心架构图</h5>\n<p><img alt=\"Tesseract 3D 处理器排列\" src=\"https://ar5iv.labs.arxiv.org/html/2105.14500/assets/x3.png\" />\n<em>图：<span class=\"kb-math kb-math-inline\">p = dq^2</span> 个处理器的 Tesseract 排列，形状为 <span class=\"kb-math kb-math-inline\">[q, q, d]</span>。每个 depth 层包含 <span class=\"kb-math kb-math-inline\">q \\times q</span> 个处理器，共 <span class=\"kb-math kb-math-inline\">d</span> 层。</em></p>\n<p><img alt=\"Feed Forward 并行化\" src=\"https://ar5iv.labs.arxiv.org/html/2105.14500/assets/x7.png\" />\n<em>图：Tesseract 对 Transformer Feed Forward 层的并行化方案</em></p>\n<p><img alt=\"Multi-Head Attention 并行化\" src=\"https://ar5iv.labs.arxiv.org/html/2105.14500/assets/x8.png\" />\n<em>图：Tesseract 对 Multi-Head Attention 层的并行化方案</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># Tesseract 3D 并行矩阵乘法 C = A × B\n# 处理器排列: [q, q, d], 总处理器数 p = d * q^2\n# 每个处理器坐标: (i, j, k), i,j ∈ [0,q), k ∈ [0,d)\n\ndef tesseract_matmul(A, B, q, d):\n    &quot;&quot;&quot;\n    A: [n, n] 输入矩阵\n    B: [n, n] 参数矩阵\n    每个处理器持有:\n      A_local: [n/q, n/(dq)] — A 的子块\n      B_local: [n/(dq), n/q] — B 的子块\n    &quot;&quot;&quot;\n    # Step 1: 初始化 — 将 A 按行列切分到 q×q 网格,\n    #          depth 维度上进一步切分列(A)或行(B)\n    # 处理器(i,j,k) 持有 A[i, j*d+k] 和 B[j*d+k, i]\n\n    C_local = zeros(n/q, n/q)\n\n    # Step 2: 2D SUMMA 风格迭代 (共 q 步,而非 dq 步)\n    for t in range(q):\n        # 在行方向广播 A 的列块\n        A_col = broadcast_row(A_local, source_col=t)  # 沿行通信\n\n        # 在列方向广播 B 的行块\n        B_row = broadcast_col(B_local, source_row=t)  # 沿列通信\n\n        # 本地矩阵乘法累加\n        C_local += A_col @ B_row\n\n    # Step 3: 沿 depth 维度 reduce-scatter 合并部分和\n    C_final = reduce_scatter_depth(C_local)\n\n    return C_final  # 每个处理器持有 C 的 [n/q, n/q] 子块\n</code></pre>\n<h5>方法详解</h5>\n<p><strong>动机与背景</strong></p>\n<p>随着大规模语言模型（如 GPT-3、BERT）参数量急剧增长，单 GPU 内存已无法容纳完整模型。张量并行（Tensor Parallelism）通过将模型参数和激活值切分到多个 GPU 上来解决这一问题。然而，现有方法存在明显瓶颈：</p>\n<ul>\n<li><strong>1D 并行（Megatron-LM）</strong>：将参数矩阵按列或行切分到 <span class=\"kb-math kb-math-inline\">p</span> 个 GPU，每次矩阵乘法需要一次 all-reduce 通信，通信量为 <span class=\"kb-math kb-math-inline\">O(n^2/p)</span> 但通信带宽利用率低</li>\n<li><strong>2D 并行（Optimus/SUMMA）</strong>：将 <span class=\"kb-math kb-math-inline\">p</span> 个 GPU 排列为 <span class=\"kb-math kb-math-inline\">\\sqrt{p} \\times \\sqrt{p}</span> 网格，使用 SUMMA 算法，通信量为 <span class=\"kb-math kb-math-inline\">O(n^2/\\sqrt{p})</span>，但仍受限于 2D 网格的通信开销</li>\n</ul>\n<p>Tesseract 的核心洞察是：可以通过引入第三个维度（depth）来进一步降低通信量。这一思想源自高性能计算领域的 2.5D 矩阵乘法算法（Solomonik &amp; Demmel, 2011），Tesseract 将其适配到深度学习的张量并行场景。</p>\n<p><strong>核心机制：3D 处理器排列与矩阵切分</strong></p>\n<p>Tesseract 将 <span class=\"kb-math kb-math-inline\">p = dq^2</span> 个处理器排列为三维网格 <span class=\"kb-math kb-math-inline\">[q, q, d]</span>，其中：\n- <span class=\"kb-math kb-math-inline\">q</span>：2D 平面的维度（行和列方向各 <span class=\"kb-math kb-math-inline\">q</span> 个处理器）\n- <span class=\"kb-math kb-math-inline\">d</span>：depth 维度（复制层数）</p>\n<p>对于矩阵乘法 <span class=\"kb-math kb-math-inline\">C = A \\times B</span>，其中 <span class=\"kb-math kb-math-inline\">A \\in \\mathbb{R}^{n \\times n}</span>，<span class=\"kb-math kb-math-inline\">B \\in \\mathbb{R}^{n \\times n}</span>：</p>\n<p>矩阵 <span class=\"kb-math kb-math-inline\">A</span> 被切分为 <span class=\"kb-math kb-math-inline\">q \\times (dq)</span> 个子块，每个子块大小为 <span class=\"kb-math kb-math-inline\">[n/q, n/(dq)]</span>：</p>\n<div class=\"kb-math kb-math-display\">A_{i,(j \\cdot d + k)} \\in \\mathbb{R}^{n/q \\times n/(dq)}, \\quad i \\in [0,q),\\ j \\in [0,q),\\ k \\in [0,d)</div>\n<p>矩阵 <span class=\"kb-math kb-math-inline\">B</span> 被切分为 <span class=\"kb-math kb-math-inline\">(dq) \\times q</span> 个子块，每个子块大小为 <span class=\"kb-math kb-math-inline\">[n/(dq), n/q]</span>：</p>\n<div class=\"kb-math kb-math-display\">B_{(j \\cdot d + k), i} \\in \\mathbb{R}^{n/(dq) \\times n/q}, \\quad i \\in [0,q),\\ j \\in [0,q),\\ k \\in [0,d)</div>\n<div class=\"key-point\">💡 关键：depth 维度的引入使得每个处理器持有的子块更小（列/行方向多切了 <span class=\"kb-math kb-math-inline\">d</span> 倍），从而每步通信的数据量减少 <span class=\"kb-math kb-math-inline\">d</span> 倍。</div>\n<p><strong>通信流程</strong></p>\n<p>Tesseract 的前向传播包含三种通信操作：</p>\n<ol>\n<li><strong>行方向广播（Broadcast along row）</strong>：在 SUMMA 的每一步中，将 <span class=\"kb-math kb-math-inline\">A</span> 的列块沿行方向广播，通信量为 <span class=\"kb-math kb-math-inline\">n^2/(dq^2)</span></li>\n<li><strong>列方向广播（Broadcast along column）</strong>：将 <span class=\"kb-math kb-math-inline\">B</span> 的行块沿列方向广播，通信量为 <span class=\"kb-math kb-math-inline\">n^2/(dq^2)</span></li>\n<li><strong>Depth 方向 reduce-scatter</strong>：将各 depth 层的部分积合并，通信量为 <span class=\"kb-math kb-math-inline\">n^2/q^2 \\cdot (d-1)/d</span></li>\n</ol>\n<p>总通信量分析：</p>\n<div class=\"kb-math kb-math-display\">W_{forward} = 2q \\cdot \\frac{n^2}{dq^2} + \\frac{n^2}{q^2} \\cdot \\frac{d-1}{d} = \\frac{2n^2}{dq} + \\frac{n^2(d-1)}{dq^2}</div>\n<p>当 <span class=\"kb-math kb-math-inline\">d &gt; 1</span> 时，相比 2D SUMMA 的通信量 <span class=\"kb-math kb-math-inline\">2n^2/q</span>，Tesseract 将主要通信项降低了 <span class=\"kb-math kb-math-inline\">d</span> 倍。</p>\n<p><strong>Transformer 层的适配</strong></p>\n<p>对于 Transformer 的 Feed Forward 层（输入 <span class=\"kb-math kb-math-inline\">[b, s, h]</span>，参数 <span class=\"kb-math kb-math-inline\">[h, 4h]</span> 和 <span class=\"kb-math kb-math-inline\">[4h, h]</span>）：\n- 输入切分为 <span class=\"kb-math kb-math-inline\">[b/(dq), s, h/q]</span>\n- 第一层参数切分为 <span class=\"kb-math kb-math-inline\">[h/q, 4h/q]</span>\n- 第二层参数切分为 <span class=\"kb-math kb-math-inline\">[4h/q, h/q]</span>\n- 输出形状仍为 <span class=\"kb-math kb-math-inline\">[b/(dq), s, h/q]</span></p>\n<p>对于 Multi-Head Attention 层：\n- QKV 投影参数切分为 <span class=\"kb-math kb-math-inline\">[h/q, 3h/q]</span>\n- 每个处理器处理 <span class=\"kb-math kb-math-inline\">n/q</span> 个注意力头\n- 注意力计算完全本地化（无跨位置通信）\n- 输出投影参数切分为 <span class=\"kb-math kb-math-inline\">[h/q, h/q]</span></p>\n<p><strong>LayerNorm 的分布式计算</strong></p>\n<p>LayerNorm 需要计算全局均值和方差。由于隐藏维度 <span class=\"kb-math kb-math-inline\">h</span> 被切分到 <span class=\"kb-math kb-math-inline\">q</span> 个处理器上，需要：</p>\n<div class=\"kb-math kb-math-display\">E[X] = \\frac{\\Sigma X_i}{n}, \\quad Var[X] = E[X^2] - E[X]^2</div>\n<p>Tesseract 通过在行方向执行 all-reduce 来聚合局部统计量，然后各处理器独立完成归一化计算。</p>\n<p><strong>与传统方法的对比</strong></p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>方法</th>\n<th>处理器排列</th>\n<th>通信量（前向）</th>\n<th>内存/GPU</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>Megatron-LM (1D)</td>\n<td><span class=\"kb-math kb-math-inline\">[p]</span></td>\n<td><span class=\"kb-math kb-math-inline\">O(n^2)</span></td>\n<td><span class=\"kb-math kb-math-inline\">O(n^2/p)</span></td>\n</tr>\n<tr>\n<td>Optimus (2D)</td>\n<td><span class=\"kb-math kb-math-inline\">[q, q]</span></td>\n<td><span class=\"kb-math kb-math-inline\">O(n^2/q)</span></td>\n<td><span class=\"kb-math kb-math-inline\">O(n^2/q^2)</span></td>\n</tr>\n<tr>\n<td><strong>Tesseract (3D)</strong></td>\n<td><span class=\"kb-math kb-math-inline\">[q, q, d]</span></td>\n<td><span class=\"kb-math kb-math-inline\">O(n^2/(dq))</span></td>\n<td><span class=\"kb-math kb-math-inline\">O(n^2/(dq^2))</span></td>\n</tr>\n</tbody>\n</table></div>\n<div class=\"warn-box\">⚠️ 注意：Tesseract 的 depth 维度需要额外复制输入数据，因此存在内存-通信的 trade-off。当 <span class=\"kb-math kb-math-inline\">d</span> 增大时，通信减少但每层的输入需要在 depth 维度上分发。</div>\n<p><strong>实验结果</strong></p>\n<p>在 64 GPU 的强扩展实验中，Tesseract <span class=\"kb-math kb-math-inline\">[4,4,4]</span> 相比 Megatron-LM 实现 1.37× 加速，相比 Optimus 实现 1.53× 加速。在弱扩展实验中，Tesseract 达到 Megatron-LM 的 3.37× 吞吐量和 4.02× 推理速度。同时，在 Vision Transformer 训练中验证了 Tesseract 不影响模型精度。</p>",
      "quiz": {
    ...
    },
    {
      ...
      "summary": "Sequence Parallelism 沿序列维度把输入切到多张 GPU，并用 Ring Self-Attention 在不复制完整序列激活的情况下计算跨分片注意力，解决 Transformer 长序列训练中单卡激活内存随序列长度快速增长的问题。",
      "keyPoints": [
        "输入序列按长度维度切分：第 <span class=\"kb-math kb-math-inline\">i</span> 张 GPU 只保存 <span class=\"kb-math kb-math-inline\">L/N</span> 个 token 的激活和本地 <span class=\"kb-math kb-math-inline\">Q_i,K_i,V_i</span>。",
        ...
        "长序列内存优势明确：当 <span class=\"kb-math kb-math-inline\">BL&gt;32H</span> 或 <span class=\"kb-math kb-math-inline\">BL&gt;16AZ</span> 时，序列维度切分比 Megatron 式 tensor parallel 更节省激活内存。",
        "实验结果：ACL 2023 版本报告在 64 张 NVIDIA P100 上，相比 tensor parallelism 支持 13.7x 最大 batch size 和 3.0x 最大序列长度；结合高效注意力可处理 114K token。"
      ],
      "detail": "<h5>远程示意图</h5>\n<p><img alt=\"序列并行总体架构\" src=\"https://ar5iv.labs.arxiv.org/html/2105.13120/assets/x3.png\" />\n<em>图：论文 Figure 1(c) 的序列并行总览，来自 ar5iv 对 arXiv:2105.13120 的 HTML 渲染。Device 1 与 Device 2 共享相同参数，但各自处理不同子序列。</em></p>\n<p><img alt=\"Ring Self-Attention 的 Key 环形传递\" src=\"https://ar5iv.labs.arxiv.org/html/2105.13120/assets/x4.png\" />\n<em>图：论文 Figure 2(a)，Key 在设备间环形流动，用本地 Query 与所有 Key 分块计算注意力分数。</em></p>\n<p><img alt=\"Ring Self-Attention 的 Value 环形传递\" src=\"https://ar5iv.labs.arxiv.org/html/2105.13120/assets/x5.png\" />\n<em>图：论文 Figure 2(b)，Value 继续沿环传递，各设备用本地注意力概率块累加本地输出。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># Ring Self-Attention, rank i holds X_i with length L / N\ndef ring_self_attention(x_i, rank, world_size):\n    q_i = x_i @ W_q\n    k_i = x_i @ W_k\n    v_i = x_i @ W_v\n\n    # Stage 1: circulate K blocks and build logits for local Q_i against all K_j\n    logits_blocks = []\n    k_block = k_i\n    owner = rank\n    for step in range(world_size):\n        logits_blocks.append((owner, q_i @ k_block.transpose(-1, -2) / sqrt(d_head)))\n        k_block, owner = ring_send_recv(k_block, owner)\n\n    logits = concat_in_sequence_order(logits_blocks)\n    probs = softmax(logits, dim=-1)\n\n    # Stage 2: circulate V blocks and accumulate local output O_i\n    out_i = zeros_like(q_i)\n    v_block = v_i\n    owner = rank\n    for step in range(world_size):\n        probs_block = slice_probs_for_owner(probs, owner)\n        out_i += probs_block @ v_block\n        v_block, owner = ring_send_recv(v_block, owner)\n\n    return out_i @ W_o\n</code></pre>\n<h5>机制解读</h5>\n<p>传统 Tensor Parallelism 主要切 hidden/head 维度，因此每张 GPU 仍要保存完整长度 <span class=\"kb-math kb-math-inline\">L</span> 的序列激活。当 <span class=\"kb-math kb-math-inline\">L</span> 很长时，注意力 logits 或中间激活包含 <span class=\"kb-math kb-math-inline\">L^2</span> 或 <span class=\"kb-math kb-math-inline\">BLH</span> 级别项，单卡内存很快被序列长度打满。Sequence Parallelism 的出发点是：模型参数可以复制，序列 token 可以切分；每张卡只保存 <span class=\"kb-math kb-math-inline\">X_i \\in \\mathbb{R}^{B \\times L/N \\times H}</span>，把长序列的激活压力按 <span class=\"kb-math kb-math-inline\">N</span> 分摊。</p>\n<p>注意力层是唯一不能简单本地计算的部分，因为本地 Query 需要看见所有 Key/Value。RSA 的第一阶段让 <span class=\"kb-math kb-math-inline\">K_0,\\ldots,K_{N-1}</span> 沿环传递；第 <span class=\"kb-math kb-math-inline\">i</span> 张卡在每一步计算一块 <span class=\"kb-math kb-math-inline\">Q_iK_j^\\top</span>，最后拼出针对本地 Query 的完整 logits：</p>\n<div class=\"kb-math kb-math-display\">S_i =\n\\left[\nQ_iK_0^\\top,\\ Q_iK_1^\\top,\\ \\ldots,\\ Q_iK_{N-1}^\\top\n\\right] / \\sqrt{d}</div>\n<p>softmax 必须在拼接后的完整 key 维度上做，而不是每个块单独归一化。第二阶段再让 <span class=\"kb-math kb-math-inline\">V_j</span> 沿环传递，并按 softmax 后对应的概率块累加：</p>\n<div class=\"kb-math kb-math-display\">P_i=\\operatorname{softmax}(S_i), \\qquad\nO_i=\\sum_{j=0}^{N-1} P_{i,j}V_j</div>\n<p>这样每张 GPU 最终只得到自己 <span class=\"kb-math kb-math-inline\">L/N</span> 个 token 的输出 <span class=\"kb-math kb-math-inline\">O_i</span>，无需 materialize 其他设备的输出激活。MLP、LayerNorm、Dropout 等逐 token 操作则不需要跨设备交互，这也是序列维度切分可以和 Megatron TP 的非矩阵算子激活切分思想兼容的原因。</p>\n<p>论文从内存角度给出两个判断条件。MLP 块中，Tensor Parallelism 切权重但保留完整序列；Sequence Parallelism 保留完整权重但只处理子序列。论文推导出在 MLP 块中满足</p>\n<div class=\"kb-math kb-math-display\">BL &gt; 32H</div>\n<p>时，Sequence Parallelism 的激活内存更优。对于多头注意力，Tensor Parallelism 切 head 但每个 head 仍面对完整 <span class=\"kb-math kb-math-inline\">L \\times L</span> 关系；Sequence Parallelism 把注意力矩阵的 query 行切成 <span class=\"kb-math kb-math-inline\">L/N</span>，论文给出的优势条件为</p>\n<div class=\"kb-math kb-math-display\">BL &gt; 16AZ</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">B</span> 为 batch size，<span class=\"kb-math kb-math-inline\">A</span> 为每头维度，<span class=\"kb-math kb-math-inline\">Z</span> 为 attention head 数。直觉上，序列越长、batch 越大，切序列比切隐藏维度更直接地压低激活峰值。</p>\n<p>通信上，Sequence Parallelism 把成本集中在 attention 的两次 ring P2P 与反向传播的对应通信；MLP 层无通信。论文将其和 Megatron Tensor Parallelism 的单层总通信量比较，得到同阶且可写成：</p>\n<div class=\"kb-math kb-math-display\">\\text{Comm}_{\\mathrm{SP}} =\n8(N-1)BZA\\frac{L}{N}\n\\approx\n\\text{Comm}_{\\mathrm{TP}}</div>\n<p>差异在于 Pipeline Parallelism 组合时的激活传递。TP 下跨 pipeline stage 传递完整序列激活常需要 split 与 all-gather；SP 的激活天然已经按序列切好，可以直接把子序列交给下一 stage，因此减少额外 all-gather。这个工程差异解释了为什么论文不仅关注单层通信量，还强调 4D parallelism 的可组合性。</p>",
      "quiz": {
        "q": "Ring Self-Attention 为什么需要先传 Key 再传 Value？",
        "options": [
    ...
    },
    {
      ...
      "keyPoints": [
        "<strong>序列维度分区</strong>：将输入序列沿 token 维度均匀切分到 P 个 GPU，每个 GPU 处理 <span class=\"kb-math kb-math-inline\">N/P</span> 个 token",
        ...
        "<strong>通信复杂度优势</strong>：总通信量 <span class=\"kb-math kb-math-inline\">O(N/P)</span>，与序列长度无关；对比 Megatron-LM 的 <span class=\"kb-math kb-math-inline\">O(N)</span> all-gather 通信",
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "通信量仅为 <span class=\"kb-math kb-math-inline\">3Nd</span>（N=序列长度，d=隐藏维度），相比 Ring Attention 的 <span class=\"kb-math kb-math-inline\">14Nd</span> 降低 4.7 倍",
      ...
      "detail": "<p><img alt=\"LightSeq DistAttn 示意图\" src=\"https://arxiv.org/html/2310.03294v2/extracted/5909850/figures/distattn.png\" />\n<em>图：DistAttn 分布式注意力机制示意，展示序列分区后的 Q、K、V 通信与计算流程</em></p>\n<pre><code class=\"language-python\"># DistAttn 核心伪代码\n# 输入：本地 Q_local, K_local, V_local（序列已按 N/P 分区到 P 个 GPU）\n\n# 步骤 1: All-to-All 通信收集完整 K, V\nK_full = all_gather(K_local)  # 收集所有 GPU 的 K 分片\nV_full = all_gather(V_local)  # 收集所有 GPU 的 V 分片\n\n# 步骤 2: 本地计算注意力（仅对本地 Q 分片）\nO_local = FlashAttention(Q_local, K_full, V_full)\n\n# 步骤 3: 输出无需额外通信，直接用于后续 FFN\n# 总通信量：forward 2Nd (gather K,V) + backward Nd (scatter dQ) = 3Nd\n</code></pre>\n<p><strong>动机与背景</strong></p>\n<p>随着大语言模型对长上下文能力的需求急剧增长（如 100K+ token 的文档理解、代码生成），传统的 tensor parallelism 和 data parallelism 面临严重瓶颈：</p>\n<ol>\n<li><strong>内存瓶颈</strong>：注意力机制的内存复杂度为 <span class=\"kb-math kb-math-inline\">O(N^2)</span>，即使使用 FlashAttention 降至 <span class=\"kb-math kb-math-inline\">O(N)</span>，单 GPU 仍无法容纳超长序列的激活值</li>\n<li><strong>通信瓶颈</strong>：Ring Attention 虽然支持序列并行，但需要在环形拓扑中逐步传递 KV 块，通信量高达 <span class=\"kb-math kb-math-inline\">14Nd</span></li>\n<li><strong>负载不均</strong>：Causal attention 的下三角 mask 导致不同位置的 token 计算量差异巨大</li>\n</ol>\n<div class=\"key-point\">💡 关键：LightSeq 的核心洞察是——在序列并行中，Q 不需要通信（每个 GPU 只计算自己的 Q 对应的输出），只需收集完整的 K 和 V。</div>\n<p><strong>核心机制：DistAttn</strong></p>\n<p>DistAttn 的设计基于以下关键观察：对于注意力计算 <span class=\"kb-math kb-math-inline\">O = \\text{softmax}(QK^T/\\sqrt{d})V</span>，输出 <span class=\"kb-math kb-math-inline\">O</span> 的第 <span class=\"kb-math kb-math-inline\">i</span> 行仅依赖 <span class=\"kb-math kb-math-inline\">Q</span> 的第 <span class=\"kb-math kb-math-inline\">i</span> 行和完整的 <span class=\"kb-math kb-math-inline\">K, V</span>。因此：</p>\n<div class=\"kb-math kb-math-display\">O_i = \\text{softmax}\\left(\\frac{Q_i K^T}{\\sqrt{d}}\\right) V</div>\n<p>这意味着可以将序列均匀分到 <span class=\"kb-math kb-math-inline\">P</span> 个 GPU，每个 GPU 持有 <span class=\"kb-math kb-math-inline\">Q_{\\text{local}}</span>（<span class=\"kb-math kb-math-inline\">N/P</span> 个 token），但需要访问完整的 <span class=\"kb-math kb-math-inline\">K</span> 和 <span class=\"kb-math kb-math-inline\">V</span>。</p>\n<p><strong>前向传播通信分析：</strong>\n- 每个 GPU 需要 gather 完整 K 和 V：通信量 = <span class=\"kb-math kb-math-inline\">2 \\times N \\times d = 2Nd</span>\n- 输出 <span class=\"kb-math kb-math-inline\">O_{\\text{local}}</span> 无需通信</p>\n<p><strong>反向传播通信分析：</strong>\n- <span class=\"kb-math kb-math-inline\">dK</span> 和 <span class=\"kb-math kb-math-inline\">dV</span> 通过 reduce-scatter 聚合：已包含在 forward 的 all-gather 对偶操作中\n- <span class=\"kb-math kb-math-inline\">dQ</span> 仅需本地梯度，额外通信量 = <span class=\"kb-math kb-math-inline\">Nd</span></p>\n<p><strong>总通信量</strong> = <span class=\"kb-math kb-math-inline\">3Nd</span>，而 Ring Attention 需要 <span class=\"kb-math kb-math-inline\">14Nd</span>（包含 2P-1 步的 KV 传递）。</p>\n<div class=\"warn-box\">⚠️ 注意：这里的通信量分析假设使用 all-gather/reduce-scatter 原语，在 NVLink 互联的 GPU 集群上可实现接近带宽上限的效率。</div>\n<p><strong>负载均衡策略</strong></p>\n<p>对于 causal attention，第 <span class=\"kb-math kb-math-inline\">i</span> 个 token 只关注前 <span class=\"kb-math kb-math-inline\">i</span> 个 token，导致计算量呈三角形分布。如果简单按顺序分区，第一个 GPU 的计算量远小于最后一个 GPU。</p>\n<p>LightSeq 的解决方案：<strong>交错分配（Interleaved Assignment）</strong></p>\n<p>将 token 按如下方式分配到 <span class=\"kb-math kb-math-inline\">P</span> 个 GPU：\n- GPU 0: tokens <span class=\"kb-math kb-math-inline\">\\{0, 2P-1, 2P, 4P-1, ...\\}</span>\n- GPU 1: tokens <span class=\"kb-math kb-math-inline\">\\{1, 2P-2, 2P+1, 4P-2, ...\\}</span>\n- 一般地，将序列折叠后交替分配，使每个 GPU 同时获得\"轻\"token（序列前部）和\"重\"token（序列后部）</p>\n<p>这确保了每个 GPU 的 FLOPs 近似相等，负载差异从 <span class=\"kb-math kb-math-inline\">O(N/P)</span> 降至 <span class=\"kb-math kb-math-inline\">O(1)</span>。</p>\n<p><strong>重计算感知检查点（Rematerialization-aware Checkpointing）</strong></p>\n<p>传统激活检查点在反向传播时重新计算前向激活，但在分布式设置中，重计算需要重新执行通信操作。LightSeq 的创新在于：</p>\n<ol>\n<li><strong>选择性保存</strong>：保存通信获取的 K、V（而非本地计算的中间结果），避免反向时重复通信</li>\n<li><strong>通信-计算重叠</strong>：在重计算本地注意力的同时，异步预取下一层所需的 K、V</li>\n<li><strong>内存-通信权衡</strong>：通过保存 <span class=\"kb-math kb-math-inline\">O(N \\cdot d / P)</span> 的额外内存，完全消除反向传播中的通信等待</li>\n</ol>\n<div class=\"kb-math kb-math-display\">\\text{Memory overhead} = \\frac{2Nd}{P} \\quad \\text{(保存 K, V 的本地分片)}</div>\n<p><strong>与传统方法的对比</strong></p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>方法</th>\n<th>通信量</th>\n<th>负载均衡</th>\n<th>适用注意力类型</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>Megatron-SP</td>\n<td><span class=\"kb-math kb-math-inline\">4Nd</span> (all-reduce)</td>\n<td>均衡</td>\n<td>所有类型</td>\n</tr>\n<tr>\n<td>Ring Attention</td>\n<td><span class=\"kb-math kb-math-inline\">14Nd</span></td>\n<td>不均衡(causal)</td>\n<td>所有类型</td>\n</tr>\n<tr>\n<td>DeepSpeed-Ulysses</td>\n<td><span class=\"kb-math kb-math-inline\">4Nd</span> (all-to-all)</td>\n<td>均衡</td>\n<td>所有类型</td>\n</tr>\n<tr>\n<td><strong>LightSeq (DistAttn)</strong></td>\n<td><strong><span class=\"kb-math kb-math-inline\">3Nd</span></strong></td>\n<td><strong>均衡(含优化)</strong></td>\n<td><strong>所有类型</strong></td>\n</tr>\n</tbody>\n</table></div>\n<p>LightSeq 相比 DeepSpeed-Ulysses 进一步减少 25% 通信量，因为 Ulysses 需要在输出端执行额外的 all-to-all 将结果重新分配回 head 维度，而 DistAttn 的输出天然保持序列分区无需额外通信。</p>\n<p><strong>实验验证</strong></p>\n<p>在 32 个 A100 80GB GPU（4 节点，NVLink + InfiniBand）上的实验表明：\n- 序列长度 64K-2M tokens，模型参数 1.3B-7B\n- 相比 Megatron-LM：在 7B 模型、512K 序列上实现 2.01x 加速\n- 相比 DeepSpeed-Ulysses：在多数配置下实现 1.24x-1.54x 加速\n- 通信时间占比从 Ring Attention 的 60%+ 降至 LightSeq 的 20% 以下</p>",
      "quiz": {
    ...
    },
    {
      ...
      "keyPoints": [
        "<strong>2D-Attention 机制</strong>：将 <span class=\"kb-math kb-math-inline\">d_{sp}</span> 个 GPU 组织为 <span class=\"kb-math kb-math-inline\">d_{hp} \\times d_{cp}</span> 二维网格，HP 维度用 SeqAlltoAll 按注意力头分发，CP 维度用 Ring-Attention 按序列分块",
        "<strong>KV Replication for GQA</strong>：当 KV 头数 <span class=\"kb-math kb-math-inline\">H_{kv} &lt; d_{hp}</span> 时，复制 KV 张量使 HP 维度可扩展至 <span class=\"kb-math kb-math-inline\">H</span>（总头数），解除 GQA 场景下 HP 的头数限制",
    ...
    },
    {
      ...
      "summary": "Selective Activation Recomputation 提出“只重算最占显存但计算便宜的激活”，并与 Megatron 的序列并行结合，解决大 Transformer 训练中全层 checkpoint 带来的 30-40% 额外计算开销。",
      "keyPoints": [
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"Tensor 与 Sequence Parallel 结合示意\" src=\"https://ar5iv.labs.arxiv.org/html/2205.05198/assets/figures/transformer-tensor-sequence-parallel.jpg\" />\n<em>图：论文展示的 Transformer tensor-parallel + sequence-parallel 切分方式；sequence parallel 让原本复制在 TP 组内的序列激活变成分片保存。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># selective activation recomputation for one Transformer block\ndef forward_block(x):\n    x_sp = scatter_sequence(x)          # sequence parallel: each TP rank keeps S / tp tokens\n    h = layer_norm(x_sp)                # save small inputs, not full replicated activations\n    q, k, v = column_parallel_qkv(h)\n\n    # Do not save large attention probabilities / dropout outputs.\n    # Save only q, k, v and RNG state needed to replay dropout.\n    ctx = attention(q, k, v, save_probs=False, save_rng=True)\n    y = row_parallel_proj(ctx)\n\n    z = layer_norm(x_sp + y)\n    m = mlp(z)                          # keep expensive GEMM boundary activations\n    return gather_sequence(x_sp + y + m)\n\ndef backward_block(saved):\n    # recompute only the attention core, not the whole Transformer layer\n    probs = recompute_softmax_dropout(saved.q, saved.k, saved.v, saved.rng)\n    return attention_backward(probs, saved)\n</code></pre>\n<h5>方法解释</h5>\n<p>传统 activation checkpointing 的做法是整层丢弃激活，反向传播前再完整执行一次前向。它能把显存压下来，但代价是每个 Transformer 层的 QKV、MLP 两个大 GEMM 都要重跑，计算开销通常达到 30-40%。论文的出发点是重新做一遍激活内存账本：并非所有激活都同样昂贵，attention 的概率矩阵和 dropout mask 往往占显存很大，但重算它们主要是矩阵乘法后的 softmax/dropout；而 MLP 中间激活虽然也大，但重算需要昂贵 GEMM，性价比低。</p>\n<p>序列并行先降低“必须保存”的部分。Megatron tensor parallelism 在行并行/列并行线性层之间需要 all-reduce 或 all-gather，使一些区域的激活在 TP 组内复制。Sequence parallel 把这些区域改成沿序列维分片，LayerNorm 和 dropout 在本地 token 上独立执行，必要时通过 reduce-scatter/all-gather 与 TP 线性层衔接。若 TP 度为 <span class=\"kb-math kb-math-inline\">p</span>，这类激活的单卡占用近似从 <span class=\"kb-math kb-math-inline\">O(BSH)</span> 降到 <span class=\"kb-math kb-math-inline\">O(BSH/p)</span>。</p>\n<p>选择性重计算再处理无法仅靠切分解决的 attention 峰值。对 attention，训练需要保存 softmax 后的概率 <span class=\"kb-math kb-math-inline\">P=\\mathrm{softmax}(QK^T/\\sqrt{d})</span> 以及 dropout 结果，规模与 <span class=\"kb-math kb-math-inline\">B \\times n_h \\times S^2</span> 相关。论文选择在前向时不保存这些矩阵，反向时用保存的 <span class=\"kb-math kb-math-inline\">Q,K,V</span> 和随机数状态重新计算：</p>\n<div class=\"kb-math kb-math-display\">P = \\mathrm{Dropout}\\left(\\mathrm{softmax}\\left(\\frac{QK^\\top}{\\sqrt{d}}\\right)\\right), \\quad O = PV</div>\n<div class=\"key-point\">💡 关键：它不是“少保存一切”，而是用显存节省量除以重算 FLOPs 做取舍。只有内存收益高、重算成本低的 attention 中间量被丢弃。</div>\n<p>与全层 checkpoint 相比，这种策略保留了 MLP 和线性投影所需的关键边界激活，因此反向不会重复执行最贵的大 GEMM；与单纯 sequence parallel 相比，它仍能压掉 attention <span class=\"kb-math kb-math-inline\">S^2</span> 相关的峰值。二者组合后，大模型训练通常可以关闭或大幅减少 full recomputation，只在极端长序列或显存预算紧张时保留少量 checkpoint。</p>\n<h5>训练流程与传统方法对比</h5>\n<p>标准 checkpoint 的流程是“前向少存整层，反向重跑整层”；Selective Recomputation 的流程是“前向分片保存必要激活，attention 内部大张量不保存，反向只重算 attention 内部”。因此它保留了数据并行和 tensor parallel 的编程模型，不需要修改模型数学语义，也不改变优化器状态，只改变 activation 的保存策略。</p>\n<p>在 Megatron/NeMo 这类训练栈中，这个方法通常与 TP、PP、DP 同时启用。TP 组内部先用 sequence parallel 缩小本地激活，PP 负责跨层切分，DP 负责扩 batch；selective recompute 只影响每层内部的 autograd 保存点。这个边界很重要，因为它让方法可以作为系统优化加入，而不是引入新的模型结构。</p>",
      "quiz": {
        "q": "Selective Activation Recomputation 相比全层 checkpoint 的核心优势是什么？",
        "options": [
          "重算所有层以获得更稳定的梯度",
    ...
    },
    {
      ...
      "summary": "Dynamic Context Parallelism 在 Megatron Core 中按 microbatch 的真实 packed sequence 形状动态选择 CP size 和 CP group，解决变长序列训练里短样本被最长样本强制大规模 context sharding 后产生的通信浪费与 DP/PP 气泡问题。",
      "keyPoints": [
        ...
        "<code>PackedSeqParams</code> 承载动态配置：把 <code>cp_size</code>、<code>cp_group</code>、<code>max_seqlen</code>、<code>cu_seqlens</code> 传给 position embedding、TE Attention、FLOPs 统计等组件。",
      ...
      "detail": "<h5>远程示意图</h5>\n<p><img alt=\"Dynamic-CP 集成到 Megatron Core 的流程\" src=\"https://developer-blogs.nvidia.com/wp-content/uploads/2026/01/Dynamic-CP-Integration-png.webp\" />\n<em>图：NVIDIA 官方技术博客 Figure 6，展示 Dynamic-CP 如何通过 data iterator wrapper、PackedSeqParams、CP group 广播、position embedding、Transformer Engine Attention 和 FLOPs 统计集成到 Megatron Core。</em></p>\n<p><img alt=\"Dynamic-CP 降低 DP/PP 气泡\" src=\"https://developer-blogs.nvidia.com/wp-content/uploads/2026/01/Dynamic-CP-1-png.webp\" />\n<em>图：NVIDIA 官方技术博客 Figure 5，展示调度前后的 DP rank 与 microbatch 工作量气泡变化。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># Dynamic Context Parallelism scheduler and runtime selection\ndef plan_dynamic_cp(global_batch, dp_size, pp_size, max_cp_size, memory_limit):\n    samples = probe_sequence_lengths_and_shapes(global_batch)\n    candidates = []\n\n    for microbatch_count in grid_search_counts(start=pp_size, stop=small_multiple(pp_size)):\n        quotas = build_work_and_memory_quotas(samples, dp_size, microbatch_count, pp_size)\n        buckets = initialize_microbatch_buckets(dp_size, microbatch_count, quotas)\n\n        for sample in sort_by_estimated_work(samples, descending=True):\n            cp_size = 1\n            while estimate_memory(sample, cp_size) &gt; memory_limit:\n                cp_size *= 2\n                assert cp_size &lt;= max_cp_size\n\n            bucket = choose_bucket_by_work_then_memory(buckets, sample, cp_size)\n            bucket.add(sample, cp_size=cp_size)\n\n        schedule = simulate_pipeline_and_dp_execution(buckets)\n        if schedule.peak_memory &lt;= memory_limit:\n            candidates.append(schedule)\n\n    return min(candidates, key=lambda s: s.estimated_iteration_time)\n\ndef dynamic_cp_data_iterator(data_iterator, prebuilt_cp_groups):\n    for global_batch in data_iterator:\n        schedule = plan_dynamic_cp(global_batch, dp_size, pp_size, max_cp_size, memory_limit)\n        for microbatch in schedule.microbatches_for_this_rank():\n            cp_size = microbatch.cp_size\n            yield PackedSeqParams(\n                tokens=microbatch.tokens_thd,\n                cu_seqlens=microbatch.cu_seqlens,\n                max_seqlen=microbatch.max_seqlen,\n                cp_size=cp_size,\n                cp_group=prebuilt_cp_groups[cp_size],\n            )\n</code></pre>\n<h5>机制解读</h5>\n<p>静态 Context Parallelism 通常为整次训练或整个 batch 使用同一个 CP size。这个选择必须能容纳最长样本，否则长序列会 OOM；但真实后训练、长文档和视频 DiT 数据有明显长尾分布，绝大多数 packed microbatch 并不需要最大 CP。结果是短序列也被切到多张 GPU 上，attention 计算量不足以隐藏 NCCL 通信，尤其当 CP 通信跨 InfiniBand 域时，通信 kernel 会暴露成瓶颈。</p>\n<p>Dynamic-CP 的第一步是认识到 packed token 数相等不代表工作量相等。一个 packed 样本包含若干子序列 <span class=\"kb-math kb-math-inline\">\\{S_i\\}</span> 时，注意力有效计算近似与平方和相关：</p>\n<div class=\"kb-math kb-math-display\">C_{\\mathrm{attn}} \\propto \\sum_i S_i^2</div>\n<p>激活显存则更接近线性：</p>\n<div class=\"kb-math kb-math-display\">M_{\\mathrm{act}} \\propto \\sum_i S_i</div>\n<p>因此 FLOPs 均衡和显存均衡并不总能同时满足：把短样本凑到一起可以平衡工作量，但可能推高一个 microbatch 的 token 峰值；把长样本拆得更细可以控显存，却会增加 CP 通信。Dynamic-CP 的调度器在这两个目标之间做近似搜索。</p>\n<p>在 Megatron Core 集成上，Dynamic-CP 避免了动态 TP/PP 那类高开销重构。TP/PP 改变通常意味着权重重分布或 pipeline graph 重建；CP 改变主要影响序列激活分片和 attention 通信组。系统在初始化阶段为 rank 预先构造多个 CP group，大小从 1 到 <span class=\"kb-math kb-math-inline\">dp \\times cp</span> 的 2 次幂。运行时 <code>PackedSeqParams</code> 携带当前 microbatch 的 <code>cp_size</code> 与 <code>cp_group</code>，让 position embedding 和 Transformer Engine Attention 从该对象读取动态 CP 配置，而不是读取全局静态 CP 变量。</p>\n<p>调度器由 cost model、solver、simulator 三段组成。Cost model 用序列长度和模型配置估计每个样本的执行时间；solver 使用启发式方法把样本打包成 microbatch，并给重样本分配更大 CP size；simulator 再把候选 microbatch 放进 DP/PP schedule 中，估计 pipeline bubble、DP rank 等待和峰值显存。NVIDIA 博客给出的端到端平衡公式可以写为：</p>\n<div class=\"kb-math kb-math-display\">W_1(m_1V+p-1)=W_2(m_2V+p-1)</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">W_i</span> 是第 <span class=\"kb-math kb-math-inline\">i</span> 个 DP rank 的 microbatch 工作量 quota，<span class=\"kb-math kb-math-inline\">m_i</span> 是 microbatch 数，<span class=\"kb-math kb-math-inline\">V</span> 是 virtual pipeline stage 数，<span class=\"kb-math kb-math-inline\">p</span> 是 pipeline stage 数。这个公式表达的是：不同 DP rank 的总执行时间应接近，而不是只让每个 microbatch 的 token 数相同。</p>\n<p>Zero-overhead execution 的关键在于把额外工作移出主训练路径。为生成计划，系统需要额外 probe 一次 global batch 的长度与形状元信息；NVIDIA 的方案将 probe 分散到集群并只 gather 轻量 metadata。Solver 运行在 <code>data_sampler</code> 后台，与当前训练 iteration 重叠；microbatch 数不是全量穷举，而是在从 <span class=\"kb-math kb-math-inline\">PP \\times 1</span> 到小倍数 <span class=\"kb-math kb-math-inline\">PP</span> 的小网格中找 knee point，限制搜索区域。</p>\n<p>官方 benchmark 使用 Llama-13B、global batch size 2048、PP=8、CP=8、full recompute，并把 Dynamic CP 与 only packing 对比。GitHub 数据集 TFLOPS/GPU 从 195.88 提升到 289.32：</p>\n<div class=\"kb-math kb-math-display\">\\frac{289.32}{195.88}\\approx 1.48</div>\n<p>CommonCrawl 数据集从 139.17 到 174.39：</p>\n<div class=\"kb-math kb-math-display\">\\frac{174.39}{139.17}\\approx 1.25</div>\n<p>这些数字说明 Dynamic-CP 的收益主要来自减少变长样本引入的 DP 等待、PP 气泡和短样本过度 CP 通信，而不是改变 attention 的数学语义。训练 loss 仍按 valid token 归一化：</p>\n<div class=\"kb-math kb-math-display\">\\mathcal{L}=\\frac{\\sum_{\\text{valid token}} \\ell}{N_{\\text{valid token}}}</div>\n<p>这避免 padding token 或不同 packing 形状改变优化目标。</p>",
      "quiz": {
        "q": "Dynamic Context Parallelism 为什么要把 cp_size 放进 PackedSeqParams？",
        "options": [
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>激活重计算（Re-materialization）</strong>：前向传播仅保留分区边界激活，反向时重新计算中间激活，将峰值显存从 <span class=\"kb-math kb-math-inline\">O(N)</span> 降至 <span class=\"kb-math kb-math-inline\">O(N/K + L/K \\cdot N/M)</span>",
        "<strong>Bubble 开销分析</strong>：空闲时间比例为 <span class=\"kb-math kb-math-inline\">O((K-1)/(M+K-1))</span>，当 <span class=\"kb-math kb-math-inline\">M \\geq 4K</span> 时可忽略不计",
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>1F1B 调度策略</strong>：启动阶段注入 <span class=\"kb-math kb-math-inline\">N</span> 个 minibatch 填充流水线，稳态阶段每个 stage 严格交替执行一次 forward 和一次 backward，最大化 GPU 利用率",
      ...
      "detail": "<p><img alt=\"PipeDream 流水线并行示意图\" src=\"https://arxiv.org/html/1806.03377v5/extracted/figures/timeline_1f1b.png\" />\n<em>图：1F1B 流水线调度时间线——数字表示 minibatch ID，蓝色为 forward，绿色为 backward。启动阶段逐步注入 minibatch，稳态阶段各 stage 交替执行 F/B。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># PipeDream 1F1B 调度伪代码\n# 假设 pipeline 有 N 个 stage, stage_id 从 0 (input) 到 N-1 (output)\n\ndef pipedream_1f1b(stage_id, num_stages):\n    num_outstanding = num_stages  # startup 阶段注入的 minibatch 数\n\n    # === Startup Phase ===\n    # 每个 stage 根据自身位置执行不同数量的 forward\n    for i in range(num_stages - stage_id):\n        activations = forward(next_minibatch())\n        send_activations_to_next_stage(activations)\n        stash_weights(version=current_version)  # Weight Stashing\n\n    # === Steady State: 严格交替 1F1B ===\n    while not converged:\n        # Backward pass (使用 stashed weights)\n        gradients = backward(received_gradients, stashed_weights[oldest_version])\n        send_gradients_to_prev_stage(gradients)\n        update_weights(gradients)\n\n        # Forward pass\n        activations = forward(next_minibatch())\n        send_activations_to_next_stage(activations)\n        stash_weights(version=current_version)\n</code></pre>\n<h5>动机与背景</h5>\n<p>传统分布式 DNN 训练主要依赖<strong>数据并行（Data Parallelism）</strong>：每个 worker 持有完整模型副本，处理不同数据分片，训练后同步梯度。这种方式的核心瓶颈在于<strong>通信开销</strong>——每轮迭代需要在所有 worker 间同步全部模型参数。对于 VGG16（550MB 参数）这样的大模型，在 25Gbps 以太网上，通信时间可能远超计算时间，导致 GPU 严重空闲。</p>\n<p>传统<strong>模型并行（Model Parallelism）</strong>将不同层分配到不同 GPU，但由于 DNN 的前向-反向双向依赖，同一时刻只有一个 GPU 在工作，其余 GPU 全部空闲，硬件利用率极低。</p>\n<div class=\"key-point\">💡 <strong>关键洞察</strong>：PipeDream 的核心思想是将多个 minibatch 注入模型并行的流水线中，让不同 GPU 同时处理不同 minibatch 的不同阶段，从而同时解决数据并行的通信瓶颈和模型并行的低利用率问题。</div>\n<h5>核心机制一：自动分区算法</h5>\n<p>PipeDream 的分区问题可形式化为：给定 <span class=\"kb-math kb-math-inline\">N</span> 层的 DNN 和 <span class=\"kb-math kb-math-inline\">M</span> 台机器，找到最优的层到 stage 的映射以及每个 stage 的副本数，使得流水线吞吐量最大化（即最慢 stage 的执行时间最小化）。</p>\n<p><strong>Profiling 阶段</strong>：在单机上运行 1000 个 minibatch，记录每层的三个关键指标：\n- <span class=\"kb-math kb-math-inline\">T_l</span>：第 <span class=\"kb-math kb-math-inline\">l</span> 层的前向+反向计算时间\n- <span class=\"kb-math kb-math-inline\">a_l</span>：第 <span class=\"kb-math kb-math-inline\">l</span> 层输出 activation 的大小（也是反向传播时 gradient 的大小）\n- <span class=\"kb-math kb-math-inline\">w_l</span>：第 <span class=\"kb-math kb-math-inline\">l</span> 层的参数量</p>\n<p><strong>动态规划求解</strong>：定义 <span class=\"kb-math kb-math-inline\">A(j, m)</span> 为将前 <span class=\"kb-math kb-math-inline\">j</span> 层最优分配到 <span class=\"kb-math kb-math-inline\">m</span> 台机器上时，最慢 stage 的执行时间。递推关系为：</p>\n<div class=\"kb-math kb-math-display\">A(j, m) = \\min_{1 \\le i \\le j} \\left[ \\max\\left( A(i-1, m-m&#x27;), \\frac{\\sum_{l=i}^{j} T_l}{m&#x27;} + \\frac{C_{i-1}}{m&#x27;} \\right) \\right]</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">m&#x27;</span> 是当前 stage 的副本数（用于数据并行），<span class=\"kb-math kb-math-inline\">C_{i-1}</span> 是 stage 边界处的通信开销。当某个 stage 被分配 <span class=\"kb-math kb-math-inline\">m&#x27;</span> 个副本时，该 stage 内部采用数据并行，计算时间和通信时间均除以 <span class=\"kb-math kb-math-inline\">m&#x27;</span>。</p>\n<div class=\"warn-box\">⚠️ <strong>注意</strong>：该算法的时间复杂度为 <span class=\"kb-math kb-math-inline\">O(N^2 \\cdot M)</span>，对于数百层的现代 DNN 和数十台机器，可在秒级完成求解。</div>\n<h5>核心机制二：1F1B 调度</h5>\n<p>1F1B 调度分为两个阶段：</p>\n<ol>\n<li>\n<p><strong>Startup Phase（启动阶段）</strong>：input stage 连续注入多个 minibatch 的 forward pass。对于 <span class=\"kb-math kb-math-inline\">N</span> 个 stage 的流水线，stage <span class=\"kb-math kb-math-inline\">k</span>（从 0 开始编号）在启动阶段执行 <span class=\"kb-math kb-math-inline\">N - k</span> 次 forward pass。这确保了流水线被充分填满。</p>\n</li>\n<li>\n<p><strong>Steady State（稳态阶段）</strong>：每个 stage 严格交替执行一次 forward 和一次 backward。这种调度保证了：</p>\n</li>\n<li>每个 stage 在任意时刻都有工作可做（高 GPU 利用率）</li>\n<li>同时处于 in-flight 状态的 minibatch 数量恒定（内存可控）</li>\n<li>流水线中最多有 <span class=\"kb-math kb-math-inline\">N</span> 个未完成的 minibatch（<span class=\"kb-math kb-math-inline\">N</span> 为 stage 数）</li>\n</ol>\n<p>与 GPipe 的\"全 forward 再全 backward\"方案相比，1F1B 的关键优势在于<strong>内存效率</strong>：GPipe 需要缓存所有 micro-batch 的 activation 直到 backward 完成，而 1F1B 中每个 stage 最多只需缓存 <span class=\"kb-math kb-math-inline\">N</span> 个 minibatch 的 activation。</p>\n<h5>核心机制三：Weight Stashing 与 Vertical Sync</h5>\n<p>流水线并行引入了<strong>权重版本不一致</strong>问题：当 minibatch <span class=\"kb-math kb-math-inline\">b</span> 在 stage 1 执行 forward 时使用权重 <span class=\"kb-math kb-math-inline\">w^{(t)}</span>，但当它回到 stage 1 执行 backward 时，权重可能已被更新为 <span class=\"kb-math kb-math-inline\">w^{(t+k)}</span>。这种不一致会导致梯度计算错误，影响收敛。</p>\n<p><strong>Weight Stashing</strong> 解决了 stage 内的一致性：每个 stage 为每个 in-flight minibatch 保存一份权重快照。当 minibatch <span class=\"kb-math kb-math-inline\">b</span> 在某 stage 执行 forward 时，使用的权重版本被保存；当该 minibatch 回到同一 stage 执行 backward 时，使用保存的同一版本权重计算梯度。</p>\n<div class=\"kb-math kb-math-display\">\\text{Forward: } \\hat{y}_b^{(k)} = f_k(x_b^{(k)}; w_k^{(t)}) \\quad \\Rightarrow \\quad \\text{stash } w_k^{(t)}</div>\n<div class=\"kb-math kb-math-display\">\\text{Backward: } g_b^{(k)} = \\nabla_{w_k^{(t)}} \\mathcal{L}(\\hat{y}_b, y_b) \\quad \\text{using stashed } w_k^{(t)}</div>\n<p><strong>Vertical Sync</strong> 进一步保证跨 stage 的一致性：确保 minibatch <span class=\"kb-math kb-math-inline\">b</span> 在所有 stage 的 forward pass 中使用的是同一\"逻辑版本\"的权重。具体实现是在每个 activation 消息中附带权重版本号，接收 stage 据此选择对应版本的权重。</p>\n<div class=\"key-point\">💡 <strong>关键</strong>：Weight Stashing 的额外内存开销为 <span class=\"kb-math kb-math-inline\">O(N)</span> 份权重副本（<span class=\"kb-math kb-math-inline\">N</span> 为 stage 数），这在实践中是可接受的，因为 stage 数通常较少（4-16）。论文证明了使用 Weight Stashing 后，PipeDream 的权重更新等价于在一个有界陈旧性（bounded staleness）条件下的异步 SGD，可以保证收敛。</div>\n<h5>与传统方法的对比</h5>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>特性</th>\n<th>数据并行 (BSP)</th>\n<th>模型并行</th>\n<th>PipeDream (1F1B)</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>通信量</td>\n<td>全部参数</td>\n<td>stage 边界 activation</td>\n<td>stage 边界 activation</td>\n</tr>\n<tr>\n<td>GPU 利用率</td>\n<td>受通信阻塞</td>\n<td>极低（串行）</td>\n<td>高（流水线重叠）</td>\n</tr>\n<tr>\n<td>内存</td>\n<td>每 GPU 存全部参数</td>\n<td>每 GPU 存部分参数</td>\n<td>部分参数 + weight stash</td>\n</tr>\n<tr>\n<td>收敛性</td>\n<td>等价单机</td>\n<td>等价单机</td>\n<td>有界陈旧性，实验验证收敛</td>\n</tr>\n<tr>\n<td>扩展性</td>\n<td>受限于通信带宽</td>\n<td>受限于 stage 数</td>\n<td>可混合 DP+PP</td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>实验结果</strong>（Table 1 摘要）：\n- <strong>VGG16</strong>（8 GPU, 25Gbps 网络）：PipeDream 比 BSP 快 <strong>3.0×</strong>，通信减少 <strong>95%</strong>\n- <strong>VGG16</strong>（8 GPU, 10Gbps 网络）：PipeDream 比 BSP 快 <strong>5.3×</strong>（低带宽场景优势更大）\n- <strong>S2VT</strong>（4 GPU）：PipeDream 比 BSP 快 <strong>3.0×</strong>，通信减少 <strong>95%</strong>\n- 所有配置均达到与 BSP 相同的最终精度</p>",
      "quiz": {
    ...
    },
    {
      ...
      "keyPoints": [
        "<strong>虚拟阶段划分</strong>：将模型的 <span class=\"kb-math kb-math-inline\">L</span> 层均匀分为 <span class=\"kb-math kb-math-inline\">v \\times p</span> 个虚拟阶段，每个设备承载 <span class=\"kb-math kb-math-inline\">v</span> 个非连续的 model chunks",
        "<strong>气泡时间缩减</strong>：流水线气泡比例从 <span class=\"kb-math kb-math-inline\">\\frac{p-1}{m}</span> 降至 <span class=\"kb-math kb-math-inline\">\\frac{1}{v} \\cdot \\frac{p-1}{m}</span>，即缩小 <span class=\"kb-math kb-math-inline\">v</span> 倍",
        "<strong>通信代价</strong>：点对点（P2P）通信量增加 <span class=\"kb-math kb-math-inline\">v</span> 倍，但可利用节点内 NVLink 高带宽隐藏",
        "<strong>微批次约束</strong>：微批次数量 <span class=\"kb-math kb-math-inline\">m</span> 必须是流水线并行度 <span class=\"kb-math kb-math-inline\">p</span> 的整数倍",
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"Interleaved 1F1B Pipeline Schedule\" src=\"https://ar5iv.labs.arxiv.org/html/2104.04473/assets/x4.png\" />\n<em>图：上方为 Default 1F1B Schedule，下方为 Interleaved 1F1B Schedule。每个设备被分配多个 model chunks（用不同颜色深浅表示），微批次在虚拟阶段间交替执行，warmup 和 cooldown 阶段更短，气泡更小。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># Interleaved 1F1B Pipeline Schedule\n# p: pipeline parallel size, v: num model chunks per device\n# m: num microbatches (must be divisible by p)\n# Device i holds model chunks: [i, i+p, i+2p, ..., i+(v-1)*p]\n\ndef interleaved_1f1b(device_id, microbatches, model_chunks):\n    p = pipeline_size\n    v = len(model_chunks)  # number of chunks per device\n    m = len(microbatches)\n\n    # === Warmup Phase ===\n    # Execute forward passes to fill the pipeline\n    # Number of warmup microbatches is smaller than default\n    num_warmup = (p - 1) * v  # across all virtual stages on this device\n    for i in range(num_warmup):\n        chunk_id = i % v  # rotate through model chunks\n        micro_id = i // v\n        forward(model_chunks[chunk_id], microbatches[micro_id])\n\n    # === Steady State (1F1B) ===\n    # Alternate one forward and one backward per microbatch\n    for i in range(m - num_warmup):\n        # Backward for an earlier microbatch\n        chunk_id_b = schedule_backward(i)\n        backward(model_chunks[chunk_id_b], ...)\n        # Forward for the next microbatch\n        chunk_id_f = schedule_forward(i)\n        forward(model_chunks[chunk_id_f], microbatches[...])\n\n    # === Cooldown Phase ===\n    # Drain remaining backward passes\n    for i in range(num_warmup):\n        chunk_id = schedule_cooldown(i)\n        backward(model_chunks[chunk_id], ...)\n</code></pre>\n<h5>方法细节</h5>\n<p><strong>动机与背景</strong></p>\n<p>在大规模语言模型（如 GPT-3 175B）训练中，单设备无法容纳完整模型，流水线并行（Pipeline Parallelism）是必要的分布式策略。传统的 GPipe 方法将所有前向传播执行完毕后再执行反向传播，导致巨大的激活内存开销。PipeDream 提出的 1F1B（One Forward One Backward）调度通过交替执行前向和反向来限制内存，但仍存在不可避免的流水线气泡：</p>\n<div class=\"kb-math kb-math-display\">\\text{Bubble fraction (default)} = \\frac{t_{pb}}{t_{id}} = \\frac{p - 1}{m}</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">p</span> 为流水线并行度，<span class=\"kb-math kb-math-inline\">m</span> 为微批次数量，<span class=\"kb-math kb-math-inline\">t_{pb}</span> 为气泡时间，<span class=\"kb-math kb-math-inline\">t_{id}</span> 为理想执行时间。当 <span class=\"kb-math kb-math-inline\">p</span> 较大时（如 <span class=\"kb-math kb-math-inline\">p=64</span>），即使 <span class=\"kb-math kb-math-inline\">m</span> 很大，气泡仍然显著。</p>\n<div class=\"key-point\">💡 关键：气泡的根本原因是流水线的\"填充\"和\"排空\"阶段——第一个微批次必须经过所有阶段后，最后一个阶段才能开始反向传播。</div>\n<p><strong>核心机制：虚拟阶段与交错调度</strong></p>\n<p>Interleaved 1F1B 的核心思想是：<strong>将每个设备分配多个非连续的模型层（model chunks）</strong>，从而创建更多但更小的虚拟流水线阶段。</p>\n<p>具体地，假设模型有 <span class=\"kb-math kb-math-inline\">L</span> 层，流水线并行度为 <span class=\"kb-math kb-math-inline\">p</span>，每个设备持有 <span class=\"kb-math kb-math-inline\">v</span> 个 model chunks：\n- 总虚拟阶段数 = <span class=\"kb-math kb-math-inline\">v \\times p</span>\n- 每个 chunk 包含 <span class=\"kb-math kb-math-inline\">\\frac{L}{v \\times p}</span> 层\n- 设备 <span class=\"kb-math kb-math-inline\">i</span> 持有阶段：<span class=\"kb-math kb-math-inline\">i,\\ i+p,\\ i+2p,\\ \\ldots,\\ i+(v-1)p</span></p>\n<p>例如，当 <span class=\"kb-math kb-math-inline\">p=4, v=2</span> 时：\n- Device 0 持有 Stage 0 和 Stage 4\n- Device 1 持有 Stage 1 和 Stage 5\n- Device 2 持有 Stage 2 和 Stage 6\n- Device 3 持有 Stage 3 和 Stage 7</p>\n<p>微批次按照虚拟阶段顺序 0→1→2→...→7 流动，但由于设备 0 同时持有 Stage 0 和 Stage 4，它会在处理完 Stage 0 的前向后，等待数据回到自己时再处理 Stage 4 的前向。这种交错使得流水线的\"深度\"在逻辑上不变，但每个阶段的计算量变为原来的 <span class=\"kb-math kb-math-inline\">\\frac{1}{v}</span>，因此填充和排空时间也缩短为原来的 <span class=\"kb-math kb-math-inline\">\\frac{1}{v}</span>：</p>\n<div class=\"kb-math kb-math-display\">\\text{Bubble fraction (interleaved)} = \\frac{1}{v} \\cdot \\frac{p-1}{m}</div>\n<div class=\"warn-box\">⚠️ 注意：这里的关键约束是微批次数量 <span class=\"kb-math kb-math-inline\">m</span> 必须是 <span class=\"kb-math kb-math-inline\">p</span> 的整数倍，以确保调度的均匀性。</div>\n<p><strong>通信开销分析</strong></p>\n<p>交错调度的代价是通信量增加。在 default schedule 中，每个微批次在相邻设备间传递一次激活张量（前向）和一次梯度张量（反向），共 <span class=\"kb-math kb-math-inline\">2 \\times (p-1)</span> 次点对点通信。在 interleaved schedule 中，由于虚拟阶段数变为 <span class=\"kb-math kb-math-inline\">v \\times p</span>，通信次数变为 <span class=\"kb-math kb-math-inline\">2 \\times v \\times (p-1)</span>，即增加 <span class=\"kb-math kb-math-inline\">v</span> 倍。</p>\n<p>然而，论文指出这一额外通信可以通过以下方式缓解：\n1. <strong>节点内高带宽互联</strong>：将 Tensor 并行放在节点内（NVLink），Pipeline 并行跨节点，利用 DGX A100 的 8 块 InfiniBand 网卡\n2. <strong>通信-计算重叠</strong>：点对点通信可与其他设备上的计算并行执行\n3. <strong>散射/聚集优化</strong>：将多个小消息合并为大消息传输</p>\n<p><strong>与传统方法的对比</strong></p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>特性</th>\n<th>GPipe</th>\n<th>Default 1F1B</th>\n<th>Interleaved 1F1B</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>气泡比例</td>\n<td><span class=\"kb-math kb-math-inline\">\\frac{p-1}{m}</span></td>\n<td><span class=\"kb-math kb-math-inline\">\\frac{p-1}{m}</span></td>\n<td><span class=\"kb-math kb-math-inline\">\\frac{p-1}{m \\cdot v}</span></td>\n</tr>\n<tr>\n<td>激活内存</td>\n<td><span class=\"kb-math kb-math-inline\">O(m)</span></td>\n<td><span class=\"kb-math kb-math-inline\">O(p)</span></td>\n<td><span class=\"kb-math kb-math-inline\">O(p)</span></td>\n</tr>\n<tr>\n<td>通信量</td>\n<td>基准</td>\n<td>基准</td>\n<td><span class=\"kb-math kb-math-inline\">v</span> 倍</td>\n</tr>\n<tr>\n<td>微批次约束</td>\n<td>无</td>\n<td>无</td>\n<td><span class=\"kb-math kb-math-inline\">m \\mod p = 0</span></td>\n</tr>\n<tr>\n<td>每设备层数</td>\n<td>连续 <span class=\"kb-math kb-math-inline\">\\frac{L}{p}</span> 层</td>\n<td>连续 <span class=\"kb-math kb-math-inline\">\\frac{L}{p}</span> 层</td>\n<td><span class=\"kb-math kb-math-inline\">v</span> 个非连续块，每块 <span class=\"kb-math kb-math-inline\">\\frac{L}{vp}</span> 层</td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>实际部署策略（PTD-P）</strong></p>\n<p>论文提出 PTD-P（Pipeline, Tensor, Data Parallelism）组合策略：\n- <strong>Tensor 并行</strong>（<span class=\"kb-math kb-math-inline\">t</span>）：节点内，利用 NVLink 高带宽（600 GB/s on A100）\n- <strong>Pipeline 并行</strong>（<span class=\"kb-math kb-math-inline\">p</span>）：跨节点，使用 Interleaved 1F1B，通信量相对较小\n- <strong>Data 并行</strong>（<span class=\"kb-math kb-math-inline\">d</span>）：跨节点，梯度 all-reduce 可与计算重叠</p>\n<p>总 GPU 数 <span class=\"kb-math kb-math-inline\">n = p \\times t \\times d</span>。实验表明在 3072 块 A100 GPU 上训练 1T 参数模型可达 52% 峰值 FLOPS 利用率。</p>",
      "quiz": {
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>ZB-H1 手工调度</strong>：与 1F1B 相同峰值内存（<span class=\"kb-math kb-math-inline\">p \\cdot M_B</span>），气泡从 <span class=\"kb-math kb-math-inline\">(p-1)T_F</span> 降至 <span class=\"kb-math kb-math-inline\">(p-1)(T_F - T_W)/3</span>",
        "<strong>ZB-H2 手工调度</strong>：峰值内存 <span class=\"kb-math kb-math-inline\">(2p-1)M_B</span>，理论零气泡（当 <span class=\"kb-math kb-math-inline\">T_F = T_B = T_W</span>）",
        "<strong>ZB-V 调度</strong>：V 形模型分块策略，在 1F1B 同等内存下实现接近零气泡",
        "<strong>自动调度算法</strong>：启发式 + ILP 联合优化，输入 <span class=\"kb-math kb-math-inline\">T_F, T_B, T_W, T_{\\text{comm}}</span> 和内存限制，自动搜索最优调度",
    ...
    },
    {
      ...
      "summary": "Mist 是一个 memory、overlap、imbalance aware 的自动分布式训练系统，联合搜索数据/张量/流水线并行和 activation checkpointing、冗余消除、offload 等内存优化，解决手工 3D 并行配置忽略重叠与 microbatch 不均衡的问题。",
      "keyPoints": [
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"Mist 系统概览\" src=\"https://ar5iv.labs.arxiv.org/html/2503.19050/assets/x1.png\" />\n<em>图：Mist 将并行配置、内存优化、性能建模和层次化搜索组织成自动训练配置系统。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># high-level Mist tuner\ndef mist_search(model, cluster, memory_budget):\n    profiles = symbolic_profile(model, cluster)\n    pareto_by_stage = []\n\n    for stage in candidate_pipeline_stages(model):\n        local_candidates = []\n        for tp, dp, checkpoint, offload, zero in enumerate_local_plans(stage):\n            schedule = overlap_centric_schedule(stage, tp, checkpoint, offload, zero)\n            time = symbolic_time(schedule, profiles)\n            memory = symbolic_memory(schedule, profiles)\n            if memory &lt;= memory_budget:\n                local_candidates.append((schedule, time, memory))\n        pareto_by_stage.append(pareto_frontier(local_candidates))\n\n    global_plan = solve_milp_for_pipeline_balance(pareto_by_stage)\n    return instantiate_training_plan(global_plan)\n</code></pre>\n<h5>方法解释</h5>\n<p>大模型训练系统通常把问题拆开处理：先由工程师决定 DP/TP/PP，再选择是否 activation checkpoint、是否 ZeRO、是否 offload。Mist 指出这种流程会漏掉关键相互作用。例如 checkpoint 节省显存但增加重算，如果重算能被 pipeline bubble 或通信隐藏，实际开销就很小；反之，如果它落在 critical path 上，显存节省会直接换成吞吐下降。</p>\n<p>Mist 的第一个设计是细粒度 overlap-centric scheduling。它把内存优化不再看成“开/关选项”，而是看成可调度操作：重算可以放在反向所需激活之前，CPU/NVMe offload 可以提前 prefetch，ZeRO/DP 通信可以与相邻层计算重叠。调度器的目标不是单纯减少每个操作时间，而是最小化未被隐藏的暴露时间。</p>\n<p>第二个设计是符号化建模。对某个层或 stage，Mist 以符号表达式描述计算、通信、重算、offload 和显存峰值，例如：</p>\n<div class=\"kb-math kb-math-display\">T_{\\text{stage}}=\\max(T_{\\text{compute}}, T_{\\text{comm}}^{\\text{hidden}} + T_{\\text{comm}}^{\\text{exposed}}) + T_{\\text{recompute}}^{\\text{exposed}}</div>\n<p>显存侧则累加参数、梯度、优化器状态、激活检查点、通信 buffer 和 offload staging buffer。符号模型的好处是搜索时可以快速替换 batch size、TP 度、PP 切分、checkpoint 粒度，而不用为每个候选计划完整训练几步。</p>\n<div class=\"key-point\">💡 关键：Mist 的“memory-parallelism co-optimization”不是多加一个搜索维度，而是把显存节省、通信重叠和 pipeline 负载均衡放进同一个目标函数。</div>\n<p>第三个设计是层次化搜索。完整空间包含层切分、stage 数、TP/DP 度、microbatch 数、checkpoint/offload 策略，直接穷举不可行。Mist 先在 stage 内生成多种满足显存约束的 Pareto 候选，再用 MILP 在 stage 间组合这些候选，使每个 pipeline stage 的时间接近，减少 inter-microbatch imbalance。这个设计与 Zero Bubble 的动机相邻，但 Mist 更强调自动地为每个 stage 选择不同的内存优化和并行组合。</p>\n<h5>与传统自动并行的区别</h5>\n<p>早期自动并行系统通常优化算子切分或 3D 并行配置，内存优化要么固定，要么只用 activation checkpointing 的粗粒度策略。Mist 则把 offload、checkpoint、ZeRO-like redundancy elimination 与并行策略一起建模，并显式区分 hidden overhead 和 exposed overhead。因此同样的 checkpoint 开销在不同 pipeline stage 上可能被选择或放弃，体现出系统级协同。</p>",
      "quiz": {
        "q": "Mist 为什么需要 overlap-aware 的性能模型？",
        "options": [
          "因为所有通信都不能和计算并行",
    ...
    },
    {
      ...
      "summary": "Deep Gradient Compression 通过 Top-k 梯度稀疏化配合动量校正、局部梯度裁剪、动量因子掩码和 warm-up，在不明显损失精度的情况下将分布式 SGD 的梯度通信压缩到 0.1% 量级。",
      "keyPoints": [
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"DGC 梯度压缩效果概览\" src=\"https://ar5iv.labs.arxiv.org/html/1712.01887/assets/x1.png\" />\n<em>图：DGC 通过极高稀疏率显著降低每轮需要传输的梯度数据量。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># Deep Gradient Compression on each worker\nfor step in range(T):\n    g = backward(model, batch)\n    g = local_gradient_clip(g, clip_norm)\n\n    # momentum correction: momentum is accumulated before sparsification\n    u = momentum * u + g\n    v = v + u                       # residual / gradient accumulation\n\n    mask = abs(v) &gt;= topk_threshold(abs(v), k)\n    sparse_update = v[mask]\n    all_reduce_sparse(mask, sparse_update)\n\n    # clear transmitted coordinates, keep unsent residuals\n    v[mask] = 0\n    u[mask] = 0                     # momentum factor masking\n    optimizer_apply(aggregated_sparse_update)\n</code></pre>\n<h5>方法解释</h5>\n<p>朴素 Top-k 梯度压缩的问题是收敛容易掉点。若每轮只发送最大的 <span class=\"kb-math kb-math-inline\">k</span> 个坐标，其余梯度被直接丢弃，优化方向会系统性偏向“短期大幅变化”的参数。DGC 保留本地残差 <span class=\"kb-math kb-math-inline\">v_t</span>，未发送的坐标继续累积，直到其幅度足够大再发送。这相当于 error feedback：</p>\n<div class=\"kb-math kb-math-display\">v_t = v_{t-1} + g_t,\\quad \\Delta_t = \\mathrm{TopK}(v_t),\\quad v_t \\leftarrow v_t - \\Delta_t</div>\n<p>动量校正进一步解决 momentum SGD 的特殊问题。标准动量为 <span class=\"kb-math kb-math-inline\">u_t = m u_{t-1}+g_t</span>，如果先稀疏化 <span class=\"kb-math kb-math-inline\">g_t</span> 再更新动量，未发送坐标的动量会被破坏。DGC 先在本地计算完整动量，再对动量累积量做 Top-k，这让稀疏更新更接近未压缩 SGD 的轨迹。</p>\n<p>局部梯度裁剪和 momentum factor masking 是稳定性补丁。前者防止单个 worker 的异常 batch 产生过大的稀疏坐标，后者在某坐标已经发送后清除该坐标的动量项，避免同一方向的旧动量在下一轮重复触发发送。Warm-up 则从较低压缩率逐步提高到目标稀疏率，使训练早期还未稳定的表示不会被过强压缩扰动。</p>\n<div class=\"warn-box\">⚠️ 注意：DGC 的通信省的是带宽，不是完全消除同步。每轮仍要交换稀疏索引和值，并且各 worker 的 Top-k 索引可能不同，因此实现通常比 dense all-reduce 更复杂。</div>\n<h5>与传统方法的区别</h5>\n<p>梯度量化方法降低每个坐标的 bit 数，DGC 则减少坐标数量；参数服务器式稀疏更新容易受中心节点瓶颈影响，DGC 面向数据并行训练的梯度交换过程；随机丢弃梯度虽然便宜，但没有 Top-k 的重要性选择。DGC 的贡献在于把 Top-k 稀疏化与优化器状态修正结合，使 270x 到 600x 压缩率在 CNN、RNN 和语言模型任务上仍能维持精度。</p>",
      "quiz": {
        "q": "DGC 中 momentum factor masking 的作用是什么？",
        "options": [
          "把所有未发送梯度立即置零",
    ...
    },
    {
      ...
      "keyPoints": [
        "<strong>无偏稀疏化机制</strong>：以概率 <span class=\"kb-math kb-math-inline\">\\pi_i</span> 保留梯度第 <span class=\"kb-math kb-math-inline\">i</span> 个坐标，保留后放大 <span class=\"kb-math kb-math-inline\">1/\\pi_i</span> 倍，确保稀疏化梯度的期望等于原始梯度",
        "<strong>凸优化建模</strong>：将最优采样概率的选取形式化为在方差预算约束下最小化期望稀疏度的凸优化问题",
        "<strong>最优解闭式形式</strong>：最优概率 <span class=\"kb-math kb-math-inline\">\\pi_i^* = \\min(\\lambda |g_i|, 1)</span>，即按梯度绝对值成比例采样，大分量必保留、小分量按比例随机丢弃",
        "<strong>(<span class=\"kb-math kb-math-inline\">\\rho</span>, s)-近似稀疏性</strong>：提出近似稀疏性概念，证明期望稀疏度 ≤ <span class=\"kb-math kb-math-inline\">(1+\\rho)s</span>，方差增加因子仅为 <span class=\"kb-math kb-math-inline\">(1+\\rho)</span>",
        "<strong>编码长度理论界</strong>：证明通信比特数上界为 <span class=\"kb-math kb-math-inline\">s(b + \\log_2 d) + \\min(\\rho s \\cdot \\log_2 d,\\; d) + b</span>",
        "<strong>高效近似算法</strong>：提出 Algorithm 2（闭式精确解）和 Algorithm 3（贪心迭代近似），计算复杂度为 <span class=\"kb-math kb-math-inline\">O(d \\log d)</span>",
        "<strong>实验验证</strong>：在凸问题（逻辑回归 + SVRG）和非凸问题（CNN/CIFAR-10）上均验证有效性，稀疏率可达 0.4% 仍收敛"
      ],
      "detail": "<p><img alt=\"Gradient Sparsification 概念示意\" src=\"https://arxiv.org/abs/1710.09854\" />\n<em>图（参见论文 Figure 1-2）：梯度稀疏化的核心思想。左：均匀采样对所有坐标一视同仁；右：最优稀疏化按 <span class=\"kb-math kb-math-inline\">|g_i|</span> 成比例采样，大分量必保留、小分量随机丢弃。在相同稀疏度下，最优方案的方差显著低于均匀采样。</em></p>\n<pre><code class=\"language-python\"># Algorithm 1: 同步分布式 SGD + 梯度稀疏化\ndef distributed_sgd_with_sparsification(workers, T, rho):\n    w = initialize_parameters()\n    for t in range(T):\n        sparse_grads = []\n        for worker in workers:\n            g = worker.compute_stochastic_gradient(w)\n            # 最优稀疏化: pi_i = min(lambda * |g_i|, 1)\n            pi = compute_optimal_probability(g, rho)\n            # 随机采样坐标\n            mask = bernoulli_sample(pi)  # mask[i] ~ Bernoulli(pi[i])\n            g_sparse = mask * g / pi     # 放大保持无偏: E[g_sparse] = g\n            sparse_grads.append(g_sparse)\n        # Server 聚合 (仅传输非零坐标)\n        w = w - lr * average(sparse_grads)\n    return w\n\n# Algorithm 2: 最优概率的闭式求解\ndef compute_optimal_probability(g, rho):\n    &quot;&quot;&quot;找到最小的 k 使得 sum_{i&gt;k} |g_i| / (d - k) 满足约束&quot;&quot;&quot;\n    d = len(g)\n    abs_g = sorted(abs(g), reverse=True)  # 降序排列\n    # 找最小 k: |g_{k+1}| &lt;= (1/lambda) = sum_{i&gt;k}|g_i| / (d-k)\n    for k in range(d):\n        threshold = sum(abs_g[k+1:]) / (d - k)  # 即 1/lambda\n        if abs_g[k] &lt;= threshold or k == d - 1:\n            break\n    # pi_i = min(lambda * |g_i|, 1)\n    lam = 1.0 / threshold if threshold &gt; 0 else float('inf')\n    pi = [min(lam * abs(g[i]), 1.0) for i in range(d)]\n    return pi\n</code></pre>\n<p><strong>动机与背景</strong></p>\n<p>在大规模分布式深度学习中，多个 Worker 需要频繁同步梯度信息，通信开销往往成为训练的主要瓶颈。尤其当模型参数维度 <span class=\"kb-math kb-math-inline\">d</span> 极高（如数亿参数）时，每轮迭代传输完整的 <span class=\"kb-math kb-math-inline\">d</span> 维梯度向量代价巨大。现有方法如梯度量化（QSGD）通过降低每个坐标的比特数来压缩通信，但未减少传输的坐标数量。本文从另一个正交角度出发——<strong>减少传输的坐标数量本身</strong>，即梯度稀疏化。核心挑战在于：如何在大幅减少传输坐标数的同时，保证稀疏化梯度仍是原始梯度的无偏估计，且方差增加可控？</p>\n<p><strong>核心机制：无偏随机稀疏化</strong></p>\n<p>本文提出的稀疏化算子 <span class=\"kb-math kb-math-inline\">Q(g)</span> 对梯度向量 <span class=\"kb-math kb-math-inline\">g \\in \\mathbb{R}^d</span> 的每个坐标 <span class=\"kb-math kb-math-inline\">i</span> 独立操作：以概率 <span class=\"kb-math kb-math-inline\">\\pi_i</span> 保留该坐标，保留时将其值放大为 <span class=\"kb-math kb-math-inline\">g_i / \\pi_i</span>；以概率 <span class=\"kb-math kb-math-inline\">1 - \\pi_i</span> 将其置零。形式化地：</p>\n<div class=\"kb-math kb-math-display\">Q(g)_i = \\begin{cases} g_i / \\pi_i &amp; \\text{以概率 } \\pi_i \\\\ 0 &amp; \\text{以概率 } 1 - \\pi_i \\end{cases}</div>\n<p>容易验证 <span class=\"kb-math kb-math-inline\">\\mathbb{E}[Q(g)_i] = \\pi_i \\cdot g_i/\\pi_i + (1-\\pi_i) \\cdot 0 = g_i</span>，即无偏性成立。稀疏化引入的额外方差为：</p>\n<div class=\"kb-math kb-math-display\">\\text{Var}(Q(g)_i) = \\frac{1-\\pi_i}{\\pi_i} g_i^2</div>\n<p>总方差为 <span class=\"kb-math kb-math-inline\">\\sum_{i=1}^d \\frac{1-\\pi_i}{\\pi_i} g_i^2</span>。显然，<span class=\"kb-math kb-math-inline\">\\pi_i</span> 越大方差越小但稀疏度越低，需要在两者间取得最优平衡。</p>\n<p><strong>最优概率的凸优化求解</strong></p>\n<p>作者将最优稀疏化形式化为如下凸优化问题：在给定方差预算 <span class=\"kb-math kb-math-inline\">V</span> 的约束下，最小化期望编码长度（即期望非零坐标数）：</p>\n<div class=\"kb-math kb-math-display\">\\min_{\\pi \\in [0,1]^d} \\sum_{i=1}^d \\pi_i \\quad \\text{s.t.} \\quad \\sum_{i=1}^d \\frac{1-\\pi_i}{\\pi_i} g_i^2 \\leq V</div>\n<p>通过 KKT 条件求解，最优解具有优美的闭式形式：</p>\n<div class=\"kb-math kb-math-display\">\\pi_i^* = \\min(\\lambda |g_i|, 1)</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">\\lambda</span> 是拉格朗日乘子，由约束条件确定。这一结果的直觉非常清晰：<strong>梯度绝对值大的坐标更重要，应以更高概率保留</strong>；当 <span class=\"kb-math kb-math-inline\">\\lambda|g_i| \\geq 1</span> 时该坐标必定保留（<span class=\"kb-math kb-math-inline\">\\pi_i = 1</span>）。这与简单的均匀随机采样（<span class=\"kb-math kb-math-inline\">\\pi_i = k/d</span>）形成鲜明对比——均匀采样对所有坐标一视同仁，忽略了梯度分量的异质性，导致在相同稀疏度下方差更大。</p>\n<div class=\"key-point\">💡 关键直觉：最优稀疏化本质上是一种\"重要性采样\"——按梯度绝对值分配保留概率，使得信息损失最小化。</div>\n<p><strong>(<span class=\"kb-math kb-math-inline\">\\rho</span>, s)-近似稀疏性与理论保证</strong></p>\n<p>为了分析算法的通信效率，作者引入了 (<span class=\"kb-math kb-math-inline\">\\rho</span>, s)-近似稀疏性的概念：如果梯度向量 <span class=\"kb-math kb-math-inline\">g</span> 最多有 <span class=\"kb-math kb-math-inline\">s</span> 个坐标的绝对值超过 <span class=\"kb-math kb-math-inline\">\\|g\\|_1 / d</span>（即超过均值），则称 <span class=\"kb-math kb-math-inline\">g</span> 是 <span class=\"kb-math kb-math-inline\">s</span>-稀疏的。对于 (<span class=\"kb-math kb-math-inline\">\\rho</span>, s)-近似稀疏的梯度，Algorithm 3 的贪心解保证：</p>\n<ul>\n<li>期望稀疏度（非零坐标数）≤ <span class=\"kb-math kb-math-inline\">(1+\\rho)s</span></li>\n<li>方差增加因子 ≤ <span class=\"kb-math kb-math-inline\">(1+\\rho)</span>（相比不稀疏化的原始 SGD）</li>\n</ul>\n<p>这意味着当梯度本身具有近似稀疏结构时（在深度学习中普遍成立），通信量可以从 <span class=\"kb-math kb-math-inline\">O(d)</span> 降低到 <span class=\"kb-math kb-math-inline\">O(s)</span>，而收敛速度仅减慢 <span class=\"kb-math kb-math-inline\">(1+\\rho)</span> 倍。Theorem 4 进一步给出了编码长度的精确上界：</p>\n<div class=\"kb-math kb-math-display\">\\text{Coding Length} \\leq s(b + \\log_2 d) + \\min(\\rho s \\cdot \\log_2 d,\\; d) + b</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">b</span> 是每个非零值的量化比特数。当 <span class=\"kb-math kb-math-inline\">\\rho s \\ll d</span> 时，通信量远小于传输完整梯度所需的 <span class=\"kb-math kb-math-inline\">d \\cdot b</span> 比特。</p>\n<p><strong>实验验证与关键发现</strong></p>\n<p>在凸优化实验中（<span class=\"kb-math kb-math-inline\">\\ell_2</span> 正则化逻辑回归），作者比较了最优稀疏化（GSpar）与均匀采样（Uniform）在相同稀疏度下的表现。结果表明 GSpar 在所有稀疏率下均具有更低的方差和更快的收敛速度，且在 SVRG 方差缩减框架下同样有效。在非凸实验中（3层 CNN/CIFAR-10），即使稀疏率低至 <span class=\"kb-math kb-math-inline\">\\rho = 0.004</span>（仅保留 0.4% 的坐标），模型仍能正常收敛，通信量减少超过 250 倍。作者指出神经网络优化对梯度噪声具有天然鲁棒性，适度噪声甚至有助于逃离局部极小值。</p>",
      "quiz": {
    ...
    },
    {
      ...
      "summary": "ScaleCom 提出 Cyclic Local Top-k (CLT-k) 与残差低通滤波，把稀疏梯度压缩改造成可交换、可 all-reduce 的形式，解决大规模 worker 下 Top-k 稀疏索引发散导致的 gradient build-up。",
      "keyPoints": [
        "<code>paper_url</code> 对应的 arXiv 2004.13334 不是 ScaleCom 论文；本文基于 NeurIPS 2020 官方论文与 IBM/ arXiv 2104.11125 版本精读，YAML 保持 worker prompt 元信息不变。",
        "传统本地 Top-k 每个 worker 选择不同坐标，聚合后非零坐标接近 <span class=\"kb-math kb-math-inline\">nk</span>，压缩率随 worker 数增加快速下降。",
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"ScaleCom gradient build-up 与 CLT-k 示意\" src=\"https://ar5iv.labs.arxiv.org/html/2104.11125/assets/intro.png\" />\n<em>图：arXiv 2104.11125 版本中的 ScaleCom 总览图，展示传统 Top-k 的 gradient build-up 以及 CLT-k 统一索引后可直接稀疏归约的思路。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># ScaleCom / CLT-k on worker i\nmemory_i = zeros_like(theta)\n\nfor t in range(1, T + 1):\n    grad_i = backward(theta, minibatch_i)\n    p_i = memory_i + grad_i\n\n    leader = t % world_size\n    if rank == leader:\n        index = topk_indices(abs(p_i), k)\n    index = broadcast(index, src=leader)\n\n    # all workers compress with the same index set\n    sparse_i = gather(p_i, index)\n    sparse_avg = all_reduce_sum(sparse_i) / world_size\n\n    g_i = scatter_like(theta, index, sparse_avg)\n    residual_i = p_i - scatter_like(theta, index, gather(p_i, index))\n    memory_i = (1 - beta) * memory_i + beta * residual_i\n\n    theta = theta - lr * g_i\n</code></pre>\n<h5>方法机制解读</h5>\n<p>ScaleCom 的起点是一个系统问题，而不只是压缩算子问题。Top-k SGD 在单机或少量 worker 下可以只发送 <span class=\"kb-math kb-math-inline\">k</span> 个最大幅值坐标，但在同步分布式训练中，每个 worker 的 Top-k 索引集合通常不同。若第 <span class=\"kb-math kb-math-inline\">i</span> 个 worker 的索引为 <span class=\"kb-math kb-math-inline\">I_i</span>，聚合后的稀疏集合是 <span class=\"kb-math kb-math-inline\">\\cup_i I_i</span>，其大小会从 <span class=\"kb-math kb-math-inline\">k</span> 膨胀到接近 <span class=\"kb-math kb-math-inline\">nk</span>。这就是论文称为 gradient build-up 的现象：压缩后的数据可以 gather，却很难像 dense tensor 一样 reduce，最终通信量随 worker 数线性增长。</p>\n<p>CLT-k 利用论文观察到的 worker 间 residual memory 相似性，把“每个 worker 自己选 Top-k”改成“所有 worker 跟随一个 leader 的 Top-k”。令 <span class=\"kb-math kb-math-inline\">I_k(x_\\ell)</span> 是 leader <span class=\"kb-math kb-math-inline\">\\ell</span> 的 Top-k 坐标集合，CLT-k 对任意 worker 向量 <span class=\"kb-math kb-math-inline\">x_j</span> 的定义为：</p>\n<div class=\"kb-math kb-math-display\">[\\mathrm{CLT}^k_\\ell(x_j)]_m =\n\\begin{cases}\n(x_j)_m, &amp; m \\in I_k(x_\\ell) \\\\\n0, &amp; \\text{otherwise}\n\\end{cases}</div>\n<p>因为所有 worker 使用同一个 mask，压缩与求和可以交换：</p>\n<div class=\"kb-math kb-math-display\">\\frac{1}{n}\\sum_{j=1}^{n}\\mathrm{CLT}^k_\\ell(x_j)\n=\n\\mathrm{CLT}^k_\\ell\\left(\\frac{1}{n}\\sum_{j=1}^{n}x_j\\right)</div>\n<p>这正是它能接入 all-reduce 的关键。实际实现中只需要广播 leader 的索引集合，再对这些坐标上的数值执行 collective reduction；布局一致后，不再需要为每个 worker 的不同坐标做昂贵的 gather/scatter 式合并。</p>\n<p>低通滤波处理的是大 batch 训练的第二个问题：为了保持吞吐，分布式训练往往线性放大学习率，而 error feedback memory 会因此积累更强的高频噪声，降低不同 worker 的 Top-k 重叠。ScaleCom 用带折扣的 residual memory 替代标准 error feedback：</p>\n<div class=\"kb-math kb-math-display\">p_i^t = m_i^t + \\nabla f_{B_i}(\\theta^t), \\quad\ng_i^t = \\mathrm{CLT}^k_{t \\bmod n}(p_i^t)</div>\n<div class=\"kb-math kb-math-display\">m_i^{t+1}=(1-\\beta)m_i^t+\\beta(p_i^t-g_i^t), \\quad 0 &lt; \\beta \\le 1</div>\n<p>当 <span class=\"kb-math kb-math-inline\">\\beta=1</span> 时，它退化为普通残差累积；当 <span class=\"kb-math kb-math-inline\">\\beta&lt;1</span> 时，历史残差被平滑衰减，能减少学习率放大带来的突变，使 leader 的 Top-k 更可能代表全局 Top-k。直觉上，CLT-k 让通信结构可扩展，低通滤波则让这个共享索引假设在大 batch 噪声下仍然成立。</p>\n<p>论文的理论分析把 CLT-k 的有效性与 Top-k 索引重叠联系起来。若真实 Top-k 集合与 leader Top-k 集合的 Hamming 距离为 <span class=\"kb-math kb-math-inline\">2d</span>，并且标准 Top-k 的收缩系数为 <span class=\"kb-math kb-math-inline\">\\rho_0</span>，则 CLT-k 的收缩系数可写成：</p>\n<div class=\"kb-math kb-math-display\">\\rho \\le \\frac{d}{k}+\\left(1-\\frac{d}{k}\\right)\\rho_0</div>\n<p>只要重叠不是太差，即 <span class=\"kb-math kb-math-inline\">d&lt;k</span>，就有 <span class=\"kb-math kb-math-inline\">\\rho&lt;1</span>，压缩误差仍可控。进一步在随机梯度有界方差等假设下，ScaleCom 给出与分布式 SGD 类似的平均梯度范数收敛阶：</p>\n<div class=\"kb-math kb-math-display\">\\frac{1}{T}\\sum_{t=1}^{T}\\mathbb{E}\\|\\nabla f(\\theta^t)\\|^2\n= O\\left(\\frac{1}{\\sqrt{nT}}\\right)</div>\n<p>这说明 CLT-k 不是仅靠经验 trick 工作：它把“worker 残差相似”转化为索引重叠，再通过收缩性保证压缩 SGD 的收敛。</p>\n<div class=\"key-point\">💡 关键：ScaleCom 不追求每个 worker 的局部 Top-k 最优，而是追求一个全局通信友好的共同稀疏子空间；在大规模训练中，可归约性比单个 worker 的 Top-k 精确性更重要。</div>\n<h5>与普通 Top-k / DGC 的区别</h5>\n<p>普通 Top-k 与 DGC 更关注如何在压缩后保留优化精度，例如 error feedback、动量修正和 warm-up；ScaleCom 进一步把 collective 通信原语纳入算法设计。它让所有 worker 发送相同坐标上的值，因此压缩梯度可以像 dense tensor 一样归约。这个设计牺牲少量局部选择自由度，换取了通信复杂度不随 worker 数爆炸，适合 IBM 论文目标中的大规模同步训练场景。</p>",
      "quiz": {
        "q": "ScaleCom 的 CLT-k 为什么能缓解 gradient build-up？",
        "options": [
    ...
    },
    {
      ...
      "summary": "8-bit Optimizers 用块级动态量化保存 Adam/AdaGrad/momentum 的优化器状态，解决大模型训练中优化器状态占用显存远超参数本身的问题，同时保持接近 32-bit 优化器的收敛表现。",
      "keyPoints": [
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"8-bit Optimizers 块量化示意\" src=\"https://ar5iv.labs.arxiv.org/html/2110.02861/assets/x1.png\" />\n<em>图：论文展示 8-bit optimizer state 通过块级量化降低内存占用，并在反量化后参与标准优化器更新。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># 8-bit Adam update with block-wise quantized states\nfor param, grad in model.parameters():\n    m = dequantize(state_m8[param], scale_m[param])\n    v = dequantize(state_v8[param], scale_v[param])\n\n    m = beta1 * m + (1 - beta1) * grad\n    v = beta2 * v + (1 - beta2) * grad * grad\n    update = m / (sqrt(v) + eps)\n    param -= lr * update\n\n    state_m8[param], scale_m[param] = blockwise_quantize_dynamic(m, block_size=2048)\n    state_v8[param], scale_v[param] = blockwise_quantize_dynamic(v, block_size=2048)\n</code></pre>\n<h5>方法解释</h5>\n<p>Adam 的显存瓶颈来自优化器状态。混合精度训练中，参数可用 fp16/bf16，但 Adam 通常仍保存 fp32 的一阶动量 <span class=\"kb-math kb-math-inline\">m_t</span>、二阶动量 <span class=\"kb-math kb-math-inline\">v_t</span>，有时还保存 fp32 master weight。对大模型来说，优化器状态可能是参数显存的数倍，限制最大模型规模和 batch size。</p>\n<p>直接把 <span class=\"kb-math kb-math-inline\">m_t,v_t</span> 线性量化到 8-bit 会遇到 outlier 问题：若整张量共享一个 scale，少数极大值会压缩绝大多数小值的分辨率。论文采用 block-wise quantization，把张量分成固定大小块，每块独立统计 scale：</p>\n<div class=\"kb-math kb-math-display\">q_i = \\mathrm{round}\\left(\\frac{x_i}{s_b}\\right), \\quad s_b=\\frac{\\max_{j \\in b}|x_j|}{127}</div>\n<p>这样 outlier 只影响所在 block。动态量化进一步使用非线性码本，让靠近 0 的值拥有更密集的表示，因为优化器状态中大量元素幅值较小但对更新方向仍重要。</p>\n<p>语言模型还需要 stable embedding。输入 token 频率高度不均匀，常见 token 的 embedding 梯度统计与稀有 token 差异很大，量化状态更容易不稳定。Stable embedding 将 embedding 的归一化和初始化做得更保守，降低梯度方差，使 8-bit state 不会在训练早期被异常更新破坏。</p>\n<div class=\"key-point\">💡 关键：8-bit Optimizers 并不是把前向/反向计算都变成 8-bit，而是只压缩优化器历史统计量；计算更新时仍可反量化到较高精度。</div>\n<h5>与通信压缩的关系</h5>\n<p>它在任务分类中属于 <code>comm</code>，但核心收益更偏显存：减小 optimizer state 后，单 GPU 可容纳更大模型或 batch，分布式训练中也能减少 ZeRO/offload 需要搬运的状态量。与 DGC/ScaleCom 压缩每轮梯度通信不同，8-bit Optimizers 压缩的是跨 step 保存的优化器状态，通常与梯度 all-reduce、ZeRO 和 activation checkpointing 互补。</p>",
      "quiz": {
        "q": "8-bit Optimizers 为什么采用 block-wise quantization？",
        "options": [
    ...
    },
    {
      ...
      "summary": "CoCoNet 将分布式训练中的计算和通信都提升为 DSL 的一等操作，通过编译器做融合、分解和重排，解决深度学习框架把 GEMM/update 与 all-reduce/all-gather 分开后错失跨边界优化的问题。",
      "keyPoints": [
        "任务中的 <code>paper_url</code> 与 CoCoNet 论文不匹配；本文基于 Microsoft Research 页面、官方仓库和真实 arXiv <code>https://arxiv.org/abs/2105.05720</code> 完成，YAML 保持任务元信息不变。",
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"CoCoNet 编译流程图\" src=\"https://ar5iv.labs.arxiv.org/html/2105.05720/assets/x2.png\" />\n<em>图：CoCoNet 将包含计算与通信的高层 DSL 程序变换为定制 CUDA/NCCL 执行代码。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-cpp\">// CoCoNet-style SGD program\nVariable N(Int32, &quot;N&quot;);\nVariable lr(Float32, &quot;lr&quot;);\nTensor g(Float32, N, Local, &quot;g&quot;);       // each worker has local gradients\nTensor w(Float32, N, Replicated, &quot;w&quot;);  // all workers keep same weights\n\nStage g1 = AllReduce(Summation, g);\nStage w1 = Update(w, w - lr * g1);\n\nPipeline pipeline({g, w, lr}, {w1});\npipeline.codegen(&quot;sgd-ar-c.cu&quot;);\n</code></pre>\n<h5>方法解释</h5>\n<p>传统深度学习框架把计算 kernel 和通信 collective 分开调度。比如数据并行 Adam 通常先 all-reduce 梯度，再启动 optimizer update kernel；模型并行层先 GEMM，再 all-reduce 或 all-gather。这种边界便于模块化，但会导致优化器看不到通信内部结构，通信库也看不到后续计算，无法做跨边界融合。</p>\n<p>CoCoNet 的 DSL 明确描述张量布局和操作语义。Local 表示每个 rank 拥有不同内容，Replicated 表示每个 rank 拥有相同内容，Sliced 表示张量按 rank 分片。基于这些 layout，编译器可以判断某个 Update 是否只需要分片数据，是否可以把 all-reduce 拆成 reduce-scatter + all-gather，或者是否可以把 reduce-scatter 后的本地更新融合到通信过程中。</p>\n<p>一个典型变换是把：</p>\n<div class=\"kb-math kb-math-display\">g&#x27;=\\mathrm{AllReduce}(g), \\quad w \\leftarrow w-\\eta g&#x27;</div>\n<p>改写为：</p>\n<div class=\"kb-math kb-math-display\">g_s=\\mathrm{ReduceScatter}(g), \\quad w_s \\leftarrow w_s-\\eta g_s,\\quad w=\\mathrm{AllGather}(w_s)</div>\n<p>如果权重更新能在每个分片上本地完成，通信量和临时内存都会下降；进一步融合时，编译器可以生成在通信 chunk 到达时立即做 update 的 kernel，从而减少单独 kernel launch 和全量 buffer 往返。</p>\n<div class=\"key-point\">💡 关键：CoCoNet 的创新不是某个新的 collective，而是让 compiler 同时理解“这段通信在数学上做什么”和“通信之后紧接着的计算是什么”。</div>\n<h5>与库级通信优化的区别</h5>\n<p>NCCL 优化单个 collective 的带宽和延迟，cuBLAS/cuDNN 优化单个计算 kernel；CoCoNet 关注二者之间的组合空间。与手工写 fused kernel 相比，DSL 方式可以把 data parallel、model parallel、pipeline parallel 的常见模式系统化表达，再由编译器应用语义保持变换。这种方法尤其适合训练系统中反复出现的 optimizer update、梯度同步、分片参数同步等模式。</p>",
      "quiz": {
        "q": "CoCoNet 为什么需要显式建模 Local/Replicated/Sliced 三种 tensor layout？",
        "options": [
    ...
    },
    {
      ...
      "summary": "ZeRO++ 在 ZeRO-3 的参数 all-gather、梯度 reduce-scatter 和跨节点分区通信上分别引入量化与层次化分区，把巨模型训练的通信量降低约 4 倍，缓解低带宽集群和小 per-GPU batch 下 ZeRO 通信暴露的问题。",
      "keyPoints": [
        "目标不是重新设计 ZeRO 的内存切分，而是降低 ZeRO-3 三类 collective 的通信体积和跨节点压力。",
        "<code>qwZ</code> 使用 block-based quantization 压缩前向/反向 all-gather 的权重分片。",
        "<code>hpZ</code> 采用 hierarchical partitioning，在节点内保留更多参数副本，以增加少量显存换取跨节点通信减少。",
        "<code>qgZ</code> 用量化梯度通信替代标准 reduce-scatter，通过 all-to-all 风格聚合保持训练精度。",
        "论文报告总体通信量约 4x 降低，在 384 GPU 规模最高 2.16x 吞吐提升。"
      ],
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"ZeRO++ 总览图\" src=\"https://ar5iv.labs.arxiv.org/html/2306.10209/assets/x1.png\" />\n<em>图：ZeRO++ 针对 ZeRO-3 的权重 all-gather、分区方式和梯度平均分别加入 qwZ、hpZ、qgZ。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># one ZeRO++ training step, simplified\nfor layer in model.layers:\n    # qwZ: gather quantized parameter partitions and dequantize for compute\n    q_part, scale = quantize_blockwise(local_param_partition(layer))\n    full_param = dequantize(all_gather(q_part, scale))\n    activation = layer.forward(activation, full_param)\n\nfor layer in reversed(model.layers):\n    full_param = gather_quantized_params(layer)\n    grad = layer.backward(full_param)\n\n    # qgZ: quantized gradient averaging\n    q_grad, g_scale = quantize_blockwise(grad)\n    avg_grad_partition = quantized_all_to_all_average(q_grad, g_scale)\n\n    # hpZ: update partition within hierarchical ZeRO groups\n    optimizer_step(local_partition(layer), avg_grad_partition)\n</code></pre>\n<h5>方法解释</h5>\n<p>ZeRO-3 的优势是每张 GPU 只保存参数、梯度和优化器状态的一部分；代价是每层前向和反向都要 all-gather 参数，反向还要 reduce-scatter 梯度。在高带宽集群且 batch 较大时，这些通信能被部分隐藏；但在低带宽网络、小 microbatch 或超大 DP 规模下，通信暴露成为吞吐瓶颈。</p>\n<p><code>qwZ</code> 处理权重 all-gather。ZeRO-3 all-gather 的参数只是用于当前层计算，通信后可反量化为计算精度，因此可以在通信前做 block-wise quantization：</p>\n<div class=\"kb-math kb-math-display\">\\hat{W}_b = Q(W_b), \\quad W_b \\approx D(\\hat{W}_b, s_b)</div>\n<p>每个 block 独立 scale，减少 outlier 影响。这样 all-gather 传输的是低 bit 权重加少量 scale 元数据，显著降低前向和反向参数通信体积。</p>\n<p><code>hpZ</code> 处理跨节点通信。大集群里节点内 NVLink/NVSwitch 带宽远高于跨节点网络。Hierarchical partitioning 把 ZeRO 分区分成节点内和节点间层次，在节点内适度复制部分参数分区，使更多同步留在高速域内，减少慢速跨节点 all-gather 的次数或体积。这是典型的“用显存换网络”设计。</p>\n<p><code>qgZ</code> 处理梯度平均。梯度 reduce-scatter 直接低精度化容易影响收敛，因为梯度噪声会累积到优化器状态。ZeRO++ 设计量化梯度平均流程，在 all-to-all/分组聚合中传输量化梯度，并通过合适的 scale 与聚合顺序控制误差，使最终更新接近 full precision reduce-scatter。</p>\n<div class=\"key-point\">💡 关键：ZeRO++ 的三项技术分别对准 ZeRO-3 的三段主要通信路径，因此能组合成端到端 4x 通信体积降低，而不是单点优化。</div>\n<h5>与 ZeRO 的区别</h5>\n<p>ZeRO 解决的是“每张卡是否需要保存完整模型状态”；ZeRO++ 解决的是“切分后每一步把状态临时拼回来和同步回去要传多少数据”。在内存模型上，ZeRO++ 仍继承 ZeRO-3 的参数/梯度/优化器分区；在通信模型上，它引入量化和层次化，把 ZeRO-3 从高带宽集群友好扩展到更低带宽或更大规模的环境。</p>",
      "quiz": {
        "q": "ZeRO++ 中 hpZ 的主要 trade-off 是什么？",
        "options": [
    ...
    },
    {
      ...
      "summary": "Centauri 通过通信分区和层次化调度扩大计算-通信重叠空间，解决大模型混合并行训练中 collective 粒度过粗、依赖复杂而难以隐藏通信的问题。",
      "keyPoints": [
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"Centauri 论文 PDF，含 Figure 4 通信分区流程\" src=\"https://openreview.net/pdf/58de1dd82ec19b52473be7e4af3f6ed777c4a525.pdf\" />\n<em>图：可访问论文 PDF 中的 Figure 4 展示了对混合训练任务中 N 个通信操作构造分区树，并选择最小调度成本方案的流程。ACM 页面未直接暴露独立图片资源。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># Centauri-style communication partitioning and scheduling\ndef centauri_schedule(training_graph):\n    comm_ops = extract_collectives(training_graph)\n    partition_trees = {}\n\n    for op in comm_ops:\n        tree = PartitionTree(op)\n        for primitive in split_primitives(op):          # primitive partitioning\n            for group in split_process_groups(primitive):  # group partitioning\n                for chunk in split_workload(group):     # workload partitioning\n                    tree.add_candidate(chunk)\n        partition_trees[op] = tree\n\n    candidates = combine_partition_choices(partition_trees)\n    best = min(candidates, key=lambda c: scheduling_cost(c, training_graph))\n    return hierarchical_schedule(best, training_graph.dependencies)\n</code></pre>\n<h5>方法解释</h5>\n<p>大模型训练中的通信并不是单一 all-reduce。TP 可能在每层插入 all-reduce 或 all-gather，DP 在反向后同步梯度，PP 在 stage 间传激活和梯度。已有系统常用两类方法：一类是细粒度 kernel fusion，把通信和计算塞进同一个 kernel，但可能牺牲 GEMM/NCCL 的高性能实现；另一类是 operation-level scheduling，只移动完整 collective，粒度太粗，很多可重叠窗口无法利用。</p>\n<p>Centauri 的核心是先拆通信，再调度通信。Primitive partitioning 把一个 collective 拆成更小的通信 primitive；group partitioning 按 rank group 或节点层级拆分通信范围；workload partitioning 再把数据量按 chunk 切开。拆分后，一个原本必须整体执行的 all-reduce 可以变成多个有依赖关系的子通信，其中一部分能提前启动，一部分能延后到计算空隙。</p>\n<p>通信分区不是越细越好。过细会增加 kernel launch、同步和调度开销，也可能破坏 NCCL 的带宽效率。因此 Centauri 为每个通信操作构建 partition tree，节点表示不同层级的拆分选择，边表示从粗到细的分区扩展。调度器在这些树上选择一组方案，使总训练图的暴露通信时间最小：</p>\n<div class=\"kb-math kb-math-display\">\\min_{\\pi \\in \\Pi} \\; T_{\\text{compute}} + T_{\\text{comm}}^{\\text{exposed}}(\\pi) + T_{\\text{overhead}}(\\pi)</div>\n<div class=\"key-point\">💡 关键：Centauri 的“分区”是为了创造可重叠的调度单元，而不是单纯缩小通信消息。</div>\n<p>层次化调度再考虑硬件拓扑和依赖。节点内通信、跨节点通信、不同并行维度的 collective 有不同带宽和竞争关系；调度器需要避免把所有子通信同时压到同一网络链路，也要保证某个计算 kernel 真正需要的数据已经到位。相比 CoCoNet 更偏编译融合，Centauri 更偏运行图层面的通信分区与调度搜索。</p>\n<h5>与传统 overlap 的区别</h5>\n<p>传统 overlap 往往依赖框架自动把反向计算和梯度 all-reduce 异步重叠，粒度是 tensor bucket。Centauri 面向混合并行中的多种 collective，把“是否拆、怎么拆、拆到哪个 group、每块多大”纳入调度空间。这样它可以处理 TP/DP/PP 交织时的复杂依赖，而不只优化单一数据并行梯度同步。</p>",
      "quiz": {
        "q": "Centauri 为什么不直接把所有 collective 拆到最细粒度？",
        "options": [
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>Expert Capacity 机制</strong>：设定每个专家的 buffer 上限 <span class=\"kb-math kb-math-inline\">C = 2N / E</span>（capacity factor 可调），溢出 token 通过残差连接直通，防止单专家过载",
        "<strong>辅助负载均衡损失</strong>：<span class=\"kb-math kb-math-inline\">l_{aux} = c_e \\cdot \\sum_{i=1}^{E} f_i \\cdot m_i</span>，其中 <span class=\"kb-math kb-math-inline\">f_i</span> 为分配到专家 <span class=\"kb-math kb-math-inline\">i</span> 的 token 比例，<span class=\"kb-math kb-math-inline\">m_i</span> 为门控均值，鼓励均匀分配",
    ...
    },
    {
      ...
      "summary": "Switch Transformer 将 MoE 路由从 GShard 的 Top-2 简化为 Top-1，每个 token 只发往一个专家，从而降低通信和计算复杂度，并首次稳定训练到万亿参数级稀疏语言模型。",
      "keyPoints": [
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"Switch Transformer 路由示意\" src=\"https://ar5iv.labs.arxiv.org/html/2101.03961/assets/x1.png\" />\n<em>图：Switch Transformer 中 router 为每个 token 选择一个专家，token 经 all-to-all 分发到专家 FFN，再组合回原序列位置。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># Switch FFN layer\ndef switch_ffn(tokens, experts, router_w, capacity_factor):\n    logits = tokens @ router_w\n    probs = softmax(logits, dim=-1)\n    expert_id = argmax(probs, dim=-1)        # Top-1 routing\n    gate = max(probs, dim=-1)\n\n    capacity = int(capacity_factor * len(tokens) / len(experts))\n    dispatch = build_capacity_limited_dispatch(expert_id, capacity)\n    expert_inputs = all_to_all(dispatch, tokens)\n\n    expert_outputs = [experts[e](expert_inputs[e]) for e in range(len(experts))]\n    outputs = inverse_all_to_all(dispatch, expert_outputs)\n    return gate[:, None] * outputs, load_balance_loss(probs, expert_id)\n</code></pre>\n<h5>方法解释</h5>\n<p>MoE 的基本目标是扩大参数量而不线性增加计算量。Dense FFN 对所有 token 使用同一组参数；MoE FFN 则准备多个专家 <span class=\"kb-math kb-math-inline\">E_i</span>，router 根据 token 表示 <span class=\"kb-math kb-math-inline\">x</span> 选择少数专家：</p>\n<div class=\"kb-math kb-math-display\">y = \\sum_i g_i(x) E_i(x)</div>\n<p>GShard 使用 Top-2 routing，每个 token 通常发给两个专家并加权合并。Switch Transformer 的关键简化是只选一个专家：</p>\n<div class=\"kb-math kb-math-display\">e=\\arg\\max_i p_i(x), \\quad y=p_e(x)E_e(x)</div>\n<p>这让 dispatch/combine 逻辑更简单，通信量和专家计算量也更低。Top-1 的代价是 router 更容易负载不均，因此论文保留并强化了 load balancing。辅助损失常写成：</p>\n<div class=\"kb-math kb-math-display\">L_{\\text{aux}} = \\alpha \\cdot N \\sum_{i=1}^{N} f_i P_i</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">f_i</span> 是实际路由到专家 <span class=\"kb-math kb-math-inline\">i</span> 的 token 比例，<span class=\"kb-math kb-math-inline\">P_i</span> 是 router 分配给专家 <span class=\"kb-math kb-math-inline\">i</span> 的平均概率。若某个专家概率高且实际 token 多，损失会增大，推动 router 更均匀。</p>\n<p>Expert capacity 是系统侧稳定器。每个专家只接收固定上限 <span class=\"kb-math kb-math-inline\">C=\\mathrm{capacity\\_factor}\\cdot T/N</span> 的 token，超出容量的 token 被 drop 或通过残差路径跳过专家。这避免单个专家因热门 token 过载导致 all-to-all buffer 爆炸。</p>\n<div class=\"key-point\">💡 关键：Switch 的“简单”不是功能减少，而是把 Top-2 MoE 中最昂贵的双专家通信/组合简化掉，换来更好的大规模可训练性。</div>\n<h5>与 GShard 的区别</h5>\n<p>GShard 证明了 Top-2 MoE Transformer 可扩展到数千 TPU；Switch Transformer 进一步面向稳定性和工程复杂度做减法。它的 Top-1 路由减少通信，选择性 fp32 router 计算和较小初始化缓解训练不稳定，expert dropout 提高下游迁移泛化。结果是更适合扩展到 trillion-parameter 的稀疏模型。</p>",
      "quiz": {
        "q": "Switch Transformer 相比 GShard Top-2 routing 的核心简化是什么？",
        "options": [
    ...
    },
    {
      ...
      "summary": "DeepSpeed-MoE 是面向 MoE 训练和推理的一体化系统，通过 PR-MoE 架构、专家并行、MoE inference 优化和 offload/压缩技术，让稀疏专家模型在训练成本、推理延迟和部署成本上优于质量相当的 dense 模型。",
      "keyPoints": [
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"DeepSpeed-MoE 系统与模型示意\" src=\"https://ar5iv.labs.arxiv.org/html/2201.05596/assets/x1.png\" />\n<em>图：DeepSpeed-MoE 将 MoE 层、专家并行、训练/推理系统优化整合到 DeepSpeed 栈中。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># DeepSpeed-MoE layer, simplified\ndef deepspeed_moe_layer(x, router, local_experts, ep_group):\n    score = softmax(router(x), dim=-1)\n    experts, gates = top_k(score, k=1 or 2)\n\n    send_buf = pack_tokens_by_expert(x, experts, ep_group)\n    expert_inputs = all_to_all(send_buf, group=ep_group)\n\n    expert_outputs = []\n    for expert_id, tokens in expert_inputs.items():\n        expert_outputs.append(local_experts[expert_id](tokens))\n\n    recv_buf = all_to_all(pack_outputs(expert_outputs), group=ep_group)\n    return combine_by_original_token(recv_buf, gates)\n</code></pre>\n<h5>方法解释</h5>\n<p>MoE 训练的基本瓶颈是 token dispatch。每个 GPU 只持有一部分专家，router 为 token 选专家后，token 必须通过 all-to-all 发到拥有对应专家的 GPU。DeepSpeed-MoE 将专家并行作为一等并行维度，与数据并行、张量并行、流水线并行组合，使专家数量可以随 GPU 数扩展，而 dense attention/embedding 等部分仍可使用已有 DeepSpeed 3D 并行策略。</p>\n<p>PR-MoE 的动机是 MoE 参数虽多，但不是所有层都需要同样多专家。Pyramid 结构让不同深度层使用不同专家规模，Residual 结构保留 dense FFN 路径并叠加稀疏专家输出：</p>\n<div class=\"kb-math kb-math-display\">y = \\mathrm{DenseFFN}(x) + \\sum_{i \\in \\mathrm{TopK}(x)} g_i E_i(x)</div>\n<p>这样可以在保持模型质量的同时减少专家参数和路由不稳定，推理时也能降低需要加载和调度的专家规模。</p>\n<p>推理比训练更难，因为在线服务的 batch 可能小、token 分布不稳定，MoE all-to-all 更容易暴露。DeepSpeed-MoE 通过专家切分和分层通信减少单设备热点，用调度把同专家 token 聚合，用压缩和 offload 降低显存压力。MoE-Offload 的直觉是推理时每个 token 只访问少数专家，未访问专家不必常驻 GPU；系统可以按热度和路由预测把专家在 GPU/CPU/NVMe 间迁移。</p>\n<div class=\"key-point\">💡 关键：DeepSpeed-MoE 不只是一层 MoE kernel，而是从模型结构、训练并行到推理部署都围绕“稀疏激活但专家巨大”这一特性设计。</div>\n<h5>与 GShard/Switch 的区别</h5>\n<p>GShard 和 Switch 更强调模型和路由机制，DeepSpeed-MoE 更强调端到端系统化。它既支持训练时的 expert parallel all-to-all，也关注推理时的专家放置、offload、低延迟调度和模型压缩。因此它把 MoE 从“可训练的大模型结构”推进到“可部署的稀疏大模型系统”。</p>",
      "quiz": {
        "q": "DeepSpeed-MoE 中 PR-MoE 的核心目的是什么？",
        "options": [
    ...
    },
    {
      ...
      "summary": "Tutel 提出 Flex MoE 系统栈，通过零迁移代价的自适应并行/流水切换和优化 all-to-all/token dispatch，在动态专家负载下显著提升 MoE 训练与推理效率。",
      "keyPoints": [
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"Tutel/Flex MoE 架构示意\" src=\"https://ar5iv.labs.arxiv.org/html/2206.03382/assets/x1.png\" />\n<em>图：Tutel 将路由、all-to-all、专家执行和自适应并行封装成可扩展 MoE runtime。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># Tutel Flex runtime sketch\ndef tutel_moe(x, gate, experts, runtime_state):\n    route = gate(x)\n    load = count_tokens_per_expert(route)\n    plan = choose_parallel_and_pipeline(load, runtime_state.available_layouts)\n\n    # identical layout allows switching without tensor migration\n    encoded = fast_encode_tokens(x, route, plan.capacity)\n    remote_inputs = optimized_all_to_all(encoded, plan.ep_group)\n    remote_outputs = run_experts_with_pipeline(remote_inputs, experts, plan)\n    gathered = optimized_all_to_all(remote_outputs, plan.ep_group)\n    return fast_decode_tokens(gathered, route)\n</code></pre>\n<h5>方法解释</h5>\n<p>MoE 系统的难点在于 workload 是数据相关的。router 每步根据 token 内容决定专家，热门专家可能接收大量 token，冷门专家可能几乎空闲。静态 expert parallelism 假设专家负载均衡，但真实负载会让部分 GPU 等待热点专家，或者让 all-to-all 产生长尾消息。</p>\n<p>Tutel/Flex 的关键设计是 identical layout：模型参数和输入数据采用一种能被不同并行或流水方法共享的布局。这样运行时可以根据当前 batch 的专家负载，在不同策略间切换，而不需要先把专家参数或 token tensor 迁移成另一种布局。论文称之为 no-penalty switching，因为切换策略本身不应引入抵消收益的搬运成本。</p>\n<p>系统热路径包括四步：encode 将 token 按专家打包；all-to-all 把 token 发到专家所在 rank；专家 FFN 执行；decode 把输出恢复到原 token 顺序。Tutel 对这些步骤做 fused/optimized implementation，减少 padding、排序和内存拷贝开销，并根据负载选择合适流水，使通信和专家计算重叠。</p>\n<div class=\"key-point\">💡 关键：Tutel 的自适应不是改变 router 决策，而是根据 router 造成的实际专家负载，动态选择更合适的执行并行方式。</div>\n<h5>与 DeepSpeed-MoE 的区别</h5>\n<p>DeepSpeed-MoE 提供训练和推理端到端方案，重点包括 PR-MoE、offload 和部署成本；Tutel 更聚焦 MoE runtime 的高性能执行，尤其是 all-to-all 和动态 parallelism/pipelining。它可以作为 MoE 执行层被上层模型系统调用，用较少模型改动获得更高专家并行效率。</p>",
      "quiz": {
        "q": "Tutel/Flex 的 identical layout 主要解决什么问题？",
        "options": [
    ...
    },
    {
      ...
      "summary": "Galvatron 通过 cost model、决策树剪枝和动态规划，在 DP/TP/PP/重计算等大规模混合并行空间中自动搜索 Transformer 的高吞吐训练策略，解决手工配置 3D 并行难以适配模型和显存预算的问题。",
      "keyPoints": [
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"Galvatron 系统流程\" src=\"https://ar5iv.labs.arxiv.org/html/2211.13878/assets/x1.png\" />\n<em>图：Galvatron 先建立并行策略成本模型，再通过搜索生成每层混合并行计划并执行训练。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># Galvatron dynamic programming search\ndef search_parallel_plan(layers, devices, memory_budget):\n    strategies = build_strategy_set(dp=True, tp=True, pp=True, checkpoint=True)\n    strategies = decision_tree_prune(strategies, model_shape=layers[0].shape)\n\n    dp = {}\n    for l, layer in enumerate(layers):\n        for s in strategies[layer.type]:\n            cost = compute_time(layer, s) + memory_penalty(layer, s, memory_budget)\n            if l == 0:\n                dp[l, s] = cost\n            else:\n                dp[l, s] = min(\n                    dp[l - 1, prev] + reshard_cost(prev, s) + cost\n                    for prev in strategies[layers[l - 1].type]\n                )\n\n    return backtrack_min_cost_plan(dp)\n</code></pre>\n<h5>方法解释</h5>\n<p>Transformer 训练的并行空间很大。DP 简单但显存复制严重；TP 降低单层参数和激活压力但引入层内 collective；PP 降低层级显存但有 pipeline bubble；checkpoint 节省激活但增加重算。不同模型结构、batch size、序列长度和 GPU 拓扑下，最佳组合不同，手工调参很难覆盖。</p>\n<p>Galvatron 的第一步是为候选策略建立成本模型。对每个层和并行策略，它估计计算时间、通信时间、激活/参数/优化器显存以及 checkpoint 后的重算开销。相邻层若采用不同张量布局，还要加入 resharding cost，因为输出张量可能需要从一种切分方式转换到另一种切分方式。</p>\n<p>搜索空间剪枝依靠决策树。论文把一些显然劣势或不适用的组合提前排除，例如在显存预算宽松时不必过度 checkpoint，在通信极重的策略上限制 TP 组合。剪枝后的核心问题可视为序列决策：每层选一个策略，使总时间最小且显存不超限：</p>\n<div class=\"kb-math kb-math-display\">\\min_{s_1,\\ldots,s_L} \\sum_{l=1}^{L} T(l,s_l)+\\sum_{l=2}^{L} R(s_{l-1},s_l)</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">R</span> 是策略切换的重分片通信。</p>\n<div class=\"key-point\">💡 关键：Galvatron 的自动化价值不只是选一个全局 TP/PP/DP 度，而是允许不同层在约束下选择不同策略，并把切换成本纳入搜索。</div>\n<h5>与手工 3D 并行的区别</h5>\n<p>手工 3D 并行通常为整个模型选择固定 <span class=\"kb-math kb-math-inline\">dp,tp,pp</span>，再微调 microbatch 和 checkpoint。Galvatron 把策略粒度下放到层，并用模型/硬件 profile 适配不同显存预算。相比只搜索 pipeline 切分或只搜索 tensor parallel 的系统，它的搜索空间更接近实际大模型训练栈的组合复杂度。</p>",
      "quiz": {
        "q": "Galvatron 动态规划中为什么要考虑相邻层策略切换成本？",
        "options": [
    ...
    },
    {
      ...
      "summary": "MoE Parallel Folding 在 Megatron Core 中解耦 Attention 层和 MoE 层的并行映射，让两类层分别采用最合适的 TP/EP/CP/DP/PP 组合，解决大规模 MoE 训练中单一并行配置无法同时兼顾 dense attention 与 sparse expert 的问题。",
      "keyPoints": [
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"MoE Parallel Folding 映射示意\" src=\"https://ar5iv.labs.arxiv.org/html/2504.14960/assets/images/MoE_Parallel_Folding-mapping-switch.png\" />\n<em>图：MoE Parallel Folding 展示 Attention 和 MoE 层采用不同并行映射，并在层边界进行布局切换。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># MoE Parallel Folding in a Transformer block\ndef folded_moe_block(x, attn_plan, moe_plan):\n    # Attention prefers TP/CP for dense matmul and long sequence\n    x_attn = layout_transform(x, attn_plan.input_layout)\n    h = attention(x_attn, tp=attn_plan.tp, cp=attn_plan.cp)\n    h = layout_transform(h, moe_plan.input_layout)\n\n    # MoE prefers EP/DP with token dispatcher\n    route = router(h)\n    packed = token_dispatch(h, route, ep=moe_plan.ep, dp=moe_plan.dp)\n    expert_out = expert_ffn(packed, tp=moe_plan.expert_tp)\n    y = token_combine(expert_out, route)\n\n    return layout_transform(y, attn_plan.output_layout)\n</code></pre>\n<h5>方法解释</h5>\n<p>MoE Transformer block 里有两类性质完全不同的计算。Attention 是 dense 的，所有 token 都经过同一套投影和 attention kernel，适合 TP/CP 来切 hidden、head 或 sequence；MoE FFN 是 sparse 的，token 被 router 分发到专家，适合 EP 来切专家、DP 来扩 batch。若强制两类层使用同一个并行映射，要么 attention 通信过重，要么专家负载和 all-to-all 低效。</p>\n<p>MoE Parallel Folding 的核心是允许并行维度在层内“折叠/展开”。Attention 子层可以选择 <span class=\"kb-math kb-math-inline\">TP_a, CP_a, DP_a</span>，MoE 子层可以选择 <span class=\"kb-math kb-math-inline\">TP_e, EP_e, DP_e</span>，二者在 block 边界通过 layout transform 对齐。这个 transform 是系统代价的一部分，但相比全层被迫使用次优并行，整体更优。</p>\n<p>Token dispatcher 是关键工程组件。MoE 路由会产生动态 token-to-expert 映射，dropless 训练还要求不能简单丢弃超容量 token。dispatcher 需要在 TP/EP/CP/DP/PP 同时存在时维护 token 原始位置、专家位置、容量和反向梯度路由，确保：</p>\n<div class=\"kb-math kb-math-display\">\\mathrm{combine}(\\mathrm{experts}(\\mathrm{dispatch}(x))) \\equiv \\mathrm{MoE}(x)</div>\n<div class=\"key-point\">💡 关键：Folding 的目标不是减少并行维度，而是让每种层“看见”对自己最自然的并行空间，再用受控布局转换把它们拼回一个训练图。</div>\n<p>长上下文场景进一步放大这个价值。Attention 的 <span class=\"kb-math kb-math-inline\">S^2</span> 或长序列激活压力需要 CP；MoE 的专家参数和 all-to-all 需要 EP。传统映射若把 CP/EP 绑定，会限制可扩展性。Folding 让 CP 主要服务 attention，EP 主要服务 expert，在 Mixtral/Qwen MoE 上获得更高 MFU。</p>\n<h5>与 Switch/DeepSpeed-MoE 的区别</h5>\n<p>Switch 关注 Top-1 路由简化，DeepSpeed-MoE 关注端到端 MoE 训练推理系统；MoE Parallel Folding 更关注现代 Megatron Core 中多维并行的映射问题。它面向已有 MoE 架构，在不改变模型数学的前提下调整并行拓扑，使 attention 和 expert 两个子系统都接近硬件最优。</p>",
      "quiz": {
        "q": "MoE Parallel Folding 为什么要解耦 Attention 和 MoE 层的并行配置？",
        "options": [
    ...
    },
    {
      ...
      "summary": "X-MoE 面向 DeepSeek-style expert-specialized MoE 和 HPC 平台，提出 padding-free MoE kernel、redundancy-bypassing dispatch 和 sequence-sharded MoE block，使大 top-k、细粒度专家模型能在 AMD/NVIDIA 超算集群上扩展训练。",
      "keyPoints": [
        "任务中的 <code>paper_url</code> 指向 Sparse Deformable Mamba，与 X-MoE 不匹配；本文基于 X-MoE 官方 arXiv <code>https://arxiv.org/abs/2508.13337</code> 和官方仓库信息完成，YAML 保持任务元信息不变。",
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"X-MoE 系统概览\" src=\"https://ar5iv.labs.arxiv.org/html/2508.13337/assets/x1.png\" />\n<em>图：X-MoE 面向 expert-specialized MoE 的训练瓶颈，围绕 padding-free、RBD 和 SSMB 组织跨平台 MoE 执行。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># X-MoE execution sketch\ndef x_moe_block(x, router, experts, topology):\n    route = router_topk(x)  # larger top-k for expert-specialized MoE\n\n    # SSMB: keep sequence dimension sharded for MoE activations\n    x_shard = sequence_shard(x, topology.tp_group)\n\n    # padding-free packing: exact token counts per expert\n    packed = pack_without_capacity_padding(x_shard, route)\n\n    # RBD: bypass redundant inter-node transfers when source/destination locality permits\n    local, remote = split_by_topology(packed, topology)\n    remote = redundancy_bypassing_dispatch(remote, topology.inter_node_group)\n\n    y_local = run_local_and_remote_experts(local, remote, experts)\n    return combine_without_padding(y_local, route)\n</code></pre>\n<h5>方法解释</h5>\n<p>DeepSeek-MoE 一类 expert-specialized 架构改变了传统 MoE 系统假设。它们使用更多细粒度专家和更大的 Top-k，让每个 token 激活多个专家以获得专业化能力。这样模型质量更强，但系统上会出现两个瓶颈：一是 token dispatch 的 all-to-all 消息更多，二是为了对齐专家容量而产生大量 padding，导致无效计算和显存浪费。</p>\n<p>X-MoE 的 padding-free kernel 直接按真实 token 数打包专家输入，不再把每个专家补齐到统一 capacity 后再计算。这样专家 FFN 处理的是实际 token，避免 <span class=\"kb-math kb-math-inline\">E \\times C</span> buffer 中大量空洞。对大 Top-k MoE，这个优化尤其重要，因为每个 token 会复制到多个专家，padding 浪费会被放大。</p>\n<p>Redundancy-bypassing dispatch 关注 HPC 拓扑。Frontier 等超算节点内带宽和跨节点带宽差异明显，普通 all-to-all 会把一些可本地复用或不必跨节点的 token 也送过低带宽链路。RBD 将 dispatch 按拓扑拆分，跳过冗余跨节点传输，把更多交换留在节点内或本地路径。论文报告 RBD 可显著降低 inter-node all-to-all 时间。</p>\n<p>SSMB（sequence-sharded MoE blocks）处理激活内存迁移。随着非 MoE dense block 的 TP 度增加，MoE block 若仍保存完整序列激活，内存瓶颈会从参数转向 activation。X-MoE 将 MoE block 中的序列维保持分片，使激活内存随 TP/sequence shard 下降，同时保持专家并行的 dispatch 语义。</p>\n<div class=\"key-point\">💡 关键：X-MoE 的目标是让新一代“专家更细、Top-k 更大”的 MoE 适配 HPC 互连和 AMD/NVIDIA 多平台，而不是只优化传统 Top-1/Top-2 MoE。</div>\n<h5>与 Switch/Megatron MoE 的区别</h5>\n<p>Switch Transformer 通过 Top-1 降低路由复杂度；X-MoE 反过来面向更复杂的 expert-specialized MoE，接受大 Top-k 带来的质量收益，并在系统层消化其开销。与只针对 NVIDIA GPU 的实现不同，X-MoE 强调 cross-platform kernel 和在 Frontier MI250X 等 HPC 系统上的扩展能力。</p>",
      "quiz": {
        "q": "X-MoE 的 padding-free MoE training 主要减少什么开销？",
        "options": [
    ...
    },
    {
      ...
      "summary": "任务 URL 对应的 FastMoE 是一个基于 PyTorch 的分布式 MoE 训练系统，它提供灵活接口和高性能专家并行 runtime，使普通 GPU 集群也能训练专家数量随设备数线性扩展的 MoE 模型。",
      "keyPoints": [
        "任务 id/name 写作 FSMoE，但 <code>paper_url</code> 指向 FastMoE 论文；本文按该论文和“灵活可扩展 MoE 训练框架”动机解读。",
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"FastMoE 系统架构示意\" src=\"https://ar5iv.labs.arxiv.org/html/2103.13262/assets/x1.png\" />\n<em>图：FastMoE 展示 gate、dispatcher、专家并行和输出组合构成的 PyTorch MoE 训练系统。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># FastMoE/FSMoE-style layer\nclass FMoELayer(nn.Module):\n    def forward(self, x):\n        gate_score = self.gate(x)\n        expert_id, gate = top_k(gate_score, k=self.top_k)\n\n        # dispatch tokens to remote experts\n        packed, metadata = fmoe_encode(x, expert_id)\n        remote_inputs = fmoe_all_to_all(packed, self.expert_group)\n\n        remote_outputs = []\n        for local_expert, tokens in zip(self.local_experts, remote_inputs):\n            remote_outputs.append(local_expert(tokens))\n\n        gathered = fmoe_all_to_all(remote_outputs, self.expert_group)\n        return fmoe_decode(gathered, metadata, gate)\n</code></pre>\n<h5>方法解释</h5>\n<p>早期大规模 MoE 系统主要依赖 Google TPU 和 Mesh TensorFlow，对 GPU/PyTorch 用户不友好。FastMoE 的动机是把 MoE 抽象成可复用 PyTorch 层，同时把高性能分布式 dispatch 隐藏在 runtime 里。用户可以像插入 FFN 一样插入 MoE 层，但底层会根据 gate 输出把 token 发往远端专家。</p>\n<p>专家并行是系统核心。若共有 <span class=\"kb-math kb-math-inline\">E</span> 个专家、<span class=\"kb-math kb-math-inline\">G</span> 张 GPU，每张 GPU 只保存 <span class=\"kb-math kb-math-inline\">E/G</span> 个专家。router 为 token 选择专家后，runtime 将 token 按目标专家重新排序和打包，通过 all-to-all 发到对应 GPU；专家本地执行 FFN 后，再通过反向 all-to-all 返回原 GPU，并按 gate 权重组合输出。</p>\n<p>FastMoE 的工程优化集中在 encode/all-to-all/decode 热路径。朴素 PyTorch 实现会产生大量 scatter/gather、小 tensor 和 Python 调度开销；FastMoE 使用定制算子和通信调度减少内存拷贝，维护 token 原始位置元数据，使前向和反向都能高效恢复顺序和梯度。</p>\n<div class=\"key-point\">💡 关键：FastMoE 的贡献是把 MoE 从特定 TPU 编译栈迁移到通用 GPU/PyTorch 生态，同时保留专家并行的规模扩展能力。</div>\n<h5>与 Tutel 的关系</h5>\n<p>FastMoE 更早提供 PyTorch 分布式 MoE 基础设施，重点是接口灵活和 expert parallel 可扩展；Tutel 在此类系统基础上进一步强调自适应并行、all-to-all 优化和动态负载下的 runtime 性能。任务将 FSMoE 置于 Tutel 之后，可以理解为“灵活可扩展 MoE 框架”这一谱系中的基础系统。</p>",
      "quiz": {
        "q": "FastMoE/FSMoE 中 expert parallelism 的主要作用是什么？",
        "options": [
    ...
    },
    {
      ...
      "summary": "MegaScale-MoE 是字节跳动面向生产级 MoE 训练的通信优化系统，通过 SP+EP 并行策略、算子级通信计算重叠与 BF16/FP8 通信压缩，在 1,440 张 Hopper/H800 GPU 上训练 352B MoE 模型实现 1.88x 于 Megatron-LM 的吞吐提升。",
      "keyPoints": [
        ...
        "EP 保持专家 GEMM 完整形状，避免 TP 切分专家隐藏维带来的小矩阵低效，并按 top-<span class=\"kb-math kb-math-inline\">k</span> 自适应选择 all-to-all 或 all-gather/reduce-scatter。",
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"MegaScale-MoE 大规模 MoE 并行策略设计空间\" src=\"https://ar5iv.labs.arxiv.org/html/2505.11432/assets/x4.png\" />\n<em>图：arXiv HTML 版本 Figure 4，展示 MegaScale-MoE 在 MoE 层内选择 SP attention 与 EP FFN，并在层外结合 PP/DP 的设计空间。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># One MegaScale-MoE layer, simplified from the system design\ndef megascale_moe_layer(x, params, dp_group, mp_group):\n    # Attention: sequence parallelism, no tensor-parallel attention on the critical path\n    qkv_tiles = fused_gemm_a2a_or_a2a_gemm(\n        x_sharded_by_sequence=x,\n        weight=params.attn_qkv,\n        group=mp_group,\n    )\n    attn = grouped_query_attention(qkv_tiles)\n    x = fused_gemm_a2a_or_a2a_gemm(attn, params.attn_out, group=mp_group)\n\n    # FFN / MoE: expert parallelism\n    scores = router(x)\n    expert_ids, gate = topk(scores, k=params.top_k)\n    tokens = sort_by_expert_then_source_rank(x, expert_ids)\n\n    # Dispatch/combine are fused with GroupedGEMM tiles\n    hidden = fused_ag_scatter_grouped_gemm(tokens, params.expert_up_gate, mp_group)\n    hidden = swiglu(hidden)\n    out = fused_grouped_gemm_gather_rs(hidden, params.expert_down, mp_group)\n    x = weighted_combine(out, gate)\n\n    # Data-parallel gradient synchronization after accumulation\n    if accumulation_done():\n        grad_fp32 = main_grad_buffer()\n        shard_bf16 = cast_to_bf16(grad_fp32)\n        recv = all_to_all(shard_bf16, group=dp_group)\n        grad_synced = fp32_sum(recv)\n        write_back_in_place(grad_synced)\n    return x\n</code></pre>\n<h5>方法机制解读</h5>\n<p>MegaScale-MoE 的动机来自生产训练中的通信占比。论文报告内部 Hopper 训练中，forward pass 通信可占 43.6%，全训练过程通信约占 32%。MoE 比 dense Transformer 更容易暴露通信瓶颈：模型参数更大，需要更多 model parallelism；同时稀疏专家路由还会在前向与反向各引入 token dispatch/combine 的 all-to-all。GPU 计算能力和低精度训练越强，计算时间越短，通信反而越成为主瓶颈。</p>\n<p>第一层优化是重新匹配 MoE 子模块与并行策略。对注意力模块，传统 TP 的关键路径通信量为：</p>\n<div class=\"kb-math kb-math-display\">V_{\\mathrm{TP}}^{\\mathrm{attn}} = 2bsh\\frac{n-1}{n}</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">b</span> 是 micro-batch size，<span class=\"kb-math kb-math-inline\">s</span> 是序列长度，<span class=\"kb-math kb-math-inline\">h</span> 是 hidden size，<span class=\"kb-math kb-math-inline\">n</span> 是层内模型并行度。MegaScale-MoE 改用 DeepSpeed-Ulysses 风格的 SP，将序列维切分；在 grouped-query attention 中，通信量变为：</p>\n<div class=\"kb-math kb-math-display\">V_{\\mathrm{SP}}^{\\mathrm{attn}}\n=\n2bsh\\frac{n-1}{n}\\cdot\\frac{2+2/m}{n}</div>\n<p><span class=\"kb-math kb-math-inline\">m</span> 是 query heads 与 key-value heads 的比例。当 <span class=\"kb-math kb-math-inline\">n=8, m=4</span> 时，SP attention 的关键路径通信约为 TP attention 的 <span class=\"kb-math kb-math-inline\">0.3125</span>，论文按实际 Hopper/NVLink 配置给出约四分之一的通信延迟。SP 会复制注意力参数，但 MoE 中专家参数占主导，注意力参数同步和额外显存相对可控。</p>\n<p>对 FFN/专家模块，MegaScale-MoE 使用 EP 而不是 TP。TP 会切分专家 hidden dimension，导致专家 GEMM 形状变小、算子效率下降；EP 则让每张 GPU 持有完整专家，token 按路由结果在 GPU 间搬运。理论通信量对比如下：</p>\n<div class=\"kb-math kb-math-display\">V_{\\mathrm{EP}}^{\\mathrm{ffn}} = \\frac{2k}{n}bsh\\frac{n-1}{n},\n\\quad\nV_{\\mathrm{TP}}^{\\mathrm{ffn}} = 2bsh\\frac{n-1}{n}</div>\n<p>当 <span class=\"kb-math kb-math-inline\">k \\ll n</span> 时，EP 通信量更低；当 top-<span class=\"kb-math kb-math-inline\">k</span> 较大时，论文进一步将传统 all-to-all dispatch 切换为 all-gather + local scatter + reduce-scatter，使 EP 通信开销不高于 TP。系统层面还实现 CUDA scatter/gather，预计算 token 行映射，避免用通用 <code>torch.scatter_add</code>/<code>torch.gather</code> 拖慢路由路径。</p>\n<p>第二层优化是通信计算重叠。Inter-operator overlap 通过统一的 MoE layer macro 调度，把无依赖通信放到不同 CUDA stream 中与计算或 activation recomputation 重叠。更关键的是 intra-operator overlap：对于有直接依赖的通信和计算，系统把通信拆成 tile，在 device memory 中放 barrier，实现 A2A+GEMM、GEMM+A2A、AG+scatter+GroupedGEMM、GroupedGEMM+gather+RS 等融合 kernel。</p>\n<p><img alt=\"MegaScale-MoE tile 级通信计算重叠\" src=\"https://ar5iv.labs.arxiv.org/html/2505.11432/assets/x10.png\" />\n<em>图：arXiv HTML 版本 Figure 10，展示 A2A/AG/RS 与 GEMM/GroupedGEMM 在 tile 级别重叠的执行模式。</em></p>\n<p>在 A2A+GEMM 中，本地 tile 的 GEMM 与远端 tile 的通信同时启动，GPU copy engine 负责搬运数据，SM 继续做计算；远端 tile 到达后写 device barrier，GEMM kernel 再消费该 tile。对 MoE GroupedGEMM 更难，因为 token 需要按 expert 与 source rank shuffle。MegaScale-MoE 先按 routed expert 排序，再在每个 expert 内按 source rank 排序，让一个计算 tile 依赖尽可能少的 rank，从而减少等待并避免重复加载专家权重。</p>\n<p>第三层优化是通信压缩，但它不直接把训练精度降到底，而是调整通信模式来控制数值风险。BF16 mixed-precision 下，本地梯度累积仍保留 FP32；累积完成后只在通信前 cast 到 BF16，用 all-to-all 收集梯度分片，然后在接收端做 FP32 summation：</p>\n<div class=\"kb-math kb-math-display\">g_{\\mathrm{local}}^{\\mathrm{FP32}}=\\sum_{\\mu=1}^{M}\\nabla_\\theta L_\\mu,\\quad\ng_{\\mathrm{wire}}^{\\mathrm{BF16}}=\\mathrm{cast}_{\\mathrm{BF16}}(g_{\\mathrm{local}}^{\\mathrm{FP32}})</div>\n<div class=\"kb-math kb-math-display\">g_r^{\\mathrm{FP32}}=\n\\sum_{q\\in\\mathrm{DP}}\n\\mathrm{cast}_{\\mathrm{FP32}}\\left(\\mathrm{A2A}(g_{\\mathrm{wire}}^{\\mathrm{BF16}})_{q,r}\\right)</div>\n<p>这样相比 FP32 reduce-scatter 减少 50% 梯度通信，同时避免 ring reduce 中 BF16 反复累加。FP8 训练则采用 E4M3 格式，并对前向通信使用 per-token activation quantization，对反向通信使用 per-channel quantization，再沿 token 维做 group quantization，减少 overflow/underflow 引起的 loss mismatch。</p>\n<div class=\"key-point\">💡 关键：MegaScale-MoE 不是单点 MoE kernel 优化，而是把“并行策略选择、重叠调度、通信精度”放在同一个通信预算里联合设计。</div>\n<h5>结果与工程意义</h5>\n<p>论文在 352B MoE 模型上做强扩展对比：1,440 GPU 时 Megatron-LM 迭代 7.90s、746.6k tokens/s，MegaScale-MoE 迭代 4.19s、1,407.7k tokens/s，对应 1.88x 加速。消融显示 SP+EP 带来 13% normalized throughput 提升，inter-operator overlap 再加 9%，intra-operator overlap 再加 6%。这些收益的共同点是减少暴露通信时间，而不是只提高某一个 GEMM 的峰值 FLOPS。</p>",
      "quiz": {
        "q": "MegaScale-MoE 为什么在注意力模块选择 SP 而不是传统 TP？",
        "options": [
    ...
    },
    {
      ...
      "summary": "Sub-MoE 提出一种训练后、无需微调的 MoE 专家合并框架：先按专家输出相似度自适应聚类，再用联合 SVD 把同组专家对齐到共享子空间，只合并专家特有的 \\(V\\) 分量，从而缓解直接权重平均造成的参数冲突。",
      "keyPoints": [
        ...
        "Subspace Expert Merging 对同组专家权重做 Experts Union SVD，提取共享 <span class=\"kb-math kb-math-inline\">U\\Sigma</span> 基底，并对专家特有 <span class=\"kb-math kb-math-inline\">V</span> 矩阵做频率加权合并。",
        "频率权重来自路由器 Top-<span class=\"kb-math kb-math-inline\">k</span> 激活次数，高频专家在合并后贡献更大，同时保留低频专家的部分能力。",
      ...
      "detail": "<h5>核心示意图</h5>\n<p><img alt=\"Sub-MoE 框架公开快照\" src=\"https://moonlight-paper-snapshot.s3.ap-northeast-2.amazonaws.com/arxiv/sub-moe-efficient-mixture-of-expert-llms-compression-via-subspace-expert-merging-1.png\" />\n<em>图：Moonlight 对 Sub-MoE 论文图的公开 PNG 快照，对应论文中的专家聚类与 Subspace Expert Merging 流程；官方论文来源为 AAAI 页面 PDF。</em></p>\n<h5>算法伪代码</h5>\n<pre><code class=\"language-python\"># Sub-MoE expert compression for one or multiple MoE layers\ndef sub_moe_compress(model, calibration_tokens, target_expert_counts):\n    for layer_group in select_layer_groups(model.moe_layers):\n        # 1) Adaptive Expert Clustering\n        outputs = {}\n        for expert in layer_group.experts:\n            outputs[expert] = [expert(x) for x in calibration_tokens]\n\n        sim = cosine_similarity_matrix(outputs)\n        clusters = kmeans(features=outputs, k=target_expert_counts[layer_group])\n\n        # 2) Subspace Expert Merging\n        for cluster in clusters:\n            for weight_name in [&quot;W_gate&quot;, &quot;W_up&quot;, &quot;W_down&quot;]:\n                weights = [expert[weight_name] for expert in cluster]\n                W_stack = concat_along_input_or_output(weights)\n                U, Sigma, V_blocks = union_svd(W_stack)\n\n                freq = [\n                    routing_frequency(expert, calibration_tokens)\n                    for expert in cluster\n                ]\n                V_blocks = [ties_sparsify(V) for V in V_blocks]\n                V_merged = weighted_average(V_blocks, weights=freq)\n                W_merged = U @ Sigma @ V_merged.T\n                write_weight(cluster.merged_expert, weight_name, W_merged)\n\n            redirect_router(cluster.original_experts, cluster.merged_expert)\n\n    # Optional Sub-MoE dagger: activation-aware truncated SVD\n    for expert in model.merged_experts:\n        expert = activation_aware_truncated_svd(expert, calibration_tokens)\n    return model\n</code></pre>\n<h5>方法机制解读</h5>\n<p>Sub-MoE 要解决的是专家合并中的 parameter conflict。MoE 层对 token <span class=\"kb-math kb-math-inline\">x</span> 的输出可以写成：</p>\n<div class=\"kb-math kb-math-display\">y=\\sum_{i=1}^{n}G_i(x)\\cdot E_i(x),\n\\quad\nE_i(x)=\\left(\\sigma(xW_{\\mathrm{gate}}^i)\\odot xW_{\\mathrm{up}}^i\\right)W_{\\mathrm{down}}^i</div>\n<p>路由器会把不同输入分配给不同专家，长期训练后专家形成不同参数空间。直接做 <span class=\"kb-math kb-math-inline\">W_{\\mathrm{merged}}=\\sum_i\\alpha_iW^{(i)}</span> 往往把彼此冲突的方向平均掉，尤其在 Mixtral 这类专家相似度较低的模型上会显著损伤性能。因此 Sub-MoE 不在原始参数空间直接合并，而是先找到可共享的子空间。</p>\n<p>第一阶段用功能相似度决定谁能合并。给定校准 token 集合 <span class=\"kb-math kb-math-inline\">X=\\{x_1,\\dots,x_m\\}</span>，两个专家的相似度定义为输出余弦相似度平均：</p>\n<div class=\"kb-math kb-math-display\">\\mathrm{Sim}(E_i,E_j)=\n\\frac{1}{m}\\sum_{\\ell=1}^{m}\n\\frac{E_i(x_\\ell)\\cdot E_j(x_\\ell)}\n{\\|E_i(x_\\ell)\\|\\|E_j(x_\\ell)\\|}</div>\n<p>K-means 的目标是把专家输出表示分到 <span class=\"kb-math kb-math-inline\">k</span> 个簇 <span class=\"kb-math kb-math-inline\">Q_i</span>，最小化簇内距离：</p>\n<div class=\"kb-math kb-math-display\">J=\\sum_{i=1}^{k}\\sum_{E_j\\in Q_i}\\|Y_j-C_i\\|^2</div>\n<p>这里 <span class=\"kb-math kb-math-inline\">Y_j</span> 是专家 <span class=\"kb-math kb-math-inline\">E_j</span> 在校准集上的输出集合，<span class=\"kb-math kb-math-inline\">C_i</span> 是簇中心。使用输出而不是权重相似度很关键，因为两个专家即使权重坐标不同，也可能对真实数据产生相似函数行为；反过来，权重接近也不保证经过 SwiGLU 等非线性后输出相似。</p>\n<p>第二阶段是 Subspace Expert Merging。对一个簇 <span class=\"kb-math kb-math-inline\">Q</span> 内的专家，分别对 <span class=\"kb-math kb-math-inline\">W_{\\mathrm{gate}}, W_{\\mathrm{up}}, W_{\\mathrm{down}}</span> 做联合分解。论文把同组专家权重拼接后做 SVD：</p>\n<div class=\"kb-math kb-math-display\">\\mathrm{SVD}\\left([W^{(1)};\\ldots;W^{(n)}]\\right)\n=\nU\\Sigma [V^{(1)};\\ldots;V^{(n)}]^T</div>\n<p>其中 <span class=\"kb-math kb-math-inline\">U\\Sigma</span> 被看作同组专家共享的正交基底，<span class=\"kb-math kb-math-inline\">V^{(i)}</span> 则保留第 <span class=\"kb-math kb-math-inline\">i</span> 个专家在该共享基底下的特有投影。这样，容易冲突的原始参数先被对齐到同一个低维子空间，再只对 <span class=\"kb-math kb-math-inline\">V</span> 侧做合并，避免把未对齐的权重方向直接平均。</p>\n<p>合并 <span class=\"kb-math kb-math-inline\">V</span> 时，Sub-MoE 使用路由频率作为权重。对专家 <span class=\"kb-math kb-math-inline\">i</span>，采样频率为：</p>\n<div class=\"kb-math kb-math-display\">f(V_i)=\n\\frac{\\sum_{x\\in X}\\mathbf{1}[i\\in\\mathrm{TopK}(G(x),k)]}{|X|}</div>\n<p>合并后的 <span class=\"kb-math kb-math-inline\">V</span> 为：</p>\n<div class=\"kb-math kb-math-display\">V_{\\mathrm{merged}}=\n\\frac{\\sum_{i\\in Q}f(V_i)\\cdot V_i}{\\sum_{i\\in Q}f(V_i)}</div>\n<p>最终重构：</p>\n<div class=\"kb-math kb-math-display\">W_{\\mathrm{merged}}=U\\Sigma V_{\\mathrm{merged}}^T</div>\n<p>这个设计的直觉是：共享 <span class=\"kb-math kb-math-inline\">U\\Sigma</span> 负责对齐同组专家的共同表达空间，频率加权的 <span class=\"kb-math kb-math-inline\">V_{\\mathrm{merged}}</span> 负责按真实路由分布保留更常用专家的特征。论文还在合并前对 <span class=\"kb-math kb-math-inline\">V_i</span> 使用 TIES-style sparsification，以减少方向符号冲突。</p>\n<p>Sub-MoE† 进一步压缩专家内部维度。它用输入激活统计构造 whitening/activation-aware 矩阵 <span class=\"kb-math kb-math-inline\">S_i</span>，先分解激活加权权重：</p>\n<div class=\"kb-math kb-math-display\">W_i&#x27; = W_iS_i,\\quad\n\\mathrm{SVD}([W&#x27;^{(1)};\\ldots;W&#x27;^{(n)}])\n=\nU&#x27;\\Sigma&#x27;[V&#x27;^{(1)};\\ldots;V&#x27;^{(n)}]^T</div>\n<p>合并时把 <span class=\"kb-math kb-math-inline\">S_i^{-1}</span> 映射回原空间：</p>\n<div class=\"kb-math kb-math-display\">V_{\\mathrm{merged}}=\n\\frac{\\sum_{i\\in Q}f(V_i)\\cdot V&#x27;^{(i)}S_i^{-1}}{\\sum_{i\\in Q}f(V_i)}</div>\n<p>再通过截断 <span class=\"kb-math kb-math-inline\">\\Sigma&#x27;</span> 中较小或低重要性的奇异值控制压缩率：</p>\n<div class=\"kb-math kb-math-display\">W_{\\mathrm{merged}}^{\\mathrm{trunc}}\n=\nU&#x27;\\cdot\\mathrm{Trunc}(\\Sigma&#x27;)\\cdot V_{\\mathrm{merged}}^T</div>\n<p>这一步把专家数量压缩与专家内部低秩压缩串联起来，适合显存预算更紧的部署场景。它的风险也更高，因为截断奇异值会直接丢弃部分表达能力，因此论文把它作为 Sub-MoE 的扩展版本，而非基础专家合并的必要步骤。</p>\n<div class=\"key-point\">💡 关键：Sub-MoE 的核心不是“平均相似专家”，而是“先把专家权重投到共享子空间，再在专家特有分量上按路由频率融合”。</div>\n<h5>与剪枝和普通合并的区别</h5>\n<p>专家剪枝直接删除低频或低贡献专家，优点是简单，缺点是丢掉专家知识；普通专家合并在原始权重空间做加权平均，容易产生参数冲突。Sub-MoE 处在两者之间：它保留每个被合并专家在 <span class=\"kb-math kb-math-inline\">V</span> 分量中的投影，再通过共享 <span class=\"kb-math kb-math-inline\">U\\Sigma</span> 对齐后重构一个代表专家，因此比剪枝保留更多信息，也比原始权重平均更稳定。</p>",
      "quiz": {
        "q": "Sub-MoE 为什么要在联合 SVD 后主要合并 V 矩阵？",
        "options": [
