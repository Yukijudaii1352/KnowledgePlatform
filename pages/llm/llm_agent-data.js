/**
 * llm_agent-data.js — 由 pipeline/build.py 于 2026-05-20 17:49:45 自动生成。
  ...
  "algos": [
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>加权投票变体</strong>：可选地用模型输出概率 \\(P(\\mathbf{r}_i, \\mathbf{a}_i \\mid \\text{prompt}, \\text{question})\\) 对每条路径加权后再聚合",
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>动态停止策略</strong>：三种终止条件——成功（编译+测试全通过）、停滞检测（连续 \\(N=2\\) 轮无改进）、振荡检测（代码相似度 \\(\\tau=0.9\\)），最大 50 轮",
