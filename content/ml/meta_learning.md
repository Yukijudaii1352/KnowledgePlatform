...
page_desc: 回顾从 Siamese Networks、MAML、ProtoNet 到 TTT-Discover、FSPO 的元学习发展脉络，涵盖度量学习、优化初始化与快速适应三大范式及
  2026 年前沿突破
hero_pills:
- "\U0001F3F7️ Few-shot Learning · Optimization-based · Metric-based · Fast Adaptation"
...
num: 1
name: Siamese
full_name: 孪生网络 (Siamese Neural Networks)
year: '2015'
org: 多伦多大学
parent: —
...
num: 2
name: MatchingNet
full_name: 匹配网络 (Matching Networks)
year: '2016'
org: DeepMind
parent: siamese
...
#### 📝 一句话总结
MatchingNet 的核心目标是：首创情节训练范式与全上下文嵌入。
...
num: 3
name: L2L
full_name: 以梯度下降学习梯度下降 (Learning to Learn by Gradient Descent)
year: '2016'
org: DeepMind
parent: —
paper_url: https://arxiv.org/abs/1606.04474
project_url: ''
category: optimization
...
num: 9
name: RelationNet
full_name: 关系网络 (Relation Network)
year: '2018'
org: 萨里大学
parent: proto_net
...
num: 10
name: TADAM
full_name: 任务自适应度量 (Task Dependent Adaptive Metric)
year: '2018'
org: Element AI
parent: proto_net
...
num: 12
name: SNAIL
full_name: 简单神经注意力学习器 (Simple Neural Attentive Learner)
year: '2018'
org: UC Berkeley
parent: mann
...
num: 13
name: LEO
full_name: 潜嵌入优化 (Latent Embedding Optimization)
year: '2019'
org: DeepMind
parent: maml
paper_url: https://arxiv.org/abs/1807.05960
project_url: ''
category: optimization
...
num: 14
name: ANIL
full_name: 几乎无内循环 (Almost No Inner Loop)
year: '2020'
org: Google Brain
parent: maml
paper_url: https://arxiv.org/abs/1909.09157
project_url: ''
category: optimization
...
#### 📝 一句话总结
ANIL 的核心目标是：揭示MAML成功源于特征复用而非快速学习。
...
num: 16
name: TTT-Discover
full_name: 测试时发现 (Test-Time Training Discover)
year: '2026.01'
...
#### 📝 一句话总结
TTT-Discover 的核心目标是：测试时更新权重实现数学发现与GPU加速。
...
num: 17
name: MASS
full_name: 元适应自合成 (Meta-Adaptation with Self-Synthesis)
year: '2026.03'
org: arXiv
parent: maml
paper_url: https://arxiv.org/abs/2603.03524
project_url: ''
category: frontier
