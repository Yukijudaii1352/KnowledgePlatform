/**
 * llm_safety-data.js — 由 pipeline/build.py 于 2026-05-13 14:56:46 自动生成。
...
window.PAGE_CONFIG = {
  ...
  "algos": [
    ...
    },
    {
      ...
      "summary": "Self-Reminder 的核心目标是：系统提示词防御指令。",
      "keyPoints": [
        "核心动机：系统提示词防御指令",
        "代表机构：Academic"
      ],
      "detail": "<p>系统提示词防御指令</p>"
    },
    {
      "id": "llama_guard",
      "num": 7,
    ...
    },
    {
      ...
      "summary": "DPO 的核心目标是：直接偏好优化无需奖励模型。",
      "keyPoints": [
        "核心动机：直接偏好优化无需奖励模型",
        "演化来源：继承或改进自 rlhf",
        "代表机构：Stanford"
      ],
      "detail": "<p>直接偏好优化无需奖励模型</p>"
    },
    {
      "id": "safe_rlhf",
      "num": 15,
