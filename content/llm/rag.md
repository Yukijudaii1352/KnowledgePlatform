...
hero_pills:
- "\U0001F3F7️ RAG · Dense Retrieval · Knowledge Augmentation · Agentic AI"
...
#### 📝 一句话总结
Self-RAG 的核心目标是：反射Token自主决策检索时机并批判结果事实性。
...
#### 📝 一句话总结
GraphRAG 的核心目标是：知识图谱全局关系推理，解决跨文档总结难题。
