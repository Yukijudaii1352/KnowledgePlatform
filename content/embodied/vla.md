...
#### 📝 一句话总结
RT-1 的核心目标是：TokenLearner压缩视觉实现3Hz控制。
...
#### 📝 一句话总结
OpenVLA 的核心目标是：双视觉特征7B超越55B RT-2-X。
...
#### 📝 一句话总结
Helix-02 的核心目标是：双系统架构支持200Hz全身控制。
