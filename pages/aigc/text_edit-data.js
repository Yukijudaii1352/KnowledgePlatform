/**
 * text_edit-data.js — 由 pipeline/build.py 于 2026-06-15 18:08:20 自动生成。
...
window.PAGE_CONFIG = {
  ...
  "overview": [
    {
      "title": "",
      "body_html": "<h1>最新综述：基于文生图-扩散模型的多模态引导下的图像编辑技术</h1>\n<ul>\n<li>来源平台: <strong>zhihu</strong>（知乎专栏文章）</li>\n<li>原文链接: <a href=\"https://zhuanlan.zhihu.com/p/707806560\">https://zhuanlan.zhihu.com/p/707806560</a></li>\n<li>作者: soul</li>\n</ul>\n<hr />\n<p>最新综述：基于文生图-扩散模型的多模态引导下的图像编辑技术</p>\n<h1>最新综述：基于文生图-扩散模型的多模态引导下的图像编辑技术</h1>\n<p>作者: soul, 赞: 8</p>\n<p>近期，复旦大学 FVL 实验室和南洋理工大学的研究人员对于多模态引导的基于文生图（Text-to-Image，T2I）大模型的图像编辑算法进行了总结和回顾。综述涵盖 300 多篇相关研究，调研的最新模型截止至今年 6 月。</p>\n<p>论文：A Survey of Multimodal-Guided Image Editing with Text-to-Image Diffusion Models</p>\n<ul>\n<li>作者：Xincheng Shuai, Henghui Ding, Xingjun Ma, Rongcheng Tu, Yu-Gang Jiang, Dacheng Tao</li>\n<li>机构：复旦大学 FVL 实验室，南洋理工大学</li>\n<li>研究主题：图像和视频编辑、多模态学习</li>\n<li>论文地址：<a href=\"https://link.zhihu.com/?target=https%3A//arxiv.org/abs/2406.14555\">https://arxiv.org/abs/2406.14555</a></li>\n<li>项目地址：<a href=\"https://link.zhihu.com/?target=https%3A//github.com/xinchengshuai/Awesome-Image-Editing\">https://github.com/xinchengshuai/Awesome-Image-Editing</a></li>\n</ul>\n<p><img alt=\"\" src=\"https://pic4.zhimg.com/v2-21bdfb43da836e48f6dfaefe4606fb13_1440w.jpg\" /></p>\n<p>图2.综述框架</p>\n<p><strong>图像编辑</strong>旨在根据用户的特定需求编辑给定的合成图像或真实图像。作为人工智能生成内容（AIGC）领域中一个有前景且具有挑战性的领域，<strong>图像编辑</strong>得到了广泛研究。</p>\n<p>近期，大规模文生图（T2I）扩散模型驱动了<strong>图像编辑</strong>技术的发展。这些模型根据文本提示生成图像，展示了惊人的生成能力，已成为<strong>图像编辑</strong>的常用工具。<strong>基于 T2I 的图像编辑</strong>方法显著提升了编辑性能，为用户提供了使用多模态条件引导进行内容修改的接口。</p>\n<p>该论文对<strong>基于 T2I 扩散模型的多模态引导下的图像编辑</strong>技术进行了全面回顾。</p>\n<p>该综述主要包括：</p>\n<ol>\n<li>从更一般性的角度定义了图像编辑任务的范围，并详细描述了各种控制信号和编辑场景。</li>\n<li>该综述提出了一个统一框架将编辑过程表示为不同算法族的组合。这个框架为用户提供了一个设计空间，以实现特定目标。</li>\n<li>通过全面的定性和定量实验来说明各种组合的特性以及适应场景。</li>\n<li>回顾了 2D 技术在视频编辑中的应用，重点介绍了解决帧间不一致性的问题。</li>\n<li>最后也讨论了该领域的开放性挑战，并提出了潜在的未来研究方向。</li>\n</ol>\n<h2><strong>综述亮点</strong></h2>\n<ol>\n<li><strong>图像编辑任务的范围</strong></li>\n</ol>\n<p>相比于现有的算法以及此前的编辑综述，该论文对于图像编辑任务的定义更加广泛。</p>\n<p>具体地，论文将编辑任务分为 content-aware 和 content-free 场景组。</p>\n<ul>\n<li>content-aware 场景组：组内的场景为之前的文献所讨论的主要任务，它们的共性是保留图像中的一些低级语义特征，如编辑无关区域的像素内容，或图像结构。</li>\n<li>content-free 场景组：论文将定制化任务（customization）纳入到此场景组中，将这一类保留高级语义（如主体身份信息，或者其他细粒度属性）的任务作为对常规的编辑场景的补充。</li>\n</ul>\n<p><img alt=\"\" src=\"https://picx.zhimg.com/v2-e8346a8fefcf81119422251aee3c1b71_1440w.jpg\" /></p>\n<p>图 1. Survey 讨论的各种编辑场景</p>\n<p><strong>2. 一般性编辑算法的统一框架</strong><br />\n由于编辑场景的多样性，现有的算法无法很好的解决所有的需求。因此论文将现有的编辑过程形式化为一个统一的框架，将其表示为两个算法族的组合。<br />\n此外，论文也通过定性和定量实验分析了不同组合的特性与适应场景，为用户提供了一个良好的设计空间以适应不同的编辑目标。同时，该框架也为研究者们提供了一个较好的参考，以设计出性能更优的算法。</p>\n<p><img alt=\"\" src=\"https://pic2.zhimg.com/v2-16935a3ca0b30e46b316b61bf373d3ff_1440w.jpg\" /></p>\n<p>图 3. 一般性编辑算法的统一框架</p>\n<p><img alt=\"\" src=\"https://pic1.zhimg.com/v2-4ddc6af16b45eb1e83bdd878bc6313e0_1440w.jpg\" /><img alt=\"\" src=\"https://pic1.zhimg.com/v2-3064602127726a3cadf21c12765ce2bc_1440w.jpg\" /><img alt=\"\" src=\"https://pica.zhimg.com/v2-3ad38606ee602e4cf7d5c89b34bf9d5a_1440w.jpg\" /><img alt=\"\" src=\"https://pic2.zhimg.com/v2-3236b58381549a690295d82b18183665_1440w.jpg\" /></p>\n<p>图 15. Content-aware 任务的注入方案</p>\n<p><img alt=\"\" src=\"https://pic4.zhimg.com/v2-a3ca60e118d91779b39c76333931c1d3_1440w.jpg\" /></p>\n<p>图 16. Content-free 任务的注入方案</p>\n<ol>\n<li><strong>统一框架在多模态编辑任务中的应用</strong><br />\n论文通过定性实验说明了各个组合在多模态编辑任务中的应用：</li>\n</ol>\n<p><img alt=\"\" src=\"https://pica.zhimg.com/v2-970bb48a697b824c05ada4fff0ab0e42_1440w.jpg\" /></p>\n<p><strong>4. 不同组合在文本引导编辑场景下的比较</strong></p>\n<p>对于常见的文本引导的编辑任务，研究者通过设计了多个具有挑战性的定性实验，以说明不同组合所适合的编辑场景。</p>\n<p>此外，该研究也相应地收集了高质量和具有一定难度的数据集，以定量地说明各种组合中的先进算法在不同场景下的性能。</p>\n<p>对于 content-aware 任务，研究者主要考虑对象操作（增 / 删 / 替换），属性改变，风格迁移。</p>\n<p>特别地，研究者考虑了具有挑战性的实验设置：</p>\n<ol>\n<li>多目标编辑。</li>\n<li>对于图像的语义布局影响较大的用例。</li>\n</ol>\n<p>研究者也收集了这些复杂场景的高质量图片，并对不同组合中的先进算法进行全面定量比较。</p>\n<p><img alt=\"\" src=\"https://pica.zhimg.com/v2-fa9240590097635dd5abe7e8c9878784_1440w.jpg\" /></p>\n<p>图13. Content-aware 任务中各个组合的定性比较</p>\n<p>对于 content-free 任务，研究者主要考虑基于主体驱动的（subject-driven）定制化任务，并考虑了多种场景，如更换背景，与物体交互，行为改变，以及风格改变。</p>\n<p>研究者也定义了大量的文本引导模板，并对各个方法的整体性能进行定量分析。</p>\n<p><img alt=\"\" src=\"https://picx.zhimg.com/v2-2b400c529f3bf70870d9dd0af041d54f_1440w.jpg\" /></p>\n<p>图 14.Content-free 任务中各个组合的定性比较</p>\n<p><strong>5. 未来研究方向</strong></p>\n<ol>\n<li>Content-aware 任务的挑战。对于 content-aware 编辑任务的挑战，现有方法无法同时处理多种编辑场景和控制信号。这一限制迫使应用在不同任务之间切换合适的后端算法。此外，一些高级方法在易用性方面不友好。某些方法需要用户调整关键参数以获得最佳结果，而其他方法则需要繁琐的输入，例如源和目标提示，或辅助掩码。</li>\n<li>Content-free 任务的挑战。对于 content-free 编辑任务，现有方法在测试时调优过程冗长且存在过拟合问题 。一些研究旨在通过优化少量参数或从头开始训练模型来缓解这一问题。然而，它们常常会丢失个性化主体的细节，或表现出较差的泛化能力。此外，当前方法在从少量图像中提取抽象概念方面也有所不足，它们无法完全将所需概念与其他视觉元素分离开来。</li>\n</ol>"
    }
  ],
  "latest_overview": [
    {
      "title": "",
      "body_html": "<h1>CVPR 2026 图像编辑趋势梳理：从参考一张图，到融合整个视觉世界</h1>\n<ul>\n<li>来源平台: <strong>zhihu</strong>（知乎专栏文章）</li>\n<li>原文链接: <a href=\"https://zhuanlan.zhihu.com/p/2043399180413096108\">https://zhuanlan.zhihu.com/p/2043399180413096108</a></li>\n<li>作者: AI科技评论</li>\n</ul>\n<hr />\n<p>CVPR 2026 图像编辑趋势梳理：从参考一张图，到融合整个视觉世界</p>\n<h1>CVPR 2026 图像编辑趋势梳理：从参考一张图，到融合整个视觉世界</h1>\n<p>作者: AI科技评论, 赞: 2</p>\n<p><img alt=\"\" src=\"https://pic4.zhimg.com/v2-01602b234144cf1ba994eea4d218c973_1440w.jpg\" /></p>\n<p>复杂视觉关系成为生成模型的新考题。</p>\n<p>编辑丨马晓宁</p>\n<p><strong><em>*<img alt=\"\" src=\"https://pic4.zhimg.com/v2-6a7f46d4391e7003d356222bebf86631_1440w.jpg\" /></em></strong>*</p>\n<p>图像生成行业正在从“生成能力竞争”进入“可控能力竞争”。</p>\n<p>过去，模型的核心价值主要体现在能否生成高质量、高清晰度、风格丰富的单张图像；而随着文生图、图生图和指令式编辑能力逐渐成熟，新的瓶颈开始显现：模型能否理解多张图片之间的关系，能否在不同视角和场景中保持同一对象的一致性，能否把多个参考来源自然融合到同一画面中，能否在数据缺失或退化时恢复可信细节，以及能否让用户精确控制每一次编辑的幅度。</p>\n<p>这种变化也反映在 CVPR 2026 的相关研究中。越来越多工作开始从单张图像生成，转向多图关系建模、跨图像一致性保持、复杂场景组合、连续可控编辑和高质量视觉数据恢复。这说明图像生成和编辑的重点已经不只是“能不能生成”，而是模型能否在复杂约束下稳定理解对象、结构、关系和用户意图。</p>\n<p>更深层来看，视觉生成模型正在从单次输出工具走向复杂视觉系统。它需要同时处理身份保持、结构对齐、语义融合、细节恢复和人机交互等问题。</p>\n<p>也正因为如此，当前研究的重点正在从单张图像质量，转向多图一致性、组合泛化能力、底层数据表示以及精细化控制能力。谁能更好地把这些能力统一起来，谁就更接近下一阶段真正可用、可信、可控的视觉生成模型。</p>\n<p><strong>01</strong></p>\n<h2></h2>\n<h2><strong><em>*</em>*当图像模型不再只会「生成一张图」</strong>****</h2>\n<p><strong>《GroupEditing: Edit Multiple Images in One Go》</strong>关注的是“多图一致编辑”问题，相关研究来自香港科技大学、清华大学、上海交通大学和悉尼科技大学。论文主要研究如何对一组相关图片进行统一修改，并保证编辑后的结果在外观、身份、结构和语义上保持一致。</p>\n<p>以往的图像编辑方法大多针对单张图片，如果把同一个指令分别应用到多张相关图片上，很容易出现编辑效果不统一的问题。比如同一个物体在不同视角或姿态下，颜色、形状或身份特征可能会被改得不一致。</p>\n<p>针对这一问题，论文提出了 GroupEditing 框架，把一组静态图片看作“伪视频帧”，借助视频生成模型本身擅长保持连续帧一致性的特点，来提升多张图片之间的编辑一致性。</p>\n<p><img alt=\"\" src=\"https://pic2.zhimg.com/v2-bcf18d022dc0b64087892fa2328d5b11_1440w.jpg\" /></p>\n<p>同时，论文还引入 VGGT 来提取图片之间的几何对应关系，并设计了 Ge-RoPE 和 Identity-RoPE 两个模块。前者帮助不同图片中的对应区域更好对齐，后者帮助同一对象在不同图片中保持身份和外观一致。也就是说，模型不仅知道“要改什么”，还能够更好地判断“不同图片中哪里是同一个对象或区域”。</p>\n<p>这篇论文的亮点在于，它将图像编辑从单张图片扩展到一组相关图片，适用于商品多角度图、角色形象保持、同一物体不同视角编辑等场景。</p>\n<p>方法上，它巧妙地结合了视频模型的一致性能力和显式几何对齐信息，使多图编辑结果更加稳定、统一。实验结果也表明，GroupEditing 在编辑质量、语义一致性和跨图像一致性方面都优于已有方法。</p>\n<p>在多图一致编辑的基础上，<strong>《MICo-150K: A Comprehensive Dataset Advancing Multi-Image Composition》</strong>进一步关注多图组合生成问题，相关研究来自香港理工大学、清华大学、中山大学和 OPPO 研究院。</p>\n<p>论文主要研究的是多图组合生成，也就是给模型多张参考图片，让它根据文本指令把这些图片中的人物、物体、服装或场景自然地组合到一张新图中，同时保持身份一致、语义合理和画面协调。</p>\n<p>这项任务的难点在于，模型不仅要理解每张参考图中的关键内容，还要把多个来源的信息融合到同一场景里。例如，把一个人物、一件衣服、几个物体和一个背景组合成一张完整图片时，既不能丢失参考图中的身份特征，也不能让画面看起来像简单拼贴。</p>\n<p>为了解决训练数据不足的问题，论文提出了 MICo-150K 数据集，系统覆盖 3 大类、7 个子任务和 27 种细粒度组合类型，并加入 De&amp;Re 任务，即先把真实复杂图像拆解成组件，再重新组合。</p>\n<p>在数据构建上，作者先收集并清洗人物、物体、服装和场景等高质量源图，再用 GPT-4o 生成多图组合指令，并通过 Nano-Banana 合成目标图像。</p>\n<p>之后，论文使用 QwenVL2.5-72B、ArcFace 和人工筛选来检查生成结果，确保参考图片中的关键内容被正确保留，最终形成面向多图组合生成的大规模高质量数据集。</p>\n<p><img alt=\"\" src=\"https://pic4.zhimg.com/v2-7c783e4979535ecfafe0297b2ed784ef_1440w.jpg\" /></p>\n<p>论文还提出了 MICo-Bench 评测基准和 Weighted-Ref-VIEScore 指标，用来更全面地评估多图组合生成的效果。实验中，作者用 MICo-150K 微调了多个开源模型，结果显示这些模型的多图组合能力都有明显提升。</p>\n<p>其中基于 Qwen-Image-Edit 微调得到的 Qwen-MICo，在三图组合任务上接近甚至优于 Qwen-Image-2509，同时还能支持任意数量的多图输入。</p>\n<p>这篇论文的亮点在于，它不是单纯提出一个新模型，而是系统补齐了多图组合生成领域的数据、任务分类、评测基准和基础模型。MICo-150K 为模型学习多图融合、身份保持和复杂场景组合提供了大规模训练资源；</p>\n<p>MICo-Bench 和 Weighted-Ref-VIEScore 则让这类任务有了更专门的评测方式。总体来看，这篇论文的核心贡献是推动多图生成从“能参考一张图”走向“能理解并融合多张图”。</p>\n<p>前两篇论文主要围绕多图编辑和多图生成展开，而<strong>《Reparameterized Tensor Ring Functional Decomposition for Multi-Dimensional Data Recovery》</strong>则从多维数据表示与恢复的角度切入，相关研究来自湖南师范大学数学与统计学院、计算与随机数学教育部重点实验室，以及南方科技大学统计与数据科学系。</p>\n<p>论文主要研究的是多维数据恢复问题，例如图像修复、去噪、超分辨率和点云恢复。它关注的核心是：如何用更紧凑、更连续的方式表示高维数据，并从缺失、稀疏或退化的观测中恢复出高质量结果。</p>\n<p>传统的张量环分解 TR 适合表示高阶张量，但通常依赖固定网格上的离散数据，难以处理连续信号或非规则采样数据。</p>\n<p>为了解决这个问题，论文提出了 TRFD，也就是张量环函数分解，用隐式神经表示 INR 来参数化张量因子，使模型可以从连续坐标中生成张量表示。这样一来，方法不仅能处理常规网格数据，也能处理点云这类非网格数据。</p>\n<p>不过，直接用 INR 学习张量因子会遇到一个问题：模型容易先学习低频内容，而对细节纹理、边缘结构等高频信息建模不足。</p>\n<p><img alt=\"\" src=\"https://pica.zhimg.com/v2-6871c6d85987b6bb76ebab9cbb6a93ba_1440w.jpg\" /></p>\n<p>论文通过频域分析指出，张量环因子的频率特性会直接影响最终恢复结果的频率表现，因此如果因子本身缺少高频成分，恢复出的图像或点云也会缺少细节。</p>\n<p>针对这一问题，论文提出了 RepTRFD，也就是重参数化张量环函数分解。它把每个张量环因子表示成“可学习的潜在张量”和“固定基”的结构化组合，从而改善训练动态，让模型更容易学习高频细节。同时，论文还给出了固定基的初始化方法，并证明了模型的 Lipschitz 连续性，以保证训练过程更加稳定。</p>\n<p>这篇论文的亮点在于，它不是单纯提高一个视觉任务的效果，而是从张量表示和频率学习的角度改进多维数据恢复框架。</p>\n<p>方法既保留了张量环分解紧凑、高效的优势，又通过 INR 获得了连续建模能力，再通过重参数化增强了高频细节恢复能力。实验表明，RepTRFD 在图像修复、去噪、超分辨率和点云恢复等任务上整体优于已有方法，并且在相近计算量下取得了更好的恢复质量。</p>\n<p>在多维数据恢复之外，《SliderEdit: Continuous Image Editing with Fine-Grained Instruction Control》又回到图像编辑场景，但它关注的重点是编辑过程中的精细控制能力，相关研究来自马里兰大学和 Adobe 研究院。</p>\n<p>论文主要研究的是指令式图像编辑中的“连续可控”问题，也就是让用户不仅能用文字告诉模型要改什么，还能像调节滑杆一样精确控制每个编辑指令的强弱。</p>\n<p>现有的图像编辑模型通常会把指令一次性完整执行，例如“把头发变卷”“让人物微笑”“把背景换成夜晚”。但用户很难控制这些变化到底要多强，是轻微微笑还是大笑，是稍微变卷还是非常卷。尤其当一个提示词里包含多个编辑要求时，模型往往缺少对单个指令的独立控制能力。</p>\n<p><img alt=\"\" src=\"https://picx.zhimg.com/v2-8486a52abf2d83ae592286ffa5ea3091_1440w.jpg\" /></p>\n<p>为了解决这个问题，论文提出了 SliderEdit 框架。它会把一个复杂编辑指令拆成多个子指令，并为每个子指令提供一个可调节的滑杆。</p>\n<p>用户可以通过滑杆连续控制某个编辑效果的强度，甚至可以让某个效果被削弱、正常执行或进一步放大。这样一来，图像编辑就不再是“改或不改”的离散操作，而变成了更细腻、可交互的连续控制过程。</p>\n<p>方法上，SliderEdit 的核心是利用现代多模态扩散 Transformer 中的指令相关 token 表示。作者发现，某些文本 token 会集中控制对应的视觉编辑效果，因此可以通过对这些 token 进行调节来控制编辑强度。</p>\n<p>论文进一步提出 Partial Prompt Suppression 损失，让模型学习如何只抑制某一个子指令的视觉影响，同时保留其他编辑效果。它还使用轻量级的低秩适配器 LoRA，不需要为每个属性或概念单独训练一个新模型。</p>\n<p>这篇论文的亮点在于，它把图像编辑从“固定强度的文字指令”推进到了“可连续调节的交互式编辑”。它不仅支持单个属性的强弱控制，也支持多指令场景下对不同编辑方向分别调节。</p>\n<p>论文还将方法应用到 FLUX-Kontext 和 Qwen-Image-Edit 等先进图像编辑模型上，实验显示 SliderEdit 在编辑连续性、语义解耦、身份保持和用户可控性方面都有明显优势。</p>\n<p><img alt=\"\" src=\"https://pica.zhimg.com/v2-7d048427de4d0fe63dc45fc1a4adb2f8_1440w.jpg\" /></p>\n<p>//</p>"
    }
  ],
  "graph": {
    "nodes": [
  ...
  "algos": [
    ...
    },
    {
      ...
      "detail": "<h3>1. 从BN到IN再到AdaIN的演进逻辑</h3>\n<p>论文的核心洞察建立在对归一化层作用的重新理解之上：</p>\n<p><strong>Batch Normalization (BN)</strong>：对一个batch内所有样本的同一通道计算统计量并归一化\n<div class=\"kb-math kb-math-display\">\\text{BN}(x) = \\gamma \\cdot \\frac{x - \\mu_B}{\\sigma_B} + \\beta</div></p>\n<p><strong>Instance Normalization (IN)</strong>：对单个样本的单个通道计算统计量并归一化\n<div class=\"kb-math kb-math-display\">\\text{IN}(x) = \\gamma \\cdot \\frac{x - \\mu(x)}{\\sigma(x)} + \\beta</div></p>\n<p><strong>关键发现</strong>：IN在风格迁移中优于BN，不是因为对batch统计量的不变性，而是因为<strong>IN执行了一种风格归一化</strong>——它将每个样本的特征统计量归一化到固定值，等价于移除了原始图像的风格信息（因为风格信息编码在特征的均值和方差中）。</p>\n<p><strong>Conditional Instance Normalization (CIN)</strong>：Dumoulin等人发现，仅改变IN中的仿射参数γ和β就能生成完全不同的风格，这进一步证实了特征统计量承载风格信息的假设。但CIN需要为每个风格学习一组参数，无法泛化。</p>\n<p><strong>Adaptive Instance Normalization (AdaIN)</strong>：自然的推广——不再学习固定的γ和β，而是直接从风格图像的特征中计算：</p>\n<div class=\"kb-math kb-math-display\">\\text{AdaIN}(x, y) = \\sigma(y) \\cdot \\frac{x - \\mu(x)}{\\sigma(x)} + \\mu(y)</div>\n<p>其中 $x$ 是内容特征，$y$ 是风格特征。这个操作将内容特征的通道均值对齐到风格特征的均值，方差对齐到风格特征的方差，<strong>无需学习任何参数</strong>。</p>\n<p><img alt=\"AdaIN架构图\" src=\"https://ar5iv.labs.arxiv.org/html/1703.06868/assets/x2.png\" />\n<em>图：AdaIN风格迁移网络架构。固定的VGG编码器提取内容和风格特征，AdaIN层在特征空间执行风格迁移，可训练的解码器将结果映射回图像空间。</em></p>\n<h3>2. 网络架构详解</h3>\n<pre><code>┌─────────────────────────────────────────────────────────┐\n│                    Style Transfer Network T              │\n│                                                          │\n│  Content Image c ──→ ┌──────────────┐                    │\n│                      │  VGG-19 编码器 f │──→ f(c)         │\n│  Style Image s ────→ │ (固定, 到relu4_1) │──→ f(s)        │\n│                      └──────────────┘                    │\n│                              ↓                           │\n│                    ┌──────────────────┐                   │\n│                    │  AdaIN Layer      │                  │\n│                    │  t = AdaIN(f(c), f(s))              │\n│                    │  = σ(f(s))·(f(c)-μ(f(c)))/σ(f(c))  │\n│                    │    + μ(f(s))      │                  │\n│                    └──────────────────┘                   │\n│                              ↓                           │\n│                    ┌──────────────────┐                   │\n│                    │  解码器 g (可训练)  │                  │\n│                    │  镜像编码器结构     │                  │\n│                    │  池化→最近邻上采样   │                  │\n│                    │  ⚠️ 无BN/IN层      │                  │\n│                    └──────────────────┘                   │\n│                              ↓                           │\n│                    T(c,s) = g(t) (风格化图像)              │\n└─────────────────────────────────────────────────────────┘\n</code></pre>\n<p><strong>架构关键设计决策</strong>：\n- <strong>编码器</strong>：预训练VGG-19的前几层（到relu4_1），参数固定不训练\n- <strong>解码器</strong>：镜像编码器结构，所有池化层替换为最近邻上采样（减少棋盘效应），使用反射填充（减少边界伪影）\n- <strong>解码器不使用任何归一化层</strong>：IN会将输出归一化到单一风格，BN会将batch归一化到单一风格中心，两者都会破坏AdaIN注入的风格信息</p>\n<h3>3. 损失函数</h3>\n<p>总损失为内容损失和风格损失的加权组合：</p>\n<div class=\"kb-math kb-math-display\">\\mathcal{L} = \\mathcal{L}_c + \\lambda \\mathcal{L}_s</div>\n<p><strong>内容损失</strong>——使用AdaIN输出 $t$ 作为目标（而非常规的内容图像特征），加速收敛：</p>\n<div class=\"kb-math kb-math-display\">\\mathcal{L}_c = \\| f(g(t)) - t \\|_2</div>\n<p><strong>风格损失</strong>——匹配VGG多层特征的均值和标准差（与AdaIN操作一致，比Gram矩阵更简洁）：</p>\n<div class=\"kb-math kb-math-display\">\\mathcal{L}_s = \\sum_{i=1}^{L} \\| \\mu(\\phi_i(g(t))) - \\mu(\\phi_i(s)) \\|_2 + \\sum_{i=1}^{L} \\| \\sigma(\\phi_i(g(t))) - \\sigma(\\phi_i(s)) \\|_2</div>\n<p>其中 $\\phi_i$ 表示VGG-19的relu1_1、relu2_1、relu3_1、relu4_1层，各层等权。</p>\n<h3>4. 伪代码</h3>\n<p>```python\nimport torch\nimport torch.nn as nn</p>\n<p>def adaptive_instance_normalization(content_feat, style_feat):\n    \"\"\"AdaIN核心操作：对齐内容特征的统计量到风格特征\"\"\"\n    # 计算通道维度的均值和标准差 (B, C, H, W) → (B, C, 1, 1)\n    c_mean = content_feat.mean(dim=[2, 3], keepdim=True)\n    c_std  = content_feat.std(dim=[2, 3], keepdim=True) + 1e-5\n    s_mean = style_feat.mean(dim=[2, 3], keepdim=True)\n    s_std  = style_feat.std(dim=[2, 3], keepdim=True) + 1e-5</p>\n<pre><code># 归一化内容特征，然后用风格统计量重新缩放\nnormalized = (content_feat - c_mean) / c_std\nreturn s_std * normalized + s_mean\n</code></pre>\n<p>class StyleTransferNet(nn.Module):\n    def <strong>init</strong>(self, encoder, decoder):\n        super().<strong>init</strong>()\n        self.encoder = encoder  # 固定的VGG-19 (到relu4_1)\n        self.decoder = decoder  # 可训练的镜像解码器(无归一化层)\n        # 冻结编码器参数\n        for param in self.encoder.parameters():\n            param.requires_grad = False</p>\n<pre><code>def forward(self, content, style, alpha=1.0):\n    # 编码\n    content_feat = self.encoder(content)  # f(c)\n    style_feat = self.encoder(style)      # f(s)\n\n    # AdaIN特征对齐\n    t = adaptive_instance_normalization(content_feat, style_feat)\n\n    # 可选：内容-风格权重控制\n    t = alpha * t + (1 - alpha) * content_feat\n\n    # 解码回图像空间\n    return self.decoder(t)\n</code></pre>"
    },
    {
      "id": "wct",
      "num": 10,
    ...
    },
    {
      ...
      "detail": "<h3>Edit2Perceive</h3>\n<pre><code class=\"language-yaml\">id: edit2perceive\nname: Edit2Perceive\nfull_name: &quot;Edit2Perceive: Editing Models Are Strong Dense Perception Learners&quot;\nyear: 2026\ncategory: instruction_edit\nparent: icedit\npaper_url: https://arxiv.org/abs/2511.18673\nmotivation: 利用图像编辑扩散模型(I2I)替代传统文本生成模型(T2I)作为密集感知任务的基础，解决&quot;表征失配&quot;问题\n</code></pre>\n<h2>一句话总结</h2>\n<p>Edit2Perceive 提出将图像编辑扩散模型（FLUX.1 Kontext）重新用于深度估计、法线估计和交互式抠图等密集感知任务，通过像素空间一致性损失和理论最优的平方根深度映射，以单步推理在12个基准上取得全面SOTA。</p>\n<h2>核心要点</h2>\n<ol>\n<li>\n<p><strong>表征失配论点（Representation Mismatch）</strong>：T2I 模型的预训练目标是\"从文本创造图像\"，学到的是语义→像素的生成映射；而 I2I 编辑模型的预训练目标是\"理解输入图像并保持结构一致地修改\"，天然学到了像素→像素的结构化理解能力。后者与密集感知任务（像素→像素映射）更为匹配。消融实验显示 I2I 模型在 AbsRel 上比同架构 T2I 模型提升 25-27%。</p>\n</li>\n<li>\n<p><strong>像素空间一致性损失（Pixel-Space Consistency Loss）</strong>：流匹配损失 $\\mathcal{L}<em Cons=\"Cons\">{FM}$ 仅在潜空间监督，经 VAE 解码后可能放大误差。本文引入像素空间一致性损失 $\\mathcal{L}</em>$，针对三个任务分别设计：深度用 scale-shift invariant L1，法线用 atan2 角度误差（避免 arccos 梯度爆炸），抠图用前景/未知区域分离 L1。通过课程学习策略自适应加权。</p>\n</li>\n<li>\n<p><strong>平方根深度映射的理论推导</strong>：深度图呈长尾分布，BF16 精度下直接线性归一化会导致近场量化误差大。通过最小化相对量化误差积分并应用 Cauchy-Schwarz 不等式，理论证明最优映射函数为 $g(y) = \\sqrt{y}$，配合百分位归一化（p2/p98）映射到 [-1,1]。</p>\n</li>\n<li>\n<p><strong>单步推理高效架构</strong>：基于 FLUX.1 Kontext（DiT + Rectified Flow），仅微调 DiT 参数，冻结其余部分。训练和推理共享固定随机种子，使用单步 Euler 积分即可完成推理：$\\hat{z}<em>1 = z_0 + v</em>\\theta(\\text{concat}(z_0, c_x, c_p), t=0)$。</p>\n</li>\n<li>\n<p><strong>全面SOTA结果</strong>：仅用 74K 训练数据，在深度估计（5个基准，AvgRank 1.5）、法线估计（4个基准，AvgRank 1.4）、交互式抠图（3个基准，AvgRank 1.2）上全面超越现有方法，甚至超过使用 62.6M 数据的 DepthAnything V2。</p>\n</li>\n</ol>\n<h2>深入细节</h2>\n<h3>1. 整体架构</h3>\n<pre><code>┌─────────────────────────────────────────────────────┐\n│                  Edit2Perceive 框架                    │\n│                                                       │\n│  输入: RGB图像 x ∈ R^{H×W×3} + 文本提示 p            │\n│  输出: 密集感知图 ŷ ∈ R^{H×W×3}                      │\n│                                                       │\n│  ┌──────┐    ┌──────┐    ┌──────────────┐            │\n│  │ VAE  │───→│concat│───→│  DiT (FLUX.1 │───→ v_θ   │\n│  │Encode│    │z_t,  │    │  Kontext)    │            │\n│  │ x→c_x│    │c_x,  │    │  仅微调DiT   │            │\n│  │ y→z_1│    │c_p   │    └──────────────┘            │\n│  └──────┘    └──────┘                                 │\n│                                                       │\n│  训练: L = L_FM + λ·L_Cons                           │\n│  推理: ẑ₁ = z₀ + v_θ(concat(z₀,c_x,c_p), t=0)     │\n│        ŷ = VAE_Decode(ẑ₁)  [单步推理]                │\n└─────────────────────────────────────────────────────┘\n</code></pre>\n<p><strong>核心设计选择</strong>：选择 I2I 编辑模型而非 T2I 生成模型。FLUX.1 Kontext 通过序列拼接机制统一处理文本和图像输入，使用共享+任务特定的 Transformer 块提取特征，天然具备保持输入图像结构一致性的能力。</p>\n<h3>2. 训练流程伪代码</h3>\n<pre><code class=\"language-python\"># Edit2Perceive 训练伪代码\ndef train_step(x, y, p, step, total_steps_per_epoch):\n    &quot;&quot;&quot;\n    x: 输入RGB图像, y: 目标密集感知图(depth/normal/alpha)\n    p: 文本提示 (如 &quot;estimate depth map&quot;)\n    &quot;&quot;&quot;\n    # 1. 数据预处理 (任务特定)\n    y_norm = task_preprocess(y)  # sqrt映射+归一化(depth) / 单位化(normal) / 二值化(matting)\n\n    # 2. VAE编码\n    c_x = vae_encode(x)          # 条件图像潜码\n    z_1 = vae_encode(y_norm)     # 目标潜码\n    c_p = text_encode(p)         # 文本嵌入\n\n    # 3. Rectified Flow 前向过程\n    z_0 = torch.randn_like(z_1)  # 固定种子的高斯噪声\n    t = torch.rand(1)            # 随机时间步 t ∈ [0,1]\n    z_t = (1 - t) * z_0 + t * z_1  # 直线插值\n    v_true = z_1 - z_0           # 真实速度\n\n    # 4. 模型预测速度\n    v_pred = dit_model(concat(z_t, c_x, c_p), t)\n\n    # 5. 流匹配损失\n    L_FM = mse_loss(v_pred, v_true)\n\n    # 6. 像素空间一致性损失 (需要单步推理得到预测)\n    z1_pred = z_0 + v_pred       # 单步Euler积分\n    y_pred = vae_decode(z1_pred) # 解码到像素空间\n    L_Cons = task_consistency_loss(y_pred, y)  # 任务特定损失\n\n    # 7. 自适应加权 (课程学习)\n    ratio = max(0, step / total_steps_per_epoch - 1)  # 第一个epoch为0\n    lambda_w = (L_FM.detach().abs() / (L_Cons.detach().abs() + 1e-3)) * ratio\n\n    # 8. 总损失\n    loss = L_FM + lambda_w * L_Cons\n    loss.backward()\n</code></pre>\n<h3>3. 三个任务的一致性损失设计</h3>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>任务</th>\n<th>损失函数</th>\n<th>设计动机</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><strong>深度估计</strong></td>\n<td>Scale-Shift Invariant L1: 先最小二乘对齐 $\\hat{y}<em align=\"align\">{align}=s\\hat{y}+t$，再计算 $|\\hat{y}</em>-y|_1$</td>\n<td>深度预测的绝对尺度不确定，需要先对齐再比较</td>\n</tr>\n<tr>\n<td><strong>法线估计</strong></td>\n<td>atan2 角度误差: $\\text{atan2}(|y \\times \\hat{y}|, y \\cdot \\hat{y})$</td>\n<td>等价于 arccos 但梯度稳定，避免共线时梯度爆炸</td>\n</tr>\n<tr>\n<td><strong>交互式抠图</strong></td>\n<td>区域分离 L1: 未知区域 $\\mathcal{U}$ 和已知区域 $\\mathcal{K}$ 分别计算 L1 并求和</td>\n<td>关注边缘过渡区域的精细细节</td>\n</tr>\n</tbody>\n</table></div>\n<h3>4. 平方根深度映射推导</h3>\n<p><strong>问题</strong>：深度图在 BF16 精度下直接线性归一化，近场（小深度值）区域量化误差大。</p>\n<p><strong>形式化</strong>：寻找最优非线性映射 $g(y)$ 最小化相对量化误差积分：</p>\n<div class=\"kb-math kb-math-display\">\\min_g \\frac{1}{512(y_{max}-y_{min})} \\int_{y_{min}}^{y_{max}} \\frac{g(y)_{max}-g(y)_{min}}{y \\cdot g&#x27;(y)} dy</div>\n<p><strong>推导</strong>：应用 Cauchy-Schwarz 不等式，证明当 $g'(y) \\propto 1/\\sqrt{y}$ 时积分最小，得到：</p>\n<div class=\"kb-math kb-math-display\">g(y) = \\sqrt{y}</div>\n<p><strong>后处理</strong>：对 $\\sqrt{y}$ 应用百分位归一化（p2/p98）映射到 [-1,1]，再复制为3通道。</p>\n<p><strong>直觉理解</strong>：平方根映射\"拉伸\"了近场深度值的表示范围，\"压缩\"了远场的范围，使得 BF16 的有限精度在各深度段的相对误差更均匀。消融实验显示该映射在大深度范围的室外数据集（KITTI）上改进尤为显著。</p>\n<h3>5. 自适应损失加权策略</h3>\n<div class=\"kb-math kb-math-display\">\\lambda = \\frac{\\text{sg}(|\\mathcal{L}_{FM}|)}{\\text{sg}(|\\mathcal{L}_{Cons}|) + \\epsilon} \\cdot \\max\\left(0, \\frac{\\text{step}}{N_{step}} - 1\\right)</div>\n<ul>\n<li><strong>第一个 epoch</strong>：$\\lambda = 0$，纯流匹配训练，让模型先学习扩散先验</li>\n<li><strong>后续 epoch</strong>：$\\lambda$ 线性增长，逐渐引入像素级约束</li>\n<li><strong>自适应比例</strong>：$|\\mathcal{L}<em Cons=\"Cons\">{FM}|/|\\mathcal{L}</em>|$ 自动平衡两个损失的量级</li>\n</ul>\n<h3>6. 关键消融实验结果</h3>\n<p><strong>I2I vs T2I 基础模型对比</strong>（相同架构 FLUX.1 Kontext vs FLUX.1）：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>设置</th>\n<th>NYU AbsRel↓</th>\n<th>KITTI AbsRel↓</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>T2I (基础)</td>\n<td>~6.0</td>\n<td>~10.9</td>\n</tr>\n<tr>\n<td>I2I (基础)</td>\n<td>~4.5</td>\n<td>~7.9</td>\n</tr>\n<tr>\n<td><strong>相对提升</strong></td>\n<td><strong>~25%</strong></td>\n<td><strong>~27%</strong></td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>各组件贡献</strong>：\n- 一致性损失：在 T2I 上提升大（AbsRel 降 1.0-1.4），在 I2I 上提升较小（降 0.3-0.4），说明 I2I 已有较好结构理解\n- Sqrt 映射：在室外大范围数据集（KITTI）上提升最显著（AbsRel 降 1.4-3.0）</p>\n<h3>7. 训练细节</h3>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>参数</th>\n<th>值</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>基础模型</td>\n<td>FLUX.1 Kontext (DiT架构)</td>\n</tr>\n<tr>\n<td>微调范围</td>\n<td>仅 DiT 参数，其余冻结</td>\n</tr>\n<tr>\n<td>优化器</td>\n<td>AdamW (depth/normal), AdamW8bit (matting)</td>\n</tr>\n<tr>\n<td>学习率</td>\n<td>3×10⁻⁵</td>\n</tr>\n<tr>\n<td>Batch size</td>\n<td>16</td>\n</tr>\n<tr>\n<td>收敛步数</td>\n<td>~6000 步</td>\n</tr>\n<tr>\n<td>训练时间</td>\n<td>~1.5 天 / 单张 H200 GPU</td>\n</tr>\n<tr>\n<td>推理步数</td>\n<td>1 步 (单步 Euler)</td>\n</tr>\n<tr>\n<td>训练数据量</td>\n<td>59K-77K (远少于竞品的数百万)</td>\n</tr>\n</tbody>\n</table></div>\n<h3>8. 与相关工作的关键区别</h3>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>方法</th>\n<th>基础模型</th>\n<th>推理步数</th>\n<th>像素损失</th>\n<th>深度映射</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>Marigold</td>\n<td>SD (T2I)</td>\n<td>多步 DDIM</td>\n<td>✗</td>\n<td>线性</td>\n</tr>\n<tr>\n<td>Lotus</td>\n<td>SD (T2I)</td>\n<td>1步</td>\n<td>✗</td>\n<td>线性</td>\n</tr>\n<tr>\n<td>E2E-FT</td>\n<td>SD (T2I)</td>\n<td>1步</td>\n<td>✗</td>\n<td>线性</td>\n</tr>\n<tr>\n<td>FE2E (concurrent)</td>\n<td>编辑模型</td>\n<td>1步</td>\n<td>✗</td>\n<td>对数</td>\n</tr>\n<tr>\n<td><strong>Edit2Perceive</strong></td>\n<td><strong>FLUX Kontext (I2I)</strong></td>\n<td><strong>1步</strong></td>\n<td><strong>✓</strong></td>\n<td><strong>√y (理论最优)</strong></td>\n</tr>\n</tbody>\n</table></div>\n<h2>练习题</h2>\n<ol>\n<li>\n<p><strong>概念理解</strong>：为什么作者认为 I2I 编辑模型比 T2I 生成模型更适合密集感知任务？请从预训练目标的角度解释\"表征失配\"（Representation Mismatch）论点。</p>\n</li>\n<li>\n<p><strong>数学推导</strong>：在平方根深度映射的推导中，为什么 Cauchy-Schwarz 不等式能给出 $g'(y) \\propto 1/\\sqrt{y}$ 的结论？请尝试写出关键推导步骤。</p>\n</li>\n<li>\n<p><strong>工程设计</strong>：一致性损失中法线估计使用 atan2 而非 arccos 计算角度误差。请解释 arccos 在什么情况下会出现梯度爆炸，以及 atan2 如何避免这个问题。</p>\n</li>\n<li>\n<p><strong>消融分析</strong>：消融实验显示一致性损失在 T2I 模型上的提升（AbsRel 降 1.0-1.4）远大于在 I2I 模型上的提升（降 0.3-0.4）。如何解释这种\"互补关系\"？这对选择基础模型有什么启示？</p>\n</li>\n<li>\n<p><strong>拓展思考</strong>：本文的方法框架是否可以扩展到其他密集预测任务（如语义分割、光流估计）？如果可以，需要设计怎样的一致性损失和数据表示？如果不可以，瓶颈在哪里？</p>\n</li>\n</ol>"
    },
    {
      "id": "if-edit",
      "num": 34,
    ...
    },
    {
      ...
      "detail": "<h3>1. 核心动机：为什么要分离 Designer 和 Painter？</h3>\n<p><img alt=\"Figure 1: 三种图像编辑范式对比\" src=\"https://arxiv.org/html/2509.01986v4/2509.01986v4/x1.png\" /></p>\n<div class=\"key-point\">💡 <strong>关键洞察</strong>：现有方法要么让生成模型同时承担理解和生成（All-in-One），要么用 MLLM 做简单的 prompt 改写（MLLM-Assisted），都没有充分发挥 MLLM 的深度理解能力。DIM 的核心思想是：<strong>让 MLLM 像设计师一样深度思考编辑方案，让 DiT 像画家一样专注执行</strong>。</div>\n<p>论文将现有图像编辑方法分为三类范式：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>范式</th>\n<th>代表方法</th>\n<th>理解能力</th>\n<th>生成能力</th>\n<th>问题</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><strong>All-in-One</strong></td>\n<td>InstructPix2Pix, UltraEdit</td>\n<td>内置于生成模型</td>\n<td>✅</td>\n<td>理解能力受限于生成模型</td>\n</tr>\n<tr>\n<td><strong>MLLM-Assisted</strong></td>\n<td>Step1X-Edit, LLMCOT-Edit</td>\n<td>MLLM 做 prompt 改写</td>\n<td>✅</td>\n<td>MLLM 仅做浅层辅助</td>\n</tr>\n<tr>\n<td><strong>Designer-Painter (DIM)</strong></td>\n<td>本文</td>\n<td>MLLM 深度 CoT 规划</td>\n<td>✅</td>\n<td>充分发挥两者优势</td>\n</tr>\n</tbody>\n</table></div>\n<h3>2. DIM 数据集构建</h3>\n<h4>2.1 DIM-T2I：14M 长上下文图文对</h4>\n<p>DIM-T2I 的核心目标是训练模型理解超长、超详细的文本描述，为后续 CoT 编辑打基础。</p>\n<p><strong>21 维度标注体系</strong>（覆盖理解数据集和基准中最常见的人-物交互维度）：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>维度类别</th>\n<th>具体维度</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>空间与计数</td>\n<td>空间关系、对象计数、相对大小</td>\n</tr>\n<tr>\n<td>属性</td>\n<td>颜色、材质、形状、纹理</td>\n</tr>\n<tr>\n<td>动作与交互</td>\n<td>人体动作、物体交互、面部表情</td>\n</tr>\n<tr>\n<td>场景</td>\n<td>场景类型、天气、光照、时间</td>\n</tr>\n<tr>\n<td>文本与符号</td>\n<td>OCR 文本、标志、品牌</td>\n</tr>\n<tr>\n<td>高级语义</td>\n<td>情感氛围、风格、文化元素</td>\n</tr>\n<tr>\n<td>其他</td>\n<td>深度关系、遮挡关系、透视</td>\n</tr>\n</tbody>\n</table></div>\n<p>数据来源为真实图像（非 AI 生成），使用内部模型生成长描述，平均 prompt 长度 <strong>146.76 词</strong>，远超现有数据集：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>数据集</th>\n<th>规模</th>\n<th>来源</th>\n<th>平均词数</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>MidJourney-V6</td>\n<td>1.2M</td>\n<td>AI Gen.</td>\n<td>9.59</td>\n</tr>\n<tr>\n<td>JourneyDB</td>\n<td>4.2M</td>\n<td>AI Gen.</td>\n<td>29.27</td>\n</tr>\n<tr>\n<td>Dimba</td>\n<td>0.3M</td>\n<td>Real</td>\n<td>78.29</td>\n</tr>\n<tr>\n<td><strong>DIM-T2I</strong></td>\n<td><strong>14M</strong></td>\n<td><strong>Real</strong></td>\n<td><strong>146.76</strong></td>\n</tr>\n</tbody>\n</table></div>\n<h4>2.2 DIM-Edit：233K CoT 编辑对</h4>\n<p><img alt=\"Figure 3: DIM-Edit 数据集构建流程\" src=\"https://arxiv.org/html/2509.01986v4/2509.01986v4/x3.png\" /></p>\n<p>DIM-Edit 从三个来源构建：\n- <strong>UltraEdit</strong>（160K 对）：AI 生成的编辑对，覆盖面广\n- <strong>ShareGPT-4o-Image</strong>（46K 对）：GPT-4o 生成的高质量图像对\n- <strong>HumanEdit</strong>（27K 对）：人工标注的真实编辑对</p>\n<p><strong>4 步 CoT 想象力标注</strong>（由 GPT-4o 生成）：</p>\n<pre><code>输入: 原始图像 + 编辑指令 + 编辑后图像\n↓\nStep 1: Global Layout Perception (全局布局感知)\n  &quot;图像展示了一个现代厨房，中央有一个大理石台面岛台，\n   左侧是不锈钢冰箱，右侧是窗户...&quot;\n↓\nStep 2: Local Object Perception (局部对象感知)  \n  &quot;岛台上有一个蓝色陶瓷花瓶(高约30cm)，旁边是一组\n   三个玻璃调味罐，花瓶中有白色百合花...&quot;\n↓\nStep 3: Edit Area Localization (编辑区域定位)\n  &quot;编辑区域集中在岛台中央偏左的位置，大约占图像宽度\n   的20%和高度的35%，即花瓶所在区域...&quot;\n↓\nStep 4: Edited Image Imagination (编辑结果想象)\n  &quot;花瓶的颜色从蓝色变为红色，保持相同的陶瓷质感和形状，\n   花瓶中的百合花不受影响，周围的调味罐和台面保持不变，\n   光照和阴影相应调整以匹配红色花瓶的反射特性...&quot;\n</code></pre>\n<div class=\"key-point\">💡 <strong>为什么需要 4 步 CoT？</strong> 消融实验表明，去掉 CoT 数据后 ImgEdit 分数从 3.67 降至 3.43（-0.24），说明 CoT 想象力标注显著提升了模型对编辑意图的理解和执行精度。</div>\n<h3>3. 模型架构</h3>\n<p><img alt=\"Figure 2: DIM 框架整体架构\" src=\"https://arxiv.org/html/2509.01986v4/2509.01986v4/x2.png\" /></p>\n<p>DIM-4.6B 由三个组件构成：</p>\n<pre><code>┌─────────────────────────────────────────────────┐\n│                DIM-4.6B 架构                      │\n│                                                   │\n│  ┌──────────────┐    ┌─────────┐    ┌───────────┐ │\n│  │ Qwen2.5-VL-3B│───→│ 2-Layer │───→│SANA1.5    │ │\n│  │  (Frozen)    │    │  MLP    │    │  1.6B     │ │\n│  │  MLLM        │    │Connector│    │  (DiT)    │ │\n│  │              │    │         │    │(Trainable)│ │\n│  └──────┬───────┘    └─────────┘    └─────┬─────┘ │\n│         │                                  │       │\n│   文本+视觉编码              Flow Matching 生成    │\n│   (理解 CoT 指令)            (执行图像生成/编辑)   │\n└─────────────────────────────────────────────────┘\n</code></pre>\n<p><strong>各组件详解：</strong></p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>组件</th>\n<th>参数量</th>\n<th>是否训练</th>\n<th>功能</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>Qwen2.5-VL-3B</td>\n<td>~3B</td>\n<td>❄️ 冻结</td>\n<td>编码文本指令和输入图像，提取语义特征</td>\n</tr>\n<tr>\n<td>2-Layer MLP</td>\n<td>~0.02B</td>\n<td>✅ 训练</td>\n<td>将 MLLM 特征空间映射到 DiT 条件空间</td>\n</tr>\n<tr>\n<td>SANA1.5-1.6B</td>\n<td>~1.6B</td>\n<td>✅ 训练</td>\n<td>基于 Flow Matching 的 DiT 生成器</td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>生成过程的数学表述：</strong></p>\n<p>SANA1.5 使用 Flow Matching 目标训练。给定噪声样本 $z_t = (1-t) \\cdot z_0 + t \\cdot \\epsilon$，模型学习预测速度场：</p>\n<div class=\"kb-math kb-math-display\">\\mathcal{L}_{FM} = \\mathbb{E}_{t, z_0, \\epsilon} \\left[ \\| v_\\theta(z_t, t, c) - (\\epsilon - z_0) \\|^2 \\right]</div>\n<p>其中 $c$ 是来自 Qwen2.5-VL-3B 经 MLP 映射后的条件特征，包含文本指令和（编辑时的）输入图像信息。</p>\n<p><strong>推理时的 Designer-Painter 流程：</strong></p>\n<p>```python</p>"
    },
    {
      "id": "poem",
      "num": 38,
