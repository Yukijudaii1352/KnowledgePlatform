/**
 * rag-data.js — 由 pipeline/build.py 于 2026-06-15 18:08:26 自动生成。
...
window.PAGE_CONFIG = {
  ...
  "algos": [
    ...
    },
    {
      ...
      "detail": "<h4>1. 问题背景与动机</h4>\n<p>开放域问答（Open-domain QA）需要从大规模知识源中检索并理解信息来回答问题。传统方法分为两类：\n- <strong>抽取式方法</strong>：从检索到的段落中抽取span作为答案（如DrQA、DPR+Reader）\n- <strong>生成式方法</strong>：用seq2seq模型直接生成答案（如RAG、BART-based）</p>\n<p><strong>核心挑战</strong>：如何高效地让模型利用大量检索段落中的证据？</p>\n<ul>\n<li>将所有passage拼接后输入encoder → <strong>二次方复杂度</strong>，无法扩展到100个passage</li>\n<li>RAG对每个passage独立生成再边际化 → <strong>无法在生成过程中跨passage推理</strong></li>\n</ul>\n<h4>2. FiD 方法详解</h4>\n<p><strong>输入格式</strong>：每个检索到的passage与问题拼接，添加特殊标记：</p>\n<pre><code>question: {问题文本} title: {段落标题} context: {段落正文}\n</code></pre>\n<p><strong>核心架构</strong>（基于T5 seq2seq模型）：</p>\n<pre><code>┌─────────────────────────────────────────────────────────┐\n│                    FiD Architecture                      │\n│                                                          │\n│  Passage 1: &quot;question: Q title: T1 context: C1&quot;         │\n│  Passage 2: &quot;question: Q title: T2 context: C2&quot;         │\n│  ...                                                     │\n│  Passage k: &quot;question: Q title: Tk context: Ck&quot;         │\n│       │           │           │           │              │\n│       ▼           ▼           ▼           ▼              │\n│  ┌─────────┐ ┌─────────┐ ┌─────────┐ ┌─────────┐       │\n│  │Encoder 1│ │Encoder 2│ │Encoder 3│ │Encoder k│       │\n│  │(shared) │ │(shared) │ │(shared) │ │(shared) │       │\n│  └────┬────┘ └────┬────┘ └────┬────┘ └────┬────┘       │\n│       │           │           │           │              │\n│       └───────────┴─────┬─────┴───────────┘              │\n│                         │ Concatenate                    │\n│                         ▼                                │\n│              ┌──────────────────┐                        │\n│              │     Decoder      │                        │\n│              │ (Cross-Attention │                        │\n│              │  over ALL repr.) │                        │\n│              └────────┬─────────┘                        │\n│                       │                                  │\n│                       ▼                                  │\n│                    Answer                                │\n└─────────────────────────────────────────────────────────┘\n</code></pre>\n<p><strong>伪代码</strong>：</p>\n<pre><code class=\"language-python\">def fusion_in_decoder(question, passages, encoder, decoder):\n    &quot;&quot;&quot;\n    question: str - 输入问题\n    passages: List[Passage] - 检索到的k个段落，每个含title和text\n    encoder/decoder: T5的encoder和decoder（共享参数）\n    &quot;&quot;&quot;\n    all_encoder_outputs = []\n\n    # Step 1: 独立编码每个passage（线性复杂度 O(k * n^2)）\n    for p in passages:\n        input_text = f&quot;question: {question} title: {p.title} context: {p.text}&quot;\n        tokens = tokenize(input_text)[:250]  # 截断到250 word pieces\n        enc_output = encoder(tokens)  # shape: [seq_len, d_model]\n        all_encoder_outputs.append(enc_output)\n\n    # Step 2: 拼接所有encoder输出\n    fused_repr = concatenate(all_encoder_outputs, dim=0)  \n    # shape: [k * seq_len, d_model]\n\n    # Step 3: Decoder通过cross-attention联合处理所有passage表示\n    answer = decoder.generate(\n        encoder_output=fused_repr,  # decoder对所有passage做cross-attention\n        decoding_strategy=&quot;greedy&quot;\n    )\n    return answer\n</code></pre>\n<p><strong>复杂度分析</strong>：</p>\n<p>设 $k$ 为passage数量，$n$ 为每个passage的token长度，$m$ 为decoder输出长度：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>方法</th>\n<th>Encoder复杂度</th>\n<th>Decoder复杂度</th>\n<th>总复杂度</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>全拼接（如SpanSeqGen）</td>\n<td>$O((kn)^2) = O(k^2 n^2)$</td>\n<td>$O(m \\cdot kn)$</td>\n<td>$O(k^2 n^2)$</td>\n</tr>\n<tr>\n<td><strong>FiD</strong></td>\n<td>$O(k \\cdot n^2)$</td>\n<td>$O(m \\cdot kn)$</td>\n<td>$O(k \\cdot n^2 + m \\cdot kn)$</td>\n</tr>\n<tr>\n<td>RAG（独立生成）</td>\n<td>$O(k \\cdot n^2)$</td>\n<td>$O(k \\cdot m \\cdot n)$</td>\n<td>$O(k \\cdot n^2)$</td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>关键洞察</strong>：\n- FiD的encoder复杂度随passage数<strong>线性增长</strong>（vs 全拼接的二次方），使得扩展到100个passage成为可能\n- 虽然decoder的cross-attention仍然是 $O(m \\cdot kn)$，但由于 $m$（答案长度）通常很短（几个token），这部分开销可控\n- 与RAG不同，FiD的decoder可以在<strong>同一个生成步骤中同时关注所有passage</strong>，实现真正的多证据融合</p>\n<h4>3. 检索模块</h4>\n<p>论文使用两种现成的检索器（不进行端到端训练）：</p>\n<ul>\n<li><strong>BM25</strong>：经典稀疏检索，用于SQuAD</li>\n<li><strong>DPR（Dense Passage Retrieval）</strong>：基于BERT的双编码器密集检索，用于NQ和TriviaQA</li>\n<li>使用FAISS库进行近似最近邻搜索</li>\n<li>Wikipedia被切分为不重叠的100-word段落</li>\n</ul>\n<h4>4. 实验结果</h4>\n<p><strong>主实验（Exact Match scores）</strong>：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>模型</th>\n<th>类型</th>\n<th>NQ</th>\n<th>TriviaQA</th>\n<th>SQuAD</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>DrQA (Chen et al., 2017)</td>\n<td>抽取式</td>\n<td>-</td>\n<td>-</td>\n<td>29.8</td>\n</tr>\n<tr>\n<td>BERTserini (Yang et al., 2019)</td>\n<td>抽取式</td>\n<td>38.6</td>\n<td>-</td>\n<td>38.6</td>\n</tr>\n<tr>\n<td>Multi-passage BERT (Wang et al., 2019)</td>\n<td>抽取式</td>\n<td>-</td>\n<td>-</td>\n<td>53.0</td>\n</tr>\n<tr>\n<td>ORQA (Lee et al., 2019)</td>\n<td>抽取式</td>\n<td>33.3</td>\n<td>45.0</td>\n<td>20.2</td>\n</tr>\n<tr>\n<td>REALM (Guu et al., 2020)</td>\n<td>抽取式</td>\n<td>40.4</td>\n<td>-</td>\n<td>-</td>\n</tr>\n<tr>\n<td>DPR (Karpukhin et al., 2020)</td>\n<td>抽取式</td>\n<td>41.5</td>\n<td>57.9</td>\n<td>36.7</td>\n</tr>\n<tr>\n<td>T5-11B (Roberts et al., 2020)</td>\n<td>Closed-book</td>\n<td>36.6</td>\n<td>60.5</td>\n<td>-</td>\n</tr>\n<tr>\n<td>GPT-3 few-shot (Brown et al., 2020)</td>\n<td>Closed-book</td>\n<td>29.9</td>\n<td>71.2</td>\n<td>-</td>\n</tr>\n<tr>\n<td>RAG (Lewis et al., 2020)</td>\n<td>生成式+检索</td>\n<td>44.5</td>\n<td>56.1</td>\n<td>-</td>\n</tr>\n<tr>\n<td><strong>FiD (base, 220M)</strong></td>\n<td><strong>生成式+检索</strong></td>\n<td><strong>48.2</strong></td>\n<td><strong>65.0</strong></td>\n<td><strong>56.7</strong></td>\n</tr>\n<tr>\n<td><strong>FiD (large, 770M)</strong></td>\n<td><strong>生成式+检索</strong></td>\n<td><strong>51.4</strong></td>\n<td><strong>67.6</strong></td>\n<td><strong>56.7</strong></td>\n</tr>\n</tbody>\n</table></div>\n<p><strong>Passage数量对性能的影响</strong>：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th style=\"text-align: center;\">Passages数量</th>\n<th style=\"text-align: center;\">NQ (base)</th>\n<th style=\"text-align: center;\">TriviaQA (base)</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td style=\"text-align: center;\">10</td>\n<td style=\"text-align: center;\">~42</td>\n<td style=\"text-align: center;\">~59</td>\n</tr>\n<tr>\n<td style=\"text-align: center;\">20</td>\n<td style=\"text-align: center;\">~44</td>\n<td style=\"text-align: center;\">~61</td>\n</tr>\n<tr>\n<td style=\"text-align: center;\">50</td>\n<td style=\"text-align: center;\">~45.5</td>\n<td style=\"text-align: center;\">~63.5</td>\n</tr>\n<tr>\n<td style=\"text-align: center;\">100</td>\n<td style=\"text-align: center;\">~46.5</td>\n<td style=\"text-align: center;\">~64.7</td>\n</tr>\n</tbody>\n</table></div>\n<p>关键发现：生成式模型性能随passage数量持续提升，而抽取式模型在10-20个passage后趋于饱和。</p>\n<p><strong>训练效率优化（Table 2）</strong>：</p>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th style=\"text-align: center;\">训练Passages数</th>\n<th style=\"text-align: center;\">NQ (无微调)</th>\n<th style=\"text-align: center;\">NQ (微调后)</th>\n<th style=\"text-align: center;\">TriviaQA (无微调)</th>\n<th style=\"text-align: center;\">TriviaQA (微调后)</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td style=\"text-align: center;\">5</td>\n<td style=\"text-align: center;\">37.8</td>\n<td style=\"text-align: center;\">45.0</td>\n<td style=\"text-align: center;\">58.1</td>\n<td style=\"text-align: center;\">64.2</td>\n</tr>\n<tr>\n<td style=\"text-align: center;\">10</td>\n<td style=\"text-align: center;\">42.3</td>\n<td style=\"text-align: center;\">45.3</td>\n<td style=\"text-align: center;\">61.1</td>\n<td style=\"text-align: center;\">63.6</td>\n</tr>\n<tr>\n<td style=\"text-align: center;\">25</td>\n<td style=\"text-align: center;\">45.3</td>\n<td style=\"text-align: center;\">46.0</td>\n<td style=\"text-align: center;\">63.2</td>\n<td style=\"text-align: center;\">64.2</td>\n</tr>\n<tr>\n<td style=\"text-align: center;\">50</td>\n<td style=\"text-align: center;\">45.7</td>\n<td style=\"text-align: center;\">46.0</td>\n<td style=\"text-align: center;\">64.2</td>\n<td style=\"text-align: center;\">64.3</td>\n</tr>\n<tr>\n<td style=\"text-align: center;\">100</td>\n<td style=\"text-align: center;\">46.5</td>\n<td style=\"text-align: center;\">-</td>\n<td style=\"text-align: center;\">64.7</td>\n<td style=\"text-align: center;\">-</td>\n</tr>\n</tbody>\n</table></div>\n<p>用25个passage训练 + 100个passage微调1000步 → 46.0 EM（仅需147 GPU hours vs 直接100个passage训练的425 GPU hours）。</p>\n<h4>5. 与相关方法的关键对比</h4>\n<div class=\"table-wrap\"><table>\n<thead>\n<tr>\n<th>维度</th>\n<th>FiD</th>\n<th>RAG</th>\n<th>REALM</th>\n<th>DPR (抽取式)</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>答案生成方式</td>\n<td>Seq2seq生成</td>\n<td>Seq2seq生成</td>\n<td>Span抽取</td>\n<td>Span抽取</td>\n</tr>\n<tr>\n<td>多passage融合</td>\n<td>Decoder联合attention</td>\n<td>边际化（独立生成后加权）</td>\n<td>边际化</td>\n<td>独立打分</td>\n</tr>\n<tr>\n<td>跨passage推理</td>\n<td>✅ 可以</td>\n<td>❌ 不行</td>\n<td>❌ 不行</td>\n<td>❌ 不行</td>\n</tr>\n<tr>\n<td>Encoder处理</td>\n<td>独立（线性）</td>\n<td>独立（线性）</td>\n<td>独立</td>\n<td>独立</td>\n</tr>\n<tr>\n<td>检索器训练</td>\n<td>冻结（不端到端）</td>\n<td>端到端</td>\n<td>端到端</td>\n<td>独立训练</td>\n</tr>\n<tr>\n<td>Passage数量</td>\n<td>100</td>\n<td>5-10</td>\n<td>5</td>\n<td>100</td>\n</tr>\n</tbody>\n</table></div>\n<h4>6. 训练细节</h4>\n<ul>\n<li><strong>预训练模型</strong>：T5-base (220M) / T5-large (770M)</li>\n<li><strong>优化器</strong>：Adam，学习率 $10^{-4}$（恒定），dropout 10%</li>\n<li><strong>训练</strong>：10k步，batch size 64，64张Tesla V100 32GB</li>\n<li><strong>评估</strong>：每500步评估，选验证集最优checkpoint</li>\n<li><strong>检索</strong>：100个passage，截断到250 word pieces</li>\n<li><strong>解码</strong>：贪心解码（greedy decoding）</li>\n<li><strong>答案处理</strong>：NQ/SQuAD训练时随机采样一个答案，TriviaQA用唯一人工答案</li>\n</ul>\n<h4>7. 局限性与未来方向</h4>\n<p>论文明确提出的未来方向：\n1. <strong>效率优化</strong>：当passage数量进一步增大时，decoder的cross-attention仍是瓶颈\n2. <strong>端到端检索</strong>：当前检索器是冻结的，未来计划将检索集成到模型中进行端到端学习\n3. <strong>检索质量依赖</strong>：模型性能上限受检索器质量制约</p>\n<hr />"
    },
    {
      "id": "contriever",
      "num": 6,
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "检索触发条件：临时生成句中任一 token 概率低于阈值 <span class=\"kb-math kb-math-inline\">\\theta</span> 即触发检索，无需额外训练",
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>推理时自适应检索</strong>：通过 Retrieve token 概率阈值 <span class=\"kb-math kb-math-inline\">\\delta</span> 控制检索频率，支持按需检索而非每步检索",
    ...
    },
    {
      ...
      "keyPoints": [
        ...
        "<strong>Faithfulness 指标</strong>：将答案分解为原子声明（statements），逐条用 LLM 验证是否可从上下文推断，<span class=\"kb-math kb-math-inline\">F = |V| / |S|</span>",
        "<strong>Answer Relevance 指标</strong>：从答案反向生成 <span class=\"kb-math kb-math-inline\">n</span> 个问题，计算与原始问题的平均余弦相似度，<span class=\"kb-math kb-math-inline\">\\text{AR} = \\frac{1}{n}\\sum_{i=1}^{n}\\text{sim}(q, q_i)</span>",
        "<strong>Context Relevance 指标</strong>：用 LLM 从上下文中提取回答问题所需的关键句子，<span class=\"kb-math kb-math-inline\">\\text{CR} = \\frac{|\\text{extracted sentences}|}{|\\text{total sentences in } c(q)|}</span>",
