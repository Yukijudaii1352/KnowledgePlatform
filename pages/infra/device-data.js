/**
 * device-data.js — 由 pipeline/build.py 于 2026-05-13 12:20:54 自动生成。
...
window.PAGE_CONFIG = {
  ...
  "algos": [
    ...
    },
    {
      ...
      "summary": "Habana Gaudi 的核心目标是：集成10×100GbE以太网支持RDMA横向扩展。",
      "keyPoints": [
        "核心动机：集成10×100GbE以太网支持RDMA横向扩展",
        "代表机构：Intel/Habana"
      ],
      "detail": "<p>集成10×100GbE以太网支持RDMA横向扩展</p>"
    },
    {
      "id": "cerebras_wse",
      "num": 17,
